...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1ADC (6876)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2987 (10631)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2A0F (10767)
{
...
int func_83() // Position - 0x784A (30794)
{
...
BOOL func_86(Player plParam0) // Position - 0x788E (30862)
{
...
BOOL func_94(Player plParam0) // Position - 0x8745 (34629)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD9F2 (55794)
{
...
BOOL func_223(Any* panParam0, BOOL bParam1) // Position - 0xE452 (58450)
{
	...
	if (func_257(*panParam0) || func_255(*panParam0) || Global_80551 == 1)
		return true;
...
int func_265(var uParam0, eCharacter echParam1) // Position - 0xFFB5 (65461)
{
	int num;
