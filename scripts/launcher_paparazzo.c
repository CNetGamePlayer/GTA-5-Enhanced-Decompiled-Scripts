...
void main() // Position - 0x0 (0)
{
	...
	iLocal_90 = func_299(CHAR_BEVERLY);
	hLocal_91 = joaat("pcj");
	iLocal_93 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114018[num /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_114018[num /*10*/].f_9));
			}
		}
	...
	if (!func_280(&unk63, &num, vector, 5f))
	{
		func_279();
	...
	while (true)
	{
		...
		if (num == 47)
			func_210(&num, vector, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		else if (num == 51)
			func_210(&num, vector, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
	
		func_209(num);
		func_201(&iLocal_93, &(num.f_9), vector);
	
		if (func_186(&num, 0))
		{
			if (func_185(num))
				func_182(num, &blLocal_95);
...
BOOL func_1(var uParam0) // Position - 0x29C (668)
{
...
BOOL func_2(Any* panParam0) // Position - 0x2BA (698)
{
	const char* str;
	var unk32;
	...
	if (!func_181())
	{
		while (!func_172(*panParam0))
		{
			...
			if (!func_214(panParam0, *panParam0 != 2))
			{
...
void func_3(int iParam0, const char* sParam1) // Position - 0x37B (891)
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x437 (1079)
{
	int num;
	int num2;
...
void func_5() // Position - 0x591 (1425)
{
	int i;
...
void func_6(int iParam0) // Position - 0x644 (1604)
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xA2C (2604)
{
	Global_65020 = true;
	Global_65023 = 1;
...
void func_8(int iParam0) // Position - 0xA77 (2679)
{
...
struct<2> func_9(int iParam0) // Position - 0xAAB (2731)
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xAE3 (2787)
{
	if (Global_65027)
		return;
...
void func_11() // Position - 0xB39 (2873)
{
	int i;
...
void func_12() // Position - 0xB66 (2918)
{
	int i;
...
void func_13() // Position - 0xB9D (2973)
{
	Global_65186 = 0;
	return;
}

void func_14() // Position - 0xBA9 (2985)
{
	Global_65046 = 0;
...
var func_15(Hash hParam0) // Position - 0xBFD (3069)
{
	var outValue;
...
void func_16() // Position - 0xC11 (3089)
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xC3B (3131)
{
...
void func_18() // Position - 0xC4F (3151)
{
	int i;
...
void func_19() // Position - 0xC88 (3208)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xCCA (3274)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xCF4 (3316)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xD07 (3335)
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xD24 (3364)
{
...
void func_24() // Position - 0xD69 (3433)
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19FD (6653)
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x2886 (10374)
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28A8 (10408)
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x2930 (10544)
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2970 (10608)
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x299E (10654)
{
...
int func_31(Vehicle veParam0) // Position - 0x2A7A (10874)
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2ABC (10940)
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2B1F (11039)
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2BAD (11181)
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2BEF (11247)
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E4B (11851)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2E57 (11863)
{
	int i;
...
int func_38(int iParam0) // Position - 0x3102 (12546)
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x31B2 (12722)
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x33A5 (13221)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x33C5 (13253)
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3476 (13430)
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35A5 (13733)
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3613 (13843)
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x36EC (14060)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3729 (14121)
{
...
Hash func_47(eCharacter echParam0) // Position - 0x374E (14158)
{
	return Global_2339[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x375D (14173)
{
...
int func_49(int iParam0, int iParam1) // Position - 0x38F7 (14583)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3926 (14630)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x393B (14651)
{
	int num;
	int num2;
...
int func_52() // Position - 0x396F (14703)
{
	return Global_1574927;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x397B (14715)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x399F (14751)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39B4 (14772)
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EFD (16125)
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x413F (16703)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_58() // Position - 0x4158 (16728)
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x4255 (16981)
{
	return Global_44886 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x4263 (16995)
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x4356 (17238)
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x45DE (17886)
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x467F (18047)
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4877 (18551)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55F8 (22008)
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5633 (22067)
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58A7 (22695)
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x58E3 (22755)
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E32 (24114)
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E76 (24182)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x661D (26141)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6664 (26212)
{
...
BOOL func_73(int iParam0) // Position - 0x66BF (26303)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x66CF (26319)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x672F (26415)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6B13 (27411)
{
	return Global_33792;
}

BOOL func_77(int iParam0) // Position - 0x6B1E (27422)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B2E (27438)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6BD0 (27600)
{
	Vector3 vector;
	var unk3;
...
Vector3 func_80() // Position - 0x7436 (29750)
{
...
int func_81() // Position - 0x7731 (30513)
{
	return Global_2652582.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7740 (30528)
{
...
BOOL func_83() // Position - 0x776A (30570)
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7782 (30594)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7797 (30615)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x77AE (30638)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7806 (30726)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x78B0 (30896)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7945 (31045)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7989 (31113)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7B0D (31501)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7B1B (31515)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x85E3 (34275)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x8665 (34405)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x86BD (34493)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x86C6 (34502)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_97(int iParam0, int iParam1) // Position - 0x89DE (35294)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8B6E (35694)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8B7E (35710)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658294[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8B9B (35739)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8BAB (35755)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8F15 (36629)
{
	return Global_102506.f_417 > 0;
}

var func_103() // Position - 0x8F26 (36646)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8F6C (36716)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8FF2 (36850)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x9025 (36901)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x9076 (36982)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x9118 (37144)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x913A (37178)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x9151 (37201)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x915E (37214)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x9198 (37272)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x91D3 (37331)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x920F (37391)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x9228 (37416)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x928B (37515)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x92A1 (37537)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x92B7 (37559)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x92F9 (37625)
{
...
struct<2> func_120(int iParam0) // Position - 0x9321 (37665)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x976E (38766)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAA46 (43590)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAD8C (44428)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAE31 (44593)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAECC (44748)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAEF2 (44786)
{
	Global_80560 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAF2A (44842)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAF83 (44931)
{
...
int func_130(Ped pedParam0) // Position - 0xB006 (45062)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB037 (45111)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB04C (45132)
{
	int num;
...
int func_133() // Position - 0xB0CE (45262)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB0FF (45311)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB11A (45338)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB166 (45414)
{
	int i;
...
BOOL func_137(Vehicle veParam0) // Position - 0xB1AF (45487)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB1CF (45519)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB1F0 (45552)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB243 (45635)
{
...
BOOL func_141(int iParam0) // Position - 0xB2C0 (45760)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB313 (45843)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB409 (46089)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB474 (46196)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4B3 (46259)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB602 (46594)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB61C (46620)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB675 (46709)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB6B6 (46774)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB6D8 (46808)
{
...
BOOL func_151() // Position - 0xB717 (46871)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB725 (46885)
{
	int num;
...
BOOL func_153() // Position - 0xB758 (46936)
{
...
void func_154(int iParam0) // Position - 0xB77F (46975)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB7A2 (47010)
{
...
void func_156() // Position - 0xB7DF (47071)
{
	Global_21866 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB7EF (47087)
{
...
BOOL func_158() // Position - 0xB846 (47174)
{
...
void func_159() // Position - 0xB868 (47208)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB87D (47229)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB8D5 (47317)
{
...
void func_162(Vehicle veParam0) // Position - 0xB92C (47404)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB958 (47448)
{
...
void func_164() // Position - 0xBAA9 (47785)
{
...
void func_165(int iParam0) // Position - 0xBAFA (47866)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBB2D (47917)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBBB7 (48055)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBC2B (48171)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_169(int iParam0) // Position - 0xBC39 (48185)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBC90 (48272)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_171(int iParam0) // Position - 0xBC9F (48287)
{
...
BOOL func_172(int iParam0) // Position - 0xBCE0 (48352)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBD25 (48421)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBD57 (48471)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBE8E (48782)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBEDD (48861)
{
	return func_177(iParam0, Global_44886);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBEEE (48878)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_178(int iParam0) // Position - 0xC0CF (49359)
{
	if (Global_44886 == 15)
		return false;
...
int func_179() // Position - 0xC0F1 (49393)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_180(const char* sParam0, int iParam1) // Position - 0xC102 (49410)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_181() // Position - 0xC14B (49483)
{
	if (Global_102454 == 10 || Global_102454 == 9)
		return true;
...
void func_182(int iParam0, var uParam1) // Position - 0xC16F (49519)
{
	switch (iParam0)
	{
		case 0:
...
Blip func_183(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC5DE (50654)
{
	Blip blip;
...
var func_184(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC60A (50698)
{
	if (bParam0)
		return uParam1;
...
BOOL func_185(int iParam0) // Position - 0xC621 (50721)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_186(var uParam0, int iParam1) // Position - 0xC6B0 (50864)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_187() // Position - 0xCE93 (52883)
{
	func_27(&(Global_105490.f_2890), &Global_105490, 0, 1, 1, 0);
	return;
}

BOOL func_188(var uParam0) // Position - 0xCEAE (52910)
{
	float num;
...
void func_189(int iParam0, var uParam1) // Position - 0xCF3C (53052)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_190(BOOL bParam0) // Position - 0xCFA0 (53152)
{
...
BOOL func_191(Vehicle veParam0) // Position - 0xD037 (53303)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_192(int iParam0) // Position - 0xD061 (53345)
{
	eCharacter character;
...
BOOL func_193() // Position - 0xD77E (55166)
{
	return Global_102493.f_1;
}

BOOL func_194() // Position - 0xD78C (55180)
{
	if (Global_99351 != -1)
...
BOOL func_195() // Position - 0xD7AF (55215)
{
...
BOOL func_196() // Position - 0xD7C9 (55241)
{
	if (Global_80566)
		return true;
...
BOOL func_197() // Position - 0xD7F3 (55283)
{
	return Global_102506.f_418 > 0;
}

BOOL func_198(int iParam0, int iParam1) // Position - 0xD804 (55300)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_199() // Position - 0xD83C (55356)
{
	return Global_1575092;
}

BOOL func_200() // Position - 0xD848 (55368)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_201(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD864 (55396)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_202(int iParam0, BOOL bParam1) // Position - 0xD955 (55637)
{
	if (iParam0 == -1)
		return;
...
int func_203(int iParam0) // Position - 0xD991 (55697)
{
	if (Global_80301 == iParam0)
		if (Global_80302 == -1)
...
void func_204(var uParam0, int iParam1) // Position - 0xD9CA (55754)
{
	BOOL flag;
	int i;
...
float func_205(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDA68 (55912)
{
...
BOOL func_206() // Position - 0xDAA2 (55970)
{
	return Global_99738;
}

void func_207(var uParam0) // Position - 0xDAAE (55982)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_208(uParam0);
...
void func_208(var uParam0) // Position - 0xDAC5 (56005)
{
	BOOL flag;
	int num;
	int i;
...
void func_209(int iParam0) // Position - 0xDBAD (56237)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
int func_210(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDBD5 (56277)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_158() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_205(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC5D (56413)
{
...
void func_212(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDC98 (56472)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDCEE (56558)
{
...
BOOL func_214(Any* panParam0, BOOL bParam1) // Position - 0xDD89 (56713)
{
	var unk;
	...
	if (func_251(*panParam0) || func_249(*panParam0) || Global_80551 == true)
		return true;
...
void func_215(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDFF9 (57337)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_216(int iParam0) // Position - 0xE351 (58193)
{
...
BOOL func_217(var uParam0) // Position - 0xE371 (58225)
{
...
BOOL func_218(var uParam0) // Position - 0xE389 (58249)
{
...
void func_219(var uParam0) // Position - 0xE3AE (58286)
{
	int i;
	int taskSequenceId;
...
void func_220(Object* pobParam0) // Position - 0xE6B2 (59058)
{
...
void func_221(var uParam0) // Position - 0xE6DD (59101)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE75D (59229)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_223(Ped pedParam0, Vehicle veParam1) // Position - 0xE91B (59675)
{
...
BOOL func_224(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE94B (59723)
{
	int i;
	int num;
...
BOOL func_225(int iParam0) // Position - 0xEC07 (60423)
{
...
BOOL func_226(Vehicle veParam0, int iParam1) // Position - 0xEC3B (60475)
{
	float xSize;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		if (func_237(veParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), veParam0))
		{
...
BOOL func_227(Vehicle veParam0, int iParam1) // Position - 0xECB1 (60593)
{
	return func_228(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_228(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xECC9 (60617)
{
	BOOL flag;
	var pedBoneCoords;
	int num;

	num = func_236(veParam0, pedParam1);
	...
	if (!func_232(veParam0, pedParam1, iParam2, iParam3))
		return false;
	...
	flag = func_229(&iLocal_35[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_35[num /*4*/].f_3), veParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_35[num /*4*/].f_3 < iParam4;
}

BOOL func_229(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xED8A (60810)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_230(Ped pedParam0, int iParam1) // Position - 0xEEB6 (61110)
{
...
int func_231() // Position - 0xEF7B (61307)
{
	int i;
...
BOOL func_232(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEFC5 (61381)
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_234(ENTITY::GET_ENTITY_COORDS(pedParam1, true) - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
	...
	if (iParam3 == 0)
		...
		entityForwardVector = { func_234(PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(veParam0, 31086, 0f, 0f, 0f)) };
...
float func_233(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF056 (61526)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_234(float fParam0, var uParam1, var uParam2) // Position - 0xF077 (61559)
{
	float num;
	float num2;
...
void func_235(var uParam0) // Position - 0xF0B6 (61622)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_236(Vehicle veParam0, Ped pedParam1) // Position - 0xF0D1 (61649)
{
	int i;
...
BOOL func_237(Vehicle veParam0) // Position - 0xF110 (61712)
{
...
BOOL func_238(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF138 (61752)
{
	float radius;
	float num;
	int weaponHash;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
	{
		...
		if (!bParam2)
		{
			if (func_242(veParam0, bParam1, radius, num))
				return true;
		
			if (func_239(veParam0, num, bParam3, bParam4))
				return true;
		}
		else
		{
...
BOOL func_239(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF233 (62003)
{
	float entityCoords;
	float num;
...
BOOL func_240(Vehicle veParam0, float fParam1) // Position - 0xF33F (62271)
{
	var outProjectile;
	var outCoords;
	...
	if (MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_GRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_SMOKEGRENADE"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_BZGAS"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_STICKYBOMB"), fParam1, &outCoords, &outProjectile, false) || MISC::GET_PROJECTILE_OF_PROJECTILE_TYPE_WITHIN_DISTANCE(veParam0, joaat("WEAPON_MOLOTOV"), fParam1, &outCoords, &outProjectile, false))
		if (func_241(veParam0, outCoords, 90f, 0))
			return true;

	return false;
}

BOOL func_241(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF3D4 (62420)
{
	var unk;
	var entityForwardVector;
	float num;

	unk = { func_234(uParam1 - ENTITY::GET_ENTITY_COORDS(veParam0, true)) };
...
BOOL func_242(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF462 (62562)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_243(int iParam0) // Position - 0xF4AA (62634)
{
...
void func_244(Vehicle veParam0) // Position - 0xF4F4 (62708)
{
	int taskSequenceId;
...
BOOL func_245(int iParam0) // Position - 0xF591 (62865)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_246(int iParam0) // Position - 0xF626 (63014)
{
...
BOOL func_247() // Position - 0xF665 (63077)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_248() // Position - 0xF682 (63106)
{
	if (Global_99351 != -1)
...
BOOL func_249(int iParam0) // Position - 0xF6A5 (63141)
{
...
BOOL func_250() // Position - 0xF6D9 (63193)
{
...
BOOL func_251(int iParam0) // Position - 0xF717 (63255)
{
	if (func_119(false))
...
BOOL func_254(var uParam0) // Position - 0xF811 (63505)
{
	int num;
	char* animDict;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_263(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict))
				return false;
		...
		case 2:
			...
			{
				if (func_260(&uParam0->f_28[0], CHAR_BEVERLY, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_258(&uParam0->f_28[1], num[3], -498.16565f, 228.62839f, 82.09948f, 292.9763f, PED_TYPE_MISSION);
			...
			{
				func_258(&uParam0->f_28[2], num[4], -498.30902f, 227.91116f, 82.105995f, 296.4216f, PED_TYPE_MISSION);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_256(&uParam0->f_35[0], num[1], -497.99f, 224.97f, 82.67f, 266.5f);
			...
			{
				func_256(&uParam0->f_35[1], num[2], -501.55f, 230.7f, 83.1f, 233.93f);
			...
			{
				func_255(&uParam0->f_41[0], num[5], -490.11f, 233.15f, 82.1f, 0f);
			...
			{
				func_255(&uParam0->f_41[1], num[6], -490.11f, 233.15f, 82.1f, 0f);
...
void func_255(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDD6 (64982)
{
	func_220(pobParam0);
...
void func_256(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xFDFD (65021)
{
	func_257(pveParam0);
...
void func_257(Vehicle* pveParam0) // Position - 0xFE40 (65088)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_258(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0xFEDC (65244)
{
	func_259(ppedParam0);
...
void func_259(Ped* ppedParam0) // Position - 0xFEFD (65277)
{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFF3E (65342)
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFF9A (65434)
{
	Hash model;
...
int func_262(Ped pedParam0, eCharacter echParam1) // Position - 0x1002B (65579)
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0x10071 (65649)
{
	int i;
...
BOOL func_264(var uParam0) // Position - 0x100A2 (65698)
{
	uParam0->f_16 = 3;
...
BOOL func_265(var uParam0) // Position - 0x100D6 (65750)
{
	int num;
	int i;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			func_256(&uParam0->f_35[0], num[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
BOOL func_266(var uParam0) // Position - 0x101C1 (65985)
{
	int num;
	var unk6;
	var unk10;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_260(&uParam0->f_28[0], CHAR_BEVERLY, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], true);
			...
			if (func_137(uParam0->f_28[0]))
			{
				...
				{
					func_255(&uParam0->f_41[3], num[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
BOOL func_267(var uParam0) // Position - 0x10704 (67332)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_263(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_260(&uParam0->f_28[0], CHAR_BEVERLY, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
				}
			...
			if (func_137(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_255(&uParam0->f_41[0], num[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_256(&uParam0->f_35[0], num[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
...
BOOL func_268(var uParam0) // Position - 0x10A46 (68166)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_260(&uParam0->f_28[0], CHAR_BEVERLY, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], PV_COMP_TASK, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_256(&uParam0->f_35[0], num[1], -159.56f, 275.41f, 93.14f, 102.75f);
...
void func_269(int iParam0, BOOL bParam1) // Position - 0x10D6A (68970)
{
	switch (iParam0)
	{
		case 46:
...
BOOL func_270(int iParam0) // Position - 0x10DF5 (69109)
{
	var unk;
	eCharacter character;
...
BOOL func_271(int iParam0) // Position - 0x10E46 (69190)
{
	const char* string2;
...
BOOL func_272(int iParam0) // Position - 0x10EFF (69375)
{
	var unk;
...
BOOL func_273(int iParam0) // Position - 0x10FC0 (69568)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_274(int iParam0, char* sParam1) // Position - 0x11045 (69701)
{
...
BOOL func_275(int iParam0) // Position - 0x11127 (69927)
{
...
BOOL func_276(int iParam0) // Position - 0x11152 (69970)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_277(int iParam0) // Position - 0x1117D (70013)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_278(int iParam0) // Position - 0x111A8 (70056)
{
	if (func_246(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_279() // Position - 0x111DD (70109)
{
...
BOOL func_280(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x111F7 (70135)
{
	int i;
...
BOOL func_281(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x1125C (70236)
{
	int num;
	char* str;
...
BOOL func_282(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x112D4 (70356)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_283(var uParam0, BOOL bParam1) // Position - 0x1134F (70479)
{
	if (bParam1)
	{
...
int func_284(var uParam0) // Position - 0x114BD (70845)
{
	if (func_218(uParam0))
	{
...
void func_285(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x114F3 (70899)
{
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x11513 (70931)
{
	func_287(&(uParam0->f_41), bParam1);
	return;
}

void func_287(var uParam0, BOOL bParam1) // Position - 0x11525 (70949)
{
	int i;
...
void func_288(Object* pobParam0, BOOL bParam1) // Position - 0x11563 (71011)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x1159E (71070)
{
	func_290(&(uParam0->f_35), bParam1);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x115B0 (71088)
{
	int i;
...
void func_291(Vehicle* pveParam0) // Position - 0x115ED (71149)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_292(var uParam0, int iParam1) // Position - 0x11625 (71205)
{
	func_293(&(uParam0->f_28), iParam1);
	return;
}

void func_293(var uParam0, int iParam1) // Position - 0x11637 (71223)
{
	int i;
...
void func_294(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11678 (71288)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_295(int iParam0) // Position - 0x116C8 (71368)
{
	if (*iParam0 == -1)
		return;
...
void func_296(char* sParam0) // Position - 0x11705 (71429)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_297(var uParam0) // Position - 0x11717 (71447)
{
	*uParam0 = -1;
...
void func_298() // Position - 0x1174A (71498)
{
...
Hash func_299(eCharacter echParam0) // Position - 0x11764 (71524)
{
	if (!func_36(echParam0))
