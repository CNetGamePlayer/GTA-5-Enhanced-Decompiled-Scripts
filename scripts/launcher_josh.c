...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1B19 (6937)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29C4 (10692)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2A4C (10828)
{
...
int func_83() // Position - 0x7887 (30855)
{
...
BOOL func_86(Player plParam0) // Position - 0x78CB (30923)
{
...
BOOL func_94(Player plParam0) // Position - 0x8782 (34690)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_218(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE2D9 (58073)
{
...
BOOL func_232(Any* panParam0, BOOL bParam1) // Position - 0xE804 (59396)
{
	...
	if (func_268(*panParam0) || func_266(*panParam0) || Global_80551 == 1)
		return true;
...
int func_279(var uParam0, eCharacter echParam1) // Position - 0x108E2 (67810)
{
	int num;
