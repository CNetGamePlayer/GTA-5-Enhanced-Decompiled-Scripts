...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19B4 (6580)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x285F (10335)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x28E7 (10471)
{
...
int func_83() // Position - 0x7721 (30497)
{
...
BOOL func_86(Player plParam0) // Position - 0x7765 (30565)
{
...
BOOL func_94(Player plParam0) // Position - 0x861D (34333)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_202(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD4AD (54445)
{
...
BOOL func_212(Any* panParam0, BOOL bParam1) // Position - 0xD8D5 (55509)
{
	...
	if (func_249(*panParam0) || func_247(*panParam0) || Global_80551 == 1)
		return true;
...
int func_265(var uParam0, eCharacter echParam1) // Position - 0x13A57 (80471)
{
	int num;
