...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1B4F (6991)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29FA (10746)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2A82 (10882)
{
...
int func_83() // Position - 0x78BC (30908)
{
...
BOOL func_86(Player plParam0) // Position - 0x7900 (30976)
{
...
BOOL func_94(Player plParam0) // Position - 0x87B8 (34744)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_206(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB6D (56173)
{
...
BOOL func_218(Any* panParam0, BOOL bParam1) // Position - 0xDFFC (57340)
{
	...
	if (func_255(*panParam0) || func_253(*panParam0) || Global_80551 == 1)
		return true;
...
int func_267(var uParam0, eCharacter echParam1) // Position - 0xFED3 (65235)
{
	int num;
