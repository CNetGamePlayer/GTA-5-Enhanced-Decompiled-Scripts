...
void main() // Position - 0x0 (0)
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114018[num /*10*/].f_9 != -1)
			{
				...
				func_297(&(Global_114018[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		{
			func_209(&num);
			func_204(&num, vector, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (num == 19)
		{
			func_209(&num);
			...
			if (AUDIO::HAS_SOUND_FINISHED(iLocal_94))
				func_204(&num, vector, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
		
			if (!func_203() && _DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]) && !AUDIO::IS_ANY_SPEECH_PLAYING(num.f_28[0]) && AUDIO::HAS_SOUND_FINISHED(iLocal_94) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", false, -1) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", false, -1))
		...
		if (func_186(&num, 0) || func_184(&num))
		{
			if (func_183(num))
...
BOOL func_1(var uParam0) // Position - 0x3EC (1004)
{
...
BOOL func_2(Any* panParam0) // Position - 0x40A (1034)
{
	const char* str;
	var unk32;
	...
	if (!func_179())
	{
		while (!func_170(*panParam0))
		{
			...
			if (!func_218(panParam0, *panParam0 != 2))
			{
...
void func_3(int iParam0, const char* sParam1) // Position - 0x4CD (1229)
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x589 (1417)
{
	int num;
	int num2;
...
void func_6(int iParam0) // Position - 0x796 (1942)
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xB7E (2942)
{
	Global_65020 = true;
	Global_65023 = 1;
...
void func_8(int iParam0) // Position - 0xBC9 (3017)
{
...
struct<2> func_9(int iParam0) // Position - 0xBFD (3069)
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xC35 (3125)
{
	if (Global_65027)
		return;
...
void func_11() // Position - 0xC8B (3211)
{
	int i;
...
void func_12() // Position - 0xCB8 (3256)
{
	int i;
...
void func_13() // Position - 0xCEF (3311)
{
	Global_65186 = 0;
	return;
}

void func_14() // Position - 0xCFB (3323)
{
	Global_65046 = 0;
...
var func_15(Hash hParam0) // Position - 0xD4F (3407)
{
	var outValue;
...
void func_16() // Position - 0xD63 (3427)
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xD8D (3469)
{
...
void func_18() // Position - 0xDA1 (3489)
{
	int i;
...
void func_19() // Position - 0xDDA (3546)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xE1C (3612)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xE46 (3654)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xE59 (3673)
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xE76 (3702)
{
...
void func_24() // Position - 0xEBB (3771)
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1B4F (6991)
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x29D8 (10712)
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x29FA (10746)
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x2A82 (10882)
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2AC2 (10946)
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2AF0 (10992)
{
...
int func_31(Vehicle veParam0) // Position - 0x2BCC (11212)
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2C0E (11278)
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2C71 (11377)
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2CFF (11519)
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2D41 (11585)
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2F9D (12189)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2FA9 (12201)
{
	int i;
...
int func_38(int iParam0) // Position - 0x3254 (12884)
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3304 (13060)
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x34F7 (13559)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3517 (13591)
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x35C8 (13768)
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x36F7 (14071)
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3765 (14181)
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x383E (14398)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x387B (14459)
{
...
Hash func_47(eCharacter echParam0) // Position - 0x38A0 (14496)
{
	return Global_2339[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x38AF (14511)
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3A49 (14921)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3A78 (14968)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x3A8D (14989)
{
	int num;
	int num2;
...
int func_52() // Position - 0x3AC1 (15041)
{
	return Global_1574927;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3ACD (15053)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3AF1 (15089)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3B06 (15110)
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x4050 (16464)
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4291 (17041)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_58() // Position - 0x42AA (17066)
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x43A7 (17319)
{
	return Global_44886 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x43B5 (17333)
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x44A8 (17576)
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x4730 (18224)
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x47D1 (18385)
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x49C9 (18889)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x574A (22346)
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5785 (22405)
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x59F9 (23033)
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5A35 (23093)
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F84 (24452)
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5FC8 (24520)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x676F (26479)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x67B6 (26550)
{
...
BOOL func_73(int iParam0) // Position - 0x6811 (26641)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6821 (26657)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6881 (26753)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6C65 (27749)
{
	return Global_33792;
}

BOOL func_77(int iParam0) // Position - 0x6C70 (27760)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6C80 (27776)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6D22 (27938)
{
	Vector3 vector;
	var unk3;
...
Vector3 func_80() // Position - 0x7588 (30088)
{
...
int func_81() // Position - 0x7883 (30851)
{
	return Global_2652582.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7892 (30866)
{
...
BOOL func_83() // Position - 0x78BC (30908)
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x78D4 (30932)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x78E9 (30953)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x7900 (30976)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7958 (31064)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7A02 (31234)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7A97 (31383)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7ADB (31451)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7C5F (31839)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7C6D (31853)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8736 (34614)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x87B8 (34744)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8810 (34832)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8819 (34841)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_97(int iParam0, int iParam1) // Position - 0x8B31 (35633)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8CC1 (36033)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8CD1 (36049)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658294[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8CEE (36078)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8CFE (36094)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x9068 (36968)
{
	return Global_102506.f_417 > 0;
}

var func_103() // Position - 0x9079 (36985)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x90BF (37055)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x9145 (37189)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x9178 (37240)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x91C9 (37321)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x926B (37483)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x928D (37517)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x92A4 (37540)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x92B1 (37553)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x92EB (37611)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9326 (37670)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x9362 (37730)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x937B (37755)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x93DE (37854)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x93F4 (37876)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x940A (37898)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x944C (37964)
{
...
struct<2> func_120(int iParam0) // Position - 0x9474 (38004)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x98C1 (39105)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAB99 (43929)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAEDF (44767)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAF84 (44932)
{
	var name;
...
void func_126(int iParam0) // Position - 0xB01F (45087)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xB045 (45125)
{
	Global_80560 != 6;
...
void func_128(Ped pedParam0) // Position - 0xB07D (45181)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xB0D6 (45270)
{
...
int func_130(Ped pedParam0) // Position - 0xB159 (45401)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB18A (45450)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB19F (45471)
{
	int num;
...
int func_133() // Position - 0xB221 (45601)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB252 (45650)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB26D (45677)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB2B9 (45753)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB302 (45826)
{
...
BOOL func_138(int iParam0) // Position - 0xB322 (45858)
{
	switch (iParam0)
	{
		case 5:
...
void func_139() // Position - 0xB375 (45941)
{
...
BOOL func_140(int iParam0) // Position - 0xB3F2 (46066)
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB445 (46149)
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB53B (46395)
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB5A6 (46502)
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB5E5 (46565)
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB734 (46900)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB74E (46926)
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB7A7 (47015)
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB7E8 (47080)
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB80A (47114)
{
...
BOOL func_150() // Position - 0xB849 (47177)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB857 (47191)
{
	int num;
...
BOOL func_152() // Position - 0xB88A (47242)
{
...
void func_153(int iParam0) // Position - 0xB8B1 (47281)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB8D4 (47316)
{
...
void func_155() // Position - 0xB911 (47377)
{
	Global_21866 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB921 (47393)
{
...
void func_157() // Position - 0xB978 (47480)
{
	func_163(0);
	func_162();
	func_158();
...
void func_158() // Position - 0xB98D (47501)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_159(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB9E5 (47589)
{
...
void func_160(Vehicle veParam0) // Position - 0xBA3C (47676)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_161(BOOL bParam0, BOOL bParam1) // Position - 0xBA68 (47720)
{
...
void func_162() // Position - 0xBBB9 (48057)
{
...
void func_163(int iParam0) // Position - 0xBC0A (48138)
{
	if (func_168())
		return;
...
void func_164(int iParam0) // Position - 0xBC3D (48189)
{
	if (func_168())
		return;
...
void func_165(BOOL bParam0, BOOL bParam1) // Position - 0xBCC7 (48327)
{
	if (bParam0)
	{
		if (func_167(0))
...
BOOL func_166() // Position - 0xBD3B (48443)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_167(int iParam0) // Position - 0xBD49 (48457)
{
	if (iParam0 == 1)
...
BOOL func_168() // Position - 0xBDA0 (48544)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_169(int iParam0) // Position - 0xBDAF (48559)
{
...
BOOL func_170(int iParam0) // Position - 0xBDF0 (48624)
{
	int num;
	...
	num = func_172(&(Global_114018[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_171(int iParam0) // Position - 0xBE35 (48693)
{
...
int func_172(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBE67 (48743)
{
	int i;
...
void func_173(int iParam0, int iParam1) // Position - 0xBF9E (49054)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBFED (49133)
{
	return func_175(iParam0, Global_44886);
}

BOOL func_175(int iParam0, int iParam1) // Position - 0xBFFE (49150)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_176(int iParam0) // Position - 0xC1E1 (49633)
{
	if (Global_44886 == 15)
		return false;
...
int func_177() // Position - 0xC203 (49667)
{
	return func_178(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_178(const char* sParam0, int iParam1) // Position - 0xC214 (49684)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_179() // Position - 0xC25D (49757)
{
	if (Global_102454 == 10 || Global_102454 == 9)
		return true;
...
void func_180(int iParam0, var uParam1) // Position - 0xC281 (49793)
{
	switch (iParam0)
	{
		case 0:
...
Blip func_181(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC6F0 (50928)
{
	Blip blip;
...
var func_182(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC71C (50972)
{
	if (bParam0)
		return uParam1;
...
BOOL func_183(int iParam0) // Position - 0xC733 (50995)
{
	switch (iParam0)
	{
		case 0:
...
int func_184(var uParam0) // Position - 0xC7C2 (51138)
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.5532f, 11.916363f, -947.6847f, -2749.719f, 15.631608f, 26f, false, true, 0))
		{
			...
			else if (!func_185(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_LEAVE_ANY_VEHICLE) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)) && func_159(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 3f, 1, 1056964608, false, true, false))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
BOOL func_185(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0xC869 (51305)
{
...
int func_186(var uParam0, int iParam1) // Position - 0xC89C (51356)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_187() // Position - 0xD07F (53375)
{
	func_27(&(Global_105490.f_2890), &Global_105490, 0, 1, 1, 0);
	return;
}

BOOL func_188(var uParam0) // Position - 0xD09A (53402)
{
	float num;
...
void func_189(int iParam0, var uParam1) // Position - 0xD128 (53544)
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_190(BOOL bParam0) // Position - 0xD18C (53644)
{
...
BOOL func_191(Vehicle veParam0) // Position - 0xD223 (53795)
{
...
BOOL func_192(int iParam0) // Position - 0xD24D (53837)
{
	eCharacter character;
...
BOOL func_193() // Position - 0xD96A (55658)
{
	return Global_102493.f_1;
}

BOOL func_194() // Position - 0xD978 (55672)
{
	if (Global_99351 != -1)
...
BOOL func_195() // Position - 0xD99B (55707)
{
...
BOOL func_196() // Position - 0xD9B5 (55733)
{
	if (Global_80566)
		return true;
...
BOOL func_197() // Position - 0xD9DF (55775)
{
	return Global_102506.f_418 > 0;
}

BOOL func_198(int iParam0, int iParam1) // Position - 0xD9F0 (55792)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_199() // Position - 0xDA28 (55848)
{
	return Global_1575092;
}

BOOL func_200() // Position - 0xDA34 (55860)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0xDA50 (55888)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDA67 (55911)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_203() // Position - 0xDA88 (55944)
{
...
int func_204(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDAAA (55978)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_203() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_208(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB32 (56114)
{
...
void func_206(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB6D (56173)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDBC3 (56259)
{
...
float func_208(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDC5E (56414)
{
...
void func_209(var uParam0) // Position - 0xDC98 (56472)
{
...
void func_210(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDCC5 (56517)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_211(int iParam0, BOOL bParam1) // Position - 0xDDB6 (56758)
{
	if (iParam0 == -1)
		return;
...
int func_212(int iParam0) // Position - 0xDDF2 (56818)
{
	if (Global_80301 == iParam0)
		if (Global_80302 == -1)
...
void func_213(var uParam0, int iParam1) // Position - 0xDE2B (56875)
{
	BOOL flag;
	int i;
...
BOOL func_214() // Position - 0xDEC9 (57033)
{
	return Global_99738;
}

void func_215(var uParam0) // Position - 0xDED5 (57045)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_216(uParam0);
...
void func_216(var uParam0) // Position - 0xDEEC (57068)
{
	BOOL flag;
	int num;
	int i;
...
void func_217(int iParam0) // Position - 0xDFD4 (57300)
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_218(Any* panParam0, BOOL bParam1) // Position - 0xDFFC (57340)
{
	var unk;
	...
	if (func_255(*panParam0) || func_253(*panParam0) || Global_80551 == true)
		return true;
...
void func_219(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE26C (57964)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_220(int iParam0) // Position - 0xE5C4 (58820)
{
...
BOOL func_221(var uParam0) // Position - 0xE5E4 (58852)
{
...
BOOL func_222(var uParam0) // Position - 0xE5FC (58876)
{
...
void func_223(var uParam0) // Position - 0xE621 (58913)
{
	int i;
	int taskSequenceId;
...
void func_224(Object* pobParam0) // Position - 0xE925 (59685)
{
...
void func_225(var uParam0) // Position - 0xE950 (59728)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE9D0 (59856)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_227(Ped pedParam0, Vehicle veParam1) // Position - 0xEB8E (60302)
{
...
BOOL func_228(var uParam0, BOOL bParam1, int iParam2) // Position - 0xEBBE (60350)
{
	int i;
	int num;
...
BOOL func_229(int iParam0) // Position - 0xEE7A (61050)
{
...
BOOL func_230(Ped pedParam0, int iParam1) // Position - 0xEEAE (61102)
{
	float xSize;
...
BOOL func_231(Ped pedParam0, int iParam1) // Position - 0xEF24 (61220)
{
	return func_232(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_232(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEF3C (61244)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_233(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEFFD (61437)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_234(Ped pedParam0, int iParam1) // Position - 0xF129 (61737)
{
...
int func_235() // Position - 0xF1EE (61934)
{
	int i;
...
BOOL func_236(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF238 (62008)
{
	var unk;
...
float func_237(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF2C9 (62153)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_238(float fParam0, var uParam1, var uParam2) // Position - 0xF2EA (62186)
{
	float num;
	float num2;
...
void func_239(var uParam0) // Position - 0xF329 (62249)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_240(Ped pedParam0, Ped pedParam1) // Position - 0xF344 (62276)
{
	int i;
...
BOOL func_241(Ped pedParam0) // Position - 0xF383 (62339)
{
...
BOOL func_242(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF3AB (62379)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_243(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF4A6 (62630)
{
	float entityCoords;
	float num;
...
BOOL func_244(Ped pedParam0, float fParam1) // Position - 0xF5B2 (62898)
{
	var outProjectile;
	var outCoords;
...
BOOL func_245(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF647 (63047)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_246(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF6D5 (63189)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_247(int iParam0) // Position - 0xF71D (63261)
{
...
void func_248(Vehicle veParam0) // Position - 0xF767 (63335)
{
	int taskSequenceId;
...
BOOL func_249(int iParam0) // Position - 0xF804 (63492)
{
	if (iParam0 == -1)
		iParam0 = func_177();
...
BOOL func_250(int iParam0) // Position - 0xF899 (63641)
{
...
BOOL func_251() // Position - 0xF8D8 (63704)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_252() // Position - 0xF8F5 (63733)
{
	if (Global_99351 != -1)
...
BOOL func_253(int iParam0) // Position - 0xF918 (63768)
{
...
BOOL func_254() // Position - 0xF94C (63820)
{
...
BOOL func_255(int iParam0) // Position - 0xF98A (63882)
{
	if (func_119(false))
...
BOOL func_256(var uParam0) // Position - 0xF9B2 (63922)
{
	switch (*uParam0)
	{
		case 17:
...
BOOL func_257(var uParam0) // Position - 0xFA27 (64039)
{
	int num;
	int i;
...
void func_258(Ped* ppedParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0xFB2B (64299)
{
	func_259(ppedParam0, hLocal_91, fParam1, fParam4, PED_TYPE_MISSION);
...
void func_259(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0xFB5D (64349)
{
	func_260(ppedParam0);
...
void func_260(Ped* ppedParam0) // Position - 0xFB7E (64382)
{
...
BOOL func_261(var uParam0) // Position - 0xFBBF (64447)
{
	if (func_222(uParam0))
	{
...
BOOL func_262(var uParam0) // Position - 0xFBE9 (64489)
{
	int i;
...
void func_263(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0xFC1A (64538)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_264(var uParam0) // Position - 0xFC56 (64598)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				if (func_265(&uParam0->f_28[0], CHAR_DOM, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
...
BOOL func_265(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFDE9 (65001)
{
	if (func_266(ppedParam0, echParam1, fParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_266(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFE45 (65093)
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_301(echParam1);
...
int func_267(Ped pedParam0, eCharacter echParam1) // Position - 0xFED3 (65235)
{
	int num;
...
BOOL func_268(var uParam0) // Position - 0xFF19 (65305)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_265(&uParam0->f_28[0], CHAR_DOM, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_269(&uParam0->f_35[0], num[0], -950.8f, -2751.98f, 13.21f, 199.05f);
			...
			{
				func_269(&uParam0->f_35[1], num[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
			...
			{
				func_269(&uParam0->f_35[2], num[1], -957.23f, -2764.89f, 14.04f, 147.61f);
...
void func_269(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10222 (66082)
{
	func_270(pveParam0);
...
void func_270(Vehicle* pveParam0) // Position - 0x10265 (66149)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_271(var uParam0) // Position - 0x10301 (66305)
{
	int num;
	int i;
...
BOOL func_272(int iParam0) // Position - 0x103ED (66541)
{
	var unk;
	eCharacter character;
...
BOOL func_273(int iParam0) // Position - 0x1043E (66622)
{
	const char* string2;
...
BOOL func_274(int iParam0) // Position - 0x104F7 (66807)
{
	var unk;
...
BOOL func_275(int iParam0) // Position - 0x105B8 (67000)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_276(int iParam0, char* sParam1) // Position - 0x1063D (67133)
{
...
BOOL func_277(int iParam0) // Position - 0x1071F (67359)
{
...
BOOL func_278(int iParam0) // Position - 0x1074A (67402)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_279(int iParam0) // Position - 0x10775 (67445)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_280(int iParam0) // Position - 0x107A0 (67488)
{
	if (func_250(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_281() // Position - 0x107D5 (67541)
{
...
BOOL func_282(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x107EF (67567)
{
	int i;
...
BOOL func_283(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10854 (67668)
{
	int num;
	char* str;
...
BOOL func_284(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x108CC (67788)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_285(var uParam0, BOOL bParam1) // Position - 0x10947 (67911)
{
	if (*uParam0 == 18)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[0]))
...
int func_286(var uParam0) // Position - 0x10A28 (68136)
{
	if (func_222(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_287(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10A5E (68190)
{
...
void func_288(var uParam0, BOOL bParam1) // Position - 0x10A7E (68222)
{
	func_289(&(uParam0->f_41), bParam1);
	return;
}

void func_289(var uParam0, BOOL bParam1) // Position - 0x10A90 (68240)
{
	int i;
...
void func_290(Object* pobParam0, BOOL bParam1) // Position - 0x10ACE (68302)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_291(var uParam0, BOOL bParam1) // Position - 0x10B09 (68361)
{
	func_292(&(uParam0->f_35), bParam1);
	return;
}

void func_292(var uParam0, BOOL bParam1) // Position - 0x10B1B (68379)
{
	int i;
...
void func_293(Vehicle* pveParam0) // Position - 0x10B58 (68440)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_294(var uParam0, int iParam1) // Position - 0x10B90 (68496)
{
	func_295(&(uParam0->f_28), iParam1);
	return;
}

void func_295(var uParam0, int iParam1) // Position - 0x10BA2 (68514)
{
	int i;
...
void func_296(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10BE3 (68579)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_297(int iParam0) // Position - 0x10C33 (68659)
{
	if (*iParam0 == -1)
		return;
...
void func_298(char* sParam0) // Position - 0x10C70 (68720)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_299(var uParam0) // Position - 0x10C82 (68738)
{
	*uParam0 = -1;
...
void func_300() // Position - 0x10CB5 (68789)
{
...
Hash func_301(eCharacter echParam0) // Position - 0x10CCF (68815)
{
	if (!func_36(echParam0))
