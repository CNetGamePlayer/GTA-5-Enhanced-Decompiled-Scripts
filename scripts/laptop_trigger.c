...
void main() // Position - 0x0 (0)
{
	...
	iLocal_140 = -1;
	uLocal_154 = { 0f, 0f, 0f };
	obLocal_151 = obScriptParam_0;

	if (!ENTITY::DOES_ENTITY_EXIST(obLocal_151))
	...
	uLocal_157 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(obScriptParam_0, uLocal_154) };
	Global_1950571 = 0;
	...
	while (flag2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(obLocal_151))
		{
			if (bLocal_142)
				if (!func_389(PLAYER::PLAYER_ID()))
					if (!_STOPWATCH_IS_INITIALIZED(&uLocal_145))
						func_387(&uLocal_145, true, false);
		
			if (Global_1950567 && func_386(PLAYER::PLAYER_ID()) || func_385(PLAYER::PLAYER_ID()))
			{
				if (!_STOPWATCH_IS_INITIALIZED(&uLocal_149))
				{
					func_387(&uLocal_149, false, false);
				}
				else if (func_384(&uLocal_149, 10000, false))
				{
			...
			if (Global_1845143)
			{
				if (!flag)
				{
					entityModel = ENTITY::GET_ENTITY_MODEL(obLocal_151);
					...
					if (entityModel == joaat("prop_laptop_01a"))
					{
						...
						entityRotation = { ENTITY::GET_ENTITY_ROTATION(obLocal_151, 2) };
						obLocal_151 = OBJECT::CREATE_OBJECT(joaat("prop_laptop_lester2"), ENTITY::GET_ENTITY_COORDS(obLocal_151, true), false, true, false);
						ENTITY::SET_ENTITY_ROTATION(obLocal_151, entityRotation, 2, true);
						flag = true;
					}
				}
			}
		
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(obLocal_151, 0))
			{
				func_392();
				SCRIPT::TERMINATE_THIS_THREAD();
			}
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && ENTITY::DOES_ENTITY_EXIST(obLocal_151) && !CUTSCENE::IS_CUTSCENE_PLAYING() && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(obLocal_151))
			{
				flag3 = false;
				...
				if (func_376() || func_375(PLAYER::PLAYER_ID()) || func_385(PLAYER::PLAYER_ID()) || func_374())
					vector2 = { 1f, 1f, 0.9f };
				else if (func_373())
					vector2 = { 0.75f, 0.55f, 1.25f };
			
				flag4 = func_372(PLAYER::PLAYER_ID());
				flag5 = true;
			
				if (func_373() || func_371())
					flag5 = func_370(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(obLocal_151), 90f);
			
				if (!flag3 && !Global_34063 && !func_369(0) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false) && !func_368() && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), vector, vector2, false, true, 1) && INTERIOR::GET_ROOM_KEY_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_ROOM_KEY_FROM_ENTITY(obLocal_151) && !IS_BIT_SET(Global_2621446, 15) && !func_367() && !(Global_80305 && func_366()) && !(!Global_80305 && func_365()) && !(Global_80305 && IS_BIT_SET(Global_4718592.f_15, 24) && NETWORK::NETWORK_IS_ACTIVITY_SESSION()) && !(Global_80305 && func_364() && func_363()) && !(Global_80305 && func_362(PLAYER::PLAYER_ID()) == 5) && !NETWORK::NETWORK_IS_IN_MP_CUTSCENE() && !Global_79061 && !func_359() && !func_358() && flag5 && !func_355() && !func_354())
				{
					if (!func_353(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39) && !func_352(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_260.f_39, -1) && !func_351(PLAYER::PLAYER_ID()))
					{
						if (bLocal_143 != flag4)
						{
							if (func_386(PLAYER::PLAYER_ID()) || func_350(PLAYER::PLAYER_ID()) || func_385(PLAYER::PLAYER_ID()))
							{
								if (iLocal_140 != -1)
									func_349(&iLocal_140);
						...
						if (iLocal_140 == -1)
							if (flag)
								_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "MPLA_BILL" /*Unable to use the laptop until utility charge is paid.*/, 0, 0, 0, 0);
							else if (func_376())
								func_345(flag4);
							else if (func_342())
								func_339(flag4);
								...
								_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "BROWSEINPUTTRIG" /*Press ~INPUT_CONTEXT~ to browse the internet on this computer.*/, 0, 0, 0, 0);
					}
				
					if (iLocal_140 != -1 && func_325(iLocal_140, true) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()) && func_324())
					{
						if (iLocal_140 != -1)
							func_349(&iLocal_140);
						...
						if (!flag)
						{
							...
							if (func_323() || func_322() || func_321())
							{
								func_24(&uLocal_147, false, false);
							
								while (!func_384(&uLocal_147, 500, false))
								{
									func_377(0);
									BUILTIN::WAIT(0);
								}
					...
					else if (iLocal_140 != -1 && PAD::IS_CONTROL_JUST_PRESSED(FRONTEND_CONTROL, INPUT_CONTEXT_SECONDARY) && !TASK::IS_PED_RUNNING(PLAYER::PLAYER_PED_ID()) && func_324() && func_321())
					{
						if (iLocal_140 != -1)
						{
							func_349(&iLocal_140);
						...
						func_316();
						MISC::SET_BIT(&(Global_1950714.f_4), 28);
					
						while (IS_BIT_SET(Global_1950714.f_4, 28))
						{
							BUILTIN::WAIT(0);
						}
				...
				else
				{
					...
					if (func_386(PLAYER::PLAYER_ID()) || func_350(PLAYER::PLAYER_ID()))
						if (func_347())
							HUD::CLEAR_HELP(true);
	...
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_151))
	{
		...
		if (func_3(entityModel))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
			{
				...
				entityCoords2 = { ENTITY::GET_ENTITY_COORDS(obLocal_151, true) };
				return BUILTIN::VDIST2(entityCoords, entityCoords2) > 10000f;
			}
		}
		else
		{
			return !BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(obLocal_151);
		}
	}
...
void func_9() // Position - 0x9BD (2493)
{
	...
	if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true) && ENTITY::DOES_ENTITY_EXIST(obLocal_151))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				...
				if (func_10(2, &animDict))
				{
					if (iLocal_152 != 0)
					{
						if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_153))
						{
							PED::DETACH_SYNCHRONIZED_SCENE(iLocal_153);
							iLocal_153 = -1;
						}
					
						iLocal_153 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_157, ENTITY::GET_ENTITY_ROTATION(obLocal_151, 2), 2, false, false, 1065353216, 0, 1065353216);
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_153, &animDict, "exit", 8f, -4f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_153);
						STREAMING::REMOVE_ANIM_DICT(&animDict);
					}
				}
			}
...
BOOL func_10(int iParam0, char* sParam1) // Position - 0xAB1 (2737)
{
	...
	if (!func_386(PLAYER::PLAYER_ID()) && !func_385(PLAYER::PLAYER_ID()) && !func_11(PLAYER::PLAYER_ID()))
	{
		TEXT_LABEL_ASSIGN_STRING(sParam1, "", 64);
		return false;
	}
...
Player _INVALID_PLAYER_INDEX() // Position - 0x1129 (4393)
{
	return -1;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x1132 (4402)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x11B6 (4534)
{
	switch (func_18())
	{
		case 0:
...
Hash func_17() // Position - 0x11E9 (4585)
{
...
int func_18() // Position - 0x120D (4621)
{
	return Global_33792;
}

BOOL func_19() // Position - 0x1218 (4632)
{
	return Global_2685153.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x1227 (4647)
{
...
BOOL func_21() // Position - 0x123E (4670)
{
	return Global_2696981;
}

BOOL func_22() // Position - 0x124A (4682)
{
	return Global_2685153.f_695;
}

BOOL func_23() // Position - 0x1259 (4697)
{
	return Global_77359;
}
...
void func_25() // Position - 0x12A2 (4770)
{
	if (func_31() || func_30())
	{
		func_29();
...
void func_26() // Position - 0x12C3 (4803)
{
	if (!_IS_FMMC_ACTIVE() && !func_27() && Global_2686094)
		Global_4718592.f_139000 = 0;

	return;
}

BOOL func_27() // Position - 0x12F1 (4849)
{
	return Global_2685153.f_693;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x1300 (4864)
{
	return Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_185 != 0;
}

void func_29() // Position - 0x1317 (4887)
{
	Global_2685153.f_758 = 1;
	return;
}

BOOL func_30() // Position - 0x1327 (4903)
{
	return Global_2685153.f_737;
}

BOOL func_31() // Position - 0x1336 (4918)
{
	return IS_BIT_SET(Global_2685153.f_2, 11);
}

void func_32(int iParam0, int iParam1) // Position - 0x1347 (4935)
{
	BOOL flag;
	BOOL flag2;
	BOOL flag3;
	...
	if (Global_80305 && func_366())
		return;

	if (!Global_80305 && func_365())
		return;
...
void func_33(int iParam0, BOOL bParam1) // Position - 0x1527 (5415)
{
	if (!bParam1 && !func_315(PLAYER::PLAYER_ID(), true) && func_314() < func_313() && !NETWORK::NETWORK_IS_ACTIVITY_SESSION() && !func_309(PLAYER::PLAYER_ID()))
		func_34(true, iParam0, 375994962);

	return;
}

void func_34(BOOL bParam0, int iParam1, int iParam2) // Position - 0x1576 (5494)
{
	var unk;

	func_157(true, true, iParam1, iParam2);

	if (bParam0)
	{
		if (func_156(91) || func_156(98))
			func_153();
		...
		if (func_121(PLAYER::PLAYER_ID()) && iParam1 == 0)
			unk.f_4 = 100;
	
		func_119(unk, func_120(false, true));
		func_62();
	
		if (!func_121(PLAYER::PLAYER_ID()) && iParam1 != 1)
...
int _SEND_TEXT_MESSAGE_FROM_CHARACTER_2(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9) // Position - 0x1612 (5650)
{
	int num;
	char* str;
	int num2;
...
struct<4> _GET_CHARACTER_NAME(eCharacter character) // Position - 0x16A1 (5793)
{
	return Global_2339[character /*29*/].f_3;
}

int func_37(eCharacter echParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, BOOL bParam10, int iParam11, int iParam12, int iParam13, char* sParam14, char* sParam15, int iParam16) // Position - 0x16B4 (5812)
{
	int num;
	int num2;
	...
	if (!Global_21860 && !IS_BIT_SET(Global_9465, 9))
	{
		...
		{
			func_48(Global_21608, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_44(1);
			func_48(Global_21608, "DISPLAY_VIEW", 1f, BUILTIN::TO_FLOAT(Global_21607), -1082130432, -1082130432, -1082130432);
		}
	}
...
BOOL func_39() // Position - 0x1C32 (7218)
{
...
void func_44(int iParam0) // Position - 0x1D0B (7435)
{
	int i;
	int num;
	int value;
					...
					if (i == Global_9470[num /*15*/].f_4)
					{
						if (Global_10064[i] == 0)
						{
							...
							if (num == 1)
							{
								...
								func_45(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9470[num /*15*/].f_10), BUILTIN::TO_FLOAT(Global_24069), -1f, &Global_9470[num /*15*/], 0, 0, 0, 0);
							}
							else if (num == 7)
							{
								if (Global_80305)
								{
									...
									func_45(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9470[num /*15*/].f_10), BUILTIN::TO_FLOAT(value2), -1f, &Global_9470[num /*15*/], 0, 0, 0, 0);
								}
								else
								{
									switch (Global_21627)
									...
									func_45(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9470[num /*15*/].f_10), BUILTIN::TO_FLOAT(value3), -1f, &Global_9470[num /*15*/], 0, 0, 0, 0);
								}
							}
							else if (num == 14)
							{
							...
							else if (Global_9470[num /*15*/].f_10 == 57 && num == 25)
							{
								...
								func_45(Global_21608, "SET_DATA_SLOT", BUILTIN::TO_FLOAT(1), BUILTIN::TO_FLOAT(i), BUILTIN::TO_FLOAT(Global_9470[num /*15*/].f_10), BUILTIN::TO_FLOAT(value6), -1f, &Global_9470[num /*15*/], 0, 0, 0, 0);
							}
							else
							{
...
void func_47() // Position - 0x2357 (9047)
{
	int i;
...
void func_48(int iParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x237A (9082)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(BUILTIN::ROUND(fParam2));
...
BOOL func_49() // Position - 0x23DD (9181)
{
	return Global_1575092;
}

void func_50(int iParam0) // Position - 0x23E9 (9193)
{
	var unk;
	var unk2;
...
void func_51(int iParam0) // Position - 0x2408 (9224)
{
	int clockSeconds;
	int clockMinutes;
	int clockHours;
...
void func_52() // Position - 0x249A (9370)
{
	int num;
	int num2;
	int num3;
	...
	while (num3 < num2)
	{
		if (!func_53(Global_114931.f_14148[num3 /*104*/].f_18, Global_114931.f_14148[Global_24068 /*104*/].f_18))
			Global_24068 = num3;
...
BOOL func_53(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11) // Position - 0x2565 (9573)
{
	int num;
	int num2;
	int num3;
...
int func_54() // Position - 0x2650 (9808)
{
	int num;
	int num2;
	int i;
	...
	while (i < num2)
	{
		if (Global_114931.f_14148[i /*104*/].f_24 == 0 || Global_114931.f_14148[i /*104*/].f_24 == 1)
			if (!func_53(Global_114931.f_14148[i /*104*/].f_18, Global_114931.f_14148[Global_24068 /*104*/].f_18))
				Global_24068 = i;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x27B8 (10168)
{
	if (func_391(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x285A (10330)
{
	func_57();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_57() // Position - 0x2873 (10355)
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_58(character) && !func_391(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != character && func_58(Global_114931.f_2370.f_539.f_4321))
...
BOOL func_58(eCharacter echParam0) // Position - 0x2970 (10608)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x297C (10620)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x29B9 (10681)
{
...
Hash func_61(eCharacter echParam0) // Position - 0x29DE (10718)
{
	return Global_2339[echParam0 /*29*/];
}

void func_62() // Position - 0x29ED (10733)
{
	if (!func_116() && func_77() && func_75(PLAYER::PLAYER_ID()))
		if (func_72())
...
int _THEFEED_SHOW_MESSAGE(char* sParam0, BOOL bParam1) // Position - 0x2A31 (10801)
{
	int num;
	int num2;
	...
	func_64(0, sParam0, num2, 0, 0, 0, 0, 0, 1, 0, 0, 0);
	return num;
}
...
void func_64(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, char* sParam9, char* sParam10, char* sParam11) // Position - 0x2A69 (10857)
{
	...
	if (!IS_ROCKSTAR_DEV() || !NETWORK::NETWORK_IS_ACTIVITY_SESSION() || !func_67(PLAYER::PLAYER_ID(), 0))
		return;
...
int func_65(int iParam0) // Position - 0x2B71 (11121)
{
	int i;
...
void func_66(int iParam0) // Position - 0x2BD3 (11219)
{
	int i;
...
int func_68(int iParam0, BOOL bParam1) // Position - 0x2C65 (11365)
{
	int num;
	int num2;
...
int func_69() // Position - 0x2CA6 (11430)
{
...
BOOL IS_ROCKSTAR_DEV() // Position - 0x2CD4 (11476)
{
	return DLC::IS_DLC_PRESENT(-1762644250);
}

BOOL func_72() // Position - 0x2CE5 (11493)
{
...
BOOL IS_GAMER_HANDLE_VALID(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12) // Position - 0x2FC2 (12226)
{
...
BOOL func_86(Player plParam0, BOOL bParam1) // Position - 0x3086 (12422)
{
	if (func_70(plParam0))
...
BOOL func_105() // Position - 0x3305 (13061)
{
...
BOOL func_116() // Position - 0x34B5 (13493)
{
	int i;
	var string2;
	var string1;
...
struct<16> func_117(int iParam0) // Position - 0x350F (13583)
{
	return Global_2686095.f_3083.f_18[iParam0 /*16*/];
}

int func_118(int iParam0) // Position - 0x3527 (13607)
{
	switch (iParam0)
	{
		case 0:
...
void func_119(Hash hParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, int iParam15) // Position - 0x357D (13693)
{
	hParam0 = -642704387;
...
int func_120(BOOL bParam0, BOOL bParam1) // Position - 0x35AC (13740)
{
	int address;
	int i;
	Player player;
...
void func_123() // Position - 0x3661 (13921)
{
	var unk;
	int num;

	if (func_147(true) && !func_144(1))
		return;

	unk = { func_143(155, 157, -1) };
	num = 0;

	if (func_115(true))
	{
		unk = { func_143(47, 48, -1) };
		num = 1;
	}

	if (MISC::IS_STRING_NULL_OR_EMPTY(&unk))
		TEXT_LABEL_ASSIGN_STRING(&unk, func_141(PLAYER::PLAYER_ID(), false), 64);

	func_129(&unk, num, false);

	if (!func_128() && NETWORK::NETWORK_CHECK_USER_CONTENT_PRIVILEGES(0, -1, true) || func_126())
		func_125(28);
	else
		func_124(28);
...
BOOL func_127() // Position - 0x379E (14238)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_128() // Position - 0x37B4 (14260)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_129(const char* sParam0, int iParam1, BOOL bParam2) // Position - 0x37CA (14282)
{
	if (bParam2)
	{
		if (func_115(true) || iParam1 == 1)
		{
			func_138(47, 48, sParam0, -1, true);
			func_137(3, sParam0);
		
			if (func_72() && iParam1 == 1)
				func_136(sParam0, bParam2);
		}
		else
		{
			func_138(155, 157, sParam0, -1, true);
			func_137(1, sParam0);
...
void func_130(const char* sParam0, BOOL bParam1) // Position - 0x389A (14490)
{
	var unk;
	...
	if (bParam1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		{
			...
			{
				unk = { func_143(155, 157, -1) };
				func_131(-1408096250, unk, -81044133);
			}
		}
	}
...
void func_131(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, int iParam17) // Position - 0x3965 (14693)
{
	BOOL isBoss;
	int bossType;
	int bossId1;
	...
	bossId1 = func_133(_GET_BOSS_OF_LOCAL_PLAYER());
	bossId2 = func_132(_GET_BOSS_OF_LOCAL_PLAYER());
	textSource = iParam17;
...
BOOL func_135(BOOL bParam0) // Position - 0x3A2E (14894)
{
	return func_315(PLAYER::PLAYER_ID(), bParam0);
}

void func_136(const char* sParam0, BOOL bParam1) // Position - 0x3A40 (14912)
{
	var unk;
	...
	if (bParam1)
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		{
			func_138(49, 50, sParam0, -1, true);
			func_137(2, sParam0);
		
			if (func_135(true))
			{
				TEXT_LABEL_ASSIGN_STRING(&unk, sParam0, 64);
				func_131(-1629413369, unk, -81044133);
			}
		}
	}
...
void func_138(int iParam0, int iParam1, const char* sParam2, int iParam3, BOOL bParam4) // Position - 0x3AF2 (15090)
{
	Hash statName;
	Hash statName2;
	var value;
	...
	statName = func_139(iParam0, iParam3);
	statName2 = func_139(iParam1, iParam3);
...
Hash func_139(int iParam0, int iParam1) // Position - 0x3B85 (15237)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(3, iParam0, func_140(iParam1));
}

int func_140(int iParam0) // Position - 0x3B9A (15258)
{
	int num;
	int num2;
...
const char* func_142() // Position - 0x3BF5 (15349)
{
	return HUD::GET_FILENAME_FOR_AUDIO_CONVERSATION("GB_REST_ACCM" /*Motorcycle Club*/);
}

struct<16> func_143(int iParam0, int iParam1, int iParam2) // Position - 0x3C05 (15365)
{
	Hash statHash;
	Hash statHash2;
	var unk;
	...
	statHash = func_139(iParam0, iParam2);
	statHash2 = func_139(iParam1, iParam2);
...
BOOL func_144(int iParam0) // Position - 0x3C42 (15426)
{
	int num;

	num = func_145(16738, -1);
...
Hash func_146(int iParam0, int iParam1) // Position - 0x3C88 (15496)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_140(iParam1));
}

BOOL func_147(BOOL bParam0) // Position - 0x3C9D (15517)
{
	if (bParam0)
		return func_149();

	return func_102(func_148());
}

int func_148() // Position - 0x3CB9 (15545)
{
	return Global_1912540[PLAYER::PLAYER_ID() /*319*/].f_279;
}

BOOL func_149() // Position - 0x3CCF (15567)
{
	return func_151(526, -1) || MISC::HAS_FINALIZED_CHOSEN_CRIMINAL_CAREER() && func_150() != 0 && !func_144(0);
}

int func_150() // Position - 0x3CFF (15615)
{
	return MISC::GET_CHOSEN_CRIMINAL_CAREER();
}

BOOL func_151(int iParam0, int iParam1) // Position - 0x3D0B (15627)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_152(int iParam0, int iParam1) // Position - 0x3D2F (15663)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_140(iParam1));
}

void func_153() // Position - 0x3D44 (15684)
{
	int i;
	...
	for (i = 0; i <= 3; i = i + 1)
	{
		if (Global_2673274.f_2591[i /*80*/].f_2 != 0)
		{
			...
			func_154(&(Global_2673274.f_2591[i /*80*/].f_69), 1);
		}
	}
...
BOOL func_156(int iParam0) // Position - 0x3DB0 (15792)
{
	return Global_2673274.f_2591[0 /*80*/].f_1 == iParam0;
}

void func_157(BOOL bParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x3DC7 (15815)
{
	var userID;
	int cloudTimeAsInt;
	int num;
	...
	if (Global_1892798[PLAYER::PLAYER_ID() /*615*/].f_10 != PLAYER::PLAYER_ID())
	{
		...
		STATS::GET_BOSS_GOON_UUID(func_69(), &unk22, &unk23);
		func_298(unk22, unk23);
		userid = NETWORK::NETWORK_PLAYER_GET_USERID(PLAYER::PLAYER_ID(), &userID);
		TEXT_LABEL_ASSIGN_STRING(&unk24, userid, 64);
		func_297(unk24);
		func_296();
	
		if (func_145(14806, -1) <= 0)
			cloudTimeAsInt = NETWORK::GET_CLOUD_TIME_AS_INT();
		else
			cloudTimeAsInt = func_145(14806, -1) - 43200;
	
		func_293(cloudTimeAsInt);
		...
		if (iParam2 != 1)
		{
			...
			{
				flag = false;
				address = func_145(14803, -1);
			
				if (!IS_BIT_SET(address, 11))
				{
					MISC::SET_BIT(&address, 11);
					func_273(14803, address, -1, true);
					flag = true;
				}
		...
		if (iParam2 == 1)
			STATS::PLAYSTATS_CHANGE_MC_ROLE(func_133(_GET_BOSS_OF_LOCAL_PLAYER()), func_132(_GET_BOSS_OF_LOCAL_PLAYER()), func_228(), func_227(), Global_1892798[PLAYER::PLAYER_ID() /*615*/].f_10.f_434, 4, Global_1892798[PLAYER::PLAYER_ID() /*615*/].f_10.f_472);
	
		if (bParam1)
			if (iParam2 == 0)
				func_131(-1408096250, func_304(iParam2), -81044133);
			else
				func_131(-1629413369, func_304(iParam2), -81044133);
	}
...
void func_158(int iParam0, BOOL bParam1) // Position - 0x40BE (16574)
{
	BOOL flag;
	int num;
	...
	if (!func_223(num, bParam1 == _STAT_GET_PACKED_BOOL(iParam0, -1)))
	{
		flag = false;
	}
	else
	{
		num.f_1 = func_222(num);
	
		if (num.f_1 == 4)
			flag = false;
	
		if (flag && !func_220(iParam0, &num))
			flag = false;
	}
...
void func_159(var uParam0) // Position - 0x414E (16718)
{
	uParam0->f_6 = func_203(*uParam0, uParam0->f_2);
	...
	if (uParam0->f_6 > uParam0->f_2.f_1)
	{
		...
		if (uParam0->f_2.f_1 == 0 && uParam0->f_6 > 0 && uParam0->f_2.f_2 > 1)
			func_195(uParam0->f_2);
	}

	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		func_191(uParam0->f_2);
	
		if (func_183(*uParam0, uParam0->f_1, false, false))
		{
			func_169(*uParam0, uParam0->f_1);
			uParam0->f_7 = 1;
		
			if (!Global_2733138.f_5950.f_1 && func_222(*uParam0) >= uParam0->f_1)
			{
...
BOOL func_160(var uParam0) // Position - 0x4232 (16946)
{
	var unk;
	BOOL flag;
	...
	unk = 10;
	flag = false;
	func_164(*uParam0, uParam0->f_2, &unk, &flag);

	if (uParam0->f_6 <= uParam0->f_2.f_1)
		return false;

	if (!flag)
		if (func_163(&unk, uParam0->f_2.f_1, uParam0->f_6, &(uParam0->f_2.f_3)))
			if (func_161(*uParam0, uParam0->f_2, uParam0->f_2.f_3))
				return false;
		else
			return false;
...
BOOL func_161(var uParam0, var uParam1, var uParam2) // Position - 0x42A2 (17058)
{
	int num;

	num = func_162(uParam0, uParam1, uParam2);
...
int func_162(int iParam0, int iParam1, int iParam2) // Position - 0x42CA (17098)
{
	switch (iParam0)
	{
		case 19:
...
BOOL func_163(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x43E3 (17379)
{
	int num;
	int i;
...
void func_164(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x4435 (17461)
{
	int i;
	int j;
...
void func_165(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x56F6 (22262)
{
	int i;
...
void func_166() // Position - 0x5786 (22406)
{
	int num;
	BOOL flag;
...
int func_167() // Position - 0x5918 (22808)
{
	int num;
	int i;
	int num2;
...
int func_168(int iParam0) // Position - 0x5998 (22936)
{
	switch (iParam0)
	{
		case 0:
...
void func_169(int iParam0, int iParam1) // Position - 0x59E6 (23014)
{
	...
	address = func_145(num, -1);
	offset = func_180(iParam0, iParam1);
...
void func_170(int iParam0, int iParam1) // Position - 0x5A37 (23095)
{
	int num;
	int offset;
...
int func_171(int iParam0) // Position - 0x5AF2 (23282)
{
	return func_172(iParam0) / 8;
}

int func_172(int iParam0) // Position - 0x5B03 (23299)
{
	switch (iParam0)
	{
		case 3:
...
void func_173(int iParam0, int iParam1) // Position - 0x5C8C (23692)
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_178();
	hash = func_177();
	hash2 = func_176(iParam1);
	hash3 = func_174(iParam0);
	num2 = -1;
	STATS::_PLAYSTATS_PH_ACTIVITY(entityCoords, num, hash, hash2, hash3, num2);
	return;
}

Hash func_174(int iParam0) // Position - 0x5CDF (23775)
{
	var unk;

	TEXT_LABEL_ASSIGN_STRING(&unk, "PROGRESS_HUB_PACK_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_175(iParam0), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_175(int iParam0) // Position - 0x5CFF (23807)
{
	switch (iParam0)
	{
		case 0:
...
Hash func_176(int iParam0) // Position - 0x5ED9 (24281)
{
	switch (iParam0)
	{
		case 0:
...
Hash func_177() // Position - 0x5F45 (24389)
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_178() // Position - 0x5F55 (24405)
{
	if (Global_1674225 == 0)
		func_179();
...
void func_179() // Position - 0x5F6D (24429)
{
...
int func_180(int iParam0, int iParam1) // Position - 0x5F9C (24476)
{
	if (iParam1 == 4)
		iParam1 = 3;

	return (func_181(iParam0) * 4) + iParam1;
}

int func_181(int iParam0) // Position - 0x5FB8 (24504)
{
	return func_172(iParam0) % 8;
}

int func_182(int iParam0) // Position - 0x5FC9 (24521)
{
	int num;
...
BOOL func_183(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x5FDF (24543)
{
	BOOL flag;
	int num;
	int num2;
	...
	num2 = func_189(iParam0, iParam1, 0);
	num3 = (num2 + func_186(iParam0, iParam1)) - 1;
	i = 0;
...
int func_186(int iParam0, int iParam1) // Position - 0x7242 (29250)
{
	if (func_187(iParam0))
	{
		switch (iParam1)
...
BOOL func_187(int iParam0) // Position - 0x72B5 (29365)
{
	int num;
...
int func_188(int iParam0) // Position - 0x72DD (29405)
{
	switch (iParam0)
	{
		case 27:
...
int func_189(int iParam0, int iParam1, int iParam2) // Position - 0x73E9 (29673)
{
	int num;
	int i;
	int num2;
...
int func_190(int iParam0) // Position - 0x7455 (29781)
{
	if (func_187(iParam0))
		return 13;
...
void func_191(int iParam0) // Position - 0x7470 (29808)
{
	int num;
	int num2;
	int offset;
...
int func_192(int iParam0) // Position - 0x74AE (29870)
{
	return iParam0 % 32;
}

int func_193(int iParam0) // Position - 0x74BB (29883)
{
	return iParam0 / 32;
}

int func_194(int iParam0) // Position - 0x74C8 (29896)
{
	switch (iParam0)
	{
		case 24:
...
void func_195(var uParam0) // Position - 0x88A4 (34980)
{
	int num;
	int num2;
	int num3;
...
int func_196(int iParam0) // Position - 0x88E0 (35040)
{
	switch (iParam0)
	{
		case 2:
...
void func_197(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x9495 (38037)
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_178();
	hash = func_202(uParam0.f_6 >= uParam0.f_2.f_2);
	hash2 = func_198(uParam0, uParam0.f_1, uParam0.f_2);
	any = uParam0.f_6;
...
Hash func_198(int iParam0, var uParam1, int iParam2) // Position - 0x94FE (38142)
{
	var unk;
	...
	TEXT_LABEL_APPEND_STRING(&unk, func_201(uParam1), 64);
	TEXT_LABEL_APPEND_STRING(&unk, "_OBJ_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_199((iParam2 - func_189(iParam0, uParam1, 0)) + 1), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_199(int iParam0) // Position - 0x980F (38927)
{
	var unk;
...
char* func_200(var uParam0) // Position - 0x982A (38954)
{
	return uParam0;
}

char* func_201(int iParam0) // Position - 0x9834 (38964)
{
	switch (iParam0)
	{
		case 0:
...
Hash func_202(BOOL bParam0) // Position - 0x9888 (39048)
{
	if (bParam0)
...
BOOL func_204(int iParam0, int iParam1) // Position - 0xF2D6 (62166)
{
	...
	statHash = func_205(iParam0, iParam1);
...
Hash func_205(int iParam0, int iParam1) // Position - 0xF2FA (62202)
{
...
BOOL func_206() // Position - 0xF310 (62224)
{
	...
	flag = func_145(11960, -1);

	if (Global_2733138.f_5766.f_3 - flag >= 2)
	{
		func_207(41244, false, -1);
		return 0;
	}
...
void func_207(int iParam0, BOOL bParam1, int iParam2) // Position - 0xF357 (62295)
{
	if (iParam2 == -1)
		iParam2 = func_69();
...
BOOL func_209() // Position - 0xF3F8 (62456)
{
	...
	for (i = 0; i < 103; i = i + 1)
	{
		weaponHash = func_211(i);
		num = func_210(i);
	
		if (num == 18486)
		{
		}
		else if (IS_BIT_SET(func_145(num, -1), i % 32))
		{
	...
	func_207(41242, address, -1);
	return func_215(address);
}

int func_210(int iParam0) // Position - 0xF4EE (62702)
{
	iParam0 = iParam0 / 32;
...
Hash func_211(int iParam0) // Position - 0xF561 (62817)
{
	switch (iParam0)
	{
		case 34:
...
var func_212(BOOL bParam0, var uParam1, var uParam2) // Position - 0xFBA2 (64418)
{
	if (bParam0)
		return uParam1;
...
Hash func_214(int iParam0, int iParam1) // Position - 0xFBDD (64477)
{
...
void func_216(var uParam0, int iParam1) // Position - 0xFC33 (64563)
{
...
BOOL func_217() // Position - 0xFC48 (64584)
{
	...
	func_207(41247, num2, -1);
	return num2;
}

int func_218(BOOL bParam0) // Position - 0xFE8D (65165)
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xFE9F (65183)
{
	if (iParam1 == -1)
		iParam1 = func_69();
...
BOOL func_220(int iParam0, var uParam1) // Position - 0xFEBB (65211)
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_221(iParam0, *uParam1, i);
	
		if (uParam1->f_2 != -1)
		{
			uParam1->f_2.f_2 = func_185(*uParam1, uParam1->f_2);
			uParam1->f_2.f_1 = func_203(*uParam1, uParam1->f_2);
...
int func_221(int iParam0, int iParam1, int iParam2) // Position - 0xFF33 (65331)
{
	switch (iParam1)
	{
		case 0:
			switch (iParam2)
			{
				...
				case 2:
					if (func_218(_STAT_GET_PACKED_BOOL(54776, -1)) + func_218(_STAT_GET_PACKED_BOOL(54777, -1)) + func_218(_STAT_GET_PACKED_BOOL(54778, -1)) + func_218(_STAT_GET_PACKED_BOOL(54779, -1)) + func_218(_STAT_GET_PACKED_BOOL(54780, -1)) == 0)
						return 3;
		...
		case 1:
			switch (iParam2)
			{
				...
				case 2:
					if (func_218(_STAT_GET_PACKED_BOOL(51286, -1)) + func_218(_STAT_GET_PACKED_BOOL(51287, -1)) + func_218(_STAT_GET_PACKED_BOOL(51288, -1)) + func_218(_STAT_GET_PACKED_BOOL(51289, -1)) + func_218(_STAT_GET_PACKED_BOOL(51290, -1)) + func_218(_STAT_GET_PACKED_BOOL(51291, -1)) == 0)
						return 11;
...
int func_222(int iParam0) // Position - 0x12205 (74245)
{
	int num;
	int num2;
	int num3;
...
BOOL func_223(int iParam0, BOOL bParam1) // Position - 0x1224B (74315)
{
	if (iParam0 == -1)
		return false;
...
int func_224(int iParam0) // Position - 0x12267 (74343)
{
	switch (iParam0)
	{
		case 54773:
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x132D2 (78546)
{
	if (iParam2 == -1)
		iParam2 = func_69();
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x132F0 (78576)
{
	if (iParam1 == -1)
		iParam1 = func_69();
...
int func_227() // Position - 0x1330C (78604)
{
...
int func_228() // Position - 0x13328 (78632)
{
...
void func_229(eCharacter echParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x13344 (78660)
{
	int num;
	...
	if (Global_118[echParam0 /*10*/].f_8 != 198)
	{
		...
		if (echParam1 == 4)
		{
			func_234(echParam0, 0, 1);
			func_234(echParam0, 1, 1);
			func_234(echParam0, 2, 1);
			func_233(echParam0, 0, 1);
			func_233(echParam0, 1, 1);
			func_233(echParam0, 2, 1);
		}
		else
		{
			if (func_232(echParam0, echParam1) == 1 && func_231(echParam0, echParam1) == 1)
				bParam2 = false;
		
			num = echParam1;
			func_234(echParam0, num, 1);
			func_233(echParam0, num, 1);
...
void func_230() // Position - 0x134C2 (79042)
{
	var txdName;
	var subject;
...
int func_231(eCharacter echParam0, int iParam1) // Position - 0x1353D (79165)
{
...
int func_232(eCharacter echParam0, int iParam1) // Position - 0x13567 (79207)
{
	if (iParam1 < 0 || iParam1 > 4)
		return 0;
...
void func_233(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x13591 (79249)
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
void func_234(eCharacter echParam0, int iParam1, int iParam2) // Position - 0x135D6 (79318)
{
	if (iParam1 < 0 || iParam1 > 4)
		return;
...
BOOL func_235(int iParam0, int iParam1) // Position - 0x1361B (79387)
{
	if (func_232(iParam0, iParam1) == 1)
		return true;

	return false;
}

void func_236() // Position - 0x13637 (79415)
{
	BOOL flag;
...
void func_237() // Position - 0x136CD (79565)
{
	Global_1048576.f_10 = 0;
	return;
}

void func_238() // Position - 0x136DC (79580)
{
	var unk;
	var unk2;
	var unk3;
...
void func_239() // Position - 0x13A13 (80403)
{
	MISC::SET_BIT(&(Global_2685153.f_2), 12);
	return;
}

void func_240() // Position - 0x13A27 (80423)
{
	Global_1057441 = -1;
	return;
}

BOOL func_241() // Position - 0x13A34 (80436)
{
	switch (func_242())
	{
		case 21:
...
int func_242() // Position - 0x13B11 (80657)
{
	return Global_1057441;
}

void func_243(BOOL bParam0) // Position - 0x13B1D (80669)
{
	BOOL flag;
...
void func_244(int iParam0) // Position - 0x13BB0 (80816)
{
	Global_2685153.f_894 = iParam0;
	return;
}

void func_245(int iParam0) // Position - 0x13BC1 (80833)
{
	if (iParam0 == -1)
...
void func_246() // Position - 0x13BEB (80875)
{
	Global_2685153.f_9 = -1;
	return;
}

BOOL func_247() // Position - 0x13BFA (80890)
{
	return Global_2685153.f_739;
}

void func_248() // Position - 0x13C09 (80905)
{
	Global_2685153.f_42 = func_249();
	return;
}

int func_249() // Position - 0x13C1B (80923)
{
	if (Global_2693306)
		return 32;
...
void func_250() // Position - 0x13C36 (80950)
{
	Global_2685153.f_737 = 0;
	return;
}

void func_251() // Position - 0x13C46 (80966)
{
	Global_2685153.f_719 = 0;
	return;
}

void func_252() // Position - 0x13C56 (80982)
{
	MISC::CLEAR_BIT(&(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18), 15);
	return;
}

void func_253() // Position - 0x13C73 (81011)
{
...
void func_254() // Position - 0x13C89 (81033)
{
	MISC::SET_BIT(&(Global_2685153.f_3), 2);
	return;
}

void func_255() // Position - 0x13C9C (81052)
{
	MISC::CLEAR_BIT(&Global_2685153, 7);
	return;
}

void func_256() // Position - 0x13CAD (81069)
{
	MISC::CLEAR_BIT(&Global_2685153, 6);
	return;
}

void func_257() // Position - 0x13CBE (81086)
{
	Global_2685153 = 0;
...
void func_258(BOOL bParam0) // Position - 0x13CD9 (81113)
{
	int i;
	var unk;
	int j;
...
void func_259() // Position - 0x13DD5 (81365)
{
	Global_2681186.f_32 = 0;
	return;
}

void func_260() // Position - 0x13DE4 (81380)
{
	var unk;
	int i;
...
BOOL func_261() // Position - 0x13E5E (81502)
{
	return IS_BIT_SET(Global_2685153.f_3, 2);
}

void func_262() // Position - 0x13E6E (81518)
{
	MISC::CLEAR_BIT(&(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18), 5);
	return;
}

void func_263() // Position - 0x13E8A (81546)
{
	MISC::CLEAR_BIT(&(Global_2685153.f_2), 11);
	return;
}

BOOL func_264() // Position - 0x13E9E (81566)
{
	return IS_BIT_SET(Global_2685153.f_2, 27);
}

BOOL func_265() // Position - 0x13EAF (81583)
{
	if (func_19() || func_268() || func_267() || func_266())
		return true;

	return false;
}

BOOL func_266() // Position - 0x13EE1 (81633)
{
	return IS_BIT_SET(Global_2685153, 1);
}

BOOL func_267() // Position - 0x13EEF (81647)
{
	return IS_BIT_SET(Global_2685153, 2);
}

BOOL func_268() // Position - 0x13EFD (81661)
{
	return IS_BIT_SET(Global_2685153, 20);
}

BOOL func_269() // Position - 0x13F0C (81676)
{
	return IS_BIT_SET(Global_2686095.f_1.f_2810, 3);
}

void func_270() // Position - 0x13F1F (81695)
{
...
void func_271() // Position - 0x13F40 (81728)
{
	var unk;
...
void func_272() // Position - 0x13F94 (81812)
{
	var unk;
...
void func_274(int iParam0) // Position - 0x14017 (81943)
{
...
void func_275() // Position - 0x14041 (81985)
{
	int i;
...
BOOL func_276() // Position - 0x140A2 (82082)
{
	return Global_2685153.f_742;
}

void func_277(int iParam0) // Position - 0x140B1 (82097)
{
	int num;
	int offset;
...
BOOL func_278(int iParam0) // Position - 0x140DA (82138)
{
	int num;
	int num2;
...
void func_279(int iParam0, int iParam1, BOOL bParam2) // Position - 0x14100 (82176)
{
	if (func_286())
	{
		if (iParam1 == 1)
		{
			...
			func_24(&(Global_2733138.f_3587), false, false);
			...
			if (bParam2)
			{
				...
				func_24(&(Global_2733138.f_3590), false, false);
			}
			else
			{
...
BOOL func_281(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x141EF (82415)
{
	if (bParam1)
...
BOOL func_282(Player plParam0) // Position - 0x14221 (82465)
{
	return func_283(plParam0);
}

BOOL func_283(Player plParam0) // Position - 0x1422F (82479)
{
	return IS_BIT_SET(Global_1845299[plParam0 /*883*/].f_11.f_1, 0);
}

BOOL func_284() // Position - 0x14246 (82502)
{
	return Global_2685153.f_846;
}

void func_285(BOOL bParam0) // Position - 0x14255 (82517)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_286())
...
BOOL func_286() // Position - 0x1434E (82766)
{
...
void func_293(int iParam0) // Position - 0x1466A (83562)
{
	if (!func_306())
		return;
	...
	if (func_145(14806, -1) != func_294(PLAYER::PLAYER_ID()))
		func_273(14806, func_294(PLAYER::PLAYER_ID()), -1, true);

	return;
}

int func_294(Player plParam0) // Position - 0x146B2 (83634)
{
	if (func_295(plParam0) == -1)
		return -1;

	return func_295(plParam0) + 43200;
}

int func_295(Player plParam0) // Position - 0x146D3 (83667)
{
	return Global_1892798[plParam0 /*615*/].f_10.f_1;
}

void func_296() // Position - 0x146E8 (83688)
{
...
void func_297(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x14719 (83737)
{
...
void func_299(BOOL bParam0) // Position - 0x14762 (83810)
{
	func_300(204, bParam0, -1, true);
	return;
}

void func_300(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x14774 (83828)
{
	Hash statName;
...
void func_301(BOOL bParam0) // Position - 0x14797 (83863)
{
	if (bParam0)
	{
		if (func_303(4))
...
void func_302(BOOL bParam0) // Position - 0x147FF (83967)
{
	func_300(432, bParam0, -1, true);
	return;
}

BOOL func_303(int iParam0) // Position - 0x14812 (83986)
{
	return IS_BIT_SET(Global_2733138.f_3989.f_51, iParam0);
}

struct<16> func_304(int iParam0) // Position - 0x14826 (84006)
{
	var unk;
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(&unk))
		TEXT_LABEL_ASSIGN_STRING(&unk, func_305(iParam0), 64);

	return unk;
}

const char* func_305(int iParam0) // Position - 0x14869 (84073)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_306() // Position - 0x1488D (84109)
{
...
BOOL func_307(int iParam0) // Position - 0x148AB (84139)
{
	return Global_1574538[iParam0];
}

BOOL func_308() // Position - 0x148BB (84155)
{
...
int func_310(Player plParam0) // Position - 0x148DD (84189)
{
	...
	if (_NETWORK_IS_PLAYER_VALID(plParam0, false, true))
	{
		...
		num2 = (num + func_311()) - NETWORK::GET_CLOUD_TIME_AS_INT();
		return num2;
	}
...
var func_311() // Position - 0x14932 (84274)
{
	return Global_262145.f_15451;
}

int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x14941 (84289)
{
	Hash statHash;
	int outValue;
...
int func_313() // Position - 0x1495F (84319)
{
	return Global_262145.f_12914;
}

int func_314() // Position - 0x1496E (84334)
{
	int i;
	int num;
	Player player;
...
void func_316() // Position - 0x149E3 (84451)
{
	...
	{
		WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("WEAPON_UNARMED"), true);
		offsetFromEntityInWorldCoords = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(obLocal_151, 0.0328f, -0.8f, 0.3f) };
		flag = false;
		_STOPWATCH_DESTROY(&uLocal_147);
		...
		if (func_10(0, &unk))
		{
			while (!flag)
			{
				...
				if (!_STOPWATCH_IS_INITIALIZED(&uLocal_147))
					func_387(&uLocal_147, false, false);
				else if (func_384(&uLocal_147, 4000, false))
					flag = true;
			
				if (!func_320(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), offsetFromEntityInWorldCoords, 0.05f, false) && !func_370(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(obLocal_151), 5f))
					if (!func_318(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_GO_STRAIGHT_TO_COORD))
						TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), offsetFromEntityInWorldCoords, 1f, 5000, ENTITY::GET_ENTITY_HEADING(obLocal_151), 0.25f);
				else
					flag = true;
			
				GRAPHICS::DRAW_DEBUG_SPHERE(offsetFromEntityInWorldCoords, 0.1f, 255, 0, 0, 255);
				GRAPHICS::DRAW_DEBUG_LINE(offsetFromEntityInWorldCoords, ENTITY::GET_ENTITY_COORDS(obLocal_151, true), 0, 255, 0, 255);
...
void func_317(Object obParam0) // Position - 0x14B34 (84788)
{
	var animDict;
	var animDict2;
	var animDict3;
	...
	switch (iLocal_152)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&animDict))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), SCRIPT_TASK_GO_STRAIGHT_TO_COORD) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&animDict))
				{
					...
					iLocal_153 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_157, ENTITY::GET_ENTITY_ROTATION(obParam0, 2), 2, false, false, 1065353216, 0, 1065353216);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_153, &animDict, "enter", 4f, -2f, 5, 0, 1148846080, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_153);
					STREAMING::REMOVE_ANIM_DICT(&animDict);
					iLocal_152 = 1;
				}
		...
		case 1:
			...
			localSceneFromNetworkId = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_153);
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&animDict2) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(localSceneFromNetworkId) || PED::GET_SYNCHRONIZED_SCENE_PHASE(localSceneFromNetworkId) >= 0.96f)
			{
				...
				if (MISC::ARE_STRINGS_EQUAL(&uLocal_160, "idle_a") && randomIntInRange == 0 || MISC::ARE_STRINGS_EQUAL(&uLocal_160, "idle_b") && randomIntInRange == 1 || MISC::ARE_STRINGS_EQUAL(&uLocal_160, "idle_c") && randomIntInRange == 2 || MISC::ARE_STRINGS_EQUAL(&uLocal_160, "idle_d") && randomIntInRange == 3)
				{
				...
				iLocal_153 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(uLocal_157, ENTITY::GET_ENTITY_ROTATION(obParam0, 2), 2, false, true, 1065353216, 0, 1065353216);
			
				switch (randomIntInRange)
				{
					case 0:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_153, &animDict2, "idle_a", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_153);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_160, "idle_a", 16);
						iLocal_152 = 3;
						break;
				
					case 1:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_153, &animDict2, "idle_b", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_153);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_160, "idle_b", 16);
						iLocal_152 = 3;
						break;
				
					case 2:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_153, &animDict2, "idle_c", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_153);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_160, "idle_c", 16);
						iLocal_152 = 3;
						break;
				
					case 3:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_153, &animDict2, "idle_d", 4f, -2f, 5, 0, 1148846080, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_153);
						TEXT_LABEL_ASSIGN_STRING(&uLocal_160, "idle_d", 16);
						iLocal_152 = 3;
						break;
				
					default:
						TEXT_LABEL_ASSIGN_STRING(&uLocal_160, "idle_XXX", 16);
						break;
				}
			}
			break;
		...
		case 3:
			...
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_153) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(localSceneFromNetworkId))
			{
				if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_153))
				{
					PED::DETACH_SYNCHRONIZED_SCENE(iLocal_153);
				...
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_153, &animDict2, animnName, 4f, -2f, 5, 0, 1148846080, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_153);
				iLocal_152 = 3;
				return;
			}
...
BOOL func_318(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x1507E (86142)
{
...
BOOL func_319(Ped pedParam0) // Position - 0x150B1 (86193)
{
...
BOOL func_320(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x150D1 (86225)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
BOOL func_321() // Position - 0x1514C (86348)
{
	if (!func_11(Global_2673274.f_4.f_16))
		return false;

	return IS_BIT_SET(Global_1950714.f_759, 30);
}

BOOL func_322() // Position - 0x15172 (86386)
{
	if (func_385(Global_2673274.f_4.f_16))
		if (IS_BIT_SET(Global_1950714.f_759, 0) || IS_BIT_SET(Global_1950714.f_759, 2))
			return 1;

	return 0;
}

BOOL func_323() // Position - 0x151A9 (86441)
{
	if (func_386(Global_2673274.f_4.f_16))
		if (IS_BIT_SET(Global_1950714.f_759, 0) || IS_BIT_SET(Global_1950714.f_759, 2))
			return true;
...
BOOL func_324() // Position - 0x151E0 (86496)
{
	...
	if (func_372(PLAYER::PLAYER_ID()))
		return true;
	else if (func_314() < func_313())
		return true;

	return false;
}

BOOL func_325(int iParam0, BOOL bParam1) // Position - 0x1522F (86575)
{
	int num;
...
int func_326(int iParam0) // Position - 0x152E7 (86759)
{
	int i;
...
void func_327(BOOL bParam0) // Position - 0x15322 (86818)
{
	if (func_321() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_328() && !Global_1950567)
		_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 2, "ARENAWHINPUT" /*Press ~INPUT_CONTEXT~ to access arenawar.tv.~n~Press ~INPUT_CONTEXT_SECONDARY~ to view Sponsorship Tier Unlocks.*/, 0, 0, 0, 0);

	return;
}

BOOL func_328() // Position - 0x15362 (86882)
{
	return Global_1950714.f_772;
}

void func_329(BOOL bParam0) // Position - 0x15371 (86897)
{
	if (func_351(PLAYER::PLAYER_ID()) && func_337(PLAYER::PLAYER_ID()) == func_336(PLAYER::PLAYER_ID()) && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_328() && !Global_1950567)
	{
		if (func_333())
		{
			func_332("WHPRIVSESLAP" /*Join a public session to access the SecuroServ network.*/);
		}
		else if (!bParam0)
		{
			if (func_314() >= func_313())
				_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "WHSECUROMAXVIP" /*This computer is unavailable. The maximum number of VIPs, CEOs and Club Presidents has been reached in this session.*/, 0, 0, 0, 0);
			else if (func_309(PLAYER::PLAYER_ID()))
				_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "PIM_EXECH0x1" /*SecuroServ access is currently blocked due to your recent behavior.*/, 0, 0, 0, 0);
			else if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
				func_332("WHSECUROBLCK" /*This computer is unavailable during a mission.*/);
			else
				_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "SECINPUTTREGLAP" /*Press ~INPUT_CONTEXT~ to register as a SecuroServ CEO and access this computer.*/, 0, 0, 0, 0);
		}
		else if (func_73(PLAYER::PLAYER_ID()))
		{
			func_332("WHBIKERBLCK" /*You need to register as a SecuroServ CEO to access this computer.*/);
		}
		else if (_STOPWATCH_IS_INITIALIZED(&uLocal_145) && func_384(&uLocal_145, 10000, true) || !bLocal_142)
		{
			if (func_330(PLAYER::PLAYER_ID()) || Global_1950567 == true)
			{
				bLocal_142 = true;
			...
			else
			{
				...
				_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "WHSECUROINPUT" /*Press ~INPUT_CONTEXT~ to access this laptop.*/, 0, 0, 0, 0);
			}
		}
		else if (bLocal_142)
		{
...
BOOL func_330(Player plParam0) // Position - 0x154E6 (87270)
{
	return func_331(func_91(plParam0));
}

BOOL func_331(int iParam0) // Position - 0x154F8 (87288)
{
	switch (iParam0)
	{
		case 178:
...
void func_332(char* sParam0) // Position - 0x15518 (87320)
{
...
BOOL func_333() // Position - 0x1552E (87342)
{
	if (Global_1950572)
		return false;
...
BOOL func_335() // Position - 0x1555F (87391)
{
	return Global_1575045 == 10;
}

int func_336(Player plParam0) // Position - 0x1556E (87406)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return 0;
...
void func_339(BOOL bParam0) // Position - 0x1564D (87629)
{
	if (func_350(PLAYER::PLAYER_ID()) || func_322() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_328() && !Global_1950567 && func_370(ENTITY::GET_ENTITY_HEADING(PLAYER::PLAYER_PED_ID()), ENTITY::GET_ENTITY_HEADING(obLocal_151), 90f))
	{
		if (NETWORK::NETWORK_IS_ACTIVITY_SESSION())
		{
			func_332("WHSECUROBLCK" /*This computer is unavailable during a mission.*/);
		...
		else if (func_333())
		{
			if (func_350(PLAYER::PLAYER_ID()))
				func_332("BIKERWHBLCKC" /*Join a public session to purchase a Business.*/);
			else
				func_332("BIKERWHBLCKD" /*Join a public session to manage your Business*/);
		}
		else if (func_73(PLAYER::PLAYER_ID()))
		{
			if (_STOPWATCH_IS_INITIALIZED(&uLocal_145) && func_384(&uLocal_145, 10000, true) || !bLocal_142)
			{
				if (func_340(PLAYER::PLAYER_ID()) || Global_1950567 == true)
				{
					bLocal_142 = true;
				...
				else
				{
					...
					bLocal_142 = false;
					_STOPWATCH_DESTROY(&uLocal_145);
					_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "BIKERWHINPUT" /*Press ~INPUT_CONTEXT~ to securely access the Open Road website.*/, 0, 0, 0, 0);
				}
			}
			else if (bLocal_142)
			{
		...
		else if (!bParam0 && func_314() < func_313())
		{
			_CONTEXT_ADD_HELP_TEXT(&iLocal_140, 1, "BIKERWHBLCKA" /*Press ~INPUT_CONTEXT~ to found a Motorcycle Club and access this computer.*/, 0, 0, 0, 0);
		}
		else
		{
			func_332("BIKERWHBLCKB" /*You need to be the President of a Motorcycle Club to access this computer.*/);
		}
	}
...
BOOL func_340(Player plParam0) // Position - 0x157BC (87996)
{
	return func_341(func_91(plParam0));
}

BOOL func_341(int iParam0) // Position - 0x157CE (88014)
{
	switch (iParam0)
	{
		case 190:
...
BOOL func_342() // Position - 0x157F4 (88052)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_151))
	{
		...
		if (func_385(PLAYER::PLAYER_ID()) || func_343(PLAYER::PLAYER_ID()))
			return true;
	}
...
BOOL func_343(Player plParam0) // Position - 0x15832 (88114)
{
	if (func_352(Global_1845299[plParam0 /*883*/].f_260.f_39, -1))
		return 1;
...
void func_345(BOOL bParam0) // Position - 0x158B5 (88245)
{
	if (func_323() && !NETWORK::NETWORK_IS_PLAYER_IN_MP_CUTSCENE(PLAYER::PLAYER_ID()) && !func_328() && !Global_1950567)
	{
		if (func_333())
		{
			func_332("WHPRIVSESLAP" /*Join a public session to access the SecuroServ network.*/);
		...
		{
			if (func_389(PLAYER::PLAYER_ID()) || Global_1950567 == true)
			{
				bLocal_142 = true;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x15A10 (88592)
{
	int i;
...
BOOL func_347() // Position - 0x15B3B (88891)
{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x15BDF (89055)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_349(var uParam0) // Position - 0x15BF2 (89074)
{
	int num;
...
BOOL func_350(Player plParam0) // Position - 0x15C49 (89161)
{
	if (func_352(Global_1845299[plParam0 /*883*/].f_260.f_39, -1) && !IS_BIT_SET(Global_1845299[plParam0 /*883*/].f_260.f_37, 1))
		return 1;
...
BOOL func_354() // Position - 0x15DD4 (89556)
{
	return Global_79081;
}

BOOL func_355() // Position - 0x15DE0 (89568)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && func_315(PLAYER::PLAYER_ID(), true) && func_86(PLAYER::PLAYER_ID(), false) && func_76(PLAYER::PLAYER_ID()))
	{
		if (func_91(PLAYER::PLAYER_ID()) == 256)
			if (ENTITY::IS_ENTITY_IN_AREA(PLAYER::PLAYER_PED_ID(), 1155f, -3200.515f, -40.05f, 1176.79f, -3189.532f, -34.785f, false, true, 0))
				return true;
	
		if (func_91(PLAYER::PLAYER_ID()) == 271)
		...
		if (func_356(*Global_4718592.f_139000) == 5)
...
int func_356(int iParam0) // Position - 0x15F0E (89870)
{
	int i;
...
int func_357(int iParam0) // Position - 0x15F39 (89913)
{
	if (iParam0 != -1)
...
BOOL func_358() // Position - 0x15F58 (89944)
{
	return IS_BIT_SET(Global_1950714.f_11, 1);
}

BOOL func_359() // Position - 0x15F68 (89960)
{
	if (func_361(PLAYER::PLAYER_ID()) == 150 && func_360(PLAYER::PLAYER_PED_ID(), 3084.5112f, -4686.664f, 26.2522f, 50f, true))
		return true;

	return false;
}

BOOL func_360(Ped pedParam0, float fParam1, float fParam2, float fParam3, float fParam4, BOOL bParam5) // Position - 0x15FA5 (90021)
{
	return BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), fParam1) <= fParam4 * fParam4;
}

int func_361(Player plParam0) // Position - 0x15FC3 (90051)
{
	Player player;
...
int func_362(Player plParam0) // Position - 0x15FE2 (90082)
{
	if (func_91(plParam0) == 243)
		return func_85(plParam0);

	return -1;
}

BOOL func_363() // Position - 0x15FFF (90111)
{
	return func_372(PLAYER::PLAYER_ID());
}

BOOL func_364() // Position - 0x1600F (90127)
{
	return Global_1845299[PLAYER::PLAYER_ID() /*883*/] == 148;
}

BOOL func_365() // Position - 0x16025 (90149)
{
	return Global_77360;
}

BOOL func_366() // Position - 0x16031 (90161)
{
	return Global_1935999;
}

BOOL func_367() // Position - 0x1603D (90173)
{
...
BOOL func_368() // Position - 0x1606B (90219)
{
...
BOOL func_369(int iParam0) // Position - 0x16085 (90245)
{
	if (iParam0 == 1)
...
BOOL func_370(float fParam0, float fParam1, float fParam2) // Position - 0x160DC (90332)
{
	float num;
	float num2;
...
BOOL func_371() // Position - 0x16151 (90449)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_151))
...
BOOL func_373() // Position - 0x161A7 (90535)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_151) && func_11(PLAYER::PLAYER_ID()))
		return true;

	return false;
}

BOOL func_374() // Position - 0x161CA (90570)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_151) && func_351(PLAYER::PLAYER_ID()))
		return true;

	return false;
}

BOOL func_375(Player plParam0) // Position - 0x161ED (90605)
{
	if (func_352(Global_1845299[plParam0 /*883*/].f_260.f_39, -1))
		return 1;
...
BOOL func_376() // Position - 0x16210 (90640)
{
	if (ENTITY::DOES_ENTITY_EXIST(obLocal_151))
		if (ENTITY::GET_ENTITY_MODEL(obLocal_151) == joaat("ex_prop_monitor_01_ex") || func_386(PLAYER::PLAYER_ID()))
			return true;

	return false;
}

void func_377(int iParam0) // Position - 0x16243 (90691)
{
	if (func_382())
		return;
...
void func_378(int iParam0) // Position - 0x16276 (90742)
{
	if (func_382())
		return;
...
BOOL func_379() // Position - 0x16300 (90880)
{
...
void func_380(BOOL bParam0, BOOL bParam1) // Position - 0x16327 (90919)
{
	if (bParam0)
	{
		if (func_369(0))
...
BOOL func_381() // Position - 0x1639B (91035)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_382() // Position - 0x163A9 (91049)
{
	return IS_BIT_SET(Global_1964705, 19);
}

void _STOPWATCH_DESTROY(var uParam0) // Position - 0x163B8 (91064)
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_384(var uParam0, int iParam1, BOOL bParam2) // Position - 0x163C5 (91077)
{
	if (iParam1 == -1)
		return true;

	func_387(uParam0, bParam2, false);
...
void func_387(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x164BE (91326)
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x16503 (91395)
{
	return uParam0->f_1;
}

BOOL func_389(Player plParam0) // Position - 0x1650F (91407)
{
	return func_390(func_91(plParam0));
}

BOOL func_390(int iParam0) // Position - 0x16521 (91425)
{
	switch (iParam0)
	{
		case 167:
...
BOOL func_391(int iParam0) // Position - 0x16547 (91463)
{
	return Global_44886 == iParam0;
}

void func_392() // Position - 0x16555 (91477)
{
	if (iLocal_140 != -1)
		func_349(&iLocal_140);
