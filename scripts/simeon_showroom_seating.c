...
void func_61(int iParam0) // Position - 0x215F (8543)
{
	int i;
...
int func_74(Player plParam0) // Position - 0x25A6 (9638)
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x25D0 (9680)
{
	Player player;
...
BOOL func_97(Player plParam0) // Position - 0x29A6 (10662)
{
...
BOOL func_98(Player plParam0) // Position - 0x29DF (10719)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_99(Player plParam0) // Position - 0x2A10 (10768)
{
	if (plParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
