...
BOOL func_29() // Position - 0x1244 (4676)
{
	return func_30(PLAYER::PLAYER_ID());
}

BOOL func_30(Player plParam0) // Position - 0x1254 (4692)
{
...
int func_31(int iParam0) // Position - 0x1273 (4723)
{
	switch (iParam0)
	{
		case 0:
...
var func_32(BOOL bParam0, var uParam1, var uParam2) // Position - 0x12BE (4798)
{
	if (bParam0)
		return uParam1;
...
void func_33(var uParam0) // Position - 0x12D5 (4821)
{
	Vector3 vector;
	float num;
...
BOOL func_34(BOOL bParam0) // Position - 0x14F3 (5363)
{
...
BOOL func_35(Ped pedParam0) // Position - 0x15DE (5598)
{
	int weaponHash;
...
BOOL func_36() // Position - 0x163B (5691)
{
...
BOOL func_37() // Position - 0x165D (5725)
{
...
BOOL func_38(var uParam0) // Position - 0x1677 (5751)
{
	return func_58(&(uParam0->f_7), 9);
}

void func_39(var uParam0) // Position - 0x1689 (5769)
{
	var animDict;
	var animnName;
...
void func_40(var uParam0) // Position - 0x173C (5948)
{
	var animDict;
...
BOOL func_41() // Position - 0x17A6 (6054)
{
	return IS_BIT_SET(Global_1950714.f_3, 25);
}

BOOL func_42(float fParam0, float fParam1, float fParam2) // Position - 0x17B7 (6071)
{
	float num;
	float num2;
...
void func_43(var uParam0) // Position - 0x183D (6205)
{
	int weaponHash;
...
void func_44() // Position - 0x18D1 (6353)
{
	Global_24407.f_6 = 1;
	return;
}

void func_45(BOOL bParam0) // Position - 0x18DF (6367)
{
	if (bParam0)
		if (func_46())
...
BOOL func_46() // Position - 0x1904 (6404)
{
	return IS_BIT_SET(Global_2685153.f_2, 11);
}

void func_47() // Position - 0x1915 (6421)
{
	MISC::SET_BIT(&Global_9464, 4);
	return;
}

void func_48(int iParam0) // Position - 0x1925 (6437)
{
	if (func_54())
		return;
...
void func_49(int iParam0) // Position - 0x1958 (6488)
{
	if (func_54())
		return;
...
BOOL func_50() // Position - 0x19E2 (6626)
{
...
void func_51(BOOL bParam0, BOOL bParam1) // Position - 0x1A09 (6665)
{
	if (bParam0)
	{
		if (func_53(0))
...
BOOL func_52() // Position - 0x1A7D (6781)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_53(int iParam0) // Position - 0x1A8B (6795)
{
	if (iParam0 == 1)
...
BOOL func_54() // Position - 0x1AE2 (6882)
{
	return IS_BIT_SET(Global_1964705, 19);
}

Vector3 func_55(var uParam0) // Position - 0x1AF1 (6897)
{
	var unk;
...
Vector3 func_56(var uParam0) // Position - 0x1B3B (6971)
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_57(int* piParam0, int iParam1) // Position - 0x1B4F (6991)
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_58(var uParam0, int iParam1) // Position - 0x1B5F (7007)
{
	return IS_BIT_SET(*uParam0, iParam1);
}

void func_59(var uParam0, char* sParam1) // Position - 0x1B6D (7021)
{
	if (uParam0->f_1.f_1 == 2)
	{
		if (func_29())
...
void func_60(var uParam0, char* sParam1) // Position - 0x1E9F (7839)
{
...
void func_61(ePedComponentType epctParam0) // Position - 0x215F (8543)
{
	int i;
...
int func_62() // Position - 0x21C2 (8642)
{
	int num;
...
void func_63(var uParam0) // Position - 0x21CF (8655)
{
...
int func_64(var uParam0) // Position - 0x2207 (8711)
{
	int randomIntInRange;
...
int func_65(int iParam0) // Position - 0x229F (8863)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_66(int iParam0) // Position - 0x22E1 (8929)
{
	switch (iParam0)
	{
		case 2:
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x231F (8991)
{
	int i;
...
BOOL func_68(int iParam0) // Position - 0x244A (9290)
{
	if (iParam0 != 5)
		return false;
...
BOOL func_69(Player plParam0) // Position - 0x2463 (9315)
{
	return func_70(plParam0) == joaat("WEAPON_MINIGUN");
}

int func_70(Player plParam0) // Position - 0x2477 (9335)
{
	return Global_1892798[plParam0 /*615*/].f_592;
}

BOOL func_71(var uParam0) // Position - 0x248B (9355)
{
	*uParam0(!func_58(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9 /*14*/], uParam0->f_9);
	return StackVal || StackVal;
}

BOOL func_72(var uParam0) // Position - 0x24B5 (9397)
{
	var sizeAndPeds;
	int i;
...
BOOL func_73(var uParam0) // Position - 0x252C (9516)
{
	int i;
...
int func_74(ePedComponentType epctParam0) // Position - 0x25A6 (9638)
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x25C7 (9671)
{
	return -1;
}

BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x25D0 (9680)
{
...
BOOL func_77(var uParam0) // Position - 0x2630 (9776)
{
	return uParam0->f_7 & 31 > 0;
}

BOOL func_78(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x2641 (9793)
{
...
void func_81(var uParam0, int iParam1) // Position - 0x2731 (10033)
{
	uParam0->f_13 = iParam1;
	return;
}

void func_82(int* piParam0, int iParam1) // Position - 0x273F (10047)
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_83(var uParam0) // Position - 0x274F (10063)
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_84() // Position - 0x27A2 (10146)
{
	return 0.13f;
}

void func_85(var uParam0) // Position - 0x27AF (10159)
{
...
void func_86(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x2807 (10247)
{
	int offset;
...
BOOL func_87() // Position - 0x282B (10283)
{
	return Global_77359;
}

BOOL func_88() // Position - 0x2837 (10295)
{
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x287F (10367)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2903 (10499)
{
	switch (func_92())
	{
		case 0:
...
Hash func_91() // Position - 0x2936 (10550)
{
...
int func_92() // Position - 0x295A (10586)
{
	return Global_33792;
}

BOOL func_93() // Position - 0x2965 (10597)
{
	return Global_2685153.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x2974 (10612)
{
...
BOOL func_95() // Position - 0x298B (10635)
{
	return Global_2696981;
}

BOOL func_96() // Position - 0x2997 (10647)
{
	return Global_2685153.f_695;
}

BOOL func_97(ePedComponentType epctParam0) // Position - 0x29A6 (10662)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
		if (func_99(epctParam0) && !func_98(epctParam0))
			return true;

	return false;
}

BOOL func_98(ePedComponentType epctParam0) // Position - 0x29DF (10719)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_99(ePedComponentType epctParam0) // Position - 0x2A10 (10768)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX() && _NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
BOOL func_100(Player plParam0) // Position - 0x2A41 (10817)
{
...
BOOL func_101() // Position - 0x2A67 (10855)
{
...
void func_102() // Position - 0x2A9F (10911)
{
	func_103(0, &uLocal_140, 0, 3);
	func_103(1, &uLocal_140, 1, 3);
	func_103(2, &uLocal_140, 2, 3);
	func_103(3, &uLocal_140, 3, 2);
	func_103(4, &uLocal_140, 4, 2);
	func_103(5, &uLocal_140, 5, 2);
	return;
}

void func_103(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2ADD (10973)
{
	var unk;
	float num;
...
Vector3 func_104() // Position - 0x2B6E (11118)
{
	return 0.45f, -0.5f, 2f;
}

Vector3 func_105(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2B81 (11137)
{
	float num;
	float num2;
	float num3;
...
float func_106(int iParam0, float fParam1) // Position - 0x2BC5 (11205)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_107() // Position - 0x2C04 (11268)
{
	return -0.45f, -0.5f, 0f;
}

void func_108(int iParam0, var uParam1, var uParam2) // Position - 0x2C17 (11287)
{
	switch (iParam0)
	{
		case 0:
...
void func_109() // Position - 0x2CFE (11518)
{
	return;
}

int func_110(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2D06 (11526)
{
	int i;
...
BOOL func_111(BOOL bParam0) // Position - 0x2E1C (11804)
{
	bParam0;
