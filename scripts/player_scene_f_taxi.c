...
void func_1() // Position - 0x110 (272)
{
	iLocal_70 = 0;
	return;
}

BOOL func_2() // Position - 0x11B (283)
{
	var unk;
	...
	if (!func_3(&unk))
	{
		...
		num = BUILTIN::VDIST2(uLocal_175 + uLocal_180, entityCoords);
...
BOOL func_3(var uParam0) // Position - 0x16F (367)
{
...
BOOL func_4() // Position - 0x1B6 (438)
{
	var unk;
	...
	if (!func_3(&unk))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99759))
		{
			...
			if (!func_5(Global_102175, veLocal_73, 2))
				if (synchronizedScenePhase >= 0.9f)
					PED::SET_PED_INTO_VEHICLE(Global_102175, veLocal_73, 2);
...
BOOL func_6() // Position - 0x303 (771)
{
	if (!func_7())
		return true;
...
BOOL func_7() // Position - 0x318 (792)
{
...
int func_11() // Position - 0x46A (1130)
{
	func_12();
...
void func_12() // Position - 0x4B0 (1200)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(character) && !func_17(14) || Global_113879)
			{
...
BOOL func_13(eCharacter echParam0) // Position - 0x5AD (1453)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x5B9 (1465)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x5F6 (1526)
{
...
Hash func_16(eCharacter echParam0) // Position - 0x61B (1563)
{
	return Global_2339[echParam0 /*29*/];
}

BOOL func_17(int iParam0) // Position - 0x62A (1578)
{
	return Global_44886 == iParam0;
}

void func_18() // Position - 0x638 (1592)
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_19() // Position - 0x678 (1656)
{
	func_20(Global_102177 - 1);
	return;
}

void func_20(int iParam0) // Position - 0x68A (1674)
{
	Global_102177 = iParam0;
	return;
}

void func_21() // Position - 0x698 (1688)
{
	func_20(0);
	return;
}

void func_22() // Position - 0x6A5 (1701)
{
	int num;
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_102175) || !ENTITY::DOES_ENTITY_EXIST(veLocal_73) || !STREAMING::HAS_MODEL_LOADED(hLocal_72) && num < 400)
	{
...
void func_23() // Position - 0x7A1 (1953)
{
	var unk;
	var unk9;
	int num;
...
BOOL func_24(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5) // Position - 0x8A5 (2213)
{
	*uParam4 = 9;
	*uParam5 = 8;
...
void func_25(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5) // Position - 0xFB4 (4020)
{
...
void func_27(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x4349 (17225)
{
...
void func_28(var uParam0) // Position - 0x4373 (17267)
{
	func_27(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

BOOL func_29(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x4391 (17297)
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
void func_30(int iParam0, var uParam1, int iParam2) // Position - 0x7803 (30723)
{
	int num;
...
int func_31(int iParam0, var uParam1, int iParam2) // Position - 0x7A5F (31327)
{
...
BOOL func_32(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x7C97 (31895)
{
	int i;
	Hash outData;
...
BOOL func_33(Hash hParam0) // Position - 0x7E1C (32284)
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x7EE8 (32488)
{
...
BOOL func_35(Hash hParam0, int iParam1) // Position - 0x7EFF (32511)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_36() // Position - 0x80E9 (33001)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_37() // Position - 0x80FF (33023)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_38() // Position - 0x8115 (33045)
{
	return false;
}

BOOL func_39() // Position - 0x811E (33054)
{
	return true;
}

BOOL func_40() // Position - 0x8127 (33063)
{
	return true;
}

BOOL func_41() // Position - 0x8130 (33072)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x8149 (33097)
{
	int profileSetting;
...
BOOL func_43(int iParam0) // Position - 0x8201 (33281)
{
...
int func_44(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x8481 (33921)
{
	int num;
...
BOOL func_45(var uParam0) // Position - 0x867C (34428)
{
	int num;
	Vector3 entityCoords;
	float num2;
...
BOOL func_46(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x8734 (34612)
{
	if (bParam6)
...
BOOL func_47(int iParam0, var uParam1, char* sParam2) // Position - 0x877B (34683)
{
	var unk;
	int num;
	var unk4;
...
BOOL func_48(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0xAD7D (44413)
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0xCCCC (52428)
{
...
BOOL func_50(int iParam0, var uParam1, var uParam2) // Position - 0xCCEA (52458)
{
	switch (iParam0)
	{
		case 11:
...
char* func_51(int iParam0) // Position - 0xD659 (54873)
{
	switch (iParam0)
	{
...
void func_52() // Position - 0xD6EC (55020)
{
