...
void func_1() // Position - 0x153 (339)
{
	func_143(2);
	func_115();
	return;
...
void func_2() // Position - 0x164 (356)
{
	int num;
	int num2;
...
void func_3(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1E8 (488)
{
...
void func_5(int iParam0, int iParam1) // Position - 0x4F7 (1271)
{
	MISC::SET_BIT(&Global_1679155.f_7064[iParam0], iParam1);
	return;
}

BOOL func_6(int iParam0, int iParam1) // Position - 0x510 (1296)
{
	return IS_BIT_SET(Global_1679155.f_7064[iParam0], iParam1);
}

void func_7() // Position - 0x526 (1318)
{
	BOOL flag;

	flag = iLocal_78 - MISC::GET_GAME_TIMER();
...
void func_8(BOOL bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17) // Position - 0x816 (2070)
{
	int num;
	int i;
...
void func_9() // Position - 0x973 (2419)
{
	int i;
	int j;
...
Blip func_10(Vehicle veParam0, BOOL bParam1, int iParam2) // Position - 0xB9D (2973)
{
	Blip blip;
...
Blip func_11(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0xBE7 (3047)
{
	Blip blip;
...
var func_12(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC8B (3211)
{
	if (bParam0)
		return uParam1;
...
void func_13() // Position - 0xCA2 (3234)
{
	func_143(1);
	func_115();
	return;
...
void func_14(Blip* pblParam0, BOOL bParam1, BOOL bParam2) // Position - 0xCB3 (3251)
{
	int i;
...
int func_15() // Position - 0xE5E (3678)
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

void func_16(int iParam0, Blip* pblParam1) // Position - 0xE6E (3694)
{
	switch (iParam0)
	{
		case 0:
...
void func_17(int iParam0, Blip* pblParam1) // Position - 0xEB6 (3766)
{
	switch (iParam0)
	{
		case 0:
...
void func_18(Blip* pblParam0) // Position - 0xEFE (3838)
{
...
int func_19(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xF19 (3865)
{
...
void func_20(Vehicle veParam0) // Position - 0xF70 (3952)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_21(BOOL bParam0, BOOL bParam1) // Position - 0xF9C (3996)
{
...
BOOL func_22(Blip* pblParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, BOOL bParam7, Vehicle veParam8, char* sParam9, char* sParam10, char* sParam11, BOOL bParam12, int iParam13, BOOL bParam14, eBlipSprite ebsParam15) // Position - 0x10ED (4333)
{
...
Blip func_24(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1A41 (6721)
{
	return func_11(veParam0, !bParam1, bParam2);
}

BOOL func_25(Blip* pblParam0) // Position - 0x1A54 (6740)
{
...
BOOL func_26(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1AA9 (6825)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_27(Ped pedParam0) // Position - 0x1B8E (7054)
{
	float entitySpeed;
...
BOOL func_28(Ped pedParam0, BOOL bParam1) // Position - 0x1BC5 (7109)
{
	if (!PED::IS_PED_INJURED(pedParam0))
	{
...
BOOL func_29(Ped pedParam0, Ped pedParam1) // Position - 0x1C30 (7216)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_30(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x1C78 (7288)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_31(Blip blParam0, Blip* pblParam1) // Position - 0x1CF3 (7411)
{
...
Blip func_32(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1D2E (7470)
{
	Blip blip;
...
void func_33(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x1D5A (7514)
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, func_34(iParam2), 1);
	return;
}

char* func_34(int iParam0) // Position - 0x1D71 (7537)
{
	char* str;
...
void func_35(Blip* pblParam0, char* sParam1, BOOL bParam2) // Position - 0x1F63 (8035)
{
	if (!bParam2)
...
void _SHOW_SUBTITLE_CLEAR_EXISTING(char* sParam0, int iParam1, int iParam2) // Position - 0x1F9A (8090)
{
	iParam2 = iParam2;
...
BOOL func_37(Blip* pblParam0) // Position - 0x1FB3 (8115)
{
...
BOOL func_38(Blip* pblParam0, int iParam1) // Position - 0x1FD7 (8151)
{
...
BOOL func_39() // Position - 0x202F (8239)
{
	if (Global_24011 == 1)
		return true;
...
BOOL func_40() // Position - 0x2046 (8262)
{
...
BOOL func_41(Blip* pblParam0) // Position - 0x2068 (8296)
{
	int num;
	int gameTimer;
...
BOOL func_42(Blip* pblParam0, int iParam1) // Position - 0x208B (8331)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_43(Vehicle veParam0, Blip* pblParam1, int iParam2) // Position - 0x20BC (8380)
{
	int num;
...
void func_44(char* sParam0) // Position - 0x2150 (8528)
{
...
BOOL func_45(Blip* pblParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, char* sParam7, float fParam8, BOOL bParam9, Vehicle veParam10, BOOL bParam11, BOOL bParam12, int iParam13, int iParam14, int iParam15, int iParam16, BOOL bParam17) // Position - 0x2168 (8552)
{
	int i;
	int num;
	int num2;
...
void func_46(int iParam0, Blip* pblParam1) // Position - 0x31AB (12715)
{
	switch (iParam0)
	{
		case 0:
...
void func_47(Blip* pblParam0, const char* sParam1, const char* sParam2, BOOL bParam3) // Position - 0x31F3 (12787)
{
	if (!bParam3)
		if (!MISC::IS_STRING_NULL(sParam1))
			if (!MISC::ARE_STRINGS_EQUAL(sParam1, ""))
...
void func_48(const char* sParam0, const char* sParam1, int iParam2, int iParam3) // Position - 0x322C (12844)
{
	iParam3 = iParam3;
	HUD::BEGIN_TEXT_COMMAND_PRINT(sParam0);
...
BOOL func_49(int iParam0, Blip* pblParam1) // Position - 0x324B (12875)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_50(Ped pedParam0, float fParam1) // Position - 0x328B (12939)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_51(Ped pedParam0, Vehicle veParam1) // Position - 0x32C2 (12994)
{
...
BOOL func_52(Ped pedParam0, Vehicle veParam1) // Position - 0x3329 (13097)
{
	if (!PED::IS_PED_INJURED(pedParam0))
...
void func_53(int iParam0, Blip* pblParam1) // Position - 0x335E (13150)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_54(int iParam0, Blip* pblParam1) // Position - 0x33A6 (13222)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_55(Ped pedParam0) // Position - 0x33E6 (13286)
{
	Vehicle vehiclePedIsUsing;
...
BOOL func_56(Vehicle veParam0, Blip* pblParam1) // Position - 0x3473 (13427)
{
	int num;
	int num2;
	int i;
...
BOOL func_57(Blip* pblParam0) // Position - 0x35D3 (13779)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_58(Blip* pblParam0, Ped pedParam1, float fParam2, BOOL bParam3) // Position - 0x3602 (13826)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_59(Vehicle veParam0) // Position - 0x36E0 (14048)
{
	float entitySpeed;
...
BOOL func_60(Ped pedParam0, Vehicle veParam1) // Position - 0x3718 (14104)
{
	Vehicle vehiclePedIsUsing;
...
void func_61() // Position - 0x3748 (14152)
{
	Vehicle vehiclePedIsEntering;
	Ped pedInVehicleSeat;
...
void func_62(Blip* pblParam0) // Position - 0x37B5 (14261)
{
	int i;
...
void func_63(Blip* pblParam0) // Position - 0x3855 (14421)
{
	int i;
...
char* func_64() // Position - 0x38EB (14571)
{
	char* unk;
...
Vector3 func_65() // Position - 0x38F5 (14581)
{
	var unk;
...
void func_66() // Position - 0x3901 (14593)
{
	int i;
...
void func_67() // Position - 0x3A33 (14899)
{
	int i;
	...
	if (!ENTITY::IS_ENTITY_DEAD(veLocal_94, false))
	{
		...
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), veLocal_94, false))
		{
			...
			func_101(&uLocal_104, 0, false, false);
			iLocal_36 = 2;
		}
...
void func_68() // Position - 0x3BA3 (15267)
{
...
void func_69(var uParam0, Vehicle veParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x3BE1 (15329)
{
	func_70(uParam0, veParam1, 0f, 0f, 0f, iParam2, iParam3, bParam4, bParam5, bParam6);
	return;
}

void func_70(var uParam0, Vehicle veParam1, float fParam2, float fParam3, float fParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x3BFE (15358)
{
	func_71(uParam0, veParam1, fParam2, iParam5, iParam6, bParam7, bParam8, bParam9);
	return;
}

void func_71(var uParam0, Vehicle veParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x3C1C (15388)
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
...
void func_72(var uParam0, Vehicle veParam1, var uParam2, var uParam3, var uParam4, const char* sParam5, int iParam6, BOOL bParam7, BOOL bParam8, BOOL bParam9) // Position - 0x3C55 (15445)
{
	const char* string2;
	BOOL flag;
...
void func_73(var uParam0) // Position - 0x3FC9 (16329)
{
...
BOOL func_74(var uParam0) // Position - 0x4034 (16436)
{
	int num;
...
int func_75(BOOL bParam0) // Position - 0x405F (16479)
{
	switch (Global_44886)
	{
		case 0:
...
void _DISPLAY_HELP_TEXT(const char* text, int iParam1) // Position - 0x4109 (16649)
{
...
BOOL func_77(const char* sParam0) // Position - 0x4120 (16672)
{
...
BOOL func_78(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x41B9 (16825)
{
	Vehicle vehiclePedIsIn;
	int seatIndex;
...
BOOL func_79(Player plParam0) // Position - 0x4412 (17426)
{
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x4478 (17528)
{
	Player player;
...
BOOL func_82(Vehicle veParam0, int iParam1) // Position - 0x44E1 (17633)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
	{
...
int _GET_VEHICLE_SEAT_PED_IS_IN(Ped ped, BOOL includeLastVehicle) // Position - 0x4543 (17731)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_87() // Position - 0x45F1 (17905)
{
	return MISC::GET_GAME_TIMER() <= Global_24546.f_6481 + 100;
}

BOOL func_88(int iParam0) // Position - 0x4606 (17926)
{
	if (iParam0 == 1)
...
void func_89(var uParam0, Vehicle veParam1, Vector3 vParam2, var uParam3, var uParam4, int iParam5) // Position - 0x465D (18013)
{
...
BOOL func_90() // Position - 0x476E (18286)
{
	return func_91(PLAYER::PLAYER_ID());
}

BOOL func_91(Player plParam0) // Position - 0x477E (18302)
{
...
BOOL func_92(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x479D (18333)
{
	if (bParam6)
...
BOOL func_93(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x47E4 (18404)
{
	if (uParam0->f_1)
		if (MISC::GET_GAME_TIMER() >= uParam0->f_8 + uParam0->f_9)
			uParam0->f_1 = 0;
...
BOOL func_94(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4B50 (19280)
{
...
BOOL func_95(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4BA2 (19362)
{
	if (!func_78(bParam0, bParam1, bParam2))
		return false;
...
BOOL func_96(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4BEB (19435)
{
	if (!func_78(bParam0, bParam1, bParam2))
		return false;
...
BOOL func_97(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4C4A (19530)
{
	if (!func_78(bParam0, bParam1, bParam2))
		return false;
...
BOOL func_98(Vehicle veParam0) // Position - 0x4CA0 (19616)
{
	if (ENTITY::DOES_ENTITY_EXIST(veParam0))
		if (ENTITY::IS_ENTITY_A_VEHICLE(veParam0))
...
void func_99() // Position - 0x4CFB (19707)
{
	MISC::SET_BIT(&Global_9464, 4);
	return;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0x4D0B (19723)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_101(var uParam0, const char* sParam1, BOOL bParam2, BOOL bParam3) // Position - 0x4D1E (19742)
{
	const char* str;
...
BOOL func_102() // Position - 0x4DFE (19966)
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_94))
		if (!ENTITY::IS_ENTITY_DEAD(veLocal_94, false))
...
void func_103() // Position - 0x4EB6 (20150)
{
	int i;
	int j;
...
Blip func_104(Vehicle veParam0, BOOL bParam1, BOOL bParam2) // Position - 0x5009 (20489)
{
	return func_11(veParam0, !bParam1, bParam2);
}

Vehicle func_105(int iParam0) // Position - 0x501C (20508)
{
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_113638.f_222[iParam0], false))
	{
		ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_113638.f_222[iParam0], true, true);
...
BOOL func_106() // Position - 0x5054 (20564)
{
	if (ENTITY::DOES_ENTITY_EXIST(veLocal_94))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_94, false))
...
void func_107() // Position - 0x50BC (20668)
{
...
void func_108() // Position - 0x5196 (20886)
{
	...
	else if (func_112() == 14)
	{
		...
		iLocal_81 = BUILTIN::ROUND(((distanceBetweenCoords / 16.5f) + 40f) / 2f);
	}
	else if (func_112() == 13)
	{
	...
	else if (func_112() == 12)
	{
		...
		distanceBetweenCoords = MISC::GET_DISTANCE_BETWEEN_COORDS(uLocal_62, uLocal_65, true);
		iLocal_81 = BUILTIN::ROUND(((distanceBetweenCoords / 16.5f) + 15f) / 2f);
	}
	else if (func_112() == 11)
	{
...
float func_109(int iParam0, int iParam1) // Position - 0x53C4 (21444)
{
	switch (iParam0)
	{
		case 10:
...
Vector3 func_110(int iParam0, int iParam1) // Position - 0x54F4 (21748)
{
	switch (iParam0)
	{
		case 10:
...
Vector3 func_111(int iParam0) // Position - 0x56B5 (22197)
{
	switch (iParam0)
	{
		case 2:
...
int func_112() // Position - 0x5868 (22632)
{
	return Global_113638.f_20;
}

int func_113() // Position - 0x5876 (22646)
{
	return func_114(Global_113638.f_20, Global_113638.f_29);
}

int func_114(int iParam0, int iParam1) // Position - 0x588E (22670)
{
	switch (iParam0)
	{
		case 10:
...
void func_115() // Position - 0x5996 (22934)
{
...
int func_116(Vehicle veParam0, int iParam1, eCharacter echParam2) // Position - 0x59E5 (23013)
{
	var script;
...
void func_117(Vehicle veParam0, eCharacter echParam1) // Position - 0x5A25 (23077)
{
	Ped pedInVehicleSeat;
	int i;
	int j;
	...
	func_118(veParam0, &(Global_114931.f_32757.f_5510));
	return;
}

void func_118(Vehicle veParam0, var uParam1) // Position - 0x5C27 (23591)
{
	int i;
...
int func_119(int iParam0) // Position - 0x5ED2 (24274)
{
	switch (iParam0)
	{
		case 1:
...
int func_120(var uParam0, var uParam1, var uParam2) // Position - 0x5F82 (24450)
{
	int i;
	int modType;
...
BOOL func_121(int iParam0) // Position - 0x6175 (24949)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_122(var uParam0) // Position - 0x6195 (24981)
{
	int i;
...
BOOL func_123(Vehicle veParam0) // Position - 0x6245 (25157)
{
...
BOOL func_124(Hash hParam0) // Position - 0x6322 (25378)
{
	if (hParam0 == 0)
		return false;
...
BOOL func_125(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0x64E0 (25824)
{
	int i;
	Hash outData;
...
BOOL func_126(Hash hParam0) // Position - 0x6665 (26213)
{
	int num;
	var unk;
	var name;
...
BOOL _NETSHOPPING_SHOULD_USE_TRANSACTION_SYSTEM() // Position - 0x6731 (26417)
{
...
BOOL func_128(Hash hParam0, int iParam1) // Position - 0x6748 (26440)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_129() // Position - 0x6930 (26928)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_130() // Position - 0x6946 (26950)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_131() // Position - 0x695C (26972)
{
	return false;
}

BOOL func_132() // Position - 0x6965 (26981)
{
	return true;
}

BOOL func_133() // Position - 0x696E (26990)
{
	return true;
}

BOOL func_134() // Position - 0x6977 (26999)
{
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x6990 (27024)
{
	int profileSetting;
...
BOOL func_136(Vehicle veParam0) // Position - 0x6A48 (27208)
{
	Hash entityModel;
...
BOOL func_137(Vehicle veParam0) // Position - 0x6A8F (27279)
{
	int i;
...
BOOL func_138(Vehicle veParam0) // Position - 0x6ACA (27338)
{
	int i;
...
BOOL func_139(Vehicle veParam0) // Position - 0x6B46 (27462)
{
	int i;
...
eCharacter func_140(Vehicle veParam0) // Position - 0x6C2E (27694)
{
	int i;
...
BOOL func_141(Vehicle veParam0, int iParam1, BOOL bParam2) // Position - 0x6C91 (27793)
{
	int i;
	var garageName;
	int num;
...
BOOL func_142(int iParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x6CFF (27903)
{
...
void func_143(int iParam0) // Position - 0x6DD7 (28119)
{
