...
void main() // Position - 0x0 (0)
{
	...
	if (func_89() || func_88() || MISC::IS_PC_VERSION())
		iLocal_177 = 40;
			...
			while (iLocal_169 == 0)
			{
				...
				if (HUD::HAS_MENU_LAYOUT_CHANGED_EVENT_OCCURRED())
				{
					...
					else
					{
						...
						{
							iLocal_173 = selectedItemUniqueId;
							func_1(&uLocal_175);
						}
					}
				}
...
int func_1(var uParam0) // Position - 0x18B (395)
{
	...
	func_77(0, iLocal_173, false, true);
	func_76(1);
	num = 0;
	num2 = func_69(func_72(PLAYER::PLAYER_ID(), true), false);
	...
	switch (iLocal_173)
	{
		case 0:
			for (i = 0; i < 20; i = i + 1)
			{
				...
				func_53(&num, flag, flag2, func_56(num));
			}
			break;
...
BOOL func_8(int iParam0, int iParam1, int iParam2) // Position - 0x147D (5245)
{
	...
	flag = func_12(iParam0, iParam1);
	action = func_10(iParam0);
	return IS_BIT_SET(flag, func_9(action));
}
...
BOOL func_12(int iParam0, int iParam1) // Position - 0x1B1C (6940)
{
	BOOL flag;

	flag = func_13(func_17(iParam0), iParam1);
	return flag;
}

BOOL func_13(int iParam0, int iParam1) // Position - 0x1B34 (6964)
{
	Hash statHash;
	int outValue;
...
{
	func_24(1, *uParam0, iLocal_168, *uParam0, sParam1, bParam2, 1);
	*uParam0 = *uParam0 + 1;
	return;
}
...
BOOL func_26() // Position - 0x1EF2 (7922)
{
	BOOL flag;
...
BOOL func_27() // Position - 0x1F4F (8015)
{
	return Global_1575080;
}

BOOL func_28() // Position - 0x1F5B (8027)
{
	return Global_1575082;
}

BOOL func_29(Player plParam0, int iParam1) // Position - 0x1F67 (8039)
{
	if (!func_33())
		return false;
	...
	return func_30(&(Global_1845299[plParam0 /*883*/].f_822), func_31(iParam1));
}

BOOL func_30(var uParam0, int iParam1) // Position - 0x1FA7 (8103)
{
	int num;
	int num2;
	int num3;
...
int func_31(int iParam0) // Position - 0x1FCA (8138)
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_32() // Position - 0x21B6 (8630)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_144, 3);
}

BOOL func_33() // Position - 0x21CD (8653)
{
	if (!func_34())
		return false;
...
BOOL func_34() // Position - 0x21EE (8686)
{
	if (Global_1574612)
		return true;
...
BOOL func_35(int iParam0, int iParam1) // Position - 0x221E (8734)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_36(int iParam0, int iParam1) // Position - 0x2242 (8770)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_15(iParam1));
}

BOOL func_37(BOOL bParam0) // Position - 0x2257 (8791)
{
	if (bParam0)
		return func_40();
...
BOOL func_38(int iParam0) // Position - 0x2273 (8819)
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_39() // Position - 0x2288 (8840)
{
	return Global_1912540[PLAYER::PLAYER_ID() /*319*/].f_279;
}

BOOL func_40() // Position - 0x229E (8862)
{
	return func_35(526, -1) || MISC::HAS_FINALIZED_CHOSEN_CRIMINAL_CAREER() && func_42() != 0 && !func_41(0);
}

BOOL func_41(int iParam0) // Position - 0x22CE (8910)
{
	BOOL flag;

	flag = func_13(16738, -1);
	return IS_BIT_SET(flag, iParam0);
}

int func_42() // Position - 0x22E5 (8933)
{
	return MISC::GET_CHOSEN_CRIMINAL_CAREER();
}

void func_43(var uParam0, int iParam1, BOOL bParam2) // Position - 0x22F1 (8945)
{
	char* str;

	if (!bParam2)
	{
		func_44(1, *uParam0, iLocal_168, *uParam0, "", iParam1);
		*uParam0 = *uParam0 + 1;
	}

	str = "PAUSEUNLRANK" /*RANK ~1~*/;
	func_44(1, *uParam0, iLocal_168, *uParam0, str, iParam1);
	*uParam0 = *uParam0 + 1;
	return;
}

void func_44(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5) // Position - 0x2339 (9017)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
void func_45(var uParam0, BOOL bParam1) // Position - 0x238F (9103)
{
	var unk;

	TEXT_LABEL_ASSIGN_STRING(&unk, "PM_UJOB_T", 16);
	TEXT_LABEL_APPEND_INT(&unk, *uParam0, 16);
	func_24(1, *uParam0, iLocal_168, *uParam0, &unk, bParam1, 0);
	*uParam0 = *uParam0 + 1;
	return;
}

BOOL func_46(int iParam0) // Position - 0x23C0 (9152)
{
	switch (iParam0)
	{
		case 0:
		...
		case 5:
			return func_13(1259, -1) > false;
	
		case 6:
			return func_13(1261, -1) > false;
		...
		case 28:
			return func_13(1265, -1) > false;
	
		case 29:
			return func_35(85, -1);
	
		case 30:
			return func_13(1263, -1) > false;
	
		case 31:
			return func_13(1267, -1) > false;
	
		case 32:
			return func_13(1260, -1) > false;
	
		case 33:
			return func_13(1266, -1) > false;
	
		case 34:
			return func_13(1249, -1) > false;
		...
		case 39:
			return func_13(1258, -1) > false;
	
		case 40:
			return func_13(1168, -1) > false;
		...
		case 43:
			return func_13(1148, -1) > false || func_13(1149, -1) > false;
...
BOOL func_47() // Position - 0x271B (10011)
{
	int num;

	num = 0;

	if (func_13(2090, -1) > false)
		num = 1;

	return num;
}

int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x2737 (10039)
{
	Hash statHash;
	int outValue;
...
int func_49(int iParam0, int iParam1) // Position - 0x2755 (10069)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x2779 (10105)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_15(iParam1));
}

BOOL func_51() // Position - 0x278F (10127)
{
	int num;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x27AA (10154)
{
	if (iParam1 == -1)
		iParam1 = func_16();
...
void func_53(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x27C6 (10182)
{
	var unk;
	int num;
	...
	if (*uParam0 > num)
	{
		...
		func_55(1, *uParam0, iLocal_168, *uParam0, &unk, "PM_UGEN_NUM" /*~1~/~1~*/, bParam1, bParam2);
		*uParam0 = *uParam0 + 1;
		return;
	}
	...
	if (num == *uParam0)
	{
		TEXT_LABEL_ASSIGN_STRING(&unk, "PM_UGEN_THAO" /*Hao's Special Works Races*/, 16);
	
		if (!bParam3)
			func_55(1, *uParam0, iLocal_168, *uParam0, &unk, "PM_UGEN_NUM" /*~1~/~1~*/, bParam1, bParam2);
		else
			func_54(1, *uParam0, iLocal_168, *uParam0, &unk, "NUMBR" /*~1~*/, bParam1);
...
void func_54(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, BOOL bParam6) // Position - 0x28A0 (10400)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
		...
		HUD::ADD_TEXT_COMPONENT_INTEGER(bParam6);
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, BOOL bParam6, BOOL bParam7) // Position - 0x28F4 (10484)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
		...
		GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam5);
		HUD::ADD_TEXT_COMPONENT_INTEGER(bParam6);
		HUD::ADD_TEXT_COMPONENT_INTEGER(bParam7);
		GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
...
BOOL func_56(int iParam0) // Position - 0x294E (10574)
{
...
int func_57(int iParam0) // Position - 0x299E (10654)
{
	int num;
	...
	{
		case 0:
			return Global_794954.f_163995[2];
	
		case 8:
			return Global_794954.f_163995[1];
	
		case 9:
			return Global_794954.f_163995[8];
	
		case 10:
			return Global_794954.f_163995[3];
	
		case 11:
			return Global_794954.f_163995[0];
	
		case 12:
			if (func_59() || func_58() || MISC::IS_PC_VERSION() || func_88() || func_89())
			{
				num = num + 2;
				num = num + 2;
				num = num + 1;
				...
				if (Global_262145.f_22734)
					num = num + 1;
			
				if (*Global_262145.f_32781)
					num = num + 1;
		...
		case 13:
			if (NETWORK::NETWORK_HAS_SOCIAL_CLUB_ACCOUNT() || func_59() || func_58())
			{
				...
				num = num + 19;
				num = num + 8;
				return Global_262145.f_21658 + num;
			}
			else
			{
...
BOOL func_58() // Position - 0x2B2D (11053)
{
	return 1;
}

BOOL func_59() // Position - 0x2B36 (11062)
{
	return true;
}

BOOL func_60(int iParam0) // Position - 0x2B3F (11071)
{
	BOOL flag;
	...
	{
		case 0:
			return Global_794954.f_164009[2];
		...
		case 8:
			return Global_794954.f_164009[1];
	
		case 9:
			return Global_794954.f_164009[8];
	
		case 10:
			return Global_794954.f_164009[3];
	
		case 11:
			return Global_794954.f_164009[0];
...
BOOL func_61() // Position - 0x2D45 (11589)
{
	int num;
...
int func_62(int iParam0) // Position - 0x2D62 (11618)
{
	int num;
	int i;
	...
	for (i = 0; i < 1500; i = i + 1)
	{
		if (IS_BIT_SET(Global_794954.f_4[i /*95*/].f_82, 14))
			if (Global_794954.f_4[i /*95*/].f_71 < 13 && Global_794954.f_4[i /*95*/].f_76 <= 1000 && Global_794954.f_4[i /*95*/].f_74 == iParam0 && Global_794954.f_4[i /*95*/].f_71 == 2)
				num = num + 1;
	}
...
BOOL func_63() // Position - 0x2DE9 (11753)
{
	int num;
...
BOOL func_64() // Position - 0x2E06 (11782)
{
	int num;
...
BOOL func_65() // Position - 0x2E21 (11809)
{
	int num;
...
BOOL func_66() // Position - 0x2E3C (11836)
{
	int num;
...
BOOL func_67() // Position - 0x2E57 (11863)
{
	int num;
...
BOOL func_68() // Position - 0x2E74 (11892)
{
	int num;
...
int func_69(BOOL bParam0, BOOL bParam1) // Position - 0x2EAF (11951)
{
	bParam1;
	return func_70(bParam0, 0);
}

int func_70(BOOL bParam0, int iParam1) // Position - 0x2EC3 (11971)
{
	int i;
	int value;
	int value2;
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_71(num) == bParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_71(num) < bParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
BOOL func_71(int iParam0) // Position - 0x2F7E (12158)
{
	int num;
	int num2;
...
BOOL func_72(Player plParam0, BOOL bParam1) // Position - 0x34C2 (13506)
{
	bParam1;
	return func_73(plParam0);
}

BOOL func_73(Player plParam0) // Position - 0x34D5 (13525)
{
...
BOOL func_74(Player plParam0) // Position - 0x352C (13612)
{
	if (!func_75(plParam0))
		return false;
...
BOOL func_75(Player plParam0) // Position - 0x354B (13643)
{
	Player player;
...
void func_76(int iParam0) // Position - 0x356D (13677)
{
...
void func_77(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x358A (13706)
{
	if (iParam1 == -1)
		return;
...
void func_78() // Position - 0x35C2 (13762)
{
	var lastItemMenuId;
	...
	func_76(0);
	iLocal_173 = 0;
	func_80(0, 0, iLocal_167, 0, true, "PM_UL_D0" /*General*/, false, 0, false);
	func_80(0, 1, iLocal_167, 1, true, "PM_UL_D1" /*Progress*/, false, 0, false);
	func_80(0, 2, iLocal_167, 2, true, "PM_UL_D2" /*Content*/, false, 0, false);
	func_2(0);
	func_79(2);
	func_79(3);
	func_79(4);
...
void func_79(int iParam0) // Position - 0x364E (13902)
{
	func_3(iParam0, false);
	return;
}

void func_80(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4, char* sParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x365D (13917)
{
	if (GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("SET_DATA_SLOT"))
	{
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam0);
...
BOOL func_81() // Position - 0x36D7 (14039)
{
	int i;
	...
	{
		if (IS_BIT_SET(Global_794954.f_4[i /*95*/].f_82, 14))
			if (Global_794954.f_4[i /*95*/].f_71 < 13 && Global_794954.f_4[i /*95*/].f_76 <= 1000)
				Global_794954.f_164009[Global_794954.f_4[i /*95*/].f_71] = Global_794954.f_164009[Global_794954.f_4[i /*95*/].f_71] + 1;
	}

	return true;
}

BOOL func_82(eControlAction ecaParam0) // Position - 0x377E (14206)
{
	eControlAction action;
	int num;
	int offset;
	...
	if (PAD::IS_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || PAD::IS_DISABLED_CONTROL_JUST_RELEASED(FRONTEND_CONTROL, ecaParam0) || func_83(ecaParam0, &(Global_1677594.f_1064), 1))
	{
...
BOOL func_83(eControlAction ecaParam0, var uParam1, int iParam2) // Position - 0x3812 (14354)
{
	int num;
	int num2;
	int num3;
...
void func_84() // Position - 0x3975 (14709)
{
	int controlValue;
	...
	if (!PAD::IS_USING_KEYBOARD_AND_MOUSE(FRONTEND_CONTROL))
	{
		...
		if (controlValue > 180)
		{
			if (func_86(&uLocal_170, iLocal_172, false))
			{
				if (bLocal_174)
				{
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x3A32 (14898)
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_86(var uParam0, int iParam1, BOOL bParam2) // Position - 0x3A3F (14911)
{
	if (iParam1 == -1)
		return true;

	func_87(uParam0, bParam2, false);
...
void func_87(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3A9D (15005)
{
	if (uParam0->f_1 == 0)
	{
...
BOOL func_88() // Position - 0x3AE2 (15074)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_89() // Position - 0x3AF8 (15096)
{
