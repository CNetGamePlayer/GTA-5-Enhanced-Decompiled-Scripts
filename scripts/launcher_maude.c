...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x194A (6474)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x27F5 (10229)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x287D (10365)
{
...
int func_83() // Position - 0x76B8 (30392)
{
...
BOOL func_86(Player plParam0) // Position - 0x76FC (30460)
{
...
BOOL func_94(Player plParam0) // Position - 0x85B3 (34227)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_206(Any* panParam0, BOOL bParam1) // Position - 0xD5E3 (54755)
{
	...
	if (func_243(*panParam0) || func_241(*panParam0) || Global_80551 == 1)
		return true;
...
int func_248(var uParam0, eCharacter echParam1) // Position - 0xF33A (62266)
{
	int num;
