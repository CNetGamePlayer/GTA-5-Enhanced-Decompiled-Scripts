...
void func_221(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x19008 (102408)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = iParam3;
...
void func_303() // Position - 0x362BE (221886)
{
	...
	if (randomIntInRange < 50)
		func_304(&uLocal_124, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	else
		func_304(&uLocal_124, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);

	return;
}

void func_304(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x36356 (222038)
{
...
void func_305(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x36386 (222086)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_306(var uParam0, int iParam1, char* sParam2) // Position - 0x363B3 (222131)
{
