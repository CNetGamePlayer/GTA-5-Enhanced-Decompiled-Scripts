...
void main() // Position - 0x0 (0)
{
	...
	if (func_191(uLocal_49, -1, 0, false, false))
		func_188(-1);
	else
		SCRIPT::TERMINATE_THIS_THREAD();
...
void func_1() // Position - 0x4AC (1196)
{
	int i;
...
void func_2() // Position - 0x697 (1687)
{
	Global_34031 = false;
	Global_34032 = false;
	Global_34034 = false;
...
void func_3(BOOL bParam0) // Position - 0x6B3 (1715)
{
	int i;
...
void func_4(int iParam0, BOOL bParam1) // Position - 0x6D6 (1750)
{
	if (bParam1)
...
void func_5(int iParam0, int iParam1, BOOL bParam2) // Position - 0x70D (1805)
{
	int address;
...
void func_6(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x77D (1917)
{
	Hash statName;
...
Hash func_7(int iParam0, int iParam1) // Position - 0x7AB (1963)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_8(iParam1));
}

int func_8(int iParam0) // Position - 0x7C0 (1984)
{
	int num;
	int num2;
...
int func_9() // Position - 0x7F4 (2036)
{
	return Global_1574927;
}

int func_10(int iParam0, int iParam1) // Position - 0x800 (2048)
{
	Hash statHash;
	int outValue;
...
int func_11(int iParam0) // Position - 0x82F (2095)
{
	switch (iParam0)
	{
		case 0:
...
int func_12() // Position - 0xC13 (3091)
{
	return Global_33792;
}

void func_13(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC1E (3102)
{
	int address;
...
BOOL func_14(int iParam0, int iParam1, BOOL bParam2) // Position - 0xC8E (3214)
{
	if (iParam0 == -1)
		return false;
...
void func_15() // Position - 0xCEE (3310)
{
	while (func_163())
	{
		BUILTIN::WAIT(0);
	...
	Global_114931.f_18581.f_383 = func_43() + 1;
	func_19(-1, 0);
	func_16();
	iLocal_46 = 3;
	return;
...
void func_16() // Position - 0xD32 (3378)
{
	func_17();
	return;
}

int func_17() // Position - 0xD3F (3391)
{
	if (func_18(false))
		return 0;
...
BOOL func_18(BOOL bParam0) // Position - 0xD8A (3466)
{
...
void func_19(int iParam0, int iParam1) // Position - 0xDB2 (3506)
{
	if (iParam0 == -1)
		iParam0 = func_41();
...
void func_20(int iParam0) // Position - 0xEB5 (3765)
{
	Global_114917 = iParam0;
	return;
}

void func_21(int iParam0, var uParam1, var uParam2) // Position - 0xEC3 (3779)
{
	BOOL flag;
...
void func_22() // Position - 0xFA9 (4009)
{
	int num;
	float num2;
	float num3;
...
BOOL func_23(int iParam0, int iParam1) // Position - 0x1467 (5223)
{
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x14B8 (5304)
{
	if (iParam2 == -1)
		iParam2 = func_9();
...
int func_25(int iParam0, int iParam1) // Position - 0x14D6 (5334)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_26(int iParam0) // Position - 0x184A (6218)
{
	switch (iParam0)
	{
		case 29:
...
void func_27(int iParam0) // Position - 0x1879 (6265)
{
	int offset;
	int i;
...
void func_28(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x18BB (6331)
{
	func_29(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_29(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x18DB (6363)
{
	int i;
...
void func_30() // Position - 0x1AAD (6829)
{
	int i;
...
int func_31() // Position - 0x1BC4 (7108)
{
	func_32();
...
void func_32() // Position - 0x1C0A (7178)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_34(character) && !func_33(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != character && func_34(Global_114931.f_2370.f_539.f_4321))
...
BOOL func_33(int iParam0) // Position - 0x1D07 (7431)
{
	return Global_44886 == iParam0;
}

BOOL func_34(eCharacter echParam0) // Position - 0x1D15 (7445)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1D21 (7457)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1D5E (7518)
{
...
Hash func_37(eCharacter echParam0) // Position - 0x1D83 (7555)
{
	return Global_2339[echParam0 /*29*/];
}

BOOL func_38(int iParam0) // Position - 0x1D92 (7570)
{
	int num;
	int i;
...
void func_39(int iParam0, int iParam1) // Position - 0x1DD2 (7634)
{
	MISC::SET_BIT(&Global_114931.f_25002.f_8[iParam0], iParam1);
	return;
}

int func_40(int iParam0) // Position - 0x1DED (7661)
{
	int num;
...
int func_41() // Position - 0x1E9E (7838)
{
	var unk;
	int num;
...
int func_42(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15) // Position - 0x1EBB (7867)
{
...
int func_43() // Position - 0x2095 (8341)
{
	return Global_114931.f_10023.f_21 + Global_114931.f_18581.f_380;
}

BOOL func_44() // Position - 0x20B1 (8369)
{
	return true;
}

BOOL func_45() // Position - 0x20BA (8378)
{
	if (Global_34032)
	{
		func_20(4);
...
BOOL func_46() // Position - 0x20D2 (8402)
{
...
void func_47(int iParam0) // Position - 0x20F3 (8435)
{
	Global_24011 = iParam0;
	return;
}

BOOL func_48() // Position - 0x2100 (8448)
{
...
BOOL func_49() // Position - 0x211C (8476)
{
	return Global_34031;
}

void func_50(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0x2127 (8487)
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(pedParam0, sParam1, sParam2, func_51(iParam3), bParam4);
	return;
}

char* func_51(int iParam0) // Position - 0x2141 (8513)
{
	char* str;
...
void func_52() // Position - 0x2331 (9009)
{
	iLocal_46 = 3;
	return;
}

BOOL func_53() // Position - 0x233C (9020)
{
...
BOOL func_54() // Position - 0x237F (9087)
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x23FA (9210)
{
	func_32();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_56() // Position - 0x2413 (9235)
{
	Global_21866 = 0;
	func_57();
	return;
...
void func_57() // Position - 0x2423 (9251)
{
...
void func_58(BOOL bParam0) // Position - 0x2444 (9284)
{
	if (bParam0)
	{
		if (bLocal_69)
...
void func_59() // Position - 0x24A0 (9376)
{
	Global_21866 = 0;
	func_60();
	return;
...
void func_60() // Position - 0x24B0 (9392)
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
struct<6> func_61() // Position - 0x24D4 (9428)
{
	var unk;
...
struct<6> func_62() // Position - 0x251A (9498)
{
	var unk;
...
BOOL func_63() // Position - 0x253E (9534)
{
...
BOOL func_64(char* sParam0) // Position - 0x25B5 (9653)
{
	var string2;
...
BOOL func_65(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6) // Position - 0x25DD (9693)
{
	func_81(uParam0, _CHAR_NULL, sParam1, iParam5, iParam6, 0);
...
BOOL func_66(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x2631 (9777)
{
	Global_23001 = 0;
...
void func_67() // Position - 0x28FF (10495)
{
	if (!func_68())
		return;
...
BOOL func_68() // Position - 0x2936 (10550)
{
...
BOOL func_69(Player plParam0) // Position - 0x2999 (10649)
{
...
BOOL func_70(Player plParam0, int iParam1) // Position - 0x29D0 (10704)
{
	return IS_BIT_SET(Global_1892798[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_71(int iParam0) // Position - 0x29E8 (10728)
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x29FA (10746)
{
	return -1;
}

void func_73() // Position - 0x2A03 (10755)
{
	int i;
...
void func_74() // Position - 0x2A33 (10803)
{
...
BOOL func_75() // Position - 0x2AC8 (10952)
{
...
BOOL func_76() // Position - 0x2AEF (10991)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x2B88 (11144)
{
	if (func_33(14))
	{
...
void func_78() // Position - 0x2C2A (11306)
{
	int i;
...
BOOL func_79(int iParam0, int iParam1) // Position - 0x2C80 (11392)
{
	switch (iParam0)
	{
		case 5:
...
void func_80() // Position - 0x2CB8 (11448)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
void func_81(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2D0F (11535)
{
...
BOOL func_82(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x2D65 (11621)
{
	if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
	{
		if (func_49() && !Global_34034)
		{
			if (fLocal_45 == -1f)
...
void func_83() // Position - 0x2DF2 (11762)
{
	switch (iLocal_68)
	{
		case 0:
		...
		case 2:
			...
			if (ENTITY::DOES_ENTITY_EXIST(pedLocal_56))
			{
				if (!PED::IS_PED_INJURED(pedLocal_56))
				{
					if (ENTITY::IS_ENTITY_AT_COORD(pedLocal_56, uLocal_110, Global_20, true, true, 0) && func_123(true, false, true))
					{
...
void func_84() // Position - 0x2FF7 (12279)
{
	switch (iLocal_141)
	{
		case 0:
		...
		case 4:
			if (!func_163())
			{
				...
				func_120(&(Global_114931.f_18986), 16);
			
				if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_MICHAEL)
					func_119(&(Global_114931.f_18986.f_24), 1);
				else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_FRANKLIN)
					func_119(&(Global_114931.f_18986.f_24), 4);
				else if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
					func_119(&(Global_114931.f_18986.f_24), 2);
			
				func_85(_GET_CURRENT_PLAYER_CHARACTER(), 1, 80, false, true);
				BUILTIN::SETTIMERA(0);
				iLocal_141 = iLocal_141 + 1;
			}
			break;
...
void func_85(eCharacter echParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0x3183 (12675)
{
	int outValue;
	Hash statHash;

	if (func_118(echParam0) == 3)
		return;

	if (func_118(echParam0) == 4)
		return;

	func_86(func_118(echParam0), 1, iParam1, iParam2, false);
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3, BOOL bParam4) // Position - 0x3255 (12885)
{
	float num;
	int num2;
	int num3;
...
void func_87(BOOL bParam0) // Position - 0x3854 (14420)
{
	int i;
	int j;
...
void func_88(int iParam0) // Position - 0x3AD6 (15062)
{
	int value;
...
void func_89(int iParam0) // Position - 0x3B30 (15152)
{
	int num;
	BOOL flag;
	var txdName;
	...
	if (func_97(iParam0))
	{
		func_6(func_96(iParam0), 0, -1, true);
		return;
	}

	if (func_95(iParam0))
	{
		num = _MPPLY_STAT_GET_INT(func_94(iParam0));
		_MPPLY_STAT_SET_INT(func_94(iParam0), num - 1);
		return;
	}
	...
	else if (IS_BIT_SET(Global_114931.f_20571.f_471, iParam0) || IS_BIT_SET(Global_2359296[func_91() /*5574*/].f_681.f_10, iParam0))
	{
		flag = true;
		MISC::CLEAR_BIT(&(Global_114931.f_20571.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2359296[func_91() /*5574*/].f_681.f_10), iParam0);
	}
...
char* func_90(int iParam0) // Position - 0x3CFA (15610)
{
	switch (iParam0)
	{
		case 0:
...
int func_91() // Position - 0x3E2B (15915)
{
	int num;
...
void _MPPLY_STAT_SET_INT(Hash hParam0, int iParam1) // Position - 0x3E38 (15928)
{
	Hash statName;
...
int _MPPLY_STAT_GET_INT(Hash hParam0) // Position - 0x3E54 (15956)
{
	Hash statHash;
	int outValue;
...
Hash func_94(int iParam0) // Position - 0x3E72 (15986)
{
	switch (iParam0)
	{
		case 38:
...
BOOL func_95(int iParam0) // Position - 0x3E94 (16020)
{
	switch (iParam0)
	{
		case 38:
...
int func_96(int iParam0) // Position - 0x3EB1 (16049)
{
	switch (iParam0)
	{
		case 18:
...
BOOL func_97(int iParam0) // Position - 0x3FB6 (16310)
{
	switch (iParam0)
	{
		case 18:
...
void func_98(int iParam0) // Position - 0x4088 (16520)
{
	func_116(93, iParam0);
	func_116(29, iParam0);
	func_116(30, iParam0);
...
BOOL func_99(int iParam0) // Position - 0x40A8 (16552)
{
	int cloudTimeAsInt;
	int num;
	int cloudTimeAsInt2;
	...
	if (func_97(iParam0))
	{
		...
		num7 = func_10(func_96(iParam0), -1);
	...
	if (func_95(iParam0))
	{
		num8 = _MPPLY_STAT_GET_INT(func_94(iParam0));
	...
	return IS_BIT_SET(Global_2359296[func_91() /*5574*/].f_681.f_10, iParam0);
}

BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x42B3 (17075)
{
	if (iParam1 == -1)
		iParam1 = func_9();
...
int func_101(BOOL bParam0) // Position - 0x42CF (17103)
{
	var outValue;
	int value;
	int outValue2;
...
int func_102(int iParam0, int iParam1) // Position - 0x4386 (17286)
{
	if (iParam0 >= 78)
		return 0;
...
int func_103(int iParam0, int iParam1) // Position - 0x43A1 (17313)
{
	if (func_33(14) && !func_114(iParam0))
		return 0;
	...
	if (func_113(&Global_4525144))
	{
		if (func_111(&Global_4525144, iParam0))
			return 0;
	
		if (func_104(&Global_4525144, iParam0))
			return 1;
	}
	else
	{
...
BOOL func_104(var uParam0, int iParam1) // Position - 0x443E (17470)
{
	int i;
	var unk;
	...
	if (func_33(14) && !func_114(iParam1))
		return false;
...
int func_105(var uParam0, int iParam1) // Position - 0x44EF (17647)
{
	int i;
...
BOOL func_106(var uParam0, int iParam1) // Position - 0x456A (17770)
{
	return uParam0->[iParam1] == 78;
}

void func_107(var uParam0) // Position - 0x457B (17787)
{
	int i;
	...
	func_109(uParam0, Global_4525143 - 0.5f);
	return;
}

void func_108(var uParam0, int iParam1) // Position - 0x45AF (17839)
{
	uParam0->[iParam1] = 78;
	return;
}

void func_109(var uParam0, int iParam1) // Position - 0x45BF (17855)
{
	if (iParam1 == 0f)
		uParam0->f_80 = 0f;
	else
...
float func_110(var uParam0) // Position - 0x45DC (17884)
{
	return uParam0->f_80;
}

BOOL func_111(var uParam0, int iParam1) // Position - 0x45E8 (17896)
{
	return func_112(uParam0, iParam1) != -1;
}

int func_112(var uParam0, int iParam1) // Position - 0x45FA (17914)
{
	int i;
...
BOOL func_113(var uParam0) // Position - 0x4627 (17959)
{
	return uParam0->f_79 == 1;
}

BOOL func_114(int iParam0) // Position - 0x4635 (17973)
{
	switch (iParam0)
	{
		case 60:
...
void func_115(Hash hParam0, int iParam1) // Position - 0x4685 (18053)
{
	int outValue;
...
void func_116(int iParam0, int iParam1) // Position - 0x46A8 (18088)
{
	int outValue;
...
void func_117() // Position - 0x4705 (18181)
{
	int outValue;
...
int func_118(eCharacter echParam0) // Position - 0x477A (18298)
{
	return Global_2339[echParam0 /*29*/].f_17;
}

void func_119(int iParam0, int iParam1) // Position - 0x478B (18315)
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_120(var uParam0, int iParam1) // Position - 0x479C (18332)
{
	uParam0->f_23 = uParam0->f_23 || iParam1;
	return;
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x47AF (18351)
{
...
void func_122() // Position - 0x47C6 (18374)
{
	switch (iLocal_141)
	{
		case 0:
...
BOOL func_123(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0x4A10 (18960)
{
...
void func_124() // Position - 0x4AF5 (19189)
{
	if (!func_63())
		func_58(true);
...
void func_125() // Position - 0x5020 (20512)
{
	if (!PED::IS_PED_INJURED(pedLocal_56))
	{
		if (!bLocal_82)
...
void func_126() // Position - 0x5147 (20807)
{
...
void func_127() // Position - 0x51FF (20991)
{
	if (!PED::IS_PED_INJURED(pedLocal_56))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), pedLocal_56, 8f, 8f, 8f, false, true, 0) || PED::IS_PED_IN_ANY_TAXI(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (!HUD::DOES_BLIP_EXIST(uLocal_100[0]))
					uLocal_100[0] = func_131(pedLocal_56, false, 145);
			...
			else
			{
				...
				if (!HUD::DOES_BLIP_EXIST(blLocal_98))
					blLocal_98 = func_129(uLocal_110, true);
			
				if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR && !func_48())
				{
					if (!HUD::DOES_BLIP_EXIST(blLocal_99))
					{
						blLocal_99 = func_129(uLocal_116, false);
...
void func_128() // Position - 0x531E (21278)
{
	if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
	{
		if (!Global_34033)
...
Blip func_129(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x5342 (21314)
{
	Blip blip;
...
var func_130(BOOL bParam0, var uParam1, var uParam2) // Position - 0x536E (21358)
{
	if (bParam0)
		return uParam1;
...
Blip func_131(Ped pedParam0, BOOL bParam1, int iParam2) // Position - 0x5385 (21381)
{
	Blip blip;

	blip = func_132(pedParam0, !bParam1, false);
...
Blip func_132(Ped pedParam0, BOOL bParam1, BOOL bParam2) // Position - 0x53CF (21455)
{
	Blip blip;
...
void func_133() // Position - 0x5473 (21619)
{
	int i;

	ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&pedLocal_55);
	func_134(&uLocal_153, 4);
...
void func_134(var uParam0, int iParam1) // Position - 0x54AC (21676)
{
...
void func_135() // Position - 0x54C9 (21705)
{
	if (!PED::IS_PED_INJURED(pedLocal_56))
	{
		...
		{
			PED::SET_PED_AS_GROUP_MEMBER(pedLocal_56, func_136());
...
int func_136() // Position - 0x55EA (21994)
{
	return PLAYER::GET_PLAYER_GROUP(PLAYER::GET_PLAYER_INDEX());
}

BOOL func_137() // Position - 0x55FA (22010)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true))
...
BOOL func_138() // Position - 0x5665 (22117)
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_139() // Position - 0x5787 (22407)
{
	switch (iLocal_67)
	{
		case 0:
		...
		case 3:
			if (!PED::IS_PED_INJURED(pedLocal_56) && ENTITY::DOES_ENTITY_EXIST(iLocal_119[8]))
			{
				TASK::OPEN_SEQUENCE_TASK(&iLocal_93);
				iLocal_66 > 18;
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, ENTITY::GET_ENTITY_COORDS(iLocal_119[8], true) + { 0f, 0.39f, 0.35f }, 1f, -1, 0f, 512, func_141(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iLocal_119[8], true)));
		...
		case 5:
			if (!PED::IS_PED_INJURED(pedLocal_56) && !ENTITY::IS_ENTITY_DEAD(iLocal_119[8], false))
			{
				...
				else if (BUILTIN::TIMERB() > 10000 || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_119[8], true), 1.5f, 1.5f, 3f, false, true, 0))
				{
...
void func_140() // Position - 0x5CF4 (23796)
{
	if (!func_48())
		if (_GET_CURRENT_PLAYER_CHARACTER() == CHAR_TREVOR)
			Global_34031 = true;
...
float func_141(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5) // Position - 0x5D10 (23824)
{
	return MISC::GET_HEADING_FROM_VECTOR_2D(fParam3 - uParam0, fParam3.f_1 - uParam0.f_1);
}

BOOL func_142(char* sParam0) // Position - 0x5D2A (23850)
{
	var string2;
...
void func_143() // Position - 0x5D52 (23890)
{
	if (!bLocal_96)
	{
		if (!PED::IS_PED_INJURED(pedLocal_56))
...
void func_144() // Position - 0x5EF5 (24309)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_56))
	{
...
BOOL func_145() // Position - 0x5F4E (24398)
{
	if (Global_24011 == 1)
		return true;
...
void func_146() // Position - 0x5F65 (24421)
{
	switch (iLocal_66)
	{
		case 0:
...
void func_147() // Position - 0x6721 (26401)
{
	int i;
...
int func_148(BOOL bParam0) // Position - 0x67AC (26540)
{
	if (func_151())
	{
		Global_114921 = true;
		...
		if (func_26(Global_114920))
			func_149(0);
	
		HUD::SET_MISSION_NAME(true, "RE_TITLE" /*Random Event*/);
	
		if (bParam0 && func_26(Global_114920))
...
void func_149(int iParam0) // Position - 0x67FF (26623)
{
	switch (iParam0)
	{
		case 0:
			if (Global_114931.f_25002.f_2 < 3)
			{
				...
				{
					_DISPLAY_HELP_TEXT(func_150(iParam0), -1);
...
char* func_150(int iParam0) // Position - 0x68DA (26842)
{
	char* str;
...
BOOL func_151() // Position - 0x691C (26908)
{
	switch (func_152(&Global_33852, 0, 5, false, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return true;
...
int func_152(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x6952 (26962)
{
	int i;
...
void func_153(var uParam0, int iParam1) // Position - 0x6A89 (27273)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x6AD8 (27352)
{
	return func_155(iParam0, Global_44886);
}

BOOL func_155(int iParam0, int iParam1) // Position - 0x6AE9 (27369)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_156(int iParam0) // Position - 0x6CCA (27850)
{
	if (Global_44886 == 15)
		return false;
...
void func_157() // Position - 0x6CEC (27884)
{
	if (HUD::DOES_BLIP_EXIST(blLocal_103))
		HUD::REMOVE_BLIP(&blLocal_103);
...
void func_158() // Position - 0x6D28 (27944)
{
	func_4(39, true);
	func_4(40, true);
	func_4(41, true);
	...
	func_161(pedLocal_55, "GENERIC_WHATEVER", 24);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hLocal_94);
	...
	func_161(pedLocal_56, "GENERIC_WHATEVER", 24);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(hLocal_95);
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x7086 (28806)
{
...
void func_160() // Position - 0x7121 (28961)
{
...
void func_161(Ped pedParam0, char* sParam1, int iParam2) // Position - 0x7406 (29702)
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(pedParam0, sParam1, func_51(iParam2), 1);
	return;
}

BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x741D (29725)
{
...
BOOL func_163() // Position - 0x746B (29803)
{
...
void func_164() // Position - 0x748D (29837)
{
	if (!PED::IS_PED_INJURED(pedLocal_56) && !PED::IS_PED_INJURED(pedLocal_55))
	{
	...
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_55))
		if (func_167(pedLocal_55))
			func_165();

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_56))
		if (func_167(pedLocal_56) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_56, PLAYER::PLAYER_PED_ID(), true))
			func_165();

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_55))
		if (func_167(pedLocal_55) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(pedLocal_55, PLAYER::PLAYER_PED_ID(), true))
			func_165();
...
void func_165() // Position - 0x7650 (30288)
{
	func_56();
	BUILTIN::WAIT(0);
...
void func_166() // Position - 0x76ED (30445)
{
	int i;
...
BOOL func_167(Ped pedParam0) // Position - 0x7739 (30521)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
void func_168() // Position - 0x7767 (30567)
{
	func_166();
	func_56();
	BUILTIN::WAIT(0);
...
void func_169() // Position - 0x77DF (30687)
{
	if (!PED::IS_PED_INJURED(pedLocal_56))
	{
		TASK::CLEAR_PED_TASKS(pedLocal_56);
...
BOOL func_170(Ped pedParam0) // Position - 0x781E (30750)
{
...
void func_171() // Position - 0x7873 (30835)
{
	func_56();
	BUILTIN::WAIT(0);
	_CONVERSATION_ADD_LINE(&uLocal_153, "REDO2AU", "REDO2_CRAZY", 4, 0, 0, 0);
...
void func_172() // Position - 0x78EA (30954)
{
...
void func_173() // Position - 0x7ABB (31419)
{
...
BOOL func_174() // Position - 0x7B60 (31584)
{
...
int func_175(float fParam0, BOOL bParam1) // Position - 0x7BE6 (31718)
{
	var unk;
	int num;
	int num2;
...
void func_176(int iParam0, var uParam1) // Position - 0x7C97 (31895)
{
	switch (iParam0)
	{
		case 0:
...
int func_178(int iParam0) // Position - 0x8E9E (36510)
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_179(int iParam0) // Position - 0x91E4 (37348)
{
	var unk;
	var unk3;
...
struct<2> func_180(int iParam0) // Position - 0x921A (37402)
{
	var unk;
...
BOOL func_181() // Position - 0x9665 (38501)
{
...
BOOL func_182() // Position - 0x9697 (38551)
{
	return Global_114649 > 0;
}

BOOL func_183() // Position - 0x96A5 (38565)
{
	if (Global_99351 != -1)
		return true;
...
BOOL func_184() // Position - 0x96BA (38586)
{
	if (Global_99351 != -1)
...
BOOL func_185() // Position - 0x96DD (38621)
{
...
BOOL func_186() // Position - 0x96FA (38650)
{
...
BOOL func_187() // Position - 0x975C (38748)
{
	if (Global_114920 == func_41() && MISC::GET_RANDOM_EVENT_FLAG() && Global_114921)
		return true;

	return false;
}

void func_188(int iParam0) // Position - 0x9787 (38791)
{
	if (iParam0 == -1)
		iParam0 = func_41();
...
void func_189() // Position - 0x97BD (38845)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
void func_190(int iParam0) // Position - 0x97FA (38906)
{
	Global_114920 = iParam0;
	return;
}

BOOL func_191(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6) // Position - 0x9808 (38920)
{
	BOOL flag;
	...
	if (!flag)
	{
		...
		if (func_34(_GET_CURRENT_PLAYER_CHARACTER()))
			if (func_229(_GET_CURRENT_PLAYER_CHARACTER()) == 4 || func_229(_GET_CURRENT_PLAYER_CHARACTER()) == 5)
				return false;
		...
		if (!func_227(Global_114931.f_25002.f_43[iParam3]))
			return false;
		...
		if (func_34(_GET_CURRENT_PLAYER_CHARACTER()))
		{
			for (i = CHAR_MICHAEL; i < CHAR_MULTIPLAYER; i = i + 1)
			{
				...
				if (func_215(num))
					if (func_193(i))
						if (!func_192(vector, 0f, 0f, 0f, false))
...
BOOL func_192(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x9BA2 (39842)
{
	if (bParam6)
...
BOOL func_193(eCharacter echParam0) // Position - 0x9BE9 (39913)
{
	int num;
...
BOOL func_194(int iParam0) // Position - 0x9C0A (39946)
{
	return func_195(iParam0, 1);
}

int func_195(int iParam0, int iParam1) // Position - 0x9C19 (39961)
{
	var unk;
	var unk2;
	int num;
...
void func_196(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x9C6C (40044)
{
	func_197(func_208(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
	return;
}

void func_197(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x9C8A (40074)
{
	int num;
	int num2;
	int num3;
...
float func_198(float fParam0, float fParam1, float fParam2) // Position - 0x9E8B (40587)
{
	float num;
...
int func_199(int iParam0, int iParam1) // Position - 0x9ECD (40653)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_200(int iParam0) // Position - 0x9F6F (40815)
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_201(int iParam0) // Position - 0x9F82 (40834)
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_202(int iParam0) // Position - 0x9F95 (40853)
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_203(int iParam0) // Position - 0x9FA8 (40872)
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_204(int iParam0) // Position - 0x9FBA (40890)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_205(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9FDC (40924)
{
	if (bParam0)
		return uParam1;
...
int func_206(int iParam0) // Position - 0x9FF3 (40947)
{
	return iParam0 & 15;
}

BOOL func_207(int iParam0, int iParam1) // Position - 0xA000 (40960)
{
	int num;
	int num2;
...
int func_208() // Position - 0xA10C (41228)
{
	var unk;
...
void func_209(var uParam0, int iParam1) // Position - 0xA152 (41298)
{
	if (iParam1 <= 0)
		return;
...
void func_210(var uParam0, int iParam1) // Position - 0xA1D8 (41432)
{
...
void func_211(var uParam0, int iParam1) // Position - 0xA20B (41483)
{
	int num;
	int num2;
...
void func_212(var uParam0, int iParam1) // Position - 0xA25C (41564)
{
...
void func_213(var uParam0, int iParam1) // Position - 0xA296 (41622)
{
...
void func_214(var uParam0, int iParam1) // Position - 0xA2D1 (41681)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
BOOL func_215(int iParam0) // Position - 0xA30D (41741)
{
	int num;
	int num2;
	int num3;
...
BOOL func_216(int iParam0, int iParam1) // Position - 0xA3E9 (41961)
{
...
BOOL func_217(int iParam0) // Position - 0xA409 (41993)
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_225() || Global_113978 || Global_33795 || func_224() || func_79(8, -1) || func_223() || func_222() || func_221() || func_220() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_225() || Global_33795 || func_224() || func_79(8, -1) || func_221() || func_223() || func_222() || func_220() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_225() || Global_113978 || Global_33795 || func_224() || func_79(8, -1) || func_221() || func_223() || func_222() || func_220() || Global_114931.f_7695.f_919[character] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_225() || Global_113978 || Global_33795 || func_224() || func_79(8, -1) || func_223() || func_222() || func_220() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_225() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_79(8, -1) || func_220() || func_219() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 5:
						if (func_79(8, -1) || func_223() || func_222() || func_219() || func_218())
							return false;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_225() || Global_33795 || func_224() || func_79(8, -1) || func_222() || func_221() || func_220() || Global_114931.f_7695.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_225() || func_222() || Global_113978 || Global_33795 || func_224() || Global_46111 || func_79(8, -1) || func_221() || func_219() || func_220() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_225() || Global_113978 || Global_33795 || func_224() || func_79(8, -1) || func_221() || func_219() || func_223() || func_222() || func_220())
							return false;
						break;
				}
			}
...
BOOL func_218() // Position - 0xAB26 (43814)
{
	return Global_102493.f_1;
}

BOOL func_219() // Position - 0xAB34 (43828)
{
	if (Global_99351 != -1)
...
BOOL func_220() // Position - 0xAB57 (43863)
{
...
BOOL func_221() // Position - 0xAB71 (43889)
{
	if (Global_80566)
		return true;
...
BOOL func_222() // Position - 0xAB9B (43931)
{
	return Global_102506.f_418 > 0;
}

BOOL func_223() // Position - 0xABAC (43948)
{
	return Global_102506.f_417 > 0;
}

BOOL func_224() // Position - 0xABBD (43965)
{
	return Global_1575092;
}

BOOL func_225() // Position - 0xABC9 (43977)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_226() // Position - 0xABE5 (44005)
{
	_UPDATE_CURRENT_PLAYER_CHARACTER();
...
BOOL func_227(int iParam0) // Position - 0xAC0D (44045)
{
	return func_207(func_208(), iParam0);
}

BOOL func_228(int iParam0, int iParam1, eCharacter echParam2) // Position - 0xAC1F (44063)
{
	BOOL num;
	eCharacter character;
...
int func_229(eCharacter echParam0) // Position - 0xAD03 (44291)
{
...
BOOL func_230(int iParam0) // Position - 0xAD27 (44327)
{
	int num;
	BOOL flag;
...
BOOL func_231() // Position - 0xAD7F (44415)
{
	Vehicle vehiclePedIsIn;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0xADC3 (44483)
{
	int profileSetting;
...
BOOL func_233(int iParam0, int iParam1) // Position - 0xAE7B (44667)
{
	if (Global_114931.f_10201[iParam0 /*12*/].f_5 == 1)
	{
		iParam1 == 1;
...
void func_234() // Position - 0xAEA2 (44706)
{
	int i;
...
void func_235(int iParam0) // Position - 0xB00B (45067)
{
	var name;
	...
	if (func_187())
	{
		...
		func_238(30000);
		TEXT_LABEL_ASSIGN_STRING(&name, func_237(Global_114920, true), 64);
	
		if (func_40(Global_114920) > 0)
		{
	...
	func_236(&Global_33852);
	Global_114921 = false;
	func_190(-1);
	return;
}

void func_236(var uParam0) // Position - 0xB0BD (45245)
{
	if (*uParam0 == -1)
		return;
...
char* func_237(int iParam0, BOOL bParam1) // Position - 0xB0FA (45306)
{
	switch (iParam0)
	{
		case 0:
...
void func_238(int iParam0) // Position - 0xB343 (45891)
{
	Global_45437 = MISC::GET_GAME_TIMER() + iParam0;
	return;
}

void func_239(int iParam0) // Position - 0xB355 (45909)
{
	func_240(iParam0, 0, func_245(iParam0));
	return;
}

void func_240(int iParam0, int iParam1, int iParam2) // Position - 0xB36A (45930)
{
	int unk;
	var unk2;

	unk = func_208();
	func_243(&unk, 0, 0, iParam2, iParam1, 0, 0);
	func_242(iParam0, &unk);
	unk2 = { func_241(&unk) };
	return;
}

struct<16> func_241(var uParam0) // Position - 0xB399 (45977)
{
	var unk;
	int num;
...
void func_242(int iParam0, var uParam1) // Position - 0xB468 (46184)
{
	Global_114931.f_25002.f_43[iParam0] = *uParam1;
	return;
}

void func_243(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB480 (46208)
{
	int num;
	int i;
	int num2;
	...
	num = num + iParam6;
	func_244(uParam0, l, k, j, num2, i, num);
	return;
}

void func_244(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB602 (46594)
{
...
int func_245(int iParam0) // Position - 0xB63A (46650)
{
	int num;
