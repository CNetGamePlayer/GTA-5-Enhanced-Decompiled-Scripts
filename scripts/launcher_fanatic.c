...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A3C (6716)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28E7 (10471)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x296F (10607)
{
...
int func_83() // Position - 0x77A9 (30633)
{
...
BOOL func_86(Player plParam0) // Position - 0x77ED (30701)
{
...
BOOL func_94(Player plParam0) // Position - 0x86A4 (34468)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_205(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBA5 (56229)
{
...
int func_263(var uParam0, eCharacter echParam1) // Position - 0x10043 (65603)
{
	int num;
