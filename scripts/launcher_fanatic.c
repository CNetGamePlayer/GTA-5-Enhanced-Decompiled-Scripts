...
void main() // Position - 0x0 (0)
{
	...
	iLocal_90 = func_306(CHAR_MARY_ANN);
	iLocal_92 = -1;
	iLocal_95 = -1;
	...
	if (!func_284(&unk63, &num, vector, 1f))
	{
		func_283();
	...
	while (true)
	{
		...
		func_219(num);
		func_212(&iLocal_92, &(num.f_9), vector);
		...
		if (num == 21)
			func_208(&num, vector, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		else if (num == 22)
			func_203(&num, vector, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		else if (num == 23)
			if (iLocal_94 == 0)
				if (func_208(&num, vector, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
					iLocal_94 = 1;
			else
				func_200(&num);
...
BOOL func_1(var uParam0) // Position - 0x2DA (730)
{
...
BOOL func_2(Any* panParam0) // Position - 0x2F8 (760)
{
	const char* str;
	var unk32;
	...
	if (!func_180())
	{
		while (!func_171(*panParam0))
		{
			...
			if (!func_220(panParam0, *panParam0 != 2))
			{
...
void func_3(int iParam0, const char* sParam1) // Position - 0x3BA (954)
{
	func_21(sParam1);
...
void func_5() // Position - 0x5D0 (1488)
{
	int i;
...
void func_6(int iParam0) // Position - 0x683 (1667)
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xA6B (2667)
{
	Global_65020 = true;
	Global_65023 = 1;
...
void func_8(int iParam0) // Position - 0xAB6 (2742)
{
...
struct<2> func_9(int iParam0) // Position - 0xAEA (2794)
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xB22 (2850)
{
	if (Global_65027)
		return;
...
void func_11() // Position - 0xB78 (2936)
{
	int i;
...
void func_12() // Position - 0xBA5 (2981)
{
	int i;
...
void func_13() // Position - 0xBDC (3036)
{
	Global_65186 = 0;
	return;
}

void func_14() // Position - 0xBE8 (3048)
{
	Global_65046 = 0;
...
var func_15(Hash hParam0) // Position - 0xC3C (3132)
{
	var outValue;
...
void func_16() // Position - 0xC50 (3152)
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xC7A (3194)
{
...
void func_18() // Position - 0xC8E (3214)
{
	int i;
...
void func_19() // Position - 0xCC7 (3271)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xD09 (3337)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xD33 (3379)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xD46 (3398)
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xD63 (3427)
{
...
void func_24() // Position - 0xDA8 (3496)
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A3C (6716)
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x28C5 (10437)
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28E7 (10471)
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x296F (10607)
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x29AF (10671)
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x29DD (10717)
{
...
int func_31(Vehicle veParam0) // Position - 0x2AB9 (10937)
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2AFB (11003)
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2B5E (11102)
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2BEC (11244)
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2C2E (11310)
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E8A (11914)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2E96 (11926)
{
	int i;
...
int func_38(int iParam0) // Position - 0x3141 (12609)
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x31F1 (12785)
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x33E4 (13284)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3404 (13316)
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x34B5 (13493)
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x35E4 (13796)
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x3652 (13906)
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x372B (14123)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3768 (14184)
{
...
Hash func_47(eCharacter echParam0) // Position - 0x378D (14221)
{
	return Global_2339[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x379C (14236)
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3936 (14646)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3965 (14693)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x397A (14714)
{
	int num;
	int num2;
...
int func_52() // Position - 0x39AE (14766)
{
	return Global_1574927;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x39BA (14778)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x39DE (14814)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x39F3 (14835)
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F3C (16188)
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x417E (16766)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_58() // Position - 0x4197 (16791)
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x4294 (17044)
{
	return Global_44886 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x42A2 (17058)
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x4395 (17301)
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x461D (17949)
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x46BE (18110)
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x48B6 (18614)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x5637 (22071)
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5672 (22130)
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x58E6 (22758)
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5922 (22818)
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5E71 (24177)
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5EB5 (24245)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x665C (26204)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66A3 (26275)
{
...
BOOL func_73(int iParam0) // Position - 0x66FE (26366)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x670E (26382)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x676E (26478)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6B52 (27474)
{
	return Global_33792;
}

BOOL func_77(int iParam0) // Position - 0x6B5D (27485)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6B6D (27501)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C0F (27663)
{
	Vector3 vector;
	var unk3;
...
Vector3 func_80() // Position - 0x7475 (29813)
{
...
int func_81() // Position - 0x7770 (30576)
{
	return Global_2652582.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x777F (30591)
{
...
BOOL func_83() // Position - 0x77A9 (30633)
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x77C1 (30657)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x77D6 (30678)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x77ED (30701)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7845 (30789)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x78EF (30959)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7984 (31108)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x79C8 (31176)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7B4C (31564)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7B5A (31578)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8622 (34338)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x86A4 (34468)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x86FC (34556)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x8705 (34565)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_97(int iParam0, int iParam1) // Position - 0x8A1D (35357)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8BAD (35757)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8BBD (35773)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658294[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8BDA (35802)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8BEA (35818)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8F54 (36692)
{
	return Global_102506.f_417 > 0;
}

var func_103() // Position - 0x8F65 (36709)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8FAB (36779)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x9031 (36913)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x9064 (36964)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x90B5 (37045)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x9157 (37207)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9179 (37241)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x9190 (37264)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x919D (37277)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x91D7 (37335)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9212 (37394)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x924E (37454)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x9267 (37479)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x92CA (37578)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x92E0 (37600)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x92F6 (37622)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x9338 (37688)
{
...
struct<2> func_120(int iParam0) // Position - 0x9360 (37728)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x97AD (38829)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAA85 (43653)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xADCB (44491)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAE70 (44656)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAF0B (44811)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAF31 (44849)
{
	Global_80560 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAF69 (44905)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAFC2 (44994)
{
...
int func_130(Ped pedParam0) // Position - 0xB045 (45125)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB076 (45174)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB08B (45195)
{
	int num;
...
int func_133() // Position - 0xB10D (45325)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB13E (45374)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB159 (45401)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB1A5 (45477)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB1EE (45550)
{
...
BOOL func_138(int iParam0) // Position - 0xB20E (45582)
{
	switch (iParam0)
	{
		case 5:
...
void func_139() // Position - 0xB261 (45665)
{
...
BOOL func_140(int iParam0) // Position - 0xB2DE (45790)
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB331 (45873)
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB427 (46119)
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB492 (46226)
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB4D1 (46289)
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB620 (46624)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB63A (46650)
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB693 (46739)
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB6D4 (46804)
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB6F6 (46838)
{
...
BOOL func_150() // Position - 0xB735 (46901)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB743 (46915)
{
	int num;
...
BOOL func_152() // Position - 0xB776 (46966)
{
...
void func_153(int iParam0) // Position - 0xB79D (47005)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB7C0 (47040)
{
...
void func_155() // Position - 0xB7FD (47101)
{
	Global_21866 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB80D (47117)
{
...
BOOL func_157() // Position - 0xB864 (47204)
{
...
void func_158() // Position - 0xB886 (47238)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB89B (47259)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB8F3 (47347)
{
...
void func_161(Vehicle veParam0) // Position - 0xB94A (47434)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB976 (47478)
{
...
void func_163() // Position - 0xBAC7 (47815)
{
...
void func_164(int iParam0) // Position - 0xBB18 (47896)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xBB4B (47947)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xBBD5 (48085)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xBC49 (48201)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_168(int iParam0) // Position - 0xBC57 (48215)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xBCAE (48302)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_170(int iParam0) // Position - 0xBCBD (48317)
{
...
BOOL func_171(int iParam0) // Position - 0xBCFE (48382)
{
	int num;
...
void func_172(int iParam0) // Position - 0xBD43 (48451)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBD75 (48501)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBEAC (48812)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBEFB (48891)
{
	return func_176(iParam0, Global_44886);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBF0C (48908)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xC0ED (49389)
{
	if (Global_44886 == 15)
		return false;
...
int func_178() // Position - 0xC10F (49423)
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xC120 (49440)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_180() // Position - 0xC169 (49513)
{
	if (Global_102454 == 10 || Global_102454 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xC18D (49549)
{
	switch (iParam0)
	{
		case 0:
...
Blip func_182(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC5FC (50684)
{
	Blip blip;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC628 (50728)
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC63F (50751)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC6CE (50894)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCEB1 (52913)
{
	func_27(&(Global_105490.f_2890), &Global_105490, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCECC (52940)
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCF5A (53082)
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xCFBE (53182)
{
...
BOOL func_190(Vehicle veParam0) // Position - 0xD055 (53333)
{
...
BOOL func_191(int iParam0) // Position - 0xD07F (53375)
{
	eCharacter character;
...
BOOL func_192() // Position - 0xD79C (55196)
{
	return Global_102493.f_1;
}

BOOL func_193() // Position - 0xD7AA (55210)
{
	if (Global_99351 != -1)
...
BOOL func_194() // Position - 0xD7CD (55245)
{
...
BOOL func_195() // Position - 0xD7E7 (55271)
{
	if (Global_80566)
		return true;
...
BOOL func_196() // Position - 0xD811 (55313)
{
	return Global_102506.f_418 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD822 (55330)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD85A (55386)
{
	return Global_1575092;
}

BOOL func_199() // Position - 0xD866 (55398)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_200(var uParam0) // Position - 0xD882 (55426)
{
	if (iLocal_95 == -1)
	...
	if (MISC::GET_GAME_TIMER() - iLocal_95 >= 900)
	{
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
		{
			if (!func_157())
			{
				func_201(uParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6, false);
				iLocal_95 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_201(Ped pedParam0, char* sParam1, char* sParam2, int iParam3, BOOL bParam4) // Position - 0xD8D3 (55507)
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(pedParam0, sParam1, sParam2, func_202(iParam3), bParam4);
	return;
}

char* func_202(int iParam0) // Position - 0xD8ED (55533)
{
	char* str;
...
int func_203(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDAE2 (56034)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_157() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_207(PLAYER::PLAYER_PED_ID(), uParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDB6A (56170)
{
...
void func_205(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDBA5 (56229)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDBFB (56315)
{
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xDC96 (56470)
{
...
BOOL func_208(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xDCD0 (56528)
{
	var unk;
	...
	if (func_191(2))
	{
		if (!func_157())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_207(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
			{
				unk = 16;
				_CONVERSATION_INITIALIZE_ACTOR(&unk, iParam6, uParam0->f_28[0], sParam7, 0, 1);
				_CONVERSATION_ADD_LINE_NO_SUBTITLE(&unk, sParam4, sParam5, 7, 0, 0);
		...
		else if (func_209(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
				if (func_207(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
					func_155();
		}
	}
...
BOOL func_209(char* sParam0) // Position - 0xDD92 (56722)
{
	var string1;
...
struct<6> func_210() // Position - 0xDDB2 (56754)
{
	var unk;
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xDDD6 (56790)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_212(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xDDF7 (56823)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_213(int iParam0, BOOL bParam1) // Position - 0xDEE8 (57064)
{
	if (iParam0 == -1)
		return;
...
int func_214(int iParam0) // Position - 0xDF24 (57124)
{
	if (Global_80301 == iParam0)
		if (Global_80302 == -1)
...
void func_215(var uParam0, int iParam1) // Position - 0xDF5D (57181)
{
	BOOL flag;
	int i;
...
BOOL func_216() // Position - 0xDFFB (57339)
{
	return Global_99738;
}

void func_217(var uParam0) // Position - 0xE007 (57351)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_218(uParam0);
...
void func_218(var uParam0) // Position - 0xE01E (57374)
{
	BOOL flag;
	int num;
	int i;
...
void func_219(int iParam0) // Position - 0xE106 (57606)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_220(Any* panParam0, BOOL bParam1) // Position - 0xE12E (57646)
{
	var unk;
	...
	if (func_224(&(panParam0->f_48)) && bParam1)
		func_221(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_221(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE39E (58270)
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_223(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_222(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_223(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_222(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_222(int iParam0) // Position - 0xE6F6 (59126)
{
...
BOOL func_223(var uParam0) // Position - 0xE716 (59158)
{
...
BOOL func_224(var uParam0) // Position - 0xE72E (59182)
{
...
void func_225(var uParam0) // Position - 0xE753 (59219)
{
	int i;
	int taskSequenceId;
...
void func_226(Object* pobParam0) // Position - 0xEA57 (59991)
{
...
void func_227(var uParam0) // Position - 0xEA82 (60034)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEB02 (60162)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_229(Ped pedParam0, Vehicle veParam1) // Position - 0xECC0 (60608)
{
...
BOOL func_230(var uParam0, BOOL bParam1, int iParam2) // Position - 0xECF0 (60656)
{
	int i;
	int num;
...
BOOL func_231(int iParam0) // Position - 0xEFAC (61356)
{
...
BOOL func_232(Ped pedParam0, int iParam1) // Position - 0xEFE0 (61408)
{
	float xSize;
...
BOOL func_233(Ped pedParam0, int iParam1) // Position - 0xF056 (61526)
{
	return func_234(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF06E (61550)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_235(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF12F (61743)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_236(Ped pedParam0, int iParam1) // Position - 0xF25B (62043)
{
...
int func_237() // Position - 0xF320 (62240)
{
	int i;
...
BOOL func_238(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF36A (62314)
{
	var unk;
...
float func_239(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF3FB (62459)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_240(float fParam0, var uParam1, var uParam2) // Position - 0xF41C (62492)
{
	float num;
	float num2;
...
void func_241(var uParam0) // Position - 0xF45B (62555)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_242(Ped pedParam0, Ped pedParam1) // Position - 0xF476 (62582)
{
	int i;
...
BOOL func_243(Ped pedParam0) // Position - 0xF4B5 (62645)
{
...
BOOL func_244(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF4DD (62685)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_245(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xF5D8 (62936)
{
	float entityCoords;
	float num;
...
BOOL func_246(Ped pedParam0, float fParam1) // Position - 0xF6E4 (63204)
{
	var outProjectile;
	var outCoords;
...
BOOL func_247(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF779 (63353)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_248(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF807 (63495)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_249(int iParam0) // Position - 0xF84F (63567)
{
...
void func_250(Vehicle veParam0) // Position - 0xF899 (63641)
{
	int taskSequenceId;
...
BOOL func_251(int iParam0) // Position - 0xF936 (63798)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_252(int iParam0) // Position - 0xF9CB (63947)
{
...
BOOL func_253() // Position - 0xFA0A (64010)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_254() // Position - 0xFA27 (64039)
{
	if (Global_99351 != -1)
...
BOOL func_255(int iParam0) // Position - 0xFA4A (64074)
{
...
BOOL func_256() // Position - 0xFA7E (64126)
{
...
BOOL func_257(int iParam0) // Position - 0xFABC (64188)
{
	if (func_119(false))
...
BOOL func_258(var uParam0) // Position - 0xFAE4 (64228)
{
	switch (*uParam0)
	{
		case 21:
...
int func_259() // Position - 0xFB69 (64361)
{
...
BOOL func_260(var uParam0) // Position - 0xFB98 (64408)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			{
				if (func_261(&uParam0->f_28[0], CHAR_MARY_ANN, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xFF58 (65368)
{
...
BOOL func_262(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xFFB4 (65460)
{
	Hash model;
...
int func_263(Ped pedParam0, eCharacter echParam1) // Position - 0x10043 (65603)
{
	int num;
...
BOOL func_264(var uParam0) // Position - 0x10089 (65673)
{
	if (func_224(uParam0))
	{
...
BOOL func_265(var uParam0) // Position - 0x100B3 (65715)
{
	int i;
...
void func_266(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0x100E4 (65764)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_267(var uParam0) // Position - 0x10120 (65824)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_261(&uParam0->f_28[0], CHAR_MARY_ANN, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_271(&uParam0->f_28[1], num[1], 808.43f, 1279.16f, 360.47f, -79.11f, PED_TYPE_MISSION);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_269(&uParam0->f_35[0], num[2], 808.35f, 1277.2f, 360.15f, 216.5f);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
				func_269(&uParam0->f_35[1], num[2], 807.89f, 1275.73f, 360.18f, 208.2f);
...
int func_268() // Position - 0x103D3 (66515)
{
	int num;
...
void func_269(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x10465 (66661)
{
	func_270(pveParam0);
...
void func_270(Vehicle* pveParam0) // Position - 0x104A8 (66728)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_271(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x10544 (66884)
{
	func_272(ppedParam0);
...
void func_272(Ped* ppedParam0) // Position - 0x10565 (66917)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_273(var uParam0) // Position - 0x105A6 (66982)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_261(&uParam0->f_28[0], CHAR_MARY_ANN, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
BOOL func_274(int iParam0) // Position - 0x10701 (67329)
{
	var unk;
	eCharacter character;
...
BOOL func_275(int iParam0) // Position - 0x10752 (67410)
{
	const char* string2;
...
BOOL func_276(int iParam0) // Position - 0x1080B (67595)
{
	var unk;
...
BOOL func_277(int iParam0) // Position - 0x108CC (67788)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_278(int iParam0, char* sParam1) // Position - 0x10951 (67921)
{
...
BOOL func_279(int iParam0) // Position - 0x10A33 (68147)
{
...
BOOL func_280(int iParam0) // Position - 0x10A5E (68190)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_281(int iParam0) // Position - 0x10A89 (68233)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_282(int iParam0) // Position - 0x10AB4 (68276)
{
	if (func_252(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_283() // Position - 0x10AE9 (68329)
{
...
BOOL func_284(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10B03 (68355)
{
	int i;
...
BOOL func_285(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x10B68 (68456)
{
	int num;
	char* str;
...
BOOL func_286(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10BE0 (68576)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_287(var uParam0, BOOL bParam1) // Position - 0x10C5B (68699)
{
	char* str;
...
void func_288(char* sParam0) // Position - 0x10CFF (68863)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_209(sParam0))
			func_289();
...
void func_289() // Position - 0x10D1E (68894)
{
	Global_21866 = 0;
	func_290();
	return;
...
void func_290() // Position - 0x10D2E (68910)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
int func_291(var uParam0) // Position - 0x10D4F (68943)
{
	if (func_224(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_292(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10D85 (68997)
{
...
void func_293(var uParam0, BOOL bParam1) // Position - 0x10DA5 (69029)
{
	func_294(&(uParam0->f_41), bParam1);
	return;
}

void func_294(var uParam0, BOOL bParam1) // Position - 0x10DB7 (69047)
{
	int i;
...
void func_295(Object* pobParam0, BOOL bParam1) // Position - 0x10DF5 (69109)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_296(var uParam0, BOOL bParam1) // Position - 0x10E30 (69168)
{
	func_297(&(uParam0->f_35), bParam1);
	return;
}

void func_297(var uParam0, BOOL bParam1) // Position - 0x10E42 (69186)
{
	int i;
...
void func_298(Vehicle* pveParam0) // Position - 0x10E7F (69247)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_299(var uParam0, int iParam1) // Position - 0x10EB7 (69303)
{
	func_300(&(uParam0->f_28), iParam1);
	return;
}

void func_300(var uParam0, int iParam1) // Position - 0x10EC9 (69321)
{
	int i;
...
void func_301(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x10F0A (69386)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_302(int iParam0) // Position - 0x10F5A (69466)
{
	if (*iParam0 == -1)
		return;
...
void func_303(char* sParam0) // Position - 0x10F97 (69527)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_304(var uParam0) // Position - 0x10FA9 (69545)
{
	*uParam0 = -1;
...
void func_305() // Position - 0x10FDC (69596)
{
...
Hash func_306(eCharacter echParam0) // Position - 0x10FF6 (69622)
{
	if (!func_36(echParam0))
