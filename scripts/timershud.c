...
{
	Global_1675455.f_6043[iParam0] = false;
	Global_1675455.f_6043.f_11[iParam0] = false;
...
void func_16(int iParam0) // Position - 0x15C2 (5570)
{
	...
	Global_1675455.f_5375.f_211[iParam0] = -1;
...
void func_19(int iParam0) // Position - 0x16B8 (5816)
{
	...
	Global_1675455.f_5115.f_172[iParam0] = false;
	Global_1675455.f_5115[iParam0] = 0f;
...
void func_20(int iParam0) // Position - 0x1730 (5936)
{
	...
	Global_1675455.f_2153.f_304[iParam0] = -1;
...
void func_21(int iParam0) // Position - 0x196B (6507)
{
	...
	Global_1675455.f_1177.f_205[iParam0] = -1;
...
{
	Global_1675455.f_1808[iParam0] = false;
	...
	Global_1675455.f_1808.f_205[iParam0] = -1;
...
{
	Global_1675455.f_2872[iParam0] = false;
...
void func_49(var uParam0, var uParam1, char* sParam2, BOOL bParam3, int iParam4) // Position - 0x63E6 (25574)
{
	char* text;
	...
	if (!func_56(text))
	{
		if (func_52())
		{
			...
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(bParam3, true);
...
void func_54(var uParam0, var uParam1, char* sParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6) // Position - 0x6496 (25750)
{
	char* str;
	...
	if (!func_56(str))
	{
		if (func_52())
		{
			...
			func_55(func_51(*uParam0), func_50(uParam0->f_1), str, bParam3, bParam4);
		}
	}
...
void func_59(var uParam0, var uParam1, char* sParam2, BOOL bParam3, int iParam4) // Position - 0x6599 (26009)
{
	char* str;
	...
	if (!func_56(str))
	{
		if (func_52())
		{
			func_84(uParam1, false);
			HUD::SET_TEXT_JUSTIFICATION(iParam4);
			func_60(func_51(*uParam0), func_50(uParam0->f_1), str, bParam3, 0);
		}
	}
		...
		if (func_147(&unk134, &unk140, &unk152, &unk158, &unk170, &unk176, &unk188, &unk194, &unk206, &unk212) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			else if (func_56(sParam7))
			{
				if (bParam9 == false)
					if (iParam8 == 0)
						if (bParam5 != -999)
							func_59(uParam4, uParam2, "NUMBER" /*~1~*/, bParam5, 2);
					else
						func_57(uParam4, uParam2, "NUMBER" /*~1~*/, fParam6, Global_2698417, 2);
				else
					func_54(uParam4, uParam2, "TIMER_DASHES" /*~1~/~1~*/, bParam5, bParam9, 2, false);
			}
...
void func_152(int iParam0, int iParam1, int iParam2, char* sParam3, ePedComponentType epctParam4, ePedComponentType epctParam5, BOOL bParam6, BOOL bParam7, int iParam8, int iParam9, int iParam10, char* sParam11, char* sParam12, BOOL bParam13, eHudColour ehcParam14, ePedComponentType epctParam15) // Position - 0xA747 (42823)
{
	var unk;
	var unk12;
	var unk14;
	...
	{
		unk14 = 4;
		func_153(iParam0, &unk, &unk12, &unk14, iParam1, iParam2, 1, sParam3, epctParam4, bParam7, bParam6, epctParam5, iParam8, iParam9, iParam10, sParam11, sParam12, bParam13, ehcParam14, epctParam15);
	}

	return;
}

void func_153(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, char* sParam7, ePedComponentType epctParam8, BOOL bParam9, BOOL bParam10, ePedComponentType epctParam11, int iParam12, int iParam13, int iParam14, char* sParam15, char* sParam16, BOOL bParam17, eHudColour ehcParam18, ePedComponentType epctParam19) // Position - 0xA78A (42890)
{
	float num;
	BOOL flag;
	int drawOrder;
...
void func_172(int iParam0, char* sParam1, float fParam2, BOOL bParam3, int iParam4, int iParam5, int iParam6) // Position - 0xB313 (45843)
{
	var unk;
	var unk12;
	var unk14;
	...
	{
		unk14 = 2;
		func_173(iParam0, &unk, &unk12, &unk14, 1, sParam1, bParam3, fParam2, iParam4, iParam5, iParam6);
	}

	return;
}

void func_173(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, char* sParam5, BOOL bParam6, float fParam7, int iParam8, int iParam9, int iParam10) // Position - 0xB344 (45892)
{
	var unk;
	float num;
...
void func_198(int iParam0, BOOL bParam1, int iParam2, char* sParam3, eHudColour ehcParam4, BOOL bParam5, BOOL bParam6, ePedComponentType epctParam7, int iParam8, float fParam9, int iParam10, int iParam11, BOOL bParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, eHudColour ehcParam21) // Position - 0xD256 (53846)
{
	...
	{
		unk14 = 11;
		func_199(iParam0, &unk, &unk12, &unk14, &unk127, &unk114, &unk125, bParam1, iParam2, 1, sParam3, ehcParam4, bParam5, bParam6, epctParam7, iParam8, fParam9, iParam10, iParam11, true, bParam12, iParam13, iParam14, iParam15, iParam16, iParam17, iParam18, iParam19, iParam20, ehcParam21);
	}

	return;
}

void func_199(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, BOOL bParam7, BOOL bParam8, int iParam9, char* sParam10, eHudColour ehcParam11, BOOL bParam12, BOOL bParam13, ePedComponentType epctParam14, int iParam15, float fParam16, int iParam17, int iParam18, BOOL bParam19, BOOL bParam20, int iParam21, int iParam22, int iParam23, int iParam24, int iParam25, int iParam26, int iParam27, int iParam28, eHudColour ehcParam29) // Position - 0xD2AC (53932)
{
	float num;
	var unk9;
	var unk11;
	...
	if (func_134())
	{
		...
		func_205(bParam8, uParam2, uParam3, &num, uParam6, uParam5, uParam4, iParam9, iParam15, fParam16, uParam1, num2);
		unk9 = *uParam2;
		...
		if (GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("TimerBars"))
		{
			...
			if (bParam20 > false)
				func_59(&unk9, &unk11, "HUD_MULTSMAL" /*~1~x*/, bParam20, 2);
		
			if (flag)
				func_200(bParam7, bParam8, uParam3, uParam5, uParam6, ehcParam11, drawOrder, bParam19, iParam21, iParam22, iParam23, iParam24, iParam25, iParam26, iParam27, iParam28);
...
void func_200(BOOL bParam0, BOOL bParam1, var uParam2, var uParam3, var uParam4, eHudColour ehcParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15) // Position - 0xD708 (55048)
{
	float num;
	int i;
	char* str;
	...
	{
		func_54(uParam4, uParam3, "TIMER_DASHES" /*~1~/~1~*/, bParam0, bParam1, 2, false);
	}
	else
	{
		func_201(uParam3);
		...
		func_54(uParam4, uParam3, str, bParam0, bParam1, 2, false);
	}
...
void func_210(int iParam0, BOOL bParam1, char* sParam2, eHudColour ehcParam3, ePedComponentType epctParam4, int iParam5, BOOL bParam6, char* sParam7, eHudColour ehcParam8, BOOL bParam9, int iParam10, int iParam11, eHudColour ehcParam12, BOOL bParam13, eHudColour ehcParam14, ePedComponentType epctParam15, eHudColour ehcParam16) // Position - 0xDE69 (56937)
{
	...
	if (func_29(3, iParam0))
		func_47(3, iParam0, &unk, &unk12, &unk23, &unk25, bParam1, 1, sParam2, ehcParam3, epctParam4, iParam5, bParam6, sParam7, 0, 0f, iParam10, iParam11, ehcParam8, false, 0, bParam9, 0, 0, "", false, ehcParam12, 255, false, PV_COMP_HEAD, false, false, HUD_COLOUR_WHITE, bParam13, ehcParam14, epctParam15, false, false, false, 0, ehcParam16);
