...
void main() // Position - 0x0 (0)
{
	...
	iLocal_93 = 0;
	func_170(&Global_113579, 0);
	func_164();
	MISC::SET_THIS_IS_A_TRIGGER_SCRIPT(true);

	if (func_163(iLocal_92, 1))
		iLocal_98 = 10;
	else
		iLocal_98 = 9;
	...
	if (func_163(iLocal_92, 8388608))
		func_172(true);

	if (func_163(iLocal_92, 524288) && func_159() && !func_158())
		func_172(true);

	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_163(iLocal_92, 4194304))
	{
		if (iLocal_103 != 263)
		{
			func_157(iLocal_103, true, false);
			iLocal_103 = 263;
		}
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_83) && !ENTITY::IS_ENTITY_DEAD(pedLocal_83, false))
		{
			...
			{
				case 0:
					if (_CAN_ENTER_FREEROAM_STATE(iLocal_98) || func_163(iLocal_92, 16) && !func_163(iLocal_92, 524288))
					{
						iLocal_96 = -1;
						func_149();
						func_156(1);
				...
				case 3:
					...
					if (!func_163(iLocal_92, 4))
					{
						func_145();
						func_144(&iLocal_92, 4);
					}
					...
					{
						uLocal_67 = { uLocal_51 };
						flag3 = !func_163(iLocal_92, 64);
						func_170(&iLocal_92, 128);
					
						if (!func_141(3) && !Global_102488)
						{
							if (func_163(iLocal_92, 2097152))
							{
								if (!func_163(iLocal_92, 1) || !ENTITY::DOES_ENTITY_EXIST(func_140()) && !Global_102488)
								{
									func_156(10);
									break;
								}
						...
						if (!func_131(6) || Global_113978 || func_130())
							flag3 = false;
					
						if (!bLocal_116)
						{
							func_128(&iLocal_92, 128);
							flag3 = false;
						}
						...
						if (flag3)
						{
							...
							if (flag3)
							{
								...
								if (func_120(veLocal_84))
								{
									if (iLocal_94 == -1)
									{
										_CONTEXT_ADD_HELP_TEXT(&iLocal_94, 4, sLocal_99, 0, 0, 0, 0);
										func_128(&iLocal_92, 2048);
									}
									else if (!func_163(iLocal_92, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_118(&iLocal_94);
										func_170(&iLocal_92, 2048);
									}
								
									if (func_116(iLocal_94, true))
									{
										sLocal_99 = sLocal_99;
										func_118(&iLocal_94);
										func_170(&iLocal_92, 2048);
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&uLocal_67))
					{
						...
						if (num == 1)
						{
							...
							iLocal_50 = func_29();
							func_170(&iLocal_92, 4);
							func_28();
							func_128(&iLocal_92, 2);
							func_156(6);
							func_24(&uLocal_105);
				...
				case 6:
					if (func_163(Global_113579, 262144))
					{
						func_170(&Global_113579, 262144);
						func_16();
					}
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						func_11(&uLocal_105);
						func_170(&iLocal_92, 256);
						func_8();
					
						if (flag)
						{
							func_170(&iLocal_92, 2);
						}
						else if (func_163(iLocal_92, 2))
						{
							if (func_163(Global_113579, 0))
							{
								func_7(&iLocal_96);
								iLocal_96 = -1;
								func_170(&iLocal_92, 2);
						...
						if (iLocal_97 != -1)
						{
							if (func_163(Global_113579, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_22(iLocal_97), 0, Global_102491, 0);
								func_6(func_22(iLocal_97), 0, Global_102491, true, false);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_22(iLocal_97), 0, Global_102491, 0);
								func_6(func_22(iLocal_97), 0, Global_102491, false, false);
							}
						}
						...
						if (func_163(iLocal_92, 16777216))
							func_172(true);
				...
				case 7:
					...
					if (iLocal_103 != 263)
						func_157(iLocal_103, false, false);
					...
					if (iLocal_102 % 150 == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_104 == 2)
							{
								if (iLocal_104 == 2)
								{
									if (_CAN_ENTER_FREEROAM_STATE(iLocal_98) && func_160(0, iLocal_97))
									{
										func_164();
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xA35 (2613)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_2() // Position - 0xA48 (2632)
{
	func_3(&uLocal_117);
...
void func_3(var uParam0) // Position - 0xA66 (2662)
{
	int i;
...
void func_4() // Position - 0xA96 (2710)
{
	return;
}

void func_5() // Position - 0xA9E (2718)
{
	if (iLocal_119 == 0)
...
void func_7(var uParam0) // Position - 0xAFC (2812)
{
	if (*uParam0 == -1)
		return;
...
void func_8() // Position - 0xB39 (2873)
{
	var textLabel;
...
BOOL func_9() // Position - 0xB85 (2949)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_10() // Position - 0xB9B (2971)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_11(var uParam0) // Position - 0xBB1 (2993)
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_12(var uParam0) // Position - 0xBC7 (3015)
{
	if (func_15(uParam0))
		if (func_14(uParam0))
			return uParam0->f_2;
...
float func_13(BOOL bParam0) // Position - 0xC03 (3075)
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_15(int* piParam0) // Position - 0xC68 (3176)
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_16() // Position - 0xC75 (3189)
{
	return 1;
}

void func_17() // Position - 0xC7E (3198)
{
	func_18(&caLocal_459, veLocal_285);
	return;
}

void func_18(var uParam0, Vehicle veParam1) // Position - 0xC90 (3216)
{
	float camRot;
...
float func_19(float fParam0, float fParam1, float fParam2) // Position - 0xD19 (3353)
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

void func_20(char* sParam0, int iParam1, int iParam2) // Position - 0xD2E (3374)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_99499))
	{
	...
	STATS::PLAYSTATS_MISSION_STARTED(sParam0, iParam1, iParam2, func_21(false));
	return;
}

BOOL func_21(BOOL bParam0) // Position - 0xD6F (3439)
{
...
char* func_22(int iParam0) // Position - 0xD97 (3479)
{
	switch (iParam0)
	{
		case 0:
...
void func_23(int iParam0) // Position - 0xED5 (3797)
{
	int num;
	var textLabel;
...
void func_24(int* piParam0) // Position - 0xF36 (3894)
{
	if (!func_15(piParam0))
		func_27(piParam0);
	else
...
void func_25(int* piParam0) // Position - 0xF57 (3927)
{
	func_26(piParam0, 0f);
	return;
}

void func_26(int* piParam0, float fParam1) // Position - 0xF66 (3942)
{
...
void func_27(int* piParam0) // Position - 0xF91 (3985)
{
	if (!func_15(piParam0))
		func_25(piParam0);
...
void func_28() // Position - 0xFA9 (4009)
{
...
int func_29() // Position - 0xFF3 (4083)
{
	int num;

	Global_114931.f_18974 = iLocal_119;
...
void func_30(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x1077 (4215)
{
	if (iParam0 != 198)
	{
		if (Global_80305)
...
void func_31(int iParam0, int iParam1) // Position - 0x10CF (4303)
{
	switch (iParam0)
	{
		case 12:
...
void func_32(int iParam0, BOOL bParam1) // Position - 0x11B2 (4530)
{
	if (bParam1)
...
BOOL func_33(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x11DB (4571)
{
	BOOL flag;
	int num;
	int num2;
...
BOOL func_34() // Position - 0x1B2A (6954)
{
...
int func_35() // Position - 0x1B5A (7002)
{
	return Global_33793;
}

int func_36() // Position - 0x1B65 (7013)
{
	return Global_33792;
}

int func_37(var uParam0, int iParam1) // Position - 0x1B70 (7024)
{
	int i;
...
void func_38() // Position - 0x530C (21260)
{
...
void func_40(int iParam0) // Position - 0x53AA (21418)
{
...
void func_42(int iParam0, int iParam1, int iParam2) // Position - 0x545E (21598)
{
	func_43(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x5473 (21619)
{
	int num;
...
int func_44() // Position - 0x54F5 (21749)
{
	int i;
...
BOOL func_45(int iParam0, int iParam1, int iParam2) // Position - 0x5526 (21798)
{
...
int func_46(int iParam0, int iParam1, int iParam2) // Position - 0x5541 (21825)
{
	int i;
...
void func_48() // Position - 0x55D6 (21974)
{
...
int func_49(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x5653 (22099)
{
	int i;
...
void func_50(var uParam0, int iParam1) // Position - 0x578A (22410)
{
	int i;
...
BOOL func_51(int iParam0) // Position - 0x57D9 (22489)
{
	if (Global_44886 == 15)
		return false;
...
void func_52() // Position - 0x57FB (22523)
{
	func_53();
	return;
}

void func_53() // Position - 0x5807 (22535)
{
	...
	speed = func_115(iLocal_119) == joaat("maverick") ? 0.45f : 0.3f;
	...
	if (func_111(veLocal_285.f_3, veLocal_285, true, true, true, true, false) || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		func_154(0);
		bLocal_456 = false;
	...
	num = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), func_110(iLocal_119));
	...
	if (num < 10000f)
	{
		...
		{
			if (STREAMING::HAS_MODEL_LOADED(func_109(iLocal_119)) && ENTITY::DOES_ENTITY_EXIST(veLocal_285) && VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_285, false))
			{
				veLocal_285.f_3 = PED::CREATE_PED_INSIDE_VEHICLE(veLocal_285, PED_TYPE_CIVMALE, func_109(iLocal_119), -1, true, true);
			
				if (!PED::IS_PED_INJURED(veLocal_285.f_3))
				{
					PED::SET_PED_HELMET(veLocal_285.f_3, false);
					func_108(veLocal_285.f_3, iLocal_119);
					func_107();
					AUDIO::SET_AMBIENT_VOICE_NAME(veLocal_285.f_3, func_106(iLocal_119));
					_CONVERSATION_INITIALIZE_ACTOR(&uLocal_120, 0, veLocal_285.f_3, func_105(iLocal_119), 1, 1);
			...
			if (!IS_BIT_SET(veLocal_285.f_169, 0))
			{
				if (CAM::IS_SCREEN_FADED_IN())
				{
					if (!PED::IS_PED_INJURED(veLocal_285.f_3) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
						...
						{
							_CONVERSATION_ADD_LINE(&uLocal_120, "OJBJAUD", func_102(iLocal_119), 8, 0, 0, 0);
...
void func_54(char* sParam0) // Position - 0x6047 (24647)
{
...
float func_55(int* piParam0) // Position - 0x605D (24669)
{
	if (func_15(piParam0))
		if (func_14(piParam0))
			return piParam0->f_2;
...
void func_56(int iParam0) // Position - 0x6096 (24726)
{
	if (iLocal_93 < 5)
	{
		if (iParam0 != 263)
...
float func_57(int iParam0) // Position - 0x60D9 (24793)
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_58(int iParam0) // Position - 0x6160 (24928)
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_59(int iParam0) // Position - 0x6215 (25109)
{
	switch (iParam0)
	{
		case 0:
...
void func_60(BOOL bParam0) // Position - 0x62EA (25322)
{
	if (bParam0)
	{
		func_66();
...
void func_61(int iParam0) // Position - 0x634D (25421)
{
	if (func_65())
		return;
...
BOOL func_62() // Position - 0x63D7 (25559)
{
...
void func_63(BOOL bParam0, BOOL bParam1) // Position - 0x63FE (25598)
{
	if (bParam0)
	{
		if (func_122(0))
...
BOOL func_64() // Position - 0x6472 (25714)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_65() // Position - 0x6480 (25728)
{
	return IS_BIT_SET(Global_1964705, 19);
}

void func_66() // Position - 0x648F (25743)
{
...
void func_67(eSetPlayerControlFlags espcfParam0, BOOL bParam1, BOOL bParam2) // Position - 0x64B8 (25784)
{
...
void func_68(int iParam0, BOOL bParam1) // Position - 0x6511 (25873)
{
	if (bParam1)
...
void func_69(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x6533 (25907)
{
	if (bParam0)
	{
...
BOOL func_70() // Position - 0x6682 (26242)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_71(Player plParam0, int iParam1) // Position - 0x669C (26268)
{
	BOOL flag;
...
BOOL func_74(Player plParam0) // Position - 0x6742 (26434)
{
	Player player;
...
BOOL func_75(Player plParam0) // Position - 0x6764 (26468)
{
...
BOOL func_76() // Position - 0x67A3 (26531)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_77(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x67B1 (26545)
{
	int num;
...
void func_78(int iParam0) // Position - 0x67E4 (26596)
{
	if (iParam0 == 1)
...
BOOL func_79(Ped pedParam0, Vehicle veParam1) // Position - 0x6807 (26631)
{
...
int func_80(Ped pedParam0, Vehicle veParam1) // Position - 0x6864 (26724)
{
...
int _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x68D6 (26838)
{
...
int func_82(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x6924 (26916)
{
	Global_23001 = 0;
...
void func_83() // Position - 0x6BF2 (27634)
{
	if (!func_84())
		return;
...
BOOL func_84() // Position - 0x6C29 (27689)
{
...
BOOL func_85(Player plParam0) // Position - 0x6C8C (27788)
{
	if (plParam0 == PLAYER::PLAYER_ID())
	{
		if (func_87(8))
...
BOOL func_86(Player plParam0, int iParam1) // Position - 0x6CC3 (27843)
{
	return IS_BIT_SET(Global_1892798[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_87(int iParam0) // Position - 0x6CDB (27867)
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x6CED (27885)
{
	return -1;
}

void func_89() // Position - 0x6CF6 (27894)
{
	int i;
...
void func_90() // Position - 0x6D27 (27943)
{
...
BOOL func_91() // Position - 0x6DBC (28092)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x6E55 (28245)
{
	if (func_143(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x6EF7 (28407)
{
	func_94();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_94() // Position - 0x6F10 (28432)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_95(character) && !func_143(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != character && func_95(Global_114931.f_2370.f_539.f_4321))
...
BOOL func_95(eCharacter echParam0) // Position - 0x700D (28685)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x7019 (28697)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x7056 (28758)
{
...
Hash func_98(eCharacter echParam0) // Position - 0x707B (28795)
{
	return Global_2339[echParam0 /*29*/];
}

void func_99() // Position - 0x708A (28810)
{
	int i;
...
void func_100() // Position - 0x70E1 (28897)
{
...
char* func_102(int iParam0) // Position - 0x718E (29070)
{
	BOOL flag;
...
var func_103(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7250 (29264)
{
	if (bParam0)
		return uParam1;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x7267 (29287)
{
...
char* func_105(int iParam0) // Position - 0x7302 (29442)
{
	return "EXT1HELIPILOT";
}

char* func_106(int iParam0) // Position - 0x730E (29454)
{
	switch (iParam0)
	{
		case 0:
...
void func_107() // Position - 0x7389 (29577)
{
	iLocal_46 = iLocal_46 + 1;
	return;
}

void func_108(Ped pedParam0, int iParam1) // Position - 0x7397 (29591)
{
...
Hash func_109(int iParam0) // Position - 0x7441 (29761)
{
	switch (iParam0)
	{
		case 0:
...
Vector3 func_110(int iParam0) // Position - 0x74C1 (29889)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_111(Ped pedParam0, Vehicle veParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x760B (30219)
{
	Ped target;
	float entityCoords;
			...
			if (bParam4)
				if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), pedParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), pedParam0))
					if (PED::IS_PED_FACING_PED(pedParam0, target, 90f))
						if (func_112(pedParam0, true) < 10f)
							return true;
...
float func_112(Ped pedParam0, BOOL bParam1) // Position - 0x77FA (30714)
{
	return func_113(PLAYER::GET_PLAYER_PED(PLAYER::GET_PLAYER_INDEX()), pedParam0, bParam1);
}

float func_113(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x7812 (30738)
{
	Vector3 entityCoords;
...
var func_114(BOOL bParam0, var uParam1, var uParam2) // Position - 0x7870 (30832)
{
	if (bParam0)
		return uParam1;
...
int func_115(int iParam0) // Position - 0x7887 (30855)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_116(int iParam0, BOOL bParam1) // Position - 0x78DD (30941)
{
	int num;
...
int func_117(int iParam0) // Position - 0x7995 (31125)
{
	int i;
...
void func_118(var uParam0) // Position - 0x79D0 (31184)
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x7A27 (31271)
{
	int i;
...
BOOL func_120(Vehicle veParam0) // Position - 0x7B52 (31570)
{
	return false;
}

BOOL func_121() // Position - 0x7B5F (31583)
{
	return Global_77359;
}

BOOL func_122(int iParam0) // Position - 0x7B6B (31595)
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
BOOL func_123(int iParam0, int iParam1) // Position - 0x7BC2 (31682)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_124() // Position - 0x7BFA (31738)
{
	return MISC::GET_GAME_TIMER() <= Global_24546.f_6481 + 100;
}

BOOL func_125() // Position - 0x7C0F (31759)
{
...
BOOL func_126(BOOL bParam0) // Position - 0x7C29 (31785)
{
	if (bParam0)
...
BOOL func_127() // Position - 0x7C52 (31826)
{
	return true;
}

void func_128(var uParam0, int iParam1) // Position - 0x7C5B (31835)
{
	func_129(uParam0, iParam1);
	return;
}

void func_129(var uParam0, int iParam1) // Position - 0x7C6B (31851)
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_130() // Position - 0x7C7C (31868)
{
	int weaponHash;
	BOOL flag;
...
BOOL func_131(int iParam0) // Position - 0x7D86 (32134)
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_113978 || Global_33795 || func_137() || func_123(8, -1) || func_136() || func_135() || func_134() || func_125() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_138() || Global_33795 || func_137() || func_123(8, -1) || func_134() || func_136() || func_135() || func_125() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_113978 || Global_33795 || func_137() || func_123(8, -1) || func_134() || func_136() || func_135() || func_125() || Global_114931.f_7695.f_919[character] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_138() || Global_113978 || Global_33795 || func_137() || func_123(8, -1) || func_136() || func_135() || func_125() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_138() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_123(8, -1) || func_125() || func_133() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_138() || Global_33795 || func_137() || func_123(8, -1) || func_135() || func_134() || func_125() || Global_114931.f_7695.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_138() || func_135() || Global_113978 || Global_33795 || func_137() || Global_46111 || func_123(8, -1) || func_134() || func_133() || func_125() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_138() || Global_113978 || Global_33795 || func_137() || func_123(8, -1) || func_134() || func_133() || func_136() || func_135() || func_125())
							return false;
						break;
				}
			}
...
BOOL func_132() // Position - 0x84A5 (33957)
{
	return Global_102493.f_1;
}

BOOL func_133() // Position - 0x84B3 (33971)
{
	if (Global_99351 != -1)
...
BOOL func_134() // Position - 0x84D6 (34006)
{
	if (Global_80566)
		return true;
...
BOOL func_135() // Position - 0x8500 (34048)
{
	return Global_102506.f_418 > 0;
}

BOOL func_136() // Position - 0x8511 (34065)
{
	return Global_102506.f_417 > 0;
}

BOOL func_137() // Position - 0x8522 (34082)
{
	return Global_1575092;
}

BOOL func_138() // Position - 0x852E (34094)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_139() // Position - 0x854A (34122)
{
...
BOOL func_141(int iParam0) // Position - 0x8570 (34160)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_142(int iParam0) // Position - 0x85E2 (34274)
{
	int num;
...
BOOL func_143(int iParam0) // Position - 0x861E (34334)
{
	return Global_44886 == iParam0;
}

void func_144(var uParam0, int iParam1) // Position - 0x862C (34348)
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_145() // Position - 0x863D (34365)
{
	if (bLocal_455)
	{
		switch (iLocal_119)
		{
			...
			case 1:
				func_146(1208.1965f, 174.5777f, 81.0003f, 138.8786f);
				break;
		
			case 2:
				func_146(2463.9036f, 1509.9642f, 35.0372f, 88.9199f);
				break;
			...
			case 7:
				func_146(-742.5047f, 4493.4663f, 75.2206f, 180.991f);
				break;
		
			case 9:
				func_146(-1367.6865f, 4381.998f, 41.4017f, 277.8339f);
				break;
			...
			case 11:
				func_146(1054.5343f, -179.6562f, 70.3162f, 30.046f);
				break;
...
void func_146(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x875D (34653)
{
	var groundZ;
	BOOL flag;
...
BOOL func_147() // Position - 0x888D (34957)
{
	return func_148(&uLocal_117);
}

BOOL func_148(var uParam0) // Position - 0x889B (34971)
{
	int i;
...
void func_149() // Position - 0x88E2 (35042)
{
	switch (iLocal_119)
	{
		case 0:
...
void func_150(var uParam0) // Position - 0x8937 (35127)
{
	int i;
...
void func_151() // Position - 0x8967 (35175)
{
	if (iLocal_119 == 3)
...
int func_152(var uParam0, int iParam1) // Position - 0x8990 (35216)
{
	int i;
	int num;
...
int func_153(var uParam0) // Position - 0x89ED (35309)
{
	int i;
...
void func_154(int iParam0) // Position - 0x8A19 (35353)
{
	if (iParam0 == 2)
	{
	}
...
BOOL func_155() // Position - 0x8A3A (35386)
{
	Vector3 entityCoords;
	float num;
...
void func_156(int iParam0) // Position - 0x8AAD (35501)
{
	iLocal_93 = iParam0;
	return;
}

void func_157(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x8AB9 (35513)
{
	int num;
	BOOL flag;
...
BOOL func_158() // Position - 0x8BB9 (35769)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_159() // Position - 0x8BD6 (35798)
{
	if (Global_99351 != -1)
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x8BF9 (35833)
{
	BOOL flag;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x8C43 (35907)
{
	return func_162(iParam0, Global_44886);
}

BOOL func_162(int iParam0, int iParam1) // Position - 0x8C54 (35924)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_163(int iParam0, int iParam1) // Position - 0x8E35 (36405)
{
	return iParam0 && iParam1 != false;
}

void func_164() // Position - 0x8E44 (36420)
{
	iLocal_97 = 0;

	if (ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
	{
		func_128(&iLocal_92, 8388608);
		return;
	}

	TEXT_LABEL_ASSIGN_STRING(&uLocal_51, "bj", 64);
	iLocal_119 = func_168(uLocal_88, 1);
	func_128(&iLocal_92, 64);
	...
	func_128(&iLocal_92, 4194304);
	func_128(&iLocal_92, 16);
	fLocal_100 = BUILTIN::TO_FLOAT(func_165(iLocal_103)) + 5f;
	...
	{
		func_170(&iLocal_92, 8);
	}

	if (func_143(12))
		func_128(&iLocal_92, 8);

	essLocal_95 = 64500;
	return;
}

int func_165(int iParam0) // Position - 0x8FD7 (36823)
{
	switch (iParam0)
	{
		case 91:
...
BOOL func_166(int iParam0) // Position - 0x90EF (37103)
{
...
BOOL func_167(int iParam0) // Position - 0x911B (37147)
{
	return Global_114018[iParam0 /*10*/].f_1;
}

int func_168(Vector3 vParam0, var uParam1, var uParam2, int iParam3) // Position - 0x912D (37165)
{
	float num;
	float num2;
	int num3;
	...
	for (i = 0; i < 13; i = i + 1)
	{
		if (iParam3 == func_169(i))
		{
			num2 = BUILTIN::VDIST2(vParam0, func_110(i));
...
int func_169(int iParam0) // Position - 0x917C (37244)
{
	switch (iParam0)
	{
		case 0:
...
void func_171(var uParam0, int iParam1) // Position - 0x91D3 (37331)
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_172(BOOL bParam0) // Position - 0x91E8 (37352)
{
	if (bParam0)
		if (iLocal_103 != 263)
			func_157(iLocal_103, 0, false);

	func_118(&iLocal_94);

	if (func_163(iLocal_92, 2))
	{
		func_5();
		func_170(&iLocal_92, 2);
		func_7(&iLocal_96);
...
void func_173() // Position - 0x9231 (37425)
{
	func_170(&iLocal_92, 4);
	func_174();
...
void func_174() // Position - 0x926E (37486)
{
	return;
}
