...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_84) && !ENTITY::IS_ENTITY_DEAD(pedLocal_84, false))
		{
			...
			fLocal_92 = BUILTIN::VDIST2(uLocal_86, uScriptParam_0.f_1[0 /*3*/]);
			fLocal_92 = fLocal_92;
			uLocal_110 = { uLocal_86 };
			uLocal_113 = { uScriptParam_0.f_1[0 /*3*/] };
			uLocal_110.f_2 = 0f;
			uLocal_113.f_2 = 0f;
			fLocal_109 = BUILTIN::VDIST2(uLocal_110, uLocal_113);
			...
			switch (iLocal_94)
			{
				...
				case 3:
					...
					if (!_CAN_ENTER_FREEROAM_STATE(iLocal_99))
					{
						if (!func_184(iLocal_93, 8))
						{
							...
							if (MISC::ARE_STRINGS_EQUAL(&(Global_102454.f_3), &uLocal_68))
							{
								uLocal_68 = { uLocal_52 };
								flag2 = false;
							}
					...
					if (fLocal_109 > fLocal_101 * fLocal_101 && !Global_102488)
					{
						if (iLocal_104 != 263)
						{
					...
					else
					{
						...
						if (!func_169(3) && !Global_102488)
						{
							...
							{
								if (!func_184(iLocal_93, 1) || !ENTITY::DOES_ENTITY_EXIST(func_168()) && !Global_102488)
								{
									func_177(10);
									break;
								}
				...
				case 5:
					...
					if (SCRIPT::HAS_SCRIPT_LOADED(&uLocal_68))
					{
						...
						if (num == 1)
						{
							...
							iLocal_51 = BUILTIN::START_NEW_SCRIPT(&uLocal_68, essLocal_96);
				...
				case 6:
					...
					{
						STATS::PLAYSTATS_ODDJOB_DONE(BUILTIN::ROUND(func_13(&uLocal_106) * 1000f), iLocal_98, false);
						func_12(&uLocal_106);
						...
						if (iLocal_98 != -1)
						{
							if (func_184(Global_113579, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_98), 0, Global_102491, 0);
								func_7(func_21(iLocal_98), 0, Global_102491, true, false);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_21(iLocal_98), 0, Global_102491, 0);
								func_7(func_21(iLocal_98), 0, Global_102491, false, false);
							}
						}
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xA60 (2656)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_2() // Position - 0xA73 (2675)
{
	func_4(128);
...
void func_3(Ped pedParam0) // Position - 0xA95 (2709)
{
...
void func_4(BOOL bParam0) // Position - 0xAA9 (2729)
{
	Global_114017 = Global_114017 - Global_114017 && bParam0;
	return;
}

void func_5() // Position - 0xAC1 (2753)
{
	return;
}

void func_6() // Position - 0xAC9 (2761)
{
	return;
}

void func_7(char* sParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xAD1 (2769)
{
...
void func_8(var uParam0) // Position - 0xB15 (2837)
{
	if (*uParam0 == -1)
		return;
...
void func_9() // Position - 0xB52 (2898)
{
	var textLabel;
...
BOOL func_10() // Position - 0xB9E (2974)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_11() // Position - 0xBB4 (2996)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_12(var uParam0) // Position - 0xBCA (3018)
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_13(int* piParam0) // Position - 0xBE0 (3040)
{
	if (func_16(piParam0))
		if (func_15(piParam0))
			return piParam0->f_2;
...
float func_14(BOOL bParam0) // Position - 0xC1C (3100)
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_15(int* piParam0) // Position - 0xC74 (3188)
{
	return IS_BIT_SET(*piParam0, 2);
}

BOOL func_16(int* piParam0) // Position - 0xC81 (3201)
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_17() // Position - 0xC8E (3214)
{
	return 1;
}

void func_18() // Position - 0xC97 (3223)
{
	return;
}

void func_19(char* sParam0, int iParam1, int iParam2) // Position - 0xC9F (3231)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_99499))
	{
...
BOOL func_20(BOOL bParam0) // Position - 0xCE0 (3296)
{
...
char* func_21(int iParam0) // Position - 0xD08 (3336)
{
	switch (iParam0)
	{
		case 0:
...
void func_22(int iParam0) // Position - 0xE46 (3654)
{
	int num;
	var textLabel;
...
void func_23(int* piParam0) // Position - 0xEA7 (3751)
{
	if (!func_16(piParam0))
		func_26(piParam0);
	else
...
void func_24(int* piParam0) // Position - 0xEC8 (3784)
{
	func_25(piParam0, 0f);
	return;
}

void func_25(int* piParam0, float fParam1) // Position - 0xED7 (3799)
{
...
void func_26(int* piParam0) // Position - 0xF02 (3842)
{
	if (!func_16(piParam0))
		func_24(piParam0);
...
void func_27(Ped pedParam0) // Position - 0xF1A (3866)
{
	int num;
	int num2;
	int num3;
...
void func_28(int iParam0) // Position - 0xF73 (3955)
{
...
int func_29(Ped pedParam0) // Position - 0xFF6 (4086)
{
	int i;
...
void func_30(int iParam0, int iParam1, int iParam2) // Position - 0x1027 (4135)
{
	func_31(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_31(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x103C (4156)
{
	int num;
...
int func_32() // Position - 0x10BE (4286)
{
	int i;
...
BOOL func_33(int iParam0, int iParam1, int iParam2) // Position - 0x10EF (4335)
{
...
int func_34(int iParam0, int iParam1, int iParam2) // Position - 0x110A (4362)
{
	int i;
...
int func_35(Ped pedParam0) // Position - 0x1156 (4438)
{
	int i;
...
void func_36() // Position - 0x119F (4511)
{
...
int func_37(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x121C (4636)
{
	int i;
...
void func_38(var uParam0, int iParam1) // Position - 0x1353 (4947)
{
	int i;
...
BOOL func_39(int iParam0) // Position - 0x13A2 (5026)
{
	if (Global_44886 == 15)
		return false;
...
void func_40() // Position - 0x13C4 (5060)
{
	...
	if (iLocal_126 == 2)
	{
		if (!bLocal_128)
		{
			if (func_44(2) == 49)
			{
				...
				{
					BUILTIN::START_NEW_SCRIPT("tennis_family", MULTIPLAYER_MISSION);
...
int func_41() // Position - 0x14BD (5309)
{
	if (!func_42(22))
		return 1;
...
BOOL func_42(int iParam0) // Position - 0x14D4 (5332)
{
...
int func_43() // Position - 0x1500 (5376)
{
	if (func_42(21))
		return 1;
...
int func_44(int iParam0) // Position - 0x1516 (5398)
{
	return Global_97435[iParam0];
}

void func_45(Ped pedParam0, int iParam1) // Position - 0x1526 (5414)
{
	Hash entityModel;
	var unk;
...
void func_46(Ped pedParam0, Hash hParam1, var uParam2) // Position - 0x154D (5453)
{
	ePedComponentType i;
	var unk;
	int j;
...
int func_47(int iParam0) // Position - 0x1629 (5673)
{
	switch (iParam0)
	{
		case 0:
...
ePedComponentType func_48(int iParam0) // Position - 0x16AF (5807)
{
	switch (iParam0)
	{
		case -1:
...
struct<10> func_49(Hash hParam0, int iParam1) // Position - 0x1783 (6019)
{
	int i;
	var unk;
...
void func_50(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x20B2 (8370)
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
int func_51(Hash hParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x21DC (8668)
{
	var outfit;
	int i;
	int num;
	...
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_53(iParam2));
...
int func_52(Hash hParam0, int iParam1) // Position - 0x2297 (8855)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_53(int iParam0) // Position - 0x263E (9790)
{
	switch (iParam0)
	{
		case 0:
...
int func_54(Hash hParam0) // Position - 0x26EE (9966)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
int func_55(Hash hParam0) // Position - 0x274F (10063)
{
	switch (hParam0)
	{
		case joaat("Player_Zero"):
...
void func_56(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x27AE (10158)
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<14> func_57(Hash hParam0, int iParam1, int iParam2, int iParam3) // Position - 0x27F6 (10230)
{
	func_125();
...
void func_58(int iParam0, int iParam1) // Position - 0x2848 (10312)
{
	switch (iParam0)
	{
		case 0:
...
void func_59(int iParam0) // Position - 0x2938 (10552)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_60(&Global_80088[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_60(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x3B6D (15213)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_63(func_67(iParam1, iParam0->f_2), Global_80085);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_63(func_62(iParam1, iParam0->f_2), Global_80085);
...
BOOL func_61(int iParam0, int iParam1, var uParam2) // Position - 0x3F0E (16142)
{
	*uParam2 = 979;
...
int func_62(int iParam0, int iParam1) // Position - 0x4314 (17172)
{
	switch (iParam1)
	{
		case 0:
...
int func_63(int iParam0, int iParam1) // Position - 0x470F (18191)
{
	Hash statHash;
	int outValue;
...
Hash func_64(int iParam0, int iParam1) // Position - 0x473E (18238)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_65(iParam1));
}

int func_65(int iParam0) // Position - 0x4753 (18259)
{
	int num;
	int num2;
...
int func_66() // Position - 0x4787 (18311)
{
	return Global_1574927;
}

int func_67(int iParam0, int iParam1) // Position - 0x4793 (18323)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4B8E (19342)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
BOOL func_69(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x5A31 (23089)
{
	int num;
	int num2;
	int num3;
...
BOOL func_70(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x5A6F (23151)
{
...
void func_71(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x877C (34684)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_60(&Global_80088[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_60(&Global_80088[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80286)
		{
			...
			func_60(&Global_80088[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 11, -1, false, -1, func_53(iParam0));
...
void func_72(int iParam0) // Position - 0x8A02 (35330)
{
	BOOL flag;
	int num;
	var unk;
...
void func_73(int iParam0) // Position - 0x8B4F (35663)
{
	BOOL flag;
	int num;
	var unk;
...
void func_74(int iParam0) // Position - 0x905C (36956)
{
	BOOL flag;
	int num;
	var unk;
...
void func_75(int iParam0) // Position - 0x90D0 (37072)
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0) // Position - 0x9143 (37187)
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Position - 0x922A (37418)
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0x956C (38252)
{
	BOOL flag;
	int num;
	var unk;
...
void func_79(int iParam0) // Position - 0x9774 (38772)
{
	BOOL flag;
	int num;
	var unk;
...
void func_80(int iParam0) // Position - 0x9994 (39316)
{
	BOOL flag;
	int num;
	var unk;
...
void func_81(int iParam0) // Position - 0x9A9D (39581)
{
	BOOL flag;
	int num;
	var unk;
...
void func_82(int iParam0) // Position - 0xA42F (42031)
{
	BOOL flag;
	int num;
	var unk;
...
void func_83(int iParam0) // Position - 0xAF87 (44935)
{
	if (iParam0 < 136)
		func_85(iParam0);
	else
...
void func_84(int iParam0) // Position - 0xAFBC (44988)
{
	BOOL flag;
	int num;
	var unk;
...
void func_85(int iParam0) // Position - 0xBBC0 (48064)
{
	BOOL flag;
	int num;
	var unk;
...
void func_86(int iParam0) // Position - 0xCAC2 (51906)
{
	BOOL flag;
	int num;
	var unk;
...
void func_87(int iParam0) // Position - 0xCBEF (52207)
{
	BOOL flag;
	int num;
	var unk;
...
void func_88(int iParam0, int iParam1) // Position - 0xCCE6 (52454)
{
	switch (iParam0)
	{
		case 0:
...
void func_89(int iParam0) // Position - 0xCDD6 (52694)
{
	BOOL flag;
	int num;
	var unk;
...
void func_90(int iParam0) // Position - 0xE2A3 (58019)
{
	BOOL flag;
	int num;
	var unk;
...
void func_91(int iParam0) // Position - 0xE3EA (58346)
{
	BOOL flag;
	int num;
	var unk;
...
void func_92(int iParam0) // Position - 0xE8F4 (59636)
{
	BOOL flag;
	int num;
	var unk;
...
void func_93(int iParam0) // Position - 0xEF5D (61277)
{
	BOOL flag;
	int num;
	var unk;
...
void func_94(int iParam0) // Position - 0xEFD0 (61392)
{
	BOOL flag;
	int num;
	var unk;
...
void func_95(int iParam0) // Position - 0xF0A0 (61600)
{
	BOOL flag;
	int num;
	var unk;
...
void func_96(int iParam0) // Position - 0xF59B (62875)
{
	BOOL flag;
	int num;
	var unk;
...
void func_97(int iParam0) // Position - 0xF72C (63276)
{
	BOOL flag;
	int num;
	var unk;
...
void func_98(int iParam0) // Position - 0xFF1B (65307)
{
	BOOL flag;
	int num;
	var unk;
...
void func_99(int iParam0) // Position - 0x10024 (65572)
{
	BOOL flag;
	int num;
	var unk;
...
void func_100(int iParam0) // Position - 0x10F47 (69447)
{
	BOOL flag;
	int num;
	var unk;
...
void func_101(int iParam0) // Position - 0x11BF4 (72692)
{
	if (iParam0 < 107)
		func_104(iParam0);
	else if (iParam0 < 227)
...
void func_102(int iParam0) // Position - 0x11C3A (72762)
{
	BOOL flag;
	int num;
	var unk;
...
void func_103(int iParam0) // Position - 0x126DE (75486)
{
	BOOL flag;
	int num;
	var unk;
...
void func_104(int iParam0) // Position - 0x134CC (79052)
{
	BOOL flag;
	int num;
	var unk;
...
void func_105(int iParam0) // Position - 0x1410B (82187)
{
	BOOL flag;
	int num;
	var unk;
...
void func_106(int iParam0) // Position - 0x14383 (82819)
{
	BOOL flag;
	int num;
	var unk;
...
void func_107(int iParam0, int iParam1) // Position - 0x144BF (83135)
{
	switch (iParam0)
	{
		case 0:
...
void func_108(int iParam0) // Position - 0x145AF (83375)
{
	BOOL flag;
	int num;
	var unk;
...
void func_109(int iParam0) // Position - 0x1530D (86797)
{
	BOOL flag;
	int num;
	var unk;
...
void func_110(int iParam0) // Position - 0x1547C (87164)
{
	BOOL flag;
	int num;
	var unk;
...
void func_111(int iParam0) // Position - 0x159ED (88557)
{
	BOOL flag;
	int num;
	var unk;
...
void func_112(int iParam0) // Position - 0x15F15 (89877)
{
	BOOL flag;
	int num;
	var unk;
...
void func_113(int iParam0) // Position - 0x15F88 (89992)
{
	BOOL flag;
	int num;
	var unk;
...
void func_114(int iParam0) // Position - 0x16058 (90200)
{
	BOOL flag;
	int num;
	var unk;
...
void func_115(int iParam0) // Position - 0x16508 (91400)
{
	BOOL flag;
	int num;
	var unk;
...
void func_116(int iParam0) // Position - 0x16763 (92003)
{
	BOOL flag;
	int num;
	var unk;
...
void func_117(int iParam0) // Position - 0x16A23 (92707)
{
	BOOL flag;
	int num;
	var unk;
...
void func_118(int iParam0) // Position - 0x16BDE (93150)
{
	BOOL flag;
	int num;
	var unk;
...
void func_119(int iParam0) // Position - 0x17724 (96036)
{
	BOOL flag;
	int num;
	var unk;
...
void func_120(int iParam0) // Position - 0x18359 (99161)
{
	if (iParam0 < 60)
		func_122(iParam0);
	else
...
void func_121(int iParam0) // Position - 0x1838E (99214)
{
	BOOL flag;
	int num;
	var unk;
...
void func_122(int iParam0) // Position - 0x19121 (102689)
{
	BOOL flag;
	int num;
	var unk;
...
void func_123(int iParam0) // Position - 0x197A3 (104355)
{
	BOOL flag;
	int num;
	var unk;
...
void func_124(int iParam0) // Position - 0x19889 (104585)
{
	BOOL flag;
	int num;
	var unk;
...
void func_125() // Position - 0x19980 (104832)
{
...
int func_126(ePedComponentType epctParam0) // Position - 0x199F8 (104952)
{
	switch (epctParam0)
	{
		case 0:
...
struct<17> func_127(Hash hParam0, int iParam1) // Position - 0x19AA8 (105128)
{
	int i;
	var unk;
	...
	switch (hParam0)
	{
		case joaat("Player_Zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_129(&unk, -99, -99, Global_114931.f_2370.f_539.f_196[0], Global_114931.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("Player_One"):
			switch (iParam1)
			{
				...
				case 2:
					func_129(&unk, -99, -99, Global_114931.f_2370.f_539.f_196[1], Global_114931.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("Player_Two"):
			switch (iParam1)
			{
				...
				case 4:
					func_129(&unk, -99, -99, Global_114931.f_2370.f_539.f_196[2], Global_114931.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_128(var uParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x1B8F0 (112880)
{
	int num;
	Hash outfit;
...
void func_129(var uParam0, int iParam1, int iParam2, ePedComponentType epctParam3, ePedComponentType epctParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1BADA (113370)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
...
void func_130(BOOL bParam0) // Position - 0x1BB4B (113483)
{
	Global_114017 = Global_114017 || bParam0;
	return;
}

BOOL func_131(BOOL bParam0) // Position - 0x1BB5E (113502)
{
	return Global_114017 && bParam0 != false;
}

void func_132(int iParam0) // Position - 0x1BB6F (113519)
{
	if (iLocal_94 < 5)
	{
		if (iParam0 != 263)
...
BOOL func_133() // Position - 0x1BBB2 (113586)
{
	if (func_171(6) || func_171(7))
		return true;
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x1BBD2 (113618)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1BC0F (113679)
{
...
Hash func_136(eCharacter echParam0) // Position - 0x1BC34 (113716)
{
	return Global_2339[echParam0 /*29*/];
}

BOOL func_137(eCharacter echParam0) // Position - 0x1BC43 (113731)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

BOOL func_138(int iParam0, BOOL bParam1) // Position - 0x1BC4F (113743)
{
	int num;
...
int func_139(int iParam0) // Position - 0x1BD07 (113927)
{
	int i;
...
void func_140(var uParam0) // Position - 0x1BD42 (113986)
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x1BD99 (114073)
{
	int i;
...
BOOL func_142(var uParam0) // Position - 0x1BEC4 (114372)
{
	return true;
}

Vector3 func_143(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6) // Position - 0x1BECD (114381)
{
	return ({ 1f - fParam6, 1f - fParam6, 1f - fParam6 } * uParam0) + ({ fParam6, fParam6, fParam6 } * uParam3);
}

BOOL func_144() // Position - 0x1BEE8 (114408)
{
	return Global_77359;
}

BOOL func_145(int iParam0) // Position - 0x1BEF4 (114420)
{
	if (iParam0 == 1)
...
BOOL func_146(int iParam0, int iParam1) // Position - 0x1BF4B (114507)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_147() // Position - 0x1BF83 (114563)
{
	return MISC::GET_GAME_TIMER() <= Global_24546.f_6481 + 100;
}

BOOL func_148() // Position - 0x1BF98 (114584)
{
...
BOOL func_149(BOOL bParam0) // Position - 0x1BFB2 (114610)
{
	if (bParam0)
...
BOOL func_150() // Position - 0x1BFDB (114651)
{
	if (func_171(6) || func_171(7))
	{
...
int func_151(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1C0AA (114858)
{
	float num;
	float num2;
	int num3;
	...
	for (i = 0; i < 10; i = i + 1)
	{
		num2 = BUILTIN::VDIST2(vParam0, func_152(i));
...
Vector3 func_152(int iParam0) // Position - 0x1C0EE (114926)
{
	int num;
...
Vector3 func_153(int iParam0, int iParam1) // Position - 0x1C1CC (115148)
{
	int num;
...
void func_154(var uParam0, int iParam1) // Position - 0x1C20A (115210)
{
	func_155(uParam0, iParam1);
	return;
}

void func_155(var uParam0, int iParam1) // Position - 0x1C21A (115226)
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_156() // Position - 0x1C22B (115243)
{
	int weaponHash;
	BOOL flag;
...
BOOL func_157(int iParam0) // Position - 0x1C335 (115509)
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113978 || Global_33795 || func_163() || func_146(8, -1) || func_162() || func_161() || func_160() || func_148() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || Global_33795 || func_163() || func_146(8, -1) || func_160() || func_162() || func_161() || func_148() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113978 || Global_33795 || func_163() || func_146(8, -1) || func_160() || func_162() || func_161() || func_148() || Global_114931.f_7695.f_919[character] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_164() || Global_113978 || Global_33795 || func_163() || func_146(8, -1) || func_162() || func_161() || func_148() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_164() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_146(8, -1) || func_148() || func_159() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
					...
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_164() || func_161() || Global_113978 || Global_33795 || func_163() || Global_46111 || func_146(8, -1) || func_160() || func_159() || func_148() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
...
BOOL func_158() // Position - 0x1CA52 (117330)
{
	return Global_102493.f_1;
}

BOOL func_159() // Position - 0x1CA60 (117344)
{
	if (Global_99351 != -1)
...
BOOL func_160() // Position - 0x1CA83 (117379)
{
	if (Global_80566)
		return true;
...
BOOL func_161() // Position - 0x1CAAD (117421)
{
	return Global_102506.f_418 > 0;
}

BOOL func_162() // Position - 0x1CABE (117438)
{
	return Global_102506.f_417 > 0;
}

BOOL func_163() // Position - 0x1CACF (117455)
{
	return Global_1575092;
}

BOOL func_164() // Position - 0x1CADB (117467)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1CAF7 (117495)
{
	func_166();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_166() // Position - 0x1CB10 (117520)
{
	eCharacter character;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_137(character) && !func_171(14) || Global_113879)
			{
...
BOOL func_167() // Position - 0x1CC0D (117773)
{
...
Ped func_168() // Position - 0x1CC27 (117799)
{
	return Global_98261;
}

BOOL func_169(int iParam0) // Position - 0x1CC33 (117811)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_170(int iParam0) // Position - 0x1CCA5 (117925)
{
	int num;
...
BOOL func_171(int iParam0) // Position - 0x1CCE1 (117985)
{
	return Global_44886 == iParam0;
}

void func_172(var uParam0, int iParam1) // Position - 0x1CCEF (117999)
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_173() // Position - 0x1CD00 (118016)
{
	struct<4> args;
	...
	if (bLocal_127 && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_126 == 1)
		{
			...
			for (i = 0; i < randomIntInRange && i < 3; i = i + 1)
			{
				...
				{
					args = unk4[i];
					BUILTIN::START_NEW_SCRIPT_WITH_ARGS("tennis_ambient", &args, 4, MULTIPLAYER_MISSION);
				}
			}
		}
	}
...
int func_174(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1CDA6 (118182)
{
	BOOL flag;
	int i;
	int j;
...
BOOL func_175() // Position - 0x1CE19 (118297)
{
	if (bLocal_127)
		if (iLocal_126 == 1)
...
void func_176() // Position - 0x1CE38 (118328)
{
	if (bLocal_127)
		if (iLocal_126 == 1)
...
void func_177(int iParam0) // Position - 0x1CE53 (118355)
{
	iLocal_94 = iParam0;
	return;
}

void func_178(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1CE5F (118367)
{
	int num;
	BOOL flag;
...
BOOL func_179() // Position - 0x1CF5F (118623)
{
...
BOOL func_180() // Position - 0x1CF7C (118652)
{
	if (Global_99351 != -1)
...
BOOL func_181(int iParam0, int iParam1) // Position - 0x1CF9F (118687)
{
	BOOL flag;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x1CFE9 (118761)
{
	return func_183(iParam0, Global_44886);
}

BOOL func_183(int iParam0, int iParam1) // Position - 0x1CFFA (118778)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_184(int iParam0, int iParam1) // Position - 0x1D1DB (119259)
{
	return iParam0 && iParam1 != false;
}

void func_185() // Position - 0x1D1EA (119274)
{
	eCharacter character;
	int clockHours;
...
BOOL func_186() // Position - 0x1D624 (120356)
{
	if (func_42(20))
		return true;
...
BOOL func_187(eCharacter echParam0) // Position - 0x1D63A (120378)
{
...
int func_188(var uParam0, var uParam1, var uParam2) // Position - 0x1D688 (120456)
{
	return func_189(func_151(uParam0));
}

int func_189(int iParam0) // Position - 0x1D69C (120476)
{
	int num;
...
void func_190(int iParam0, int iParam1) // Position - 0x1D714 (120596)
{
	func_191(iParam0, iParam1);
	return;
}

void func_191(var uParam0, int iParam1) // Position - 0x1D724 (120612)
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_192(BOOL bParam0) // Position - 0x1D739 (120633)
{
	if (bParam0)
		if (iLocal_104 != 263)
...
void func_193() // Position - 0x1D782 (120706)
{
...
void func_194() // Position - 0x1D7BF (120767)
{
	func_4(128);
