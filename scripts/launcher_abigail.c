...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19FE (6654)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28A9 (10409)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2931 (10545)
{
...
int func_83() // Position - 0x776C (30572)
{
...
BOOL func_86(Player plParam0) // Position - 0x77B0 (30640)
{
...
BOOL func_94(Player plParam0) // Position - 0x8668 (34408)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_203(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD92A (55594)
{
...
int func_272(var uParam0, eCharacter echParam1) // Position - 0x104CA (66762)
{
	int num;
