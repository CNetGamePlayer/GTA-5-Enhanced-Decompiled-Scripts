...
BOOL func_96() // Position - 0x2F2F (12079)
{
	return true;
}

float func_97(Ped pedParam0, Ped pedParam1) // Position - 0x2F38 (12088)
{
	return func_85(pedParam0, pedParam1, true);
}

void func_98(int iParam0) // Position - 0x2F49 (12105)
{
	int num;
...
int func_99(int iParam0) // Position - 0x2F7A (12154)
{
	int i;
	int num;
...
int func_100(int iParam0, BOOL bParam1) // Position - 0x2FAB (12203)
{
	if (!func_78(iParam0))
	{
		!bParam1;
...
void func_101(int iParam0, int iParam1) // Position - 0x305E (12382)
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_102(int iParam0, BOOL bParam1) // Position - 0x306F (12399)
{
	if (iParam0 == 1)
		TASK::TASK_PLAY_ANIM(pedLocal_238, &uLocal_322, &uLocal_216, 2f, -2f, -1, 0, 0, false, false, false);
	else
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x30E1 (12513)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_104() // Position - 0x3102 (12546)
{
	func_105();
	return;
}

void func_105() // Position - 0x310E (12558)
{
	PED::SET_PED_PROP_INDEX(pedLocal_238, 1, 0, 0, false, 1);
	return;
}

void func_106() // Position - 0x3121 (12577)
{
...
BOOL func_107() // Position - 0x31C6 (12742)
{
...
BOOL func_108() // Position - 0x31E3 (12771)
{
	if (Global_99351 != -1)
...
BOOL func_109() // Position - 0x3206 (12806)
{
	if (Global_44886 == 15)
		return false;
...
BOOL func_110() // Position - 0x321B (12827)
{
	return true;
}

BOOL func_111(int iParam0) // Position - 0x3224 (12836)
{
	return func_112(Global_114931.f_20124, iParam0);
}

BOOL func_112(int iParam0, int iParam1) // Position - 0x3239 (12857)
{
	return iParam0 && iParam1 != false;
}

int func_113(const char* sParam0) // Position - 0x3248 (12872)
{
...
void func_114(int iParam0) // Position - 0x336F (13167)
{
	var string1;
...
void func_115(Blip* pblParam0) // Position - 0x343E (13374)
{
	if (HUD::DOES_BLIP_EXIST(*pblParam0))
	{
...
struct<6> func_116() // Position - 0x345E (13406)
{
	var unk;
...
void func_117() // Position - 0x3482 (13442)
{
	func_118();
	return;
}

void func_118() // Position - 0x348E (13454)
{
	return;
}

void func_119() // Position - 0x3496 (13462)
{
	if (iLocal_243 == -1)
