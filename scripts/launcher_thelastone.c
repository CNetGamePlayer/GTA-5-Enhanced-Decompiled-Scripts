...
void main() // Position - 0x0 (0)
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114018[num /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_114018[num /*10*/].f_9));
			}
		}
	...
	if (!func_265(&unk63, &num, vector, 1f))
	{
		func_264();
	...
	while (true)
	{
		...
		func_211(num);
		func_204(&iLocal_91, &uLocal_92, &(num.f_9), vector, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_197(&num, vector, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
...
BOOL func_1(var uParam0) // Position - 0x22E (558)
{
...
BOOL func_2(Any* panParam0) // Position - 0x24C (588)
{
	const char* str;
	var unk32;
...
void func_3(int iParam0, const char* sParam1) // Position - 0x30D (781)
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x3C9 (969)
{
	int num;
	int num2;
...
void func_5() // Position - 0x523 (1315)
{
	int i;
...
void func_6(int iParam0) // Position - 0x5D6 (1494)
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0x9BE (2494)
{
	Global_65020 = true;
	Global_65023 = 1;
...
void func_8(int iParam0) // Position - 0xA09 (2569)
{
...
struct<2> func_9(int iParam0) // Position - 0xA3D (2621)
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xA75 (2677)
{
	if (Global_65027)
		return;
...
void func_11() // Position - 0xACB (2763)
{
	int i;
...
void func_12() // Position - 0xAF8 (2808)
{
	int i;
...
void func_13() // Position - 0xB2F (2863)
{
	Global_65186 = 0;
	return;
}

void func_14() // Position - 0xB3B (2875)
{
	Global_65046 = 0;
...
var func_15(Hash hParam0) // Position - 0xB8F (2959)
{
	var outValue;
...
void func_16() // Position - 0xBA3 (2979)
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xBCD (3021)
{
...
void func_19() // Position - 0xC1A (3098)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xC5C (3164)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xC86 (3206)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xC99 (3225)
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xCB6 (3254)
{
...
void func_24() // Position - 0xCFB (3323)
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x198F (6543)
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x2818 (10264)
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x283A (10298)
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x28C2 (10434)
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2902 (10498)
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2930 (10544)
{
...
int func_31(Vehicle veParam0) // Position - 0x2A0C (10764)
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2A4E (10830)
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2AB1 (10929)
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2B3F (11071)
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2B81 (11137)
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2DDD (11741)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2DE9 (11753)
{
	int i;
...
int func_38(int iParam0) // Position - 0x3094 (12436)
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3144 (12612)
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x3337 (13111)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3357 (13143)
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3408 (13320)
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3537 (13623)
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x35A5 (13733)
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x367E (13950)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36BB (14011)
{
...
Hash func_47(eCharacter echParam0) // Position - 0x36E0 (14048)
{
	return Global_2339[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x36EF (14063)
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3889 (14473)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x38B8 (14520)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x38CD (14541)
{
	int num;
	int num2;
...
int func_52() // Position - 0x3901 (14593)
{
	return Global_1574927;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x390D (14605)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3931 (14641)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3946 (14662)
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3E8F (16015)
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x40D1 (16593)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_58() // Position - 0x40EA (16618)
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x41E7 (16871)
{
	return Global_44886 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x41F5 (16885)
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x42E8 (17128)
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x4570 (17776)
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x4611 (17937)
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x4809 (18441)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x558A (21898)
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55C5 (21957)
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x5839 (22585)
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5875 (22645)
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DC4 (24004)
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E08 (24072)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65AF (26031)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x65F6 (26102)
{
...
BOOL func_73(int iParam0) // Position - 0x6651 (26193)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6661 (26209)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x66C1 (26305)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AA5 (27301)
{
	return Global_33792;
}

BOOL func_77(int iParam0) // Position - 0x6AB0 (27312)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AC0 (27328)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B62 (27490)
{
	Vector3 vector;
	var unk3;
...
Vector3 func_80() // Position - 0x73C8 (29640)
{
...
int func_81() // Position - 0x76C3 (30403)
{
	return Global_2652582.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x76D2 (30418)
{
...
BOOL func_83() // Position - 0x76FC (30460)
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7714 (30484)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x7729 (30505)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x7740 (30528)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7798 (30616)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7842 (30786)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x78D7 (30935)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x791B (31003)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7A9F (31391)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7AAD (31405)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8577 (34167)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x85F9 (34297)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8651 (34385)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x865A (34394)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_97(int iParam0, int iParam1) // Position - 0x8972 (35186)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8B02 (35586)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8B12 (35602)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658294[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8B2F (35631)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8B3F (35647)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8EA9 (36521)
{
	return Global_102506.f_417 > 0;
}

var func_103() // Position - 0x8EBA (36538)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8F00 (36608)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8F86 (36742)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8FB9 (36793)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x900A (36874)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x90AC (37036)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x90CE (37070)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x90E5 (37093)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x90F2 (37106)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x912C (37164)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9167 (37223)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x91A3 (37283)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x91BC (37308)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x921F (37407)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x9235 (37429)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x924B (37451)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x928D (37517)
{
...
struct<2> func_120(int iParam0) // Position - 0x92B5 (37557)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x9702 (38658)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xA9DA (43482)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAD20 (44320)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xADC5 (44485)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAE60 (44640)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAE86 (44678)
{
	Global_80560 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAEBE (44734)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAF17 (44823)
{
...
int func_130(Ped pedParam0) // Position - 0xAF9A (44954)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xAFCB (45003)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xAFE0 (45024)
{
	int num;
...
int func_133() // Position - 0xB062 (45154)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB093 (45203)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB0AE (45230)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB0FA (45306)
{
	int i;
...
BOOL func_137(Vehicle veParam0) // Position - 0xB143 (45379)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB163 (45411)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB184 (45444)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB1D7 (45527)
{
...
BOOL func_141(int iParam0) // Position - 0xB254 (45652)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB2A7 (45735)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB39D (45981)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB408 (46088)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB447 (46151)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB596 (46486)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB5B0 (46512)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB609 (46601)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB64A (46666)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB66C (46700)
{
...
BOOL func_151() // Position - 0xB6AB (46763)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB6B9 (46777)
{
	int num;
...
BOOL func_153() // Position - 0xB6EC (46828)
{
...
void func_154(int iParam0) // Position - 0xB713 (46867)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB736 (46902)
{
...
void func_156() // Position - 0xB773 (46963)
{
	Global_21866 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB783 (46979)
{
...
BOOL func_158() // Position - 0xB7DA (47066)
{
...
void func_159() // Position - 0xB7FC (47100)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB811 (47121)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB869 (47209)
{
...
void func_162(Vehicle veParam0) // Position - 0xB8C0 (47296)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB8EC (47340)
{
...
void func_164() // Position - 0xBA3D (47677)
{
...
void func_165(int iParam0) // Position - 0xBA8E (47758)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBAC1 (47809)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBB4B (47947)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBBBF (48063)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_169(int iParam0) // Position - 0xBBCD (48077)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBC24 (48164)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_171(int iParam0) // Position - 0xBC33 (48179)
{
...
BOOL func_172(int iParam0) // Position - 0xBC74 (48244)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBCB9 (48313)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBCEB (48363)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBE22 (48674)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBE71 (48753)
{
	return func_177(iParam0, Global_44886);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBE82 (48770)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_178(int iParam0) // Position - 0xC076 (49270)
{
	if (Global_44886 == 15)
		return false;
...
int func_179() // Position - 0xC098 (49304)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_180(const char* sParam0, int iParam1) // Position - 0xC0A9 (49321)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_181() // Position - 0xC0F2 (49394)
{
	if (Global_102454 == 10 || Global_102454 == 9)
		return true;
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC116 (49430)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_183() // Position - 0xC8F9 (51449)
{
	func_27(&(Global_105490.f_2890), &Global_105490, 0, 1, 1, 0);
	return;
}

BOOL func_184(var uParam0) // Position - 0xC914 (51476)
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xC9A2 (51618)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xCA06 (51718)
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCA9D (51869)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(veParam0))
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(veParam0, false))
...
BOOL func_188(int iParam0) // Position - 0xCAC7 (51911)
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD1E4 (53732)
{
	return Global_102493.f_1;
}

BOOL func_190() // Position - 0xD1F2 (53746)
{
	if (Global_99351 != -1)
...
BOOL func_191() // Position - 0xD215 (53781)
{
...
BOOL func_192() // Position - 0xD22F (53807)
{
	if (Global_80566)
		return true;
...
BOOL func_193() // Position - 0xD259 (53849)
{
	return Global_102506.f_418 > 0;
}

BOOL func_194(int iParam0, int iParam1) // Position - 0xD26A (53866)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD2A2 (53922)
{
	return Global_1575092;
}

BOOL func_196() // Position - 0xD2AE (53934)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_197(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8) // Position - 0xD2CA (53962)
{
	var unk;
	...
	if (func_188(2))
	{
		if (!func_158())
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_203(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
			{
				unk = 16;
		...
		else if (func_198(sParam5))
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
				if (func_203(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
					func_156();
		}
	}
...
BOOL func_198(char* sParam0) // Position - 0xD38C (54156)
{
	var string1;
...
struct<6> func_199() // Position - 0xD3AC (54188)
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD3D0 (54224)
{
...
void func_201(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD40B (54283)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD461 (54369)
{
...
float func_203(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD4FC (54524)
{
...
void func_204(var uParam0, var uParam1, const char* sParam2, var uParam3, var uParam4, var uParam5, float fParam6, float fParam7, float fParam8, float fParam9, float fParam10, float fParam11) // Position - 0xD536 (54582)
{
	float num;
	float num2;
	float num3;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
		{
			...
			{
				if (func_203(PLAYER::PLAYER_PED_ID(), uParam3, true) <= 100f)
					func_207(uParam0, 1);
			}
			else
			{
				...
				{
					num = func_203(PLAYER::PLAYER_PED_ID(), fParam6, true);
					num2 = func_203(PLAYER::PLAYER_PED_ID(), fParam9, true);
					num3 = num - num2;
				...
				if (func_203(PLAYER::PLAYER_PED_ID(), uParam3, true) > 120f)
					func_208(uParam0);
			}
		}
	}
...
void func_205(int iParam0, BOOL bParam1) // Position - 0xD654 (54868)
{
	if (iParam0 == -1)
		return;
...
int func_206(int iParam0) // Position - 0xD690 (54928)
{
	if (Global_80301 == iParam0)
		if (Global_80302 == -1)
...
void func_207(var uParam0, int iParam1) // Position - 0xD6C9 (54985)
{
	BOOL flag;
	int i;
...
void func_208(var uParam0) // Position - 0xD767 (55143)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_209(uParam0);
...
void func_209(var uParam0) // Position - 0xD77E (55166)
{
	BOOL flag;
	int num;
	int i;
...
BOOL func_210() // Position - 0xD866 (55398)
{
	return Global_99738;
}

void func_211(int iParam0) // Position - 0xD872 (55410)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_212(Any* panParam0, BOOL bParam1) // Position - 0xD89A (55450)
{
	var unk;
...
void func_213(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDB0A (56074)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_214(int iParam0) // Position - 0xDE62 (56930)
{
...
BOOL func_215(var uParam0) // Position - 0xDE82 (56962)
{
...
BOOL func_216(var uParam0) // Position - 0xDE9A (56986)
{
...
void func_217(var uParam0) // Position - 0xDEBF (57023)
{
	int i;
	int taskSequenceId;
...
void func_218(Object* pobParam0) // Position - 0xE1C3 (57795)
{
...
void func_219(var uParam0) // Position - 0xE1EE (57838)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE26E (57966)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_221(Ped pedParam0, Vehicle veParam1) // Position - 0xE42C (58412)
{
...
BOOL func_222(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE45C (58460)
{
	int i;
	int num;
...
BOOL func_223(int iParam0) // Position - 0xE718 (59160)
{
...
BOOL func_224(Vehicle veParam0, int iParam1) // Position - 0xE74C (59212)
{
	float xSize;
...
BOOL func_225(Vehicle veParam0, int iParam1) // Position - 0xE7C2 (59330)
{
	return func_226(veParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_226(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE7DA (59354)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_227(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Vehicle veParam6, int iParam7) // Position - 0xE89B (59547)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_228(Ped pedParam0, int iParam1) // Position - 0xE9C7 (59847)
{
...
int func_229() // Position - 0xEA8C (60044)
{
	int i;
...
BOOL func_230(Vehicle veParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xEAD6 (60118)
{
	var unk;
...
float func_231(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEB67 (60263)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_232(float fParam0, var uParam1, var uParam2) // Position - 0xEB88 (60296)
{
	float num;
	float num2;
...
void func_233(var uParam0) // Position - 0xEBC7 (60359)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_234(Vehicle veParam0, Ped pedParam1) // Position - 0xEBE2 (60386)
{
	int i;
...
BOOL func_235(Vehicle veParam0) // Position - 0xEC21 (60449)
{
...
BOOL func_236(Vehicle veParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEC49 (60489)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_237(Vehicle veParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xED44 (60740)
{
	float entityCoords;
	float num;
...
BOOL func_238(Vehicle veParam0, float fParam1) // Position - 0xEE50 (61008)
{
	var outProjectile;
	var outCoords;
...
BOOL func_239(Vehicle veParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xEEE5 (61157)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_240(Vehicle veParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xEF73 (61299)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_241(int iParam0) // Position - 0xEFBB (61371)
{
...
void func_242(Vehicle veParam0) // Position - 0xF005 (61445)
{
	int taskSequenceId;
...
BOOL func_243(int iParam0) // Position - 0xF0A2 (61602)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_244(int iParam0) // Position - 0xF137 (61751)
{
...
BOOL func_245() // Position - 0xF176 (61814)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_246() // Position - 0xF193 (61843)
{
	if (Global_99351 != -1)
...
BOOL func_247(int iParam0) // Position - 0xF1B6 (61878)
{
...
BOOL func_248() // Position - 0xF1EA (61930)
{
...
BOOL func_249(int iParam0) // Position - 0xF228 (61992)
{
	if (func_119(false))
...
BOOL func_250(var uParam0) // Position - 0xF250 (62032)
{
	if (!func_251(uParam0))
		return false;
...
BOOL func_251(var uParam0) // Position - 0xF26F (62063)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_254(&num) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1") || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_PUMPSHOTGUN")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("WEAPON_SNIPERRIFLE")))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_252(&uParam0->f_35[0], num[1], -1303.1628f, 4648.085f, 104.9664f, 293.1504f);
...
void func_252(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF45B (62555)
{
	func_253(pveParam0);
...
void func_253(Vehicle* pveParam0) // Position - 0xF49E (62622)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_254(var uParam0) // Position - 0xF53A (62778)
{
	int i;
...
BOOL func_255(int iParam0) // Position - 0xF56B (62827)
{
	var unk;
	eCharacter character;
...
BOOL func_256(int iParam0) // Position - 0xF5BC (62908)
{
	const char* string2;
...
BOOL func_257(int iParam0) // Position - 0xF675 (63093)
{
	var unk;
...
BOOL func_258(int iParam0) // Position - 0xF736 (63286)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_259(int iParam0, char* sParam1) // Position - 0xF7BB (63419)
{
...
BOOL func_260(int iParam0) // Position - 0xF89D (63645)
{
...
BOOL func_261(int iParam0) // Position - 0xF8C8 (63688)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_262(int iParam0) // Position - 0xF8F3 (63731)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_263(int iParam0) // Position - 0xF91E (63774)
{
	if (func_244(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_264() // Position - 0xF953 (63827)
{
...
BOOL func_265(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0xF96D (63853)
{
	int i;
	...
	else
	{
		...
		{
			if (func_266(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_266(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0xF9D2 (63954)
{
	int num;
	char* str;
	...
	if (func_267(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_267(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0xFA4A (64074)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_268(var uParam0, BOOL bParam1) // Position - 0xFAC5 (64197)
{
	if (bParam1)
	{
...
int func_269(var uParam0) // Position - 0xFB1B (64283)
{
	if (func_216(uParam0))
	{
...
void func_270(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFB51 (64337)
{
...
void func_271(var uParam0, BOOL bParam1) // Position - 0xFB71 (64369)
{
	func_272(&(uParam0->f_41), bParam1);
	return;
}

void func_272(var uParam0, BOOL bParam1) // Position - 0xFB83 (64387)
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_273(&uParam0->[i], false);
	}

	return;
}

void func_273(Object* pobParam0, BOOL bParam1) // Position - 0xFBC1 (64449)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_274(var uParam0, BOOL bParam1) // Position - 0xFBFC (64508)
{
	func_275(&(uParam0->f_35), bParam1);
	return;
}

void func_275(var uParam0, BOOL bParam1) // Position - 0xFC0E (64526)
{
	int i;
...
void func_276(Vehicle* pveParam0) // Position - 0xFC4B (64587)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_277(var uParam0, int iParam1) // Position - 0xFC83 (64643)
{
	func_278(&(uParam0->f_28), iParam1);
	return;
}

void func_278(var uParam0, int iParam1) // Position - 0xFC95 (64661)
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_279(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_279(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0xFCD6 (64726)
{
...
void func_280(Ped* ppedParam0) // Position - 0xFD26 (64806)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_281(int iParam0) // Position - 0xFD67 (64871)
{
	if (*iParam0 == -1)
		return;
...
void func_282(char* sParam0) // Position - 0xFDA4 (64932)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_283(var uParam0) // Position - 0xFDB6 (64950)
{
	*uParam0 = -1;
...
void func_284() // Position - 0xFDE9 (65001)
{
