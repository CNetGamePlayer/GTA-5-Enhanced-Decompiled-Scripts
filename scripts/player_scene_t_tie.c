...
void func_1() // Position - 0xFD (253)
{
	iLocal_70 = 0;
	return;
}

BOOL func_2() // Position - 0x108 (264)
{
	float num;
...
int func_3(var uParam0, var uParam1) // Position - 0x142 (322)
{
	int num;
	int i;
...
BOOL func_4() // Position - 0x1A4 (420)
{
	func_3(&iLocal_71, &uLocal_111);
...
BOOL func_5() // Position - 0x1C2 (450)
{
...
void func_10() // Position - 0x35A (858)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_11(character) && !func_15(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != character && func_11(Global_114931.f_2370.f_539.f_4321))
...
BOOL func_11(eCharacter echParam0) // Position - 0x457 (1111)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x463 (1123)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x4A0 (1184)
{
...
Hash func_14(eCharacter echParam0) // Position - 0x4C5 (1221)
{
	return Global_2339[echParam0 /*29*/];
}

BOOL func_15(int iParam0) // Position - 0x4D4 (1236)
{
	return Global_44886 == iParam0;
}

void func_16() // Position - 0x4E2 (1250)
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_17() // Position - 0x522 (1314)
{
	func_18(Global_102177 - 1);
	return;
}

void func_18(int iParam0) // Position - 0x534 (1332)
{
	Global_102177 = iParam0;
	return;
}

void func_19() // Position - 0x542 (1346)
{
	func_18(0);
	return;
}

void func_20() // Position - 0x54F (1359)
{
	int i;
	int num;
	BOOL flag;
...
Vector3 func_21(float fParam0, float fParam1, float fParam2) // Position - 0x8D7 (2263)
{
	float num;
	float num2;
...
void func_22() // Position - 0x916 (2326)
{
	var unk;
	int num;
	var unk117;
...
void func_24(var uParam0, int iParam1, int iParam2, int iParam3, float fParam4, float fParam5, float fParam6, float fParam7) // Position - 0x408A (16522)
{
...
void func_25(var uParam0) // Position - 0x40B4 (16564)
{
	func_24(uParam0, 145, joaat("SCRIPT_TASK_ANY"), joaat("SCRIPT_TASK_ANY"), 0f, 0f, 0f, 0f);
	return;
}

int func_26(int iParam0, var uParam1, var uParam2, char* sParam3) // Position - 0x40D2 (16594)
{
	int num;
...
BOOL func_27(var uParam0) // Position - 0x42C5 (17093)
{
	int num;
	Vector3 entityCoords;
	float num2;
...
BOOL func_28(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x437D (17277)
{
	if (bParam6)
...
BOOL func_29(int iParam0, var uParam1, char* sParam2) // Position - 0x43C4 (17348)
{
	var unk;
	int num;
	var unk4;
...
BOOL func_30(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x6894 (26772)
{
	switch (iParam1)
	{
		case 0:
...
BOOL _GET_RANDOM_BOOL() // Position - 0x87E4 (34788)
{
...
BOOL func_32(int iParam0, var uParam1, var uParam2) // Position - 0x8802 (34818)
{
	switch (iParam0)
	{
		case 11:
...
char* func_33(int iParam0) // Position - 0x9171 (37233)
{
	switch (iParam0)
	{
...
void func_34() // Position - 0x91FB (37371)
{
	int i;
