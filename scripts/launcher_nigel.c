...
void main() // Position - 0x0 (0)
{
	...
	iLocal_90 = func_333(CHAR_NIGEL);
	iLocal_91 = func_333(63);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114018[num /*10*/].f_9 != -1)
			{
				...
				func_329(&(Global_114018[num /*10*/].f_9));
			}
		}
	
		func_311(&num, &num2, true);
	}

	if (!func_308(&unk124, &num, vector, 1f))
	{
		func_307();
	...
	while (true)
	{
		...
		func_228(num);
		func_221(&iLocal_106, &(num.f_9), vector);
		...
		if (func_218(&uLocal_94) && num == 37)
			func_215(num.f_28[1], &uLocal_94, num);
	
		if (num == 37)
		{
			func_211(&num, vector, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_108);
		}
		else if (num == 42)
		{
			func_206(&num, vector, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (num == 43)
		{
			func_204(&num2, &num.f_35[0], &num.f_28[1]);
			func_206(&num, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
	
		flag = false;
	
		if (num == 41)
			if (func_202(&num, &unk63) || func_201(&num))
				flag = true;
		else if (func_186(&num, 0))
			flag = true;
	
		if (flag)
		{
			if (num == 42)
				func_185(true, false, true, false);
		
			if (func_184(num))
				func_181(num, &blLocal_107);
		
			if (!func_2(&num))
				func_311(&num, &num2, true);
		
			if (func_1(&num))
				func_311(&num, &num2, false);
		}
	}
...
BOOL func_1(var uParam0) // Position - 0x37F (895)
{
...
BOOL func_2(Any* panParam0) // Position - 0x39D (925)
{
	const char* str;
	var unk32;
	...
	if (!func_180())
	{
		while (!func_171(*panParam0))
		{
			...
			if (!func_229(panParam0, *panParam0 != 2))
			{
...
void func_3(int iParam0, const char* sParam1) // Position - 0x45F (1119)
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x51B (1307)
{
	int num;
	int num2;
...
void func_5() // Position - 0x675 (1653)
{
	int i;
...
void func_6(int iParam0) // Position - 0x728 (1832)
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xB10 (2832)
{
	Global_65020 = true;
	Global_65023 = 1;
...
void func_8(int iParam0) // Position - 0xB5B (2907)
{
...
struct<2> func_9(int iParam0) // Position - 0xB8F (2959)
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xBC7 (3015)
{
	if (Global_65027)
		return;
...
void func_11() // Position - 0xC1D (3101)
{
	int i;
...
void func_12() // Position - 0xC4A (3146)
{
	int i;
...
void func_13() // Position - 0xC81 (3201)
{
	Global_65186 = 0;
	return;
}

void func_14() // Position - 0xC8D (3213)
{
	Global_65046 = 0;
...
var func_15(Hash hParam0) // Position - 0xCE1 (3297)
{
	var outValue;
...
void func_16() // Position - 0xCF5 (3317)
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xD1F (3359)
{
...
void func_18() // Position - 0xD33 (3379)
{
	int i;
...
void func_19() // Position - 0xD6C (3436)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xDAE (3502)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xDD8 (3544)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xDEB (3563)
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xE08 (3592)
{
...
void func_24() // Position - 0xE4D (3661)
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1AE1 (6881)
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x296A (10602)
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x298C (10636)
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x2A14 (10772)
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2A54 (10836)
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2A82 (10882)
{
...
int func_31(Vehicle veParam0) // Position - 0x2B5E (11102)
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2BA0 (11168)
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2C03 (11267)
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2C91 (11409)
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2CD3 (11475)
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2F2F (12079)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2F3B (12091)
{
	int i;
...
int func_38(int iParam0) // Position - 0x31E6 (12774)
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3296 (12950)
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x3489 (13449)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x34A9 (13481)
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x355A (13658)
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3689 (13961)
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x36F7 (14071)
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x37D0 (14288)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x380D (14349)
{
...
Hash func_47(eCharacter echParam0) // Position - 0x3832 (14386)
{
	return Global_2339[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3841 (14401)
{
...
int func_49(int iParam0, int iParam1) // Position - 0x39DB (14811)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x3A0A (14858)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x3A1F (14879)
{
	int num;
	int num2;
...
int func_52() // Position - 0x3A53 (14931)
{
	return Global_1574927;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3A5F (14943)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3A83 (14979)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A98 (15000)
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3FE1 (16353)
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4223 (16931)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_58() // Position - 0x423C (16956)
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x4339 (17209)
{
	return Global_44886 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x4347 (17223)
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x443A (17466)
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x46C2 (18114)
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x4763 (18275)
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x495B (18779)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x56DC (22236)
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x5717 (22295)
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x598B (22923)
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x59C7 (22983)
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5F16 (24342)
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F5A (24410)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x6701 (26369)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6748 (26440)
{
...
BOOL func_73(int iParam0) // Position - 0x67A3 (26531)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x67B3 (26547)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x6813 (26643)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6BF7 (27639)
{
	return Global_33792;
}

BOOL func_77(int iParam0) // Position - 0x6C02 (27650)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6C12 (27666)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6CB4 (27828)
{
	Vector3 vector;
	var unk3;
...
Vector3 func_80() // Position - 0x751A (29978)
{
...
int func_81() // Position - 0x7815 (30741)
{
	return Global_2652582.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7824 (30756)
{
...
BOOL func_83() // Position - 0x784E (30798)
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7866 (30822)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x787B (30843)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x7892 (30866)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x78EA (30954)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7994 (31124)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x7A29 (31273)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7A6D (31341)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7BF1 (31729)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7BFF (31743)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x86C9 (34505)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x874B (34635)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x87A3 (34723)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x87AC (34732)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_97(int iParam0, int iParam1) // Position - 0x8AC4 (35524)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8C54 (35924)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8C64 (35940)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658294[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8C81 (35969)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8C91 (35985)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8FFB (36859)
{
	return Global_102506.f_417 > 0;
}

var func_103() // Position - 0x900C (36876)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x9052 (36946)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x90D8 (37080)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x910B (37131)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x915C (37212)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x91FE (37374)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x9220 (37408)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x9237 (37431)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x9244 (37444)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x927E (37502)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x92B9 (37561)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x92F5 (37621)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x930E (37646)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x9371 (37745)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x9387 (37767)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x939D (37789)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x93DF (37855)
{
...
struct<2> func_120(int iParam0) // Position - 0x9407 (37895)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x9854 (38996)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAB2C (43820)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAE72 (44658)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAF17 (44823)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAFB2 (44978)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAFD8 (45016)
{
	Global_80560 != 6;
...
void func_128(Ped pedParam0) // Position - 0xB010 (45072)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xB069 (45161)
{
...
int func_130(Ped pedParam0) // Position - 0xB0EC (45292)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB11D (45341)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB132 (45362)
{
	int num;
...
int func_133() // Position - 0xB1B4 (45492)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB1E5 (45541)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB200 (45568)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB24C (45644)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB295 (45717)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB2B5 (45749)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB2D6 (45782)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB329 (45865)
{
...
BOOL func_141(int iParam0) // Position - 0xB3A6 (45990)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB3F9 (46073)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB4EF (46319)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB55A (46426)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB599 (46489)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB6E8 (46824)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB702 (46850)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB75B (46939)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB79C (47004)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB7BE (47038)
{
...
BOOL func_151() // Position - 0xB7FD (47101)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_152() // Position - 0xB80B (47115)
{
...
void func_153(int iParam0) // Position - 0xB832 (47154)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB855 (47189)
{
...
void func_155() // Position - 0xB892 (47250)
{
	Global_21866 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB8A2 (47266)
{
...
BOOL func_157() // Position - 0xB8F9 (47353)
{
...
void func_158() // Position - 0xB91B (47387)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB930 (47408)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB988 (47496)
{
...
void func_161(Vehicle veParam0) // Position - 0xB9DF (47583)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xBA0B (47627)
{
...
void func_163() // Position - 0xBB5C (47964)
{
...
void func_164(int iParam0) // Position - 0xBBAD (48045)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xBBE0 (48096)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xBC6A (48234)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xBCDE (48350)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_168(int iParam0) // Position - 0xBCEC (48364)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xBD43 (48451)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_170(int iParam0) // Position - 0xBD52 (48466)
{
...
BOOL func_171(int iParam0) // Position - 0xBD93 (48531)
{
	int num;
	...
	num = func_173(&(Global_114018[iParam0 /*10*/].f_9), 1, 4, false, 0);
...
void func_172(int iParam0) // Position - 0xBDD8 (48600)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBE0A (48650)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBF41 (48961)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBF90 (49040)
{
	return func_176(iParam0, Global_44886);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBFA1 (49057)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xC1C4 (49604)
{
	if (Global_44886 == 15)
		return false;
...
int func_178() // Position - 0xC1E6 (49638)
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xC1F7 (49655)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_180() // Position - 0xC240 (49728)
{
	if (Global_102454 == 10 || Global_102454 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xC264 (49764)
{
	switch (iParam0)
	{
		case 0:
...
Blip func_182(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC6D3 (50899)
{
	Blip blip;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC6FF (50943)
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC716 (50966)
{
	switch (iParam0)
	{
		case 0:
...
int func_185(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xC7A5 (51109)
{
	int num;
...
BOOL func_186(var uParam0, int iParam1) // Position - 0xC7D8 (51160)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_187() // Position - 0xCFBB (53179)
{
	func_27(&(Global_105490.f_2890), &Global_105490, 0, 1, 1, 0);
	return;
}

BOOL func_188(var uParam0) // Position - 0xCFD6 (53206)
{
	float num;
...
void func_189(int iParam0, var uParam1) // Position - 0xD064 (53348)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_190(BOOL bParam0) // Position - 0xD0C8 (53448)
{
...
BOOL func_191(Vehicle veParam0) // Position - 0xD15F (53599)
{
...
BOOL func_192(int iParam0) // Position - 0xD189 (53641)
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_200() || Global_113978 || Global_33795 || func_199() || func_198(8, -1) || func_102() || func_197() || func_196() || func_195() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_200() || Global_33795 || func_199() || func_198(8, -1) || func_196() || func_102() || func_197() || func_195() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_200() || Global_113978 || Global_33795 || func_199() || func_198(8, -1) || func_196() || func_102() || func_197() || func_195() || Global_114931.f_7695.f_919[character] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_200() || Global_113978 || Global_33795 || func_199() || func_198(8, -1) || func_102() || func_197() || func_195() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_200() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_198(8, -1) || func_195() || func_194() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_200() || Global_33795 || func_199() || func_198(8, -1) || func_197() || func_196() || func_195() || Global_114931.f_7695.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_200() || func_197() || Global_113978 || Global_33795 || func_199() || Global_46111 || func_198(8, -1) || func_196() || func_194() || func_195() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_200() || Global_113978 || Global_33795 || func_199() || func_198(8, -1) || func_196() || func_194() || func_102() || func_197() || func_195())
							return false;
						break;
				}
			}
...
BOOL func_193() // Position - 0xD8A6 (55462)
{
	return Global_102493.f_1;
}

BOOL func_194() // Position - 0xD8B4 (55476)
{
	if (Global_99351 != -1)
...
BOOL func_195() // Position - 0xD8D7 (55511)
{
...
BOOL func_196() // Position - 0xD8F1 (55537)
{
	if (Global_80566)
		return true;
...
BOOL func_197() // Position - 0xD91B (55579)
{
	return Global_102506.f_418 > 0;
}

BOOL func_198(int iParam0, int iParam1) // Position - 0xD92C (55596)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_199() // Position - 0xD964 (55652)
{
	return Global_1575092;
}

BOOL func_200() // Position - 0xD970 (55664)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
int func_201(var uParam0) // Position - 0xD98C (55692)
{
	int i;
...
int func_202(var uParam0, var uParam1) // Position - 0xDA50 (55888)
{
	if (func_203(uParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true)))
	{
		if (func_192(2))
		{
			if (func_190(uParam0->f_27))
...
BOOL func_203(var uParam0, float fParam1, var uParam2, var uParam3) // Position - 0xDA8D (55949)
{
	BOOL flag;
	int num;
	int num2;
...
void func_204(var uParam0, var uParam1, var uParam2) // Position - 0xDB49 (56137)
{
		...
		switch (*uParam0)
		{
			...
			case 1:
				if (MISC::GET_GAME_TIMER() - uParam0->f_2 > uParam0->f_3)
				{
					...
					AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_205(0), false);
...
char* func_205(int iParam0) // Position - 0xDCB4 (56500)
{
	char* str;
...
int func_206(var uParam0, float fParam1, float fParam2, float fParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, int iParam9) // Position - 0xDEA9 (57001)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_157() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_210(PLAYER::PLAYER_PED_ID(), fParam1, true) < iParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF31 (57137)
{
...
void func_208(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF6C (57196)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDFC2 (57282)
{
...
float func_210(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xE05D (57437)
{
...
int func_211(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10) // Position - 0xE097 (57495)
{
	var unk;
	...
	if (!(*uParam10 == 3))
	{
		if (func_192(2))
		{
			if (!func_157())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[1]) && func_210(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
				{
			...
			else if (func_213(sParam5) && !(*uParam10 == 1) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && func_210(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 20f)
			{
			...
			if (func_210(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f && *uParam10 == 1)
			{
...
void func_212(int iParam0) // Position - 0xE1E2 (57826)
{
	Global_24011 = iParam0;
	return;
}

BOOL func_213(char* sParam0) // Position - 0xE1EF (57839)
{
	var string1;
...
struct<6> func_214() // Position - 0xE20F (57871)
{
	var unk;
...
void func_215(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE233 (57907)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_216(int iParam0) // Position - 0xE58B (58763)
{
...
BOOL func_217(var uParam0) // Position - 0xE5AB (58795)
{
...
BOOL func_218(var uParam0) // Position - 0xE5C3 (58819)
{
...
Hash func_219() // Position - 0xE5E8 (58856)
{
	return joaat("U_M_M_Aldinapoli");
}

char* func_220() // Position - 0xE5F5 (58869)
{
	return "Al_DiNapoli";
}

void func_221(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE601 (58881)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_210(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_224(uParam0, 1);
			}
			else
			{
				...
				if (func_210(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_226(uParam0);
			}
		}
	}
...
void func_222(int iParam0, BOOL bParam1) // Position - 0xE6F2 (59122)
{
	if (iParam0 == -1)
		return;
...
int func_223(int iParam0) // Position - 0xE72E (59182)
{
	if (Global_80301 == iParam0)
		if (Global_80302 == -1)
...
void func_224(var uParam0, int iParam1) // Position - 0xE767 (59239)
{
	BOOL flag;
	int i;
...
BOOL func_225() // Position - 0xE805 (59397)
{
	return Global_99738;
}

void func_226(var uParam0) // Position - 0xE811 (59409)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_227(uParam0);
...
void func_227(var uParam0) // Position - 0xE828 (59432)
{
	BOOL flag;
	int num;
	int i;
...
void func_228(int iParam0) // Position - 0xE910 (59664)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_229(Any* panParam0, BOOL bParam1) // Position - 0xE938 (59704)
{
	var unk;
	...
	if (func_262(*panParam0) || func_260(*panParam0) || Global_80551 == true)
		return true;
...
void func_230(var uParam0) // Position - 0xEBA8 (60328)
{
	int i;
	int taskSequenceId;
...
void func_231(Object* pobParam0) // Position - 0xEEAC (61100)
{
...
void func_232(var uParam0) // Position - 0xEED7 (61143)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEF57 (61271)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_234(Ped pedParam0, Vehicle veParam1) // Position - 0xF115 (61717)
{
...
BOOL func_235(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF145 (61765)
{
	int i;
	int num;
...
BOOL func_236(int iParam0) // Position - 0xF401 (62465)
{
...
BOOL func_237(Ped pedParam0, int iParam1) // Position - 0xF435 (62517)
{
	float xSize;
...
BOOL func_238(Ped pedParam0, int iParam1) // Position - 0xF4AB (62635)
{
	return func_239(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_239(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF4C3 (62659)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
	...
	flag = func_240(&iLocal_47[num /*4*/], pedBoneCoords, pedParam1, &(iLocal_47[num /*4*/].f_3), pedParam0, iParam5);
	return flag || MISC::GET_GAME_TIMER() - iLocal_47[num /*4*/].f_3 < iParam4;
}

BOOL func_240(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF584 (62852)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_241(Ped pedParam0, int iParam1) // Position - 0xF6B0 (63152)
{
...
int func_242() // Position - 0xF775 (63349)
{
	int i;
...
BOOL func_243(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF7BF (63423)
{
	var unk;
...
float func_244(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF850 (63568)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_245(float fParam0, var uParam1, var uParam2) // Position - 0xF871 (63601)
{
	float num;
	float num2;
...
void func_246(var uParam0) // Position - 0xF8B0 (63664)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_247(Ped pedParam0, Ped pedParam1) // Position - 0xF8CB (63691)
{
	int i;
...
BOOL func_248(Ped pedParam0) // Position - 0xF90A (63754)
{
...
BOOL func_249(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF932 (63794)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_250(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFA2D (64045)
{
	float entityCoords;
	float num;
...
BOOL func_251(Ped pedParam0, float fParam1) // Position - 0xFB39 (64313)
{
	var outProjectile;
	var outCoords;
...
BOOL func_252(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFBCE (64462)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_253(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFC5C (64604)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_254(int iParam0) // Position - 0xFCA4 (64676)
{
...
void func_255(Ped pedParam0) // Position - 0xFCEE (64750)
{
	int taskSequenceId;
...
BOOL func_256(int iParam0) // Position - 0xFD8B (64907)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_257(int iParam0) // Position - 0xFE20 (65056)
{
...
BOOL func_258() // Position - 0xFE5F (65119)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_259() // Position - 0xFE7C (65148)
{
	if (Global_99351 != -1)
...
BOOL func_260(int iParam0) // Position - 0xFE9F (65183)
{
...
BOOL func_261() // Position - 0xFED3 (65235)
{
...
BOOL func_262(int iParam0) // Position - 0xFF11 (65297)
{
	if (func_119(false))
...
BOOL func_263(var uParam0, var uParam1) // Position - 0xFF39 (65337)
{
	switch (*uParam0)
	{
		case 37:
...
BOOL func_264(var uParam0) // Position - 0xFFF5 (65525)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_272(&num) || !func_271(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_268(&uParam0->f_28[0], CHAR_NIGEL, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_266(&uParam0->f_35[0], hLocal_93, -39.9688f, -1285.9615f, 28.3505f, 181.02f);
...
BOOL func_265(var uParam0, var uParam1) // Position - 0x101DD (66013)
{
...
void func_266(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x102B2 (66226)
{
	func_267(pveParam0);
...
void func_267(Vehicle* pveParam0) // Position - 0x102F5 (66293)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_268(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10391 (66449)
{
...
BOOL func_269(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x103ED (66541)
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_333(echParam1);
...
int func_270(Ped pedParam0, eCharacter echParam1) // Position - 0x1047B (66683)
{
	int num;
...
BOOL func_271(var uParam0) // Position - 0x104C1 (66753)
{
	if (func_218(uParam0))
	{
...
BOOL func_272(var uParam0) // Position - 0x104EB (66795)
{
	int i;
...
void func_273(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x1051C (66844)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_274(var uParam0) // Position - 0x10558 (66904)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_268(&uParam0->f_28[0], CHAR_NIGEL, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_266(&uParam0->f_35[0], hLocal_93, -1304.01f, -644.58f, 25.91f, 127.67f);
			...
			{
				func_266(&uParam0->f_35[1], num[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
...
void func_275(int iParam0, BOOL bParam1) // Position - 0x10773 (67443)
{
	switch (iParam0)
	{
		case 37:
...
void func_276(BOOL bParam0) // Position - 0x10B8D (68493)
{
	Vector3 vector;
	Vector3 vector2;
	Vector3 vector3;
...
BOOL func_279(var uParam0, var uParam1) // Position - 0x10C77 (68727)
{
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_272(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict))
				return false;
...
void func_280(var uParam0) // Position - 0x1126B (70251)
{
	int i;
	float num;
...
void func_281(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0x1130B (70411)
{
	uParam0->f_51 == 0;
	uParam0->f_46 >= 15;
...
void func_282(var uParam0) // Position - 0x1133C (70460)
{
	uParam0->f_51;
	uParam0->f_46 = 0;
...
BOOL func_283(var uParam0) // Position - 0x11363 (70499)
{
	int num;
	int i;
	char* animDict;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_272(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(animDict))
				return false;
...
BOOL func_284(var uParam0) // Position - 0x11691 (71313)
{
	int num;
	int i;
	char* animDict;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_266(&uParam0->f_35[0], num[3], -1010.97f, 359.91f, 70.65f, 331.46f);
		...
		case 3:
			...
			func_266(&uParam0->f_35[1], num[4], -1018.26f, 357.76f, 70.2f, 339.52f);
		
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_35[1]))
				VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[1], 27, 27);
		
			func_286(&uParam0->f_28[0], num[0], -1054.7f, 355.94f, 68.35f, 23.67f, PED_TYPE_MISSION);
			...
			func_286(&uParam0->f_28[1], num[1], -1058.43f, 362.78f, 69.86f, 130.45f, PED_TYPE_MISSION);
			...
			func_286(&uParam0->f_28[2], num[2], -1012.57f, 357.48f, 70.62f, -28.55f, PED_TYPE_MISSION);
			...
			func_285(&uParam0->f_41[0], num[5], -1050.03f, 368.95f, 69.29f, -11.27f);
...
void func_285(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x11BF5 (72693)
{
	func_231(pobParam0);
...
void func_286(Ped* ppedParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5, ePedType eptParam6) // Position - 0x11C1C (72732)
{
	func_287(ppedParam0);
...
void func_287(Ped* ppedParam0) // Position - 0x11C3D (72765)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_288(var uParam0) // Position - 0x11C7E (72830)
{
	int num;
	int i;
	Interior interiorAtCoordsWithType;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_272(&num) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48))
				return false;
		...
		case 2:
			func_286(&uParam0->f_28[0], num[0], -552.66f, 287.75f, 82.18f, 123.75f, PED_TYPE_MISSION);
			func_286(&uParam0->f_28[1], num[1], -553.46f, 287.34f, 82.18f, -65.86f, PED_TYPE_MISSION);
			...
			func_286(&uParam0->f_28[2], num[2], -559.94f, 285.99f, 85.38f, -59.06f, PED_TYPE_MISSION);
			func_286(&uParam0->f_28[3], num[3], -558.87f, 289.79f, 85.38f, 162.44f, PED_TYPE_MISSION);
			func_286(&uParam0->f_28[4], num[4], -559f, 286.09f, 85.38f, 65.92f, PED_TYPE_MISSION);
			func_286(&uParam0->f_28[5], num[5], -558.84f, 288.97f, 85.38f, -7.72f, PED_TYPE_MISSION);
			...
			func_266(&uParam0->f_35[0], num[6], -553.55f, 308.61f, 82.81f, 202.78f);
...
void func_289(int iParam0, BOOL bParam1) // Position - 0x121CC (74188)
{
	char* string2;
	Interior interior;
	...
	string2 = "NULL";
	interior = 0;
	string2 = func_293(iParam0, &interior);
...
BOOL func_290(int iParam0) // Position - 0x12293 (74387)
{
	int num;
...
struct<2> func_291(int iParam0) // Position - 0x122C4 (74436)
{
	int num;
...
void func_292(int iParam0, BOOL bParam1) // Position - 0x122F1 (74481)
{
	int offset;

	offset = { func_291(iParam0) };
...
char* func_293(int iParam0, var uParam1) // Position - 0x12334 (74548)
{
	Vector3 vector;

	vector = { func_294(iParam0) };
	*uParam1 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(vector, vector.f_3);
	return vector.f_4;
}

struct<5> func_294(int iParam0) // Position - 0x12359 (74585)
{
	var unk;
	var unk6;
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			unk.f_3 = func_295(&Global_4718592.f_238097[0 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 244:
			unk = { Global_4718592.f_238097[1 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_238097[1 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 245:
			unk = { Global_4718592.f_238097[2 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_238097[2 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 246:
			unk = { Global_4718592.f_238097[3 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_238097[3 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
	
		case 247:
			unk = { Global_4718592.f_238097[4 /*160*/].f_16 };
			unk.f_3 = func_295(&Global_4718592.f_238097[4 /*160*/]);
			unk.f_4 = unk.f_3;
			break;
...
char* func_295(char* sParam0) // Position - 0x15018 (86040)
{
	return sParam0;
}

struct<6> func_296(int iParam0, BOOL bParam1) // Position - 0x15022 (86050)
{
	var unk;
...
BOOL func_297(var uParam0) // Position - 0x15BD8 (89048)
{
	int num;
	int i;
	int num2;
	...
	switch (iLocal_89)
	{
		case 0:
			...
			func_273(&uLocal_94, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_89 = 1;
			break;
		...
		case 2:
			...
			if (!func_268(&uParam0->f_28[0], CHAR_NIGEL, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
				flag = false;
		
			if (!func_268(&uParam0->f_28[1], CHAR_MRS_THORNHILL, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
				flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_266(&uParam0->f_35[0], hLocal_93, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
...
BOOL func_298(int iParam0) // Position - 0x15E79 (89721)
{
	var unk;
	eCharacter character;
...
BOOL func_299(int iParam0) // Position - 0x15ECA (89802)
{
	const char* string2;
...
BOOL func_300(int iParam0) // Position - 0x15F83 (89987)
{
	var unk;
...
BOOL func_301(int iParam0) // Position - 0x16044 (90180)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_302(int iParam0, char* sParam1) // Position - 0x160C9 (90313)
{
...
BOOL func_303(int iParam0) // Position - 0x161AB (90539)
{
...
BOOL func_304(int iParam0) // Position - 0x161D6 (90582)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_305(int iParam0) // Position - 0x16201 (90625)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_306(int iParam0) // Position - 0x1622C (90668)
{
	if (func_257(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_307() // Position - 0x16261 (90721)
{
...
BOOL func_308(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1627B (90747)
{
	int i;
	...
	else
	{
		...
		{
			if (func_309(uParam0->[i], uParam2, fParam5, uParam1))
			{
				i = *uParam0;
				return true;
			}
...
BOOL func_309(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x162E0 (90848)
{
	int num;
	char* str;
	...
	if (func_310(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_310(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x16358 (90968)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_311(var uParam0, var uParam1, BOOL bParam2) // Position - 0x163D3 (91091)
{
	char* str;
...
void func_312(char* sParam0) // Position - 0x164BD (91325)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_213(sParam0))
			func_313();
...
void func_313() // Position - 0x164DC (91356)
{
	Global_21866 = 0;
	func_314();
	return;
...
void func_314() // Position - 0x164EC (91372)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
int func_315(var uParam0) // Position - 0x1650D (91405)
{
	if (func_218(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_316(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x16543 (91459)
{
...
void func_317(var uParam0, BOOL bParam1) // Position - 0x16563 (91491)
{
	func_318(&(uParam0->f_41), bParam1);
	return;
}

void func_318(var uParam0, BOOL bParam1) // Position - 0x16575 (91509)
{
	int i;
...
void func_319(Object* pobParam0, BOOL bParam1) // Position - 0x165B3 (91571)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_320(var uParam0, BOOL bParam1) // Position - 0x165EE (91630)
{
	func_321(&(uParam0->f_35), bParam1);
	return;
}

void func_321(var uParam0, BOOL bParam1) // Position - 0x16600 (91648)
{
	int i;
...
void func_322(Vehicle* pveParam0) // Position - 0x1663D (91709)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_323(var uParam0, int iParam1) // Position - 0x16675 (91765)
{
	func_324(&(uParam0->f_28), iParam1);
	return;
}

void func_324(var uParam0, int iParam1) // Position - 0x16687 (91783)
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_325(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_325(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x166C8 (91848)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_326(var uParam0) // Position - 0x16718 (91928)
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_137(uParam0->f_28[1]))
		{
			if (func_327(uParam0->f_28[1], SCRIPT_TASK_SYNCHRONIZED_SCENE))
...
BOOL func_327(Ped pedParam0, eScriptTaskHash esthParam1) // Position - 0x16769 (92009)
{
...
void func_328(var uParam0) // Position - 0x1679C (92060)
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_137(uParam0->f_28[0]))
		{
			if (func_327(uParam0->f_28[0], SCRIPT_TASK_SYNCHRONIZED_SCENE))
...
void func_329(int iParam0) // Position - 0x1682B (92203)
{
	if (*iParam0 == -1)
		return;
...
void func_330(char* sParam0) // Position - 0x16868 (92264)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_331(var uParam0) // Position - 0x1687A (92282)
{
	*uParam0 = -1;
...
void func_332() // Position - 0x168AD (92333)
{
...
Hash func_333(eCharacter echParam0) // Position - 0x168C7 (92359)
{
	if (!func_36(echParam0))
