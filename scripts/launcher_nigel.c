...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1AE1 (6881)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x298C (10636)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2A14 (10772)
{
...
int func_83() // Position - 0x784E (30798)
{
...
BOOL func_86(Player plParam0) // Position - 0x7892 (30866)
{
...
BOOL func_94(Player plParam0) // Position - 0x874B (34635)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_208(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xDF6C (57196)
{
...
int func_270(var uParam0, eCharacter echParam1) // Position - 0x1047B (66683)
{
	int num;
...
var func_295(var uParam0) // Position - 0x15018 (86040)
{
	return uParam0;
}
