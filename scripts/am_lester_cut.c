...
void main() // Position - 0x0 (0)
{
	...
	fLocal_63 = 0f;
	bLocal_446 = true;
	sLocal_448 = "MP_INTRO_MCS_13";
	func_346(uScriptParam_0);
	...
	while (true)
	{
		...
		func_329(&Global_1935442);
	
		switch (func_328(NETWORK::PARTICIPANT_ID_TO_INT()))
		{
			case 0:
				if (func_327() == 2)
					uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 2;
				else if (func_327() == 6)
					uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 5;
				break;
			...
			case 2:
				if (func_327() == 2)
				{
					...
					else if (HUD::DOES_BLIP_EXIST(Global_1935442))
					{
						func_12();
						HUD::SET_BLIP_ROUTE(Global_1935442, false);
						HUD::REMOVE_BLIP(&Global_1935442);
					
						if (IS_BIT_SET(iLocal_447, 3))
							CUTSCENE::REMOVE_CUTSCENE();
					
						MISC::SET_BIT(&(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
					}
				
					if (func_8(PLAYER::PLAYER_ID()))
					{
						uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 3;
			...
			case 5:
				func_6(&(iLocal_98.f_3));
			
				if (func_5(&(iLocal_98.f_3)))
					uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/] = 6;
				break;
...
BOOL func_1() // Position - 0x208 (520)
{
...
void func_2() // Position - 0x21E (542)
{
	NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT();
	return;
}

void func_3() // Position - 0x22D (557)
{
	Player player;
	Player playerIndex;
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		if (plLocal_177 == 0)
		{
			MISC::CLEAR_BIT(&iLocal_447, 0);
			MISC::SET_BIT(&iLocal_447, 1);
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(player))
		{
			...
			if (!IS_BIT_SET(uLocal_178[plLocal_177 /*3*/].f_2, 0))
				MISC::CLEAR_BIT(&iLocal_447, 1);
		
			if (_NETWORK_IS_PLAYER_VALID(playerIndex, false, true))
			{
				if (IS_BIT_SET(uLocal_178[plLocal_177 /*3*/].f_2, 1))
				{
					MISC::SET_BIT(&iLocal_447, 12);
				
					if (iLocal_98.f_2 == -1)
						if (iLocal_98.f_2 != plLocal_177)
							iLocal_98.f_2 = plLocal_177;
				}
				else if (iLocal_98.f_2 == plLocal_177)
				{
					iLocal_98.f_2 = -1;
				}
			}
		...
		plLocal_177 = plLocal_177 + 1;
	
		if (plLocal_177 == 32)
		{
			if (IS_BIT_SET(iLocal_447, 1))
				MISC::SET_BIT(&(iLocal_98.f_1), 0);
		
			if (!IS_BIT_SET(iLocal_447, 12))
				if (iLocal_98.f_2 != -1)
					iLocal_98.f_2 = -1;
		
			MISC::SET_BIT(&iLocal_447, 0);
			plLocal_177 = 0;
		}
	}
...
BOOL _NETWORK_IS_PLAYER_VALID(Player player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x323 (803)
{
	Player player;
...
BOOL func_5(var uParam0) // Position - 0x383 (899)
{
	if (uParam0->f_1)
...
void func_6(var uParam0) // Position - 0x3AC (940)
{
	if (!uParam0->f_1)
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
...
void func_7(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x3CB (971)
{
	if (uParam0->f_1 == 0)
	{
...
BOOL func_8(Player plParam0) // Position - 0x410 (1040)
{
	if (func_11(plParam0))
		return true;
...
BOOL func_9(Player plParam0) // Position - 0x433 (1075)
{
	Player player;
...
BOOL func_10(Player plParam0, int iParam1) // Position - 0x451 (1105)
{
	return IS_BIT_SET(Global_1892798[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_11(Player plParam0) // Position - 0x469 (1129)
{
	Player player;
...
void func_12() // Position - 0x48C (1164)
{
	if (!func_18())
		return;
...
void func_13() // Position - 0x4B9 (1209)
{
	func_15();
	func_14(false);
	return;
...
void func_14(BOOL bParam0) // Position - 0x4CA (1226)
{
	BOOL flag;
...
void func_15() // Position - 0x55C (1372)
{
	!func_17();
...
void func_16() // Position - 0x585 (1413)
{
...
BOOL func_17() // Position - 0x7F7 (2039)
{
	if (!func_18())
		return false;
...
BOOL func_18() // Position - 0x81D (2077)
{
...
void func_19() // Position - 0x833 (2099)
{
	int address;

	switch (uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1)
	{
		case 0:
			if (!IS_BIT_SET(iLocal_447, 2))
				if (!IS_BIT_SET(iLocal_447, 5))
					if (!func_325())
						if (!func_324())
							if (!func_322())
								if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
									if (!func_321(0))
										if (!func_318(PLAYER::PLAYER_ID(), true, false))
											if (!func_317())
												func_316() == 0;
		
			if (!IS_BIT_SET(iLocal_447, 5))
			{
				if (func_318(PLAYER::PLAYER_ID(), true, false) || func_317() || func_316() > 0 || func_315() || func_310() || func_309() || func_279(false) || func_278(PLAYER::PLAYER_ID(), 21) || func_278(PLAYER::PLAYER_ID(), 25))
				{
					MISC::SET_BIT(&iLocal_447, 5);
					func_12();
				
					if (HUD::DOES_BLIP_EXIST(Global_1935442))
					{
						HUD::SET_BLIP_ROUTE(Global_1935442, false);
						HUD::REMOVE_BLIP(&Global_1935442);
					}
				...
				else
				{
					if (HUD::DOES_BLIP_EXIST(Global_1935442))
					{
						if (!IS_BIT_SET(iLocal_447, 14))
						{
							if (iLocal_98.f_2 != -1)
							{
								if (iLocal_98.f_2 != NETWORK::PARTICIPANT_ID_TO_INT())
								{
									HUD::SET_BLIP_COLOUR(Global_1935442, 39);
									HUD::SET_BLIP_SCALE(Global_1935442, 0.7f);
									MISC::SET_BIT(&iLocal_447, 14);
								}
							}
						}
						else if (iLocal_98.f_2 == -1 || iLocal_98.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
						{
							HUD::SET_BLIP_COLOUR(Global_1935442, 0);
							HUD::SET_BLIP_SCALE(Global_1935442, 1f);
							MISC::CLEAR_BIT(&iLocal_447, 14);
						}
					}
				
					if (IS_BIT_SET(iLocal_447, 8))
						MISC::CLEAR_BIT(&iLocal_447, 8);
				
					if (func_277())
					{
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
						{
							if (bLocal_445 && CUTSCENE::HAS_CUTSCENE_LOADED() || !bLocal_445)
							{
								if (!IS_BIT_SET(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
									MISC::SET_BIT(&(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
								...
								if (IS_BIT_SET(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
								{
									if (iLocal_98.f_2 == NETWORK::PARTICIPANT_ID_TO_INT())
									{
										...
										MISC::SET_BIT(&iLocal_447, 25);
										MISC::CLEAR_AREA(1274.854f, -1721.1538f, 53.6808f, 2f, true, false, false, true);
									
										if (bLocal_446)
										{
											func_273();
											iLocal_455 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("SECURITY_CAM");
										}
									
										uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 1;
									}
									else if (iLocal_98.f_2 != -1)
									{
										if (!IS_BIT_SET(iLocal_447, 13))
										{
											if (func_267(true, true, true, true))
											{
					...
					{
						if (!IS_BIT_SET(iLocal_447, 9))
						{
							if (func_267(false, true, true, true))
							{
								if (!func_315())
								{
									...
									if (!HUD::DOES_BLIP_EXIST(Global_1935442))
									{
										Global_1935442 = HUD::ADD_BLIP_FOR_COORD(Global_1935443);
										HUD::SET_BLIP_SPRITE(Global_1935442, BLIP_LESTER_FAMILY);
										HUD::SET_BLIP_FLASHES(Global_1935442, true);
										HUD::SET_BLIP_FLASH_TIMER(Global_1935442, 7000);
									}
								
									MISC::SET_BIT(&iLocal_447, 2);
									MISC::SET_BIT(&iLocal_447, 9);
								}
							}
						}
					
						if (IS_BIT_SET(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 1))
							MISC::CLEAR_BIT(&(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 1);
					
						if (IS_BIT_SET(iLocal_447, 13))
							MISC::CLEAR_BIT(&iLocal_447, 13);
					}
				}
			}
			else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				if (PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
				{
					...
					{
						if (!func_318(PLAYER::PLAYER_ID(), true, false) && !func_317() && func_316() == 0 && !func_315() && !func_310() && !func_279(false) && !func_278(PLAYER::PLAYER_ID(), 21) && !func_278(PLAYER::PLAYER_ID(), 25))
						{
							if (!_STOPWATCH_IS_INITIALIZED(&uLocal_450))
							{
								func_7(&uLocal_450, false, false);
							}
							else if (func_263(&uLocal_450, 10, false))
							{
								MISC::CLEAR_BIT(&iLocal_447, 5);
								MISC::CLEAR_BIT(&iLocal_447, 2);
								MISC::CLEAR_BIT(&iLocal_447, 3);
								MISC::CLEAR_BIT(&iLocal_447, 8);
								_STOPWATCH_DESTROY(&uLocal_450);
		...
		case 1:
			if (bLocal_445)
				if (func_261())
					uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 2;
			else if (func_220())
				uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 2;
			break;
		...
		case 2:
			if (func_165())
				uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_1 = 3;
			break;
	
		case 3:
			if (!IS_BIT_SET(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
				MISC::SET_BIT(&(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
			break;
	}
	...
	if (func_164())
	{
		...
		func_12();
		address = func_163(1304, -1);
		MISC::SET_BIT(&address, 2);
		MISC::SET_BIT(&(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2), 0);
		func_161(1304, address, -1, true);
		func_276(12, false);
...
void func_20(BOOL bParam0) // Position - 0xD84 (3460)
{
	...
	flag = func_148(PLAYER::PLAYER_ID(), bParam0);
	num = func_145(flag, bParam0);
	...
	if (!func_124(true))
	{
		func_117(func_118(59, false, false), false);
		func_43(func_118(135, false, false), true);
		func_41(func_118(22, false, false), func_118(73, false, false));
	}
	else
	{
		func_41(false, false);
...
void func_21(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF5F (3935)
{
	if (bParam1)
	{
...
void func_22(int iParam0) // Position - 0x101E (4126)
{
...
void func_23(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1038 (4152)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_25() == 0)
		{
			address = func_163(func_24(iParam0), -1);
			MISC::CLEAR_BIT(&address, iParam1);
			func_161(func_24(iParam0), address, -1, true);
		}
	}
	else
	{
...
int func_24(int iParam0) // Position - 0x10A8 (4264)
{
	switch (iParam0)
	{
		case 0:
...
int func_25() // Position - 0x148C (5260)
{
	return Global_33792;
}

void func_26(int iParam0, int iParam1, BOOL bParam2) // Position - 0x1497 (5271)
{
	BOOL address;
...
void func_27(int iParam0) // Position - 0x1507 (5383)
{
...
BOOL func_28(int iParam0) // Position - 0x152E (5422)
{
	return func_30(iParam0, 5, true);
}

int func_29(int iParam0) // Position - 0x153E (5438)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_30(int iParam0, int iParam1, BOOL bParam2) // Position - 0x18A8 (6312)
{
	if (iParam0 == -1)
		return false;
	...
	if (bParam2)
		...
		if (func_25() == 0)
			return IS_BIT_SET(func_163(func_24(iParam0), -1), iParam1);
	else
...
void func_31(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x1908 (6408)
{
	Hash statName;
...
Hash func_32(int iParam0, int iParam1) // Position - 0x192B (6443)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_33(iParam1));
}

int func_33(int iParam0) // Position - 0x1940 (6464)
{
	int num;
	int num2;
...
int func_34() // Position - 0x1974 (6516)
{
	return Global_1574927;
}

BOOL func_35() // Position - 0x1980 (6528)
{
	return Global_1575080;
}

BOOL func_36() // Position - 0x198C (6540)
{
	return Global_1575082;
}

void func_37(BOOL bParam0) // Position - 0x1998 (6552)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
void func_38(BOOL bParam0) // Position - 0x19EA (6634)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		return;
...
BOOL func_39(int iParam0, int iParam1) // Position - 0x1A2A (6698)
{
	Hash statHash;
	BOOL outValue;
...
BOOL func_40() // Position - 0x1A4E (6734)
{
	if (!func_152())
		return false;
...
void func_41(BOOL bParam0, BOOL bParam1) // Position - 0x1A6F (6767)
{
	BOOL flag;
...
void func_42(int iParam0, BOOL bParam1) // Position - 0x1B97 (7063)
{
	if (bParam1)
...
void func_43(BOOL bParam0, BOOL bParam1) // Position - 0x1BBD (7101)
{
	BOOL flag;
	...
	if (Global_262145.f_61 == 1 && func_118(135, false, false))
		bParam0 = true;
...
BOOL func_44(int iParam0) // Position - 0x1C43 (7235)
{
	BOOL flag;

	if (Global_1945595[iParam0 /*8*/] == -1)
	{
		flag = func_163(func_115(iParam0), -1);
...
void func_45(int iParam0, BOOL bParam1) // Position - 0x1C86 (7302)
{
	Global_1945595[iParam0 /*8*/] = bParam1;
	func_46(func_115(iParam0), bParam1, -1);
	return;
}

void func_46(int iParam0, BOOL bParam1, int iParam2) // Position - 0x1CA5 (7333)
{
	BOOL flag;
	int num;
	...
	{
		func_161(iParam0, bParam1, iParam2, true);
		return;
	}
	...
	if (!func_113(num, bParam1 == func_163(iParam0, -1)))
	{
		flag = false;
	}
	else
	{
		num.f_1 = func_112(num);
	
		if (num.f_1 == 4)
			flag = false;
	
		if (flag && !func_110(iParam0, &num))
			flag = false;
	}
...
void func_47(var uParam0) // Position - 0x1D39 (7481)
{
	uParam0->f_6 = func_93(*uParam0, uParam0->f_2);
	...
	if (uParam0->f_6 >= uParam0->f_2.f_2)
	{
		...
		if (func_73(*uParam0, uParam0->f_1, false, false))
		{
			func_59(*uParam0, uParam0->f_1);
			uParam0->f_7 = 1;
		
			if (!Global_2733138.f_5950.f_1 && func_112(*uParam0) >= uParam0->f_1)
			{
...
BOOL func_48(var uParam0) // Position - 0x1E1D (7709)
{
	var unk;
	BOOL flag;
...
BOOL func_49(var uParam0, var uParam1, var uParam2) // Position - 0x1E8D (7821)
{
	int num;
...
BOOL _STAT_GET_PACKED_BOOL(int iParam0, int iParam1) // Position - 0x1EB5 (7861)
{
	if (iParam1 == -1)
		iParam1 = func_34();
...
int func_51(int iParam0, int iParam1, int iParam2) // Position - 0x1ED1 (7889)
{
	switch (iParam0)
	{
		case 19:
...
BOOL func_52(var uParam0, int iParam1, int iParam2, var uParam3) // Position - 0x1FEA (8170)
{
	int num;
	int i;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3) // Position - 0x203C (8252)
{
	int i;
	int j;
...
void func_54(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x32FD (13053)
{
	int i;
...
void func_55() // Position - 0x338D (13197)
{
	int num;
	BOOL flag;
...
void _STAT_SET_PACKED_BOOL(int iParam0, BOOL bParam1, int iParam2) // Position - 0x3519 (13593)
{
	if (iParam2 == -1)
		iParam2 = func_34();
...
int func_57() // Position - 0x3537 (13623)
{
	int num;
	int i;
	int num2;
...
int func_58(int iParam0) // Position - 0x35B7 (13751)
{
	switch (iParam0)
	{
		case 0:
...
void func_59(int iParam0, int iParam1) // Position - 0x3605 (13829)
{
	int num;
	BOOL address;
	int offset;
	...
	num = func_72(iParam0);
	address = func_163(num, -1);
	offset = func_70(iParam0, iParam1);

	if (!IS_BIT_SET(address, offset))
	{
		func_63(iParam0, iParam1);
		MISC::SET_BIT(&address, offset);
		func_161(num, address, -1, true);
	}
...
void func_60(int iParam0, int iParam1) // Position - 0x3656 (13910)
{
	int num;
	int offset;
...
int func_61(int iParam0) // Position - 0x3711 (14097)
{
	return func_62(iParam0) / 8;
}

int func_62(int iParam0) // Position - 0x3722 (14114)
{
	switch (iParam0)
	{
		case 3:
...
void func_63(int iParam0, int iParam1) // Position - 0x38AB (14507)
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_68();
	hash = func_67();
	hash2 = func_66(iParam1);
	hash3 = func_64(iParam0);
	num2 = -1;
	STATS::_PLAYSTATS_PH_ACTIVITY(entityCoords, num, hash, hash2, hash3, num2);
	return;
}

Hash func_64(int iParam0) // Position - 0x38FE (14590)
{
	var unk;

	TEXT_LABEL_ASSIGN_STRING(&unk, "PROGRESS_HUB_PACK_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_65(iParam0), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_65(int iParam0) // Position - 0x391D (14621)
{
	switch (iParam0)
	{
		case 0:
...
Hash func_66(int iParam0) // Position - 0x3AF1 (15089)
{
	switch (iParam0)
	{
		case 0:
...
Hash func_67() // Position - 0x3B5D (15197)
{
	return MISC::GET_HASH_KEY("PROGRESS_HUB_TIER_COMPLETED");
}

int func_68() // Position - 0x3B6D (15213)
{
	if (Global_1674225 == 0)
		func_69();
...
void func_69() // Position - 0x3B85 (15237)
{
...
int func_70(int iParam0, int iParam1) // Position - 0x3BB4 (15284)
{
	if (iParam1 == 4)
		iParam1 = 3;

	return (func_71(iParam0) * 4) + iParam1;
}

int func_71(int iParam0) // Position - 0x3BD0 (15312)
{
	return func_62(iParam0) % 8;
}

int func_72(int iParam0) // Position - 0x3BE1 (15329)
{
	int num;
...
BOOL func_73(int iParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x3BF7 (15351)
{
	BOOL flag;
	int num;
	int num2;
	...
	num2 = func_79(iParam0, iParam1, 0);
	num3 = (num2 + func_76(iParam0, iParam1)) - 1;
	i = 0;
...
BOOL func_74(int iParam0, int iParam1) // Position - 0x3C94 (15508)
{
	BOOL flag;
	BOOL flag2;

	flag = func_75(iParam0, iParam1);
	flag2 = func_93(iParam0, iParam1);
	return flag2 >= flag;
}

BOOL func_75(int iParam0, int iParam1) // Position - 0x3CB5 (15541)
{
	int i;
...
int func_76(int iParam0, int iParam1) // Position - 0x4EA2 (20130)
{
	if (func_77(iParam0))
	{
		switch (iParam1)
...
BOOL func_77(int iParam0) // Position - 0x4F15 (20245)
{
	int num;
...
int func_78(int iParam0) // Position - 0x4F3D (20285)
{
	switch (iParam0)
	{
		case 27:
...
int func_79(int iParam0, int iParam1, int iParam2) // Position - 0x5049 (20553)
{
	int num;
	int i;
	int num2;
...
int func_80(int iParam0) // Position - 0x50B5 (20661)
{
	if (func_77(iParam0))
		return 13;
...
void func_81(int iParam0) // Position - 0x50D0 (20688)
{
	int num;
	int num2;
	int offset;
...
int func_82(int iParam0) // Position - 0x510E (20750)
{
	return iParam0 % 32;
}

int func_83(int iParam0) // Position - 0x511B (20763)
{
	return iParam0 / 32;
}

int func_84(int iParam0) // Position - 0x5128 (20776)
{
	switch (iParam0)
	{
		case 24:
...
void func_85(var uParam0) // Position - 0x6207 (25095)
{
	int num;
	int num2;
	int num3;
...
int func_86(int iParam0) // Position - 0x6243 (25155)
{
	switch (iParam0)
	{
		case 2:
...
void func_87(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7) // Position - 0x6DF8 (28152)
{
	var entityCoords;
	int num;
	Hash hash;
	...
	num = func_68();
	hash = func_92(uParam0.f_6 >= uParam0.f_2.f_2);
	hash2 = func_88(uParam0, uParam0.f_1, uParam0.f_2);
	any = uParam0.f_6;
...
Hash func_88(int iParam0, var uParam1, int iParam2) // Position - 0x6E61 (28257)
{
	var unk;
	...
	TEXT_LABEL_APPEND_STRING(&unk, func_91(uParam1), 64);
	TEXT_LABEL_APPEND_STRING(&unk, "_OBJ_", 64);
	TEXT_LABEL_APPEND_STRING(&unk, func_89((iParam2 - func_79(iParam0, uParam1, 0)) + 1), 64);
	return MISC::GET_HASH_KEY(&unk);
}

char* func_89(int iParam0) // Position - 0x7170 (29040)
{
	var unk;
...
char* func_90(var uParam0) // Position - 0x718B (29067)
{
	return uParam0;
}

char* func_91(int iParam0) // Position - 0x7195 (29077)
{
	switch (iParam0)
	{
		case 0:
...
Hash func_92(BOOL bParam0) // Position - 0x71E9 (29161)
{
	if (bParam0)
...
BOOL func_93(int iParam0, int iParam1) // Position - 0x720C (29196)
{
	int i;
	BOOL flag;
	BOOL flag2;
	...
	switch (iParam0)
	{
		...
		case 10:
			switch (iParam1)
			{
				...
				case 85:
					flag = func_163(13040, -1);
					break;
			
				case 86:
					flag2 = func_163(13036, -1);
		...
		case 11:
			switch (iParam1)
			{
				...
				case 98:
					flag = func_163(12459, -1);
					break;
			
				case 99:
					flag2 = func_163(12444, -1);
				...
				case 100:
					...
					{
						flag = flag + func_108(_STAT_GET_PACKED_BOOL(9547, -1));
						flag = flag + func_108(_STAT_GET_PACKED_BOOL(9548, -1));
		...
		case 13:
			switch (iParam1)
			{
				...
				case 124:
					flag = func_163(12044, -1);
					flag = flag + func_163(12042, -1);
					break;
		...
		case 18:
			...
			{
				case 184:
					if (func_163(5448, -1) > false)
						flag = true;
					break;
			
				case 185:
					if (func_163(5453, -1) > true)
						flag = true;
					break;
				...
				case 188:
					if (func_163(5465, -1) > false)
						flag = true;
					break;
			
				case 189:
					if (func_163(5457, -1) >= true || func_163(5455, -1) >= true)
						flag = true;
					break;
			
				case 190:
					flag2 = func_163(5395, -1);
		...
		case 32:
			...
			{
				case 346:
					if (func_163(1209, -1) > false)
						flag = true;
					break;
			
				case 347:
					if (func_163(11921, -1) > false)
						flag = true;
					break;
			
				case 348:
					flag = func_103(40, -1) + func_103(41, -1);
					break;
			
				case 349:
					flag = func_163(11920, -1);
					break;
		...
		case 14:
			switch (iParam1)
			{
				...
				case 138:
					...
					if (func_163(11811, -1) >= 10)
						flag = flag + 1;
				
					if (func_163(11813, -1) >= 10)
						flag = flag + 1;
				...
				case 139:
					flag = func_163(11928, -1);
					break;
			
				case 140:
					flag = func_163(11927, -1);
					break;
		...
		case 34:
			switch (iParam1)
			{
				...
				case 373:
					flag = func_105(func_163(11964, -1));
					break;
		...
		case 15:
			switch (iParam1)
			{
				...
				case 146:
					if (func_163(9910, -1) > false)
						flag = true;
					break;
			
				case 147:
					if (IS_BIT_SET(func_163(9905, -1), 0))
						flag = true;
					break;
			
				case 148:
					if (func_94(128, -1) || func_94(129, -1) || func_94(130, -1))
						flag = true;
					break;
				...
				case 150:
					flag = func_163(9910, -1);
					break;
			
				case 151:
					if (IS_BIT_SET(func_163(9905, -1), 2))
						flag = true;
					break;
			
				case 152:
					flag = func_163(11930, -1);
					break;
		...
		case 22:
			...
			{
				case 236:
					if (func_163(9631, -1) == true && _STAT_GET_PACKED_BOOL(31737, -1))
						flag = true;
					break;
				...
				case 246:
					flag = func_163(9622, -1);
					break;
			
				case 247:
					flag = func_163(11932, -1);
					break;
		...
		case 24:
			switch (iParam1)
			{
				...
				case 264:
					if (IS_BIT_SET(func_163(9526, -1), 0) || IS_BIT_SET(func_163(9511, -1), 1))
						flag = true;
					break;
			
				case 265:
					if (IS_BIT_SET(func_163(9511, -1), 1))
						flag = true;
					break;
			
				case 266:
					if (func_163(9586, -1) > false)
						flag = true;
					break;
				...
				case 269:
					flag = func_163(11933, -1);
					break;
			
				case 270:
					flag = func_105(func_163(9586, -1));
					break;
				...
				case 273:
					if (func_163(9544, -1) > false)
						flag = flag + 1;
				
					if (func_163(9545, -1) > false)
						flag = flag + 1;
				
					if (func_163(9546, -1) > false)
						flag = flag + 1;
				
					if (func_163(9547, -1) > false)
						flag = flag + 1;
				
					if (func_163(9548, -1) > false)
						flag = flag + 1;
				
					if (func_163(9549, -1) > false)
						flag = flag + 1;
					break;
			
				case 274:
					flag = func_163(11926, -1);
					break;
			}
			break;
		...
		case 25:
			...
			{
				case 275:
					flag2 = func_163(8726, -1);
				
					if (func_105(flag2) > true || IS_BIT_SET(flag2, 1))
						flag = true;
					break;
				...
				case 278:
					if (IS_BIT_SET(func_163(8726, -1), 10))
						flag = true;
					break;
		...
		case 28:
			switch (iParam1)
			{
				...
				case 315:
					if (func_163(7864, -1) > false || func_163(7865, -1) > false)
						flag = true;
		...
		case 16:
			switch (iParam1)
			{
				...
				case 159:
					if (func_163(7231, -1) > false)
						flag = true;
					break;
			
				case 160:
					flag = func_163(12010, -1);
					break;
				...
				case 165:
					if (_STAT_GET_PACKED_BOOL(41989, -1))
						...
						flag = func_163(7212, -1);
					break;
			
				case 166:
					flag = func_163(7231, -1);
					break;
				...
				case 168:
					flag = func_163(7230, -1);
					break;
			
				case 169:
					flag = BUILTIN::FLOOR(BUILTIN::TO_FLOAT(func_163(12025, -1) / 60));
					break;
			
				case 170:
					flag = func_163(7234, -1);
					break;
			}
			break;
		...
		case 17:
			switch (iParam1)
			{
				...
				case 175:
					flag = func_163(6116, -1);
					break;
			
				case 176:
					if (func_163(6118, -1) > false)
						flag = true;
					break;
				...
				case 183:
					flag = func_163(6119, -1);
					flag = flag + func_163(6120, -1);
					break;
			}
			break;
		...
		case 19:
			...
			{
				case 197:
					if (func_163(5303, -1) > false)
						flag = true;
					break;
			
				case 198:
					if (func_163(5332, -1) > false)
						flag = true;
					break;
				...
				case 201:
					if (func_163(11941, -1) > false)
						flag = true;
					break;
			
				case 202:
					flag = func_163(11940, -1);
					break;
			
				case 203:
					flag = func_163(5332, -1);
					break;
				...
				case 208:
					flag = func_163(11941, -1);
					break;
			
				case 209:
					flag = func_163(5333, -1);
					break;
			}
			break;
		...
		case 20:
			switch (iParam1)
			{
				...
				case 217:
					if (func_163(3913, -1) > false || func_163(3903, -1) > false)
						flag = flag + 1;
				
					if (func_163(3946, -1) > false || func_163(3932, -1) > false)
						flag = flag + 1;
				
					if (func_163(3948, -1) > false || func_163(3936, -1) > false)
						flag = flag + 1;
				
					if (func_163(3950, -1) > false || func_163(3940, -1) > false)
						flag = flag + 1;
				
					if (func_163(3952, -1) > false || func_163(3944, -1) > false)
						flag = flag + 1;
					break;
			
				case 218:
					flag = func_163(10411, -1);
					break;
			
				case 219:
					flag = flag + func_163(3954, -1);
					flag = flag + func_163(3955, -1);
					flag = flag + func_163(3956, -1);
					flag = flag + func_163(3957, -1);
					flag = flag + func_163(3958, -1);
					break;
			
				case 220:
					flag = func_163(11943, -1);
					break;
			
				case 221:
					flag = func_163(11969, -1);
					break;
			
				case 222:
					flag = func_163(11942, -1);
					break;
			}
			break;
		...
		case 21:
			switch (iParam1)
			{
				...
				case 227:
					if (func_163(3639, -1) > false)
						flag = true;
					break;
			
				case 228:
					if (func_163(3667, -1) > false)
						flag = true;
					break;
				...
				case 234:
					flag = flag + func_163(11970, -1);
					break;
			
				case 235:
					flag = func_163(3671, -1);
					break;
			}
			break;
		...
		case 31:
			...
			{
				case 338:
					if (func_163(1210, -1) > false || _STAT_GET_PACKED_BOOL(42023, -1))
						flag = true;
					break;
				...
				case 340:
					flag = func_163(819, -1);
					flag = flag + func_163(12029, -1);
					flag = flag + func_163(12030, -1);
					break;
				...
				case 342:
					flag = flag + func_105(func_163(11929, -1));
					flag = flag + func_105(func_163(11966, -1));
					flag = flag + func_105(func_163(11967, -1));
					flag = flag + func_105(func_163(11968, -1));
					break;
...
BOOL func_94(int iParam0, int iParam1) // Position - 0xCC38 (52280)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_95(int iParam0, int iParam1) // Position - 0xCC5C (52316)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(10, iParam0, func_33(iParam1));
}

BOOL func_96() // Position - 0xCC72 (52338)
{
	int num;
	BOOL flag;
	...
	flag = func_163(11960, -1);

	if (Global_2733138.f_5766.f_3 - flag >= 2)
	{
		func_97(41244, false, -1);
		return 0;
	}
...
void func_97(int iParam0, BOOL bParam1, int iParam2) // Position - 0xCCB9 (52409)
{
	if (iParam2 == -1)
		iParam2 = func_34();
...
BOOL func_98() // Position - 0xCCE1 (52449)
{
	BOOL flag;
	BOOL flag2;

	flag = _STAT_GET_PACKED_INT(41244, -1);
	flag2 = func_163(11960, -1);
	...
	func_97(41244, flag, -1);
	func_161(11960, Global_2733138.f_5766.f_3, -1, true);
	return flag;
}

BOOL func_99() // Position - 0xCD5A (52570)
{
	BOOL address;
	int i;
	Hash weaponHash;
	...
	for (i = 0; i < 103; i = i + 1)
	{
		weaponHash = func_101(i);
		num = func_100(i);
	
		if (num == 18486)
		{
		}
		else if (IS_BIT_SET(func_163(num, -1), i % 32))
		{
	...
	func_97(41242, address, -1);
	return func_105(address);
}

int func_100(int iParam0) // Position - 0xCE50 (52816)
{
	iParam0 = iParam0 / 32;
...
Hash func_101(int iParam0) // Position - 0xCEC3 (52931)
{
	switch (iParam0)
	{
		case 34:
...
var func_102(BOOL bParam0, var uParam1, var uParam2) // Position - 0xD504 (54532)
{
	if (bParam0)
		return uParam1;
...
BOOL func_103(int iParam0, int iParam1) // Position - 0xD51B (54555)
{
	Hash statHash;
	int outValue;
...
Hash func_104(int iParam0, int iParam1) // Position - 0xD53F (54591)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(8, iParam0, func_33(iParam1));
}

BOOL func_105(BOOL bParam0) // Position - 0xD555 (54613)
{
	int num;
	BOOL flag;
...
void func_106(var uParam0, int iParam1) // Position - 0xD595 (54677)
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

BOOL func_107() // Position - 0xD5AA (54698)
{
	BOOL flag;
	int num;

	num = 0;
	flag = func_163(2828, -1);
...
int func_108(BOOL bParam0) // Position - 0xD7EF (55279)
{
	if (bParam0)
		return 1;
...
int _STAT_GET_PACKED_INT(int iParam0, int iParam1) // Position - 0xD801 (55297)
{
	if (iParam1 == -1)
		iParam1 = func_34();
...
BOOL func_110(int iParam0, var uParam1) // Position - 0xD81D (55325)
{
	int i;

	for (i = uParam1->f_1; i <= 4; i = i + 1)
	{
		uParam1->f_2 = func_111(iParam0, *uParam1, i);
	
		if (uParam1->f_2 != -1)
		{
			uParam1->f_2.f_2 = func_75(*uParam1, uParam1->f_2);
			uParam1->f_2.f_1 = func_93(*uParam1, uParam1->f_2);
...
int func_111(int iParam0, int iParam1, int iParam2) // Position - 0xD895 (55445)
{
	switch (iParam1)
	{
		case 0:
...
int func_112(int iParam0) // Position - 0xE8AC (59564)
{
	int num;
	BOOL flag;
	int num2;
...
BOOL func_113(int iParam0, BOOL bParam1) // Position - 0xE8F2 (59634)
{
	if (iParam0 == -1)
		return false;
...
int func_114(int iParam0) // Position - 0xE90E (59662)
{
	switch (iParam0)
	{
		case 14258:
...
int func_115(int iParam0) // Position - 0xED57 (60759)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_116(BOOL bParam0) // Position - 0xED75 (60789)
{
	BOOL flag;
...
void func_117(BOOL bParam0, BOOL bParam1) // Position - 0xEDCF (60879)
{
	BOOL flag;
...
BOOL func_118(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEE80 (61056)
{
	int num;
	int num2;

	if (func_124(false) && iParam0 == 60)
		return true;
	...
	if (Global_262145.f_8420 == 1)
	{
		...
		if (func_120(PLAYER::PLAYER_ID(), 85))
...
BOOL func_119() // Position - 0xF00C (61452)
{
	BOOL flag;
...
BOOL func_120(Player plParam0, int iParam1) // Position - 0xF069 (61545)
{
	if (!func_40())
		return false;
	...
	return func_121(&(Global_1845299[plParam0 /*883*/].f_822), func_122(iParam1));
}

BOOL func_121(var uParam0, int iParam1) // Position - 0xF0A9 (61609)
{
	int num;
	int num2;
	int num3;
...
int func_122(int iParam0) // Position - 0xF0CC (61644)
{
	switch (iParam0)
	{
		case 86:
...
BOOL func_123() // Position - 0xF2B8 (62136)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_144, 3);
}

BOOL func_124(BOOL bParam0) // Position - 0xF2CF (62159)
{
	if (bParam0)
		return func_127();

	return func_125(func_126());
}

BOOL func_125(int iParam0) // Position - 0xF2EB (62187)
{
	return iParam0 > 0 && iParam0 < 6;
}

int func_126() // Position - 0xF300 (62208)
{
	return Global_1912540[PLAYER::PLAYER_ID() /*319*/].f_279;
}

BOOL func_127() // Position - 0xF316 (62230)
{
	return func_39(526, -1) || MISC::HAS_FINALIZED_CHOSEN_CRIMINAL_CAREER() && func_129() != 0 && !func_128(0);
}

BOOL func_128(int iParam0) // Position - 0xF346 (62278)
{
	BOOL flag;

	flag = func_163(16738, -1);
	return IS_BIT_SET(flag, iParam0);
}

int func_129() // Position - 0xF35D (62301)
{
	return MISC::GET_CHOSEN_CRIMINAL_CAREER();
}

void func_130(int iParam0, BOOL bParam1) // Position - 0xF369 (62313)
{
	int offset;
	int num;
...
BOOL func_131() // Position - 0xF402 (62466)
{
	BOOL flag;
...
void func_132(BOOL bParam0) // Position - 0xF434 (62516)
{
	if (bParam0)
	{
		if (!IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_140, 25))
		{
			func_133(PLAYER::PLAYER_ID(), 12);
...
void func_133(Player plParam0, int iParam1) // Position - 0xF49B (62619)
{
	func_134(&(Global_1845299[plParam0 /*883*/].f_822), func_122(iParam1));
	return;
}

int func_134(var uParam0, int iParam1) // Position - 0xF4BA (62650)
{
	int num;
	int num2;
	int offset;
...
BOOL func_135() // Position - 0xF4F2 (62706)
{
	BOOL flag;
...
BOOL func_136() // Position - 0xF54F (62799)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_144, 7);
}

BOOL func_137() // Position - 0xF566 (62822)
{
	if (Global_1574612)
		return true;
...
BOOL func_138(int iParam0) // Position - 0xF596 (62870)
{
	if (func_139())
		return true;
...
BOOL func_139() // Position - 0xF5B1 (62897)
{
	return func_140() != -1;
}

int func_140() // Position - 0xF5BF (62911)
{
	return Global_2685153.f_767;
}

BOOL func_141(int iParam0) // Position - 0xF5CE (62926)
{
	BOOL flag;
	int num;
	...
	switch (iParam0)
	{
		...
		case 130:
			num = iParam0;
			num = num % 32;
			flag = func_163(func_142(iParam0), -1);
...
int func_142(int iParam0) // Position - 0xF7FC (63484)
{
	int num;
...
int func_143(int iParam0) // Position - 0xF8C9 (63689)
{
	if (func_36())
		return 1;
...
BOOL func_144(int iParam0) // Position - 0xFBA7 (64423)
{
	if (Global_1574612)
		return true;
...
int func_145(BOOL bParam0, BOOL bParam1) // Position - 0xFBD8 (64472)
{
	bParam1;
	return func_146(bParam0, 0);
}

int func_146(BOOL bParam0, int iParam1) // Position - 0xFBEC (64492)
{
	int i;
	int value;
	int value2;
	...
	for (i = 0; i <= 100; i = i + 1)
	{
		...
		if (func_147(num) == bParam0)
		{
			value = num;
			value2 = num;
		}
		else if (func_147(num) < bParam0)
		{
			if (value2 == num)
				value2 = value2 + 1;
			else
...
BOOL func_147(int iParam0) // Position - 0xFCA7 (64679)
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0, BOOL bParam1) // Position - 0x101EE (66030)
{
	bParam1;
	return func_149(plParam0);
}

BOOL func_149(Player plParam0) // Position - 0x10201 (66049)
{
	if (Global_1574634.f_9 == 0)
		if (plParam0 > -1)
			if (plParam0 == PLAYER::PLAYER_ID())
				return func_163(640, -1);
...
BOOL func_150(Player plParam0) // Position - 0x10258 (66136)
{
...
BOOL func_151(Player plParam0) // Position - 0x10277 (66167)
{
	Player player;
...
BOOL func_152() // Position - 0x10299 (66201)
{
	if (Global_1574612)
		return true;
...
void func_153() // Position - 0x102C9 (66249)
{
	if (!func_160(1, -1))
		func_158(1, -1);

	if (func_315() && func_25() == 0)
	{
	}
	else
	{
...
BOOL func_154() // Position - 0x10333 (66355)
{
...
var func_155(int iParam0) // Position - 0x10351 (66385)
{
	return Global_1574538[iParam0];
}

var func_156() // Position - 0x10361 (66401)
{
	return func_155(func_34() + 1);
}

BOOL func_157(int iParam0) // Position - 0x10373 (66419)
{
	return Global_1935678.f_16[iParam0 /*44*/].f_3;
}

void func_158(int iParam0, int iParam1) // Position - 0x10387 (66439)
{
	int profileSetting;
	int profileSetting2;
	...
	switch (iParam0)
	{
		case 0:
			...
			profileSetting2 = func_159(iParam1);
	...
	switch (iParam0)
	{
		case 0:
			...
			func_161(1304, 0, iParam1, true);
			func_161(7236, 0, iParam1, true);
			break;
	}
...
int func_159(int iParam0) // Position - 0x10468 (66664)
{
	int num;
...
BOOL func_160(int iParam0, int iParam1) // Position - 0x104CB (66763)
{
	int profileSetting;
	int profileSetting2;
	...
	profileSetting = func_159(iParam1);
	profileSetting2 = MISC::GET_PROFILE_SETTING(profileSetting);
	return IS_BIT_SET(profileSetting2, iParam0);
}

void func_161(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0x104F4 (66804)
{
	Hash statName;
...
Hash func_162(int iParam0, int iParam1) // Position - 0x10522 (66850)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_33(iParam1));
}

BOOL func_163(int iParam0, int iParam1) // Position - 0x10537 (66871)
{
	Hash statHash;
	int outValue;
...
BOOL func_164() // Position - 0x10566 (66918)
{
	if (IS_BIT_SET(uLocal_178[NETWORK::PARTICIPANT_ID_TO_INT() /*3*/].f_2, 0))
		return true;
...
BOOL func_165() // Position - 0x10582 (66946)
{
	switch (iLocal_275)
	{
		case 0:
			if (!IS_BIT_SET(iLocal_447, 18))
			{
				if (!PED::IS_PED_INJURED(pedLocal_276))
				{
					blLocal_449 = HUD::ADD_BLIP_FOR_ENTITY(pedLocal_276);
					HUD::SET_BLIP_AS_FRIENDLY(blLocal_449, true);
					HUD::SET_BLIP_NAME_FROM_TEXT_FILE(blLocal_449, "FM_LEST_BLP" /*Lester*/);
					func_214("FM_LEST_GTL" /*~s~Go to ~b~Lester.*/, false);
					MISC::SET_BIT(&iLocal_447, 18);
				}
			}
		
			if (!IS_BIT_SET(iLocal_447, 20))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (!PED::IS_PED_INJURED(pedLocal_276))
					{
						...
						{
							iLocal_279 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
							TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_276, iLocal_279, "missfinale_c2leadinoutfin_c_int", "_LEADIN_ACTION_LESTER", 1000f, -8f, 5, 16, 1148846080, 0);
							ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(pedLocal_278, iLocal_279, "_LEADIN_ACTION_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, 8f, 4, 1148846080);
							MISC::SET_BIT(&iLocal_447, 20);
						}
					}
				}
			}
			...
			if (!IS_BIT_SET(iLocal_447, 3))
			{
				CUTSCENE::REQUEST_CUTSCENE(sLocal_448, 8);
				MISC::SET_BIT(&iLocal_447, 3);
			}
			else if (!IS_BIT_SET(iLocal_447, 10))
			{
				if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
				{
					CUTSCENE::SET_CUTSCENE_ENTITY_STREAMING_FLAGS("MP_1", 0, 1);
					MISC::SET_BIT(&iLocal_447, 10);
				}
			}
		...
		case 4:
			...
			{
				func_168(true, true, false, true);
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
				NETWORK::NETWORK_SET_VOICE_ACTIVE(true);
			
				if (IS_BIT_SET(iLocal_447, 25))
					PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), false);
			
				if (inLocal_452 != 0)
					INTERIOR::UNPIN_INTERIOR(inLocal_452);
	...
	if (!IS_BIT_SET(iLocal_447, 11))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("MP_1", 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				MISC::SET_BIT(&iLocal_447, 11);
			}
		}
	}

	if (!IS_BIT_SET(iLocal_447, 26))
	{
		if (iLocal_275 > 2)
		{
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
			{
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
					CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
					MISC::SET_BIT(&iLocal_447, 26);
				}
			}
		}
	}

	if (IS_BIT_SET(iLocal_447, 19))
	{
...
void func_166() // Position - 0x10950 (67920)
{
	int num;

	num = func_167(53);
	Global_2645624[num /*83*/] = 53;
	TEXT_LABEL_ASSIGN_STRING(&Global_2645624[num /*83*/].f_18[0 /*16*/], "-StraightIntoFreemode", 64);
	return;
}

int func_167(int iParam0) // Position - 0x1097D (67965)
{
	int num;
	int i;
...
void func_168(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x109CA (68042)
{
	func_193();
	...
	func_184(false, true, true, false, false, bParam2, false);
	func_183();
	func_182(12, false, -1);
	func_181(1);
	...
	if (func_315() == false && func_179() == false && bParam1 && !func_177(PLAYER::PLAYER_ID()) && !STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && func_175())
...
void func_169() // Position - 0x10A9C (68252)
{
	int i;
	Player player;
	...
	{
		if (!func_263(&Global_2739360, 3500, true) || NETWORK::NETWORK_IS_PLAYER_FADING(PLAYER::PLAYER_ID()))
		{
			if (!func_174())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_173(&Global_2739360, true, false);
				}
				else if (!func_171(PLAYER::PLAYER_ID(), 0))
				{
...
void func_170(Player plParam0) // Position - 0x10BBF (68543)
{
	if (IS_BIT_SET(Global_2739364, plParam0) && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_263(&Global_2739365[plParam0 /*2*/], 3500, true) || NETWORK::NETWORK_IS_PLAYER_FADING(plParam0))
		{
			if (!func_174())
			{
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					func_173(&Global_2739365[plParam0 /*2*/], true, false);
				}
				else if (!func_171(plParam0, 0))
				{
...
BOOL func_171(Player plParam0, int iParam1) // Position - 0x10C8E (68750)
{
	BOOL flag;
...
int func_172(int iParam0, BOOL bParam1) // Position - 0x10CE7 (68839)
{
	int num;
	int num2;
...
void func_173(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x10D28 (68904)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
		if (!bParam2)
			*uParam0 = NETWORK::GET_NETWORK_TIME();
...
BOOL func_174() // Position - 0x10D65 (68965)
{
...
BOOL func_175() // Position - 0x10D83 (68995)
{
	if (func_176() == 0)
		return true;
...
int func_176() // Position - 0x10D98 (69016)
{
	return Global_1574634.f_18;
}

BOOL func_177(Player plParam0) // Position - 0x10DA6 (69030)
{
	if (func_171(plParam0, 0))
		return true;
...
BOOL func_178() // Position - 0x10DE5 (69093)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_179() // Position - 0x10DF3 (69107)
{
	return IS_BIT_SET(Global_2685153, 7);
}

void func_180() // Position - 0x10E01 (69121)
{
	Global_24407.f_5 = 0;
	return;
}

void func_181(int iParam0) // Position - 0x10E0F (69135)
{
	Global_2733138.f_3725 = iParam0;
	return;
}

void func_182(int iParam0, BOOL bParam1, int iParam2) // Position - 0x10E20 (69152)
{
	switch (iParam0)
	{
		case 5:
...
void func_183() // Position - 0x10E6F (69231)
{
	func_181(1);
	func_182(4, 0, -1);
	func_182(6, false, -1);
...
void func_184(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x10EC6 (69318)
{
	if (bParam0)
	{
		...
		func_186(true, bParam3, bParam2, false);
		Global_65033 = 1;
		Global_77362 = 1;
		Global_80303 = 1;
	}
	else
	{
		...
		func_186(false, bParam3, bParam2, false);
	
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_177(PLAYER::PLAYER_ID()) && !func_171(PLAYER::PLAYER_ID(), 0) && !func_185() && !bParam4 && !bParam5 && !NETWORK::NETWORK_IS_IN_SPECTATOR_MODE())
				ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false, false);
		else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_177(PLAYER::PLAYER_ID()) && !bParam4 && !bParam5)
			ENTITY::SET_ENTITY_INVINCIBLE(PLAYER::PLAYER_PED_ID(), false, false);
...
BOOL func_185() // Position - 0x11015 (69653)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

int func_186(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x1102F (69679)
{
	int num;
...
BOOL func_187() // Position - 0x11062 (69730)
{
...
void func_188() // Position - 0x11089 (69769)
{
	func_189(false);
	return;
}

void func_189(BOOL bParam0) // Position - 0x11096 (69782)
{
	if (bParam0)
	{
		func_190();
...
void func_190() // Position - 0x110F9 (69881)
{
...
void func_191(BOOL bParam0) // Position - 0x11122 (69922)
{
	int i;
...
void func_192(int iParam0) // Position - 0x11150 (69968)
{
...
void func_193() // Position - 0x111BA (70074)
{
	if (!Global_1574756)
		return;
...
void func_194() // Position - 0x111D1 (70097)
{
...
void func_195() // Position - 0x111F0 (70128)
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_196() // Position - 0x11226 (70182)
{
	Ped entity;

	if (HUD::DOES_BLIP_EXIST(blLocal_449))
		HUD::REMOVE_BLIP(&blLocal_449);

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_276))
	{
		entity = pedLocal_276;
		ENTITY::DELETE_ENTITY(&entity);
	}

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_278))
	{
		entity = pedLocal_278;
		ENTITY::DELETE_ENTITY(&entity);
	}
	...
	func_12();
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_197(CHAR_LESTER));
...
Hash func_197(eCharacter echParam0) // Position - 0x11288 (70280)
{
	if (!func_199(echParam0))
		return func_198(echParam0);
	else
...
Hash func_198(eCharacter echParam0) // Position - 0x112AE (70318)
{
	return Global_2339[echParam0 /*29*/];
}

BOOL func_199(eCharacter echParam0) // Position - 0x112BD (70333)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_200(int iParam0) // Position - 0x112C9 (70345)
{
	if (func_203())
		return;
...
void func_201(BOOL bParam0, BOOL bParam1) // Position - 0x11353 (70483)
{
	if (bParam0)
	{
		if (func_321(0))
...
BOOL func_202() // Position - 0x113C7 (70599)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_203() // Position - 0x113D5 (70613)
{
	return IS_BIT_SET(Global_1964705, 19);
}

void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x113E4 (70628)
{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(plParam0) && PLAYER::IS_PLAYER_PLAYING(plParam0) || bParam3 == true)
		{
			...
			if (!flag18)
			{
				...
				else if (flag14 || !func_171(PLAYER::PLAYER_ID(), 0) && !func_178() && !func_177(PLAYER::PLAYER_ID()))
			...
			else
			{
				if (!func_208(playerPed) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(playerPed))
				{
					...
					if (func_205(*Global_4718592.f_199277))
...
BOOL func_205(int iParam0) // Position - 0x11898 (71832)
{
	return iParam0 == 17;
}

void func_206() // Position - 0x118A5 (71845)
{
	var unk;
...
void func_207() // Position - 0x118F2 (71922)
{
...
BOOL func_208(Ped pedParam0) // Position - 0x11930 (71984)
{
...
void func_209(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x11961 (72033)
{
	int num;
	eViewModeContext i;
	...
	if (num == 0)
	{
		...
		if (func_171(PLAYER::PLAYER_ID(), 0))
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x11A31 (72241)
{
	Hash statName;
...
void func_211() // Position - 0x11A4D (72269)
{
	eViewModeContext i;
...
BOOL func_212() // Position - 0x11AA5 (72357)
{
...
void func_213(int iParam0) // Position - 0x11AD6 (72406)
{
	if (iParam0 == 1)
...
void func_214(char* sParam0, BOOL bParam1) // Position - 0x11AF9 (72441)
{
...
void func_215() // Position - 0x11B64 (72548)
{
	MISC::SET_BIT(&(Global_1574766.f_59), 1);
	return;
}

void func_216(BOOL bParam0) // Position - 0x11B77 (72567)
{
	if (bParam0)
	{
...
void func_217() // Position - 0x11B9D (72605)
{
...
BOOL func_218(char* sParam0) // Position - 0x11BC2 (72642)
{
	if (!func_18())
		return false;

	if (Global_1574766 == 11)
		return func_219(sParam0);
...
BOOL func_219(char* sParam0) // Position - 0x11C06 (72710)
{
	if (!func_18())
		return false;
...
BOOL func_220() // Position - 0x11C38 (72760)
{
	switch (iLocal_454)
	{
		case 0:
			...
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_455) && func_273())
			{
				func_254();
				func_253();
				func_250(false, false, true, false, true, true, false);
				...
				func_247(true, true, false, true, false);
			
				if (!PED::IS_PED_INJURED(pedLocal_277))
				{
					MISC::CLEAR_AREA(1273.8845f, -1718.0037f, 53.7715f, 3f, true, false, false, false);
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(pedLocal_277);
					ENTITY::SET_ENTITY_COORDS(pedLocal_277, 1275.2563f, -1722.3683f, 53.655f, true, false, false, true);
					ENTITY::SET_ENTITY_HEADING(pedLocal_277, 12.6638f);
					PED::FORCE_PED_MOTION_STATE(pedLocal_277, joaat("MotionState_Walk"), false, 0, false);
					PED::FORCE_PED_AI_AND_ANIMATION_UPDATE(PLAYER::PLAYER_PED_ID(), false, false);
					WEAPON::SET_CURRENT_PED_WEAPON(pedLocal_277, joaat("WEAPON_UNARMED"), true);
				}
			
				caLocal_456 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", false);
				CAM::SET_CAM_ACTIVE(caLocal_456, true);
				CAM::SET_CAM_PARAMS(caLocal_456, 1276.4088f, -1719.9183f, 56.1054f, -29.932f, 0f, 137.9132f, 50f, 0, 1, 1, 2);
				CAM::RENDER_SCRIPT_CAMS(true, false, 3000, true, false, 0);
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_455, "SET_DETAILS");
				func_246("FM_LEST_CAM" /*~s~CAM: 02*/);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_455, "SET_LOCATION");
				func_246("FM_LEST_CAM2" /*~s~FRONT DOOR*/);
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			
				if (GRAPHICS::GET_TIMECYCLE_MODIFIER_INDEX() == -1)
					GRAPHICS::SET_TIMECYCLE_MODIFIER("scanline_cam");
			
				MISC::SET_BIT(&iLocal_447, 15);
				func_7(&uLocal_457, false, false);
				STREAMING::REQUEST_MODEL(func_197(12));
				STREAMING::REQUEST_MODEL(joaat("prop_wheelchair_01_s"));
				STREAMING::REQUEST_ANIM_DICT("MissLester1ALeadInOut");
				MISC::SET_BIT(&iLocal_447, 23);
			
				if (!IS_BIT_SET(iLocal_447, 17))
				{
					if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(208246292))
					{
						OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(208246292, 0, false, false);
						MISC::SET_BIT(&iLocal_447, 17);
					}
				}
		...
		case 1:
			if (!PED::IS_PED_INJURED(pedLocal_277))
			{
				if (!IS_BIT_SET(iLocal_447, 21))
				{
					if (func_263(&uLocal_457, 1000, false))
					{
						TASK::TASK_LOOK_AT_COORD(pedLocal_277, 1276.4088f, -1719.9183f, 56.1054f, -1, 0, 2);
						MISC::SET_BIT(&iLocal_447, 21);
					}
				}
			}
		
			if (func_263(&uLocal_457, 1500, false))
			{
				if (IS_BIT_SET(iLocal_447, 17))
				{
					if (!PED::IS_PED_INJURED(pedLocal_277))
					{
						if (!PED::IS_PED_INJURED(pedLocal_276))
						{
							if (_CONVERSATION_ADD_LINE(&uLocal_280, "FM_1AU", "FM_LESTCUT", 7, 0, 0, 0))
							{
								_STOPWATCH_DESTROY(&uLocal_457);
								func_7(&uLocal_457, false, false);
								iLocal_454 = iLocal_454 + 1;
							}
						}
					}
				}
		...
		case 2:
			if (!PED::IS_PED_INJURED(pedLocal_277))
			{
				if (!func_325())
				{
					PED::SET_PED_CONFIG_FLAG(pedLocal_277, 104, true);
					MISC::SET_BIT(&iLocal_447, 22);
					TASK::TASK_CLEAR_LOOK_AT(pedLocal_277);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(pedLocal_277, 1273.5762f, -1718.4594f, 53.7715f, 1f, 20000, 1048576000, 0, 1193033728);
					_STOPWATCH_DESTROY(&uLocal_457);
					func_7(&uLocal_457, false, false);
					iLocal_454 = iLocal_454 + 1;
				}
		...
		case 3:
			if (!PED::IS_PED_INJURED(pedLocal_277))
			{
				if (func_263(&uLocal_457, 5000, false) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(pedLocal_277, 1275.1378f, -1718.4255f, 53.729942f, 1272.4507f, -1719.6267f, 55.45897f, 1.5625f, false, true, 0))
				{
					if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
					{
	...
	if (IS_BIT_SET(iLocal_447, 15))
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_455))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_455, "SET_TIME");
			...
			if (CLOCK::GET_CLOCK_HOURS() >= 0 && CLOCK::GET_CLOCK_HOURS() < 12)
				func_246("FM_LEST_AM" /*~s~AM*/);
			else
				func_246("FM_LEST_PM" /*~s~PM*/);
		
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_455, 255, 255, 255, 255, 0);
		}
	}

	if (IS_BIT_SET(iLocal_447, 22))
	{
		if (!PED::IS_PED_INJURED(pedLocal_277))
		{
			PED::SET_PED_CONFIG_FLAG(pedLocal_277, 104, true);
			PED::SET_PED_RESET_FLAG(pedLocal_277, 60, true);
			PED::SET_PED_RESET_FLAG(pedLocal_277, 342, true);
			PED::SET_PED_RESET_FLAG(pedLocal_277, 348, true);
		}
	}

	if (IS_BIT_SET(iLocal_447, 23))
		if (func_221())
			MISC::CLEAR_BIT(&iLocal_447, 23);

	return false;
}

BOOL func_221() // Position - 0x12170 (74096)
{
	BOOL flag;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_276))
	{
		if (STREAMING::HAS_MODEL_LOADED(func_197(12)))
		{
			if (func_223(&pedLocal_276, CHAR_LESTER, 1276.39f, -1712.845f, 54.372f, 338.0729f, true))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_276, true);
				ENTITY::SET_ENTITY_INVINCIBLE(pedLocal_276, true, false);
				_CONVERSATION_INITIALIZE_ACTOR(&uLocal_280, 8, pedLocal_276, "Lester", 0, 1);
				PED::SET_PED_PROP_INDEX(pedLocal_276, 1, 0, 0, false, 1);
			}
		}
	}
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_278))
		if (STREAMING::HAS_MODEL_LOADED(joaat("prop_wheelchair_01_s")))
			pedLocal_278 = OBJECT::CREATE_OBJECT(joaat("prop_wheelchair_01_s"), 1276.39f, -1712.845f, 54.372f, false, false, false);

	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_276))
		return false;

	if (!PED::IS_PED_INJURED(pedLocal_276))
		if (!PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(pedLocal_276))
			return false;
	...
	{
		iLocal_279 = PED::CREATE_SYNCHRONIZED_SCENE(1276.39f, -1712.845f, 54.372f, 0f, 0f, -155.52f, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(pedLocal_276, iLocal_279, "missfinale_c2leadinoutfin_c_int", "_LEADIN_LOOP1_LESTER", 1000f, -8f, 5, 0, 1148846080, 0);
		ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(pedLocal_278, iLocal_279, "_LEADIN_LOOP1_WCHAIR", "missfinale_c2leadinoutfin_c_int", 1000f, -8f, 4, 1148846080);
		PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_279, true);
		flag = true;
	}
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x122FE (74494)
{
...
BOOL func_223(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x12399 (74649)
{
	Hash model;

	if (!func_199(echParam1))
	{
		model = func_197(echParam1);
...
int func_224(var uParam0, eCharacter echParam1) // Position - 0x12427 (74791)
{
	int num;
...
void func_225() // Position - 0x1246D (74861)
{
	Ped ped;

	if (CAM::DOES_CAM_EXIST(caLocal_456))
	{
		CAM::SET_CAM_ACTIVE(caLocal_456, false);
		CAM::DESTROY_CAM(caLocal_456, false);
	}

	MISC::CLEAR_BIT(&iLocal_447, 15);
	CAM::RENDER_SCRIPT_CAMS(false, false, 3000, true, false, 0);

	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_277))
	{
		ped = pedLocal_277;
		ENTITY::DELETE_ENTITY(&ped);
	}

	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_455);
	GRAPHICS::CLEAR_TIMECYCLE_MODIFIER();
	return;
}

BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x124C4 (74948)
{
...
BOOL func_227(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x12512 (75026)
{
	Global_23001 = 0;
...
void func_228() // Position - 0x127E0 (75744)
{
	if (!func_229())
		return;
...
BOOL func_229() // Position - 0x12817 (75799)
{
...
BOOL func_230(Player plParam0) // Position - 0x1287A (75898)
{
	if (plParam0 == PLAYER::PLAYER_ID())
	{
		if (func_231(8))
...
BOOL func_231(int iParam0) // Position - 0x128B1 (75953)
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x128C3 (75971)
{
	return -1;
}

void func_233() // Position - 0x128CC (75980)
{
	int i;
...
void func_234() // Position - 0x128FD (76029)
{
...
BOOL func_235() // Position - 0x12992 (76178)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x12A2B (76331)
{
	if (func_241(14))
	{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x12ACD (76493)
{
	func_238();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_238() // Position - 0x12AE6 (76518)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_199(character) && !func_241(14) || Global_113879)
			{
				if (Global_114931.f_2370.f_539.f_4321 != character && func_199(Global_114931.f_2370.f_539.f_4321))
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x12BE3 (76771)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x12C20 (76832)
{
	if (func_199(character))
...
BOOL func_241(int iParam0) // Position - 0x12C45 (76869)
{
	return Global_44886 == iParam0;
}

void func_242() // Position - 0x12C53 (76883)
{
	int i;
...
BOOL func_243(int iParam0, int iParam1) // Position - 0x12CAA (76970)
{
	switch (iParam0)
	{
		case 5:
...
void func_244() // Position - 0x12CE2 (77026)
{
...
void func_245(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x12D39 (77113)
{
...
void func_246(char* sParam0) // Position - 0x12D8F (77199)
{
...
void func_247(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0x12DA1 (77217)
{
	func_249();
	...
	HUD::CLEAR_PRINTS();
	func_184(true, true, true, false, false, false, bParam2);
	func_248();
	func_182(12, true, -1);
	func_181(0);
...
void func_248() // Position - 0x12E22 (77346)
{
	func_181(0);
	func_182(4, true, -1);
	func_182(6, true, -1);
...
void func_249() // Position - 0x12E79 (77433)
{
	Global_1574756 = true;
...
void func_250(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0x12EA2 (77474)
{
...
void func_251() // Position - 0x12F31 (77617)
{
	Global_24407.f_5 = 1;
	return;
}

void func_252() // Position - 0x12F3F (77631)
{
	func_200(0);
	func_189(true);
	return;
...
void func_253() // Position - 0x12F51 (77649)
{
	Global_2673274.f_1023.f_9 = 1;
	return;
}

void func_254() // Position - 0x12F63 (77667)
{
...
void func_255() // Position - 0x12F84 (77700)
{
	if (!_IS_FMMC_ACTIVE() && !func_256() && Global_2686094)
		Global_4718592.f_139000 = 0;

	return;
}

BOOL func_256() // Position - 0x12FB2 (77746)
{
	return Global_2685153.f_693;
}

BOOL _IS_FMMC_ACTIVE() // Position - 0x12FC1 (77761)
{
	return Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_185 != 0;
}

void func_258() // Position - 0x12FD8 (77784)
{
	Global_2685153.f_758 = 1;
	return;
}

BOOL func_259() // Position - 0x12FE8 (77800)
{
	return Global_2685153.f_737;
}

BOOL func_260() // Position - 0x12FF7 (77815)
{
	return IS_BIT_SET(Global_2685153.f_2, 11);
}

BOOL func_261() // Position - 0x13008 (77832)
{
	switch (iLocal_275)
	{
		case 0:
...
void _STOPWATCH_DESTROY(var uParam0) // Position - 0x13129 (78121)
{
	uParam0->f_1 = 0;
	return;
}

BOOL func_263(var uParam0, int iParam1, BOOL bParam2) // Position - 0x13136 (78134)
{
	if (iParam1 == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(var uParam0) // Position - 0x13194 (78228)
{
	return uParam0->f_1;
}

BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x131A0 (78240)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x131B3 (78259)
{
...
BOOL func_267(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0x131CA (78282)
{
...
BOOL func_268() // Position - 0x132C3 (78531)
{
	return Global_2709408;
}

BOOL func_269() // Position - 0x132CF (78543)
{
	return Global_2685153.f_850;
}

BOOL func_270() // Position - 0x132DE (78558)
{
	return Global_2673274.f_2915.f_583;
}

BOOL func_271(Player plParam0) // Position - 0x132F0 (78576)
{
...
BOOL func_272() // Position - 0x1330C (78604)
{
	return MISC::GET_GAME_TIMER() <= Global_24546.f_6481 + 100;
}

BOOL func_273() // Position - 0x13321 (78625)
{
	Hash entityModel;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(pedLocal_277))
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			pedLocal_277 = PED::CREATE_PED(PED_TYPE_CIVMALE, entityModel, 1273.8271f, -1717.8727f, 53.7715f, 19.2225f, false, false);
			ENTITY::SET_ENTITY_INVINCIBLE(pedLocal_277, true, false);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(pedLocal_277, true);
			PED::CLONE_PED_TO_TARGET(PLAYER::PLAYER_PED_ID(), pedLocal_277);
		}
	}
	...
	if (!PED::IS_PED_INJURED(pedLocal_277))
		if (!PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(pedLocal_277))
			return false;

	return true;
}

void func_274() // Position - 0x133B0 (78768)
{
...
void func_275(int iParam0, int iParam1) // Position - 0x133E3 (78819)
{
	int profileSetting;
	int profileSetting2;
...
void func_276(int iParam0, BOOL bParam1) // Position - 0x13474 (78964)
{
	if (bParam1)
...
BOOL func_277() // Position - 0x134D1 (79057)
{
	Ped ped;
	...
	if (bLocal_446)
	{
		if (BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), 1274.5474f, -1720.6945f, 53.6807f) > 500f)
		{
			if (ENTITY::DOES_ENTITY_EXIST(pedLocal_277))
			{
				ped = pedLocal_277;
...
BOOL func_278(Player plParam0, int iParam1) // Position - 0x13568 (79208)
{
	return IS_BIT_SET(Global_2658294[plParam0 /*468*/].f_222, iParam1);
}

BOOL func_279(BOOL bParam0) // Position - 0x1357E (79230)
{
	Player player;

	player = PLAYER::PLAYER_ID();

	if (func_307(player) || func_306(player) || func_305(player) || func_304(player) || func_303(player) || func_302(player) || func_301(player) || func_300(player) || func_299(player) || func_296(player) && func_295(player) || func_294(player) || func_293(player) || func_292(player) || func_291(player) || func_290(player) || func_289(player) || func_288(player) || func_287(player) || func_286(player, false))
		return true;

	if (bParam0)
		if (func_285(player))
			return true;
	else if (func_280(player))
		return true;

	return false;
}

BOOL func_280(Player plParam0) // Position - 0x136A0 (79520)
{
	if (func_285(plParam0) || func_284(plParam0) || func_283(plParam0) || _IS_PLAYER_IN_MUSIC_LOCKER(plParam0))
		return true;

	return false;
}

BOOL _IS_PLAYER_IN_MUSIC_LOCKER(Player plParam0) // Position - 0x136DA (79578)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 19;

	return false;
}

int func_282(int iParam0) // Position - 0x13721 (79649)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_283(Player plParam0) // Position - 0x13C8A (81034)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 15;

	return false;
}

BOOL func_284(Player plParam0) // Position - 0x13CD1 (81105)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 16;

	return false;
}

BOOL func_285(Player plParam0) // Position - 0x13D18 (81176)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 14;

	return false;
}

BOOL func_286(Player plParam0, BOOL bParam1) // Position - 0x13D5F (81247)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (bParam1 || _NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 35;

	return false;
}

BOOL func_287(Player plParam0) // Position - 0x13DAE (81326)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 34;

	return false;
}

BOOL func_288(Player plParam0) // Position - 0x13DF5 (81397)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 33;

	return false;
}

BOOL func_289(Player plParam0) // Position - 0x13E3C (81468)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 32;

	return false;
}

BOOL func_290(Player plParam0) // Position - 0x13E83 (81539)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 31;

	return false;
}

BOOL func_291(Player plParam0) // Position - 0x13ECA (81610)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			return Global_2658294[plParam0 /*468*/].f_325.f_8 == 161;

	return false;
}

BOOL func_292(Player plParam0) // Position - 0x13EFB (81659)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
...
BOOL func_293(Player plParam0) // Position - 0x13F2C (81708)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 29;

	return false;
}

BOOL func_294(Player plParam0) // Position - 0x13F73 (81779)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 28;

	return false;
}

BOOL func_295(Player plParam0) // Position - 0x13FBA (81850)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_296(Player plParam0) // Position - 0x13FE0 (81888)
{
	if (func_298(plParam0) && func_297(plParam0) == plParam0)
		return true;

	return false;
}

Player func_297(Player plParam0) // Position - 0x14004 (81924)
{
	if (plParam0 == _INVALID_PLAYER_INDEX())
		return plParam0;
...
BOOL func_298(Player plParam0) // Position - 0x14028 (81960)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658294[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 25;

	return false;
}

BOOL func_299(Player plParam0) // Position - 0x14088 (82056)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 26;

	return false;
}

BOOL func_300(Player plParam0) // Position - 0x140CF (82127)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 21;

	return false;
}

BOOL func_301(Player plParam0) // Position - 0x14116 (82198)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 24;

	return false;
}

BOOL func_302(Player plParam0) // Position - 0x1415D (82269)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 22;

	return false;
}

BOOL func_303(Player plParam0) // Position - 0x141A4 (82340)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 23;

	return false;
}

BOOL func_304(Player plParam0) // Position - 0x141EB (82411)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 11;

	return false;
}

BOOL func_305(Player plParam0) // Position - 0x14232 (82482)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1)
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 17;

	return false;
}

BOOL func_306(Player plParam0) // Position - 0x14279 (82553)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(plParam0, true, true))
			if (Global_2658294[plParam0 /*468*/].f_325.f_8 != -1 && Global_2658294[plParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
				return func_282(Global_2658294[plParam0 /*468*/].f_325.f_8) == 20;

	return false;
}

BOOL func_307(Player plParam0) // Position - 0x142D9 (82649)
{
	return func_308(&(Global_2658294[plParam0 /*468*/].f_447), 0);
}

BOOL func_308(var uParam0, int iParam1) // Position - 0x142F2 (82674)
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_309() // Position - 0x14300 (82688)
{
	return Global_1948261;
}

BOOL func_310() // Position - 0x1430C (82700)
{
	return false;
}

BOOL func_311(int iParam0) // Position - 0x14326 (82726)
{
	BOOL flag;
	...
	if (iParam0 >= 0 && iParam0 <= 16 && func_313())
		return true;
	else if (iParam0 >= 17 && iParam0 <= 31 && func_312())
		return true;
	...
	flag = func_163(2481, -1);
	return IS_BIT_SET(flag, iParam0);
}

BOOL func_312() // Position - 0x143C0 (82880)
{
	return IS_BIT_SET(func_163(2482, -1), 2);
}

BOOL func_313() // Position - 0x143D2 (82898)
{
	return IS_BIT_SET(func_163(2482, -1), 1);
}

BOOL func_314(Player plParam0) // Position - 0x143E4 (82916)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_315() // Position - 0x14421 (82977)
{
	return Global_1575092;
}

int func_316() // Position - 0x1442D (82989)
{
	return Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_186;
}

BOOL func_317() // Position - 0x14442 (83010)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 0);
}

BOOL func_318(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0x1445B (83035)
{
	if (bParam1)
...
BOOL func_319(Player plParam0) // Position - 0x1448D (83085)
{
	return func_320(plParam0);
}

BOOL func_320(Player plParam0) // Position - 0x1449B (83099)
{
	return IS_BIT_SET(Global_1845299[plParam0 /*883*/].f_11.f_1, 0);
}

BOOL func_321(int iParam0) // Position - 0x144B2 (83122)
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
BOOL func_322() // Position - 0x14509 (83209)
{
	return func_323();
}

BOOL func_323() // Position - 0x14515 (83221)
{
	return Global_1674300.f_40 == 3;
}

BOOL func_324() // Position - 0x14525 (83237)
{
	if (Global_23000 == 4)
		if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
			return true;
...
BOOL func_325() // Position - 0x1454A (83274)
{
...
BOOL func_326(Player plParam0) // Position - 0x1456C (83308)
{
	if (func_36())
		return true;
...
int func_327() // Position - 0x14598 (83352)
{
	return iLocal_98;
}

int func_328(int iParam0) // Position - 0x145A2 (83362)
{
	return uLocal_178[iParam0 /*3*/];
}

void func_329(Blip blParam0) // Position - 0x145B0 (83376)
{
	if (func_331(true))
	{
	...
	else if (HUD::DOES_BLIP_EXIST(*blParam0) && HUD::IS_BLIP_SHORT_RANGE(*blParam0) && !func_330())
	{
...
BOOL func_330() // Position - 0x14622 (83490)
{
	return false;
}

BOOL func_331(BOOL bParam0) // Position - 0x1462B (83499)
{
	return func_332(PLAYER::PLAYER_ID(), bParam0);
}

BOOL func_332(Player plParam0, BOOL bParam1) // Position - 0x1463D (83517)
{
	if (!func_151(plParam0))
		return false;
	...
	return func_151(Global_1892798[plParam0 /*615*/].f_10);
}

BOOL func_333(Player plParam0) // Position - 0x14675 (83573)
{
	if (func_151(plParam0))
		if (func_151(Global_1892798[plParam0 /*615*/].f_10))
			return Global_1892798[plParam0 /*615*/].f_10 == plParam0;

	return false;
}

void func_334() // Position - 0x146AA (83626)
{
	Entity entity;
...
void func_335() // Position - 0x1479F (83871)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_336() // Position - 0x147AB (83883)
{
	Global_2673274.f_1023.f_9 = 0;
	return;
}

BOOL func_337() // Position - 0x147BD (83901)
{
	return Global_2673274.f_1023.f_9;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x147CE (83918)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x14852 (84050)
{
	switch (func_25())
	{
		case 0:
...
Hash func_340() // Position - 0x14885 (84101)
{
...
BOOL func_341() // Position - 0x148A9 (84137)
{
	return Global_2685153.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x148B8 (84152)
{
...
BOOL func_343() // Position - 0x148CF (84175)
{
	return Global_2696981;
}

BOOL func_344() // Position - 0x148DB (84187)
{
	return Global_2685153.f_695;
}

void func_345() // Position - 0x148EA (84202)
{
	BUILTIN::WAIT(0);
	return;
}

void func_346(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20) // Position - 0x148F7 (84215)
{
	func_350(func_351(uParam0), uParam0);
	func_348(0, -1, false);
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_98, 79, 0);
...
BOOL func_347() // Position - 0x14939 (84281)
{
	var unk;
...
int func_348(int iParam0, int iParam1, BOOL bParam2) // Position - 0x14997 (84375)
{
	int i;
...
BOOL func_349(BOOL bParam0) // Position - 0x14AAD (84653)
{
	bParam0;
	return Global_1575064;
}

void func_350(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19, var uParam20, var uParam21) // Position - 0x14ABE (84670)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_335();
...
int func_351(int iParam0) // Position - 0x14ADD (84701)
{
	switch (iParam0)
	{
		case 3:
	...
	switch (func_352(func_353(iParam0, true)))
	{
		case 0:
			return 8;
...
int func_352(int iParam0) // Position - 0x152B1 (86705)
{
	switch (iParam0)
	{
		case 150:
...
int func_353(int iParam0, BOOL bParam1) // Position - 0x15681 (87681)
{
	switch (iParam0)
	{
		case 244:
