...
BOOL func_1() // Position - 0x1BA (442)
{
	...
	if (BUILTIN::VDIST2(entityCoords, entityCoords2) > 10000f || ENTITY::IS_ENTITY_DEAD(pedLocal_36, false) || func_28())
		return true;
...
void func_2() // Position - 0x465 (1125)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedLocal_36) && !ENTITY::IS_ENTITY_DEAD(pedLocal_36, false))
	{
		if (TASK::GET_SEQUENCE_PROGRESS(pedLocal_36) == 1)
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x4FF (1279)
{
...
BOOL func_5(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x54D (1357)
{
	Global_23001 = 0;
...
void func_6() // Position - 0x81B (2075)
{
	if (!func_7())
		return;
...
BOOL func_7() // Position - 0x852 (2130)
{
...
BOOL func_8(Player plParam0) // Position - 0x8B5 (2229)
{
...
BOOL func_9(Player plParam0, int iParam1) // Position - 0x8EC (2284)
{
	return IS_BIT_SET(Global_1892798[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_10(int iParam0) // Position - 0x904 (2308)
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x916 (2326)
{
	return -1;
}

void func_12() // Position - 0x91F (2335)
{
	int i;
...
void func_13() // Position - 0x950 (2384)
{
...
BOOL func_14() // Position - 0x9E5 (2533)
{
...
BOOL func_15() // Position - 0xA0C (2572)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xAA5 (2725)
{
	if (func_23(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0xB47 (2887)
{
	func_18();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_18() // Position - 0xB60 (2912)
{
...
BOOL func_19(eCharacter echParam0) // Position - 0xC5D (3165)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0xC69 (3177)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0xCA6 (3238)
{
...
Hash func_22(eCharacter echParam0) // Position - 0xCCB (3275)
{
	return Global_2339[echParam0 /*29*/];
}

BOOL func_23(int iParam0) // Position - 0xCDA (3290)
{
	return Global_44886 == iParam0;
}

void func_24() // Position - 0xCE8 (3304)
{
	int i;
...
BOOL func_25(int iParam0, int iParam1) // Position - 0xD3F (3391)
{
	switch (iParam0)
	{
		case 5:
...
void func_26() // Position - 0xD77 (3447)
{
...
BOOL func_28() // Position - 0xE24 (3620)
{
...
BOOL func_29() // Position - 0xEA5 (3749)
{
	Vector3 entityCoords;
	Ped outPed;
	Hash entityModel;
...
BOOL func_30(float fParam0, var uParam1, var uParam2) // Position - 0xF7C (3964)
{
...
void func_31() // Position - 0xFA6 (4006)
{
	Vector3 entityCoords;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x105F (4191)
{
...
BOOL func_33(int iParam0, int iParam1) // Position - 0x10FA (4346)
{
	BOOL flag;
...
void func_34() // Position - 0x1144 (4420)
{
