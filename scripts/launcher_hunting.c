...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A31 (6705)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x28DC (10460)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x2964 (10596)
{
...
int func_83() // Position - 0x779F (30623)
{
...
BOOL func_86(Player plParam0) // Position - 0x77E3 (30691)
{
...
BOOL func_94(Player plParam0) // Position - 0x869E (34462)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_199(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD420 (54304)
{
...
BOOL func_210(Any* panParam0, BOOL bParam1) // Position - 0xD882 (55426)
{
	...
	if (func_247(*panParam0) || func_245(*panParam0) || Global_80551 == 1)
		return true;
...
int func_255(var uParam0, eCharacter echParam1) // Position - 0xF6E3 (63203)
{
	int num;
