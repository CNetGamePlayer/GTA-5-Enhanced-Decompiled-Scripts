...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(pedLocal_83) && !ENTITY::IS_ENTITY_DEAD(pedLocal_83, false))
		{
			...
			fLocal_91 = BUILTIN::VDIST2(uLocal_85, unk.f_1[0 /*3*/]);
			fLocal_91 = fLocal_91;
			...
			switch (iLocal_93)
			{
				...
				case 3:
					...
					else
					{
						...
						if (!func_101(3) && !Global_102488)
						{
							if (func_117(iLocal_92, 2097152))
							{
								if (!func_117(iLocal_92, 1) || !ENTITY::DOES_ENTITY_EXIST(func_100()) && !Global_102488)
								{
									func_110(10);
									break;
								}
						...
						if (!func_91(6) || Global_113978 || func_90())
							flag3 = false;
				...
				case 6:
					if (func_117(Global_113579, 262144))
					{
						func_119(&Global_113579, 262144);
						func_15();
					}
					...
					if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_50))
					{
						...
						if (iLocal_97 != -1)
						{
							if (func_117(Global_113579, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_97), 0, Global_102491, 0);
								func_5(func_19(iLocal_97), 0, Global_102491, true, false);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_97), 0, Global_102491, 0);
								func_5(func_19(iLocal_97), 0, Global_102491, false, false);
							}
						}
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0xAD8 (2776)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_2() // Position - 0xAEB (2795)
{
	if (bLocal_144)
	{
		if (hLocal_139 != 0)
...
void func_3() // Position - 0xB19 (2841)
{
	return;
}

void func_4() // Position - 0xB21 (2849)
{
	return;
}

void func_5(char* sParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4) // Position - 0xB29 (2857)
{
...
void func_6(var uParam0) // Position - 0xB6D (2925)
{
	if (*uParam0 == -1)
		return;
...
void func_7() // Position - 0xBAA (2986)
{
	var textLabel;
...
BOOL func_8() // Position - 0xBF6 (3062)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_9() // Position - 0xC0C (3084)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_10(var uParam0) // Position - 0xC22 (3106)
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_11(int* piParam0) // Position - 0xC38 (3128)
{
	if (func_14(piParam0))
		if (func_13(piParam0))
			return piParam0->f_2;
...
float func_12(BOOL bParam0) // Position - 0xC74 (3188)
{
	float num;
	float num2;
	int networkTime;
...
BOOL func_13(int* piParam0) // Position - 0xCCC (3276)
{
	return IS_BIT_SET(*piParam0, 2);
}

BOOL func_14(int* piParam0) // Position - 0xCD9 (3289)
{
	return IS_BIT_SET(*piParam0, 1);
}

int func_15() // Position - 0xCE6 (3302)
{
	return 1;
}

void func_16() // Position - 0xCEF (3311)
{
	return;
}

void func_17(char* sParam0, int iParam1, int iParam2) // Position - 0xCF7 (3319)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_99499))
	{
...
BOOL func_18(BOOL bParam0) // Position - 0xD38 (3384)
{
...
char* func_19(int iParam0) // Position - 0xD60 (3424)
{
	switch (iParam0)
	{
		case 0:
...
void func_20(int iParam0) // Position - 0xE9E (3742)
{
	int num;
	var textLabel;
...
void func_21(int* piParam0) // Position - 0xEFF (3839)
{
	if (!func_14(piParam0))
		func_24(piParam0);
	else
...
void func_22(int* piParam0) // Position - 0xF20 (3872)
{
	func_23(piParam0, 0f);
	return;
}

void func_23(int* piParam0, float fParam1) // Position - 0xF2F (3887)
{
...
void func_24(int* piParam0) // Position - 0xF5A (3930)
{
	if (!func_14(piParam0))
		func_22(piParam0);
...
int func_25() // Position - 0xF72 (3954)
{
	var entityRotation;
	int num;
	...
	num = BUILTIN::START_NEW_SCRIPT_WITH_ARGS(&uLocal_51, &uLocal_147, 7, essLocal_95);
	SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&uLocal_51);
	return num;
}

void func_26(Ped pedParam0) // Position - 0xFD9 (4057)
{
	int num;
	int num2;
	int num3;
...
void func_27(int iParam0) // Position - 0x1032 (4146)
{
...
int func_28(Ped pedParam0) // Position - 0x10B5 (4277)
{
	int i;
...
void func_29(int iParam0, int iParam1, int iParam2) // Position - 0x10E6 (4326)
{
	func_30(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_30(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x10FB (4347)
{
	int num;
...
int func_31() // Position - 0x117D (4477)
{
	int i;
...
BOOL func_32(int iParam0, int iParam1, int iParam2) // Position - 0x11AE (4526)
{
...
int func_33(int iParam0, int iParam1, int iParam2) // Position - 0x11C9 (4553)
{
	int i;
...
int func_34(Ped pedParam0) // Position - 0x1215 (4629)
{
	int i;
...
void func_35() // Position - 0x125E (4702)
{
...
int func_36(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x12DB (4827)
{
	int i;
...
void func_37(var uParam0, int iParam1) // Position - 0x1412 (5138)
{
	int i;
...
BOOL func_38(int iParam0) // Position - 0x1461 (5217)
{
	if (Global_44886 == 15)
		return false;
...
void func_39() // Position - 0x1483 (5251)
{
	var sizeAndPeds;
	int pedNearbyPeds;
	int i;
...
void func_40(int iParam0, int iParam1) // Position - 0x1A74 (6772)
{
	int num;
...
void func_41(int iParam0) // Position - 0x1B61 (7009)
{
...
void func_42(int iParam0) // Position - 0x1BAC (7084)
{
	Vector3 vector;
	BOOL flag;
	BOOL flag2;
...
BOOL func_43() // Position - 0x2072 (8306)
{
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x20F1 (8433)
{
	func_45();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_45() // Position - 0x210A (8458)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_46(character) && !func_103(14) || Global_113879)
			{
...
BOOL func_46(eCharacter echParam0) // Position - 0x2207 (8711)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x2213 (8723)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x2250 (8784)
{
...
Hash func_49(eCharacter echParam0) // Position - 0x2275 (8821)
{
	return Global_2339[echParam0 /*29*/];
}

int func_50(int iParam0) // Position - 0x2284 (8836)
{
	eCharacter character;
...
BOOL func_51(int iParam0) // Position - 0x24AC (9388)
{
	Hash entityModel;
...
Vehicle func_52(Vehicle veParam0) // Position - 0x2518 (9496)
{
	return veParam0;
}

void func_53(int iParam0, var uParam1) // Position - 0x2522 (9506)
{
	int num;
	int num2;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_54(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93217[26 /*34*/].f_6) == 0)
			{
				Global_114931.f_7268[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114931.f_7268[iParam0], true, true);
			}
...
BOOL func_54(int iParam0) // Position - 0x2EBA (11962)
{
	var unk;
	int doorState;
...
int func_55(int iParam0) // Position - 0x2EEE (12014)
{
	return BUILTIN::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_56() // Position - 0x2F01 (12033)
{
	var unk;
...
void func_57(var uParam0, int iParam1) // Position - 0x2F47 (12103)
{
	if (iParam1 <= 0)
		return;
...
void func_58(var uParam0, int iParam1) // Position - 0x2FCD (12237)
{
...
void func_59(var uParam0, int iParam1) // Position - 0x3000 (12288)
{
	int num;
	int num2;
...
int func_60(int iParam0, int iParam1) // Position - 0x3051 (12369)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_61(int iParam0) // Position - 0x30F3 (12531)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_62(BOOL bParam0, var uParam1, var uParam2) // Position - 0x3115 (12565)
{
	if (bParam0)
		return uParam1;
...
int func_63(int iParam0) // Position - 0x312C (12588)
{
	return iParam0 & 15;
}

void func_64(var uParam0, int iParam1) // Position - 0x3139 (12601)
{
...
void func_65(var uParam0, int iParam1) // Position - 0x3173 (12659)
{
...
void func_66(var uParam0, int iParam1) // Position - 0x31AE (12718)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
struct<7> func_67(int iParam0) // Position - 0x31EA (12778)
{
	var unk;
...
void func_71(int iParam0) // Position - 0x5E3C (24124)
{
	if (iParam0 == 2)
	{
	}
...
int func_72() // Position - 0x5E5D (24157)
{
	Vector3 vector;
	float num;
	float num2;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		for (i = 0; i < func_74() + 1; i = i + 1)
		{
			if (i > 0)
			{
				num2 = BUILTIN::VDIST2(vector, func_73(i));
...
Vector3 func_73(int iParam0) // Position - 0x5EBE (24254)
{
	switch (iParam0)
	{
		case 1:
...
int func_74() // Position - 0x5F00 (24320)
{
	return 1;
}

BOOL func_75(int iParam0, BOOL bParam1) // Position - 0x5F09 (24329)
{
	int num;
...
int func_76(int iParam0) // Position - 0x5FC1 (24513)
{
	int i;
...
void func_77(var uParam0) // Position - 0x5FFC (24572)
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x6053 (24659)
{
	int i;
...
BOOL func_79(var uParam0) // Position - 0x617E (24958)
{
	return true;
}

BOOL func_80(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Vector3 vParam4, var uParam5, var uParam6, Object obParam7) // Position - 0x6187 (24967)
{
	int entityHit;
	var endCoords;
	var surfaceNormal;
...
BOOL func_84() // Position - 0x62C6 (25286)
{
	return MISC::GET_GAME_TIMER() <= Global_24546.f_6481 + 100;
}

BOOL func_85() // Position - 0x62DB (25307)
{
...
BOOL func_86(BOOL bParam0) // Position - 0x62F5 (25333)
{
	if (bParam0)
...
void func_87(var uParam0, int iParam1) // Position - 0x631E (25374)
{
	func_88(uParam0, iParam1);
	return;
}

void func_88(var uParam0, int iParam1) // Position - 0x632E (25390)
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

BOOL func_89() // Position - 0x633F (25407)
{
	if (func_103(6) || func_103(7))
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			return func_102(67);
...
BOOL func_90() // Position - 0x6371 (25457)
{
	int weaponHash;
	BOOL flag;
...
BOOL func_91(int iParam0) // Position - 0x647B (25723)
{
	eCharacter character;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_98() || Global_113978 || Global_33795 || func_97() || func_83(8, -1) || func_96() || func_95() || func_94() || func_85() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 1:
						if (PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_98() || Global_33795 || func_97() || func_83(8, -1) || func_94() || func_96() || func_95() || func_85() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 2:
						if (!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_98() || Global_113978 || Global_33795 || func_97() || func_83(8, -1) || func_94() || func_96() || func_95() || func_85() || Global_114931.f_7695.f_919[character] == 5 || Global_45433 != -1)
							return false;
						break;
				
					case 3:
						if (PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || func_98() || Global_113978 || Global_33795 || func_97() || func_83(8, -1) || func_96() || func_95() || func_85() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 4:
						if (func_98() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || func_83(8, -1) || func_85() || func_93() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
							if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0 || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_98() || Global_33795 || func_97() || func_83(8, -1) || func_95() || func_94() || func_85() || Global_114931.f_7695.f_919[character] == 5)
								return false;
						break;
				
					case 7:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_98() || func_95() || Global_113978 || Global_33795 || func_97() || Global_46111 || func_83(8, -1) || func_94() || func_93() || func_85() || Global_114931.f_7695.f_919[character] == 5)
							return false;
						break;
				
					case 8:
						if (PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || !CAM::IS_SCREEN_FADED_IN() || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID()) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID()) || func_98() || Global_113978 || Global_33795 || func_97() || func_83(8, -1) || func_94() || func_93() || func_96() || func_95() || func_85())
							return false;
						break;
				}
			}
...
BOOL func_92() // Position - 0x6B98 (27544)
{
	return Global_102493.f_1;
}

BOOL func_93() // Position - 0x6BA6 (27558)
{
	if (Global_99351 != -1)
...
BOOL func_94() // Position - 0x6BC9 (27593)
{
	if (Global_80566)
		return true;
...
BOOL func_95() // Position - 0x6BF3 (27635)
{
	return Global_102506.f_418 > 0;
}

BOOL func_96() // Position - 0x6C04 (27652)
{
...
BOOL func_98() // Position - 0x6C21 (27681)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_99() // Position - 0x6C3D (27709)
{
...
Entity func_100() // Position - 0x6C57 (27735)
{
	return Global_98261;
}

BOOL func_101(int iParam0) // Position - 0x6C63 (27747)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_102(int iParam0) // Position - 0x6CD5 (27861)
{
	int num;
...
BOOL func_103(int iParam0) // Position - 0x6D11 (27921)
{
	return Global_44886 == iParam0;
}

void func_104() // Position - 0x6D1F (27935)
{
	Vector3 vector;
	Vector3 entityCoords;
	float num;
	...
	if (bLocal_144)
	{
		...
		entityCoords = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
		num = BUILTIN::VDIST2(entityCoords, vector);
	
		if (num > 45f || Global_114893 && !ENTITY::DOES_ENTITY_EXIST(pedLocal_141))
		{
			if (Global_114893)
				Global_114893 = false;
...
var func_105(BOOL bParam0, var uParam1, var uParam2) // Position - 0x6F09 (28425)
{
	if (bParam0)
		return uParam1;
...
Vector3 func_106(BOOL bParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x6F20 (28448)
{
	if (bParam0)
		return uParam1;
...
BOOL func_107() // Position - 0x6F3B (28475)
{
	if (bLocal_144)
...
void func_108() // Position - 0x6F6B (28523)
{
	int num;
...
void func_109(var uParam0, int iParam1) // Position - 0x7073 (28787)
{
	*uParam0 = *uParam0 || iParam1;
	return;
}

void func_110(int iParam0) // Position - 0x7084 (28804)
{
	iLocal_93 = iParam0;
	return;
}

void func_111(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0x7090 (28816)
{
	int num;
	BOOL flag;
...
BOOL func_112() // Position - 0x7190 (29072)
{
...
BOOL func_113() // Position - 0x71AD (29101)
{
	if (Global_99351 != -1)
...
BOOL func_114(int iParam0, int iParam1) // Position - 0x71D0 (29136)
{
	BOOL flag;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x721A (29210)
{
	return func_116(iParam0, Global_44886);
}

BOOL func_116(int iParam0, int iParam1) // Position - 0x722B (29227)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_117(int iParam0, int iParam1) // Position - 0x740C (29708)
{
	return iParam0 && iParam1 != false;
}

void func_118() // Position - 0x741B (29723)
{
	BOOL flag;
...
void func_119(int iParam0, int iParam1) // Position - 0x74B2 (29874)
{
	func_120(iParam0, iParam1);
	return;
}

void func_120(var uParam0, int iParam1) // Position - 0x74C2 (29890)
{
	*uParam0 = *uParam0 - *uParam0 && iParam1;
	return;
}

void func_121(BOOL bParam0) // Position - 0x74D7 (29911)
{
	if (bParam0)
		if (iLocal_103 != 263)
...
void func_122() // Position - 0x7520 (29984)
{
...
void func_123() // Position - 0x755D (30045)
{
	if (bLocal_157)
		func_124(func_72());
...
void func_124(int iParam0) // Position - 0x7572 (30066)
{
	if (iParam0 != 263)
