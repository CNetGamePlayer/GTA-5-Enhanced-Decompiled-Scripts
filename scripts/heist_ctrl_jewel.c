...
void main() // Position - 0x0 (0)
{
	...
	func_246(3);
	func_235(&(uLocal_44.f_1), func_245(Global_98458[1 /*19*/], Global_98458[2 /*19*/]));
...
int func_1(int iParam0) // Position - 0x17C (380)
{
	int num;
	int offset;
...
void func_2() // Position - 0x1D3 (467)
{
	int num;
...
void func_3(var uParam0) // Position - 0x215 (533)
{
...
void func_4(var uParam0) // Position - 0x25E (606)
{
	int num;
	int num2;
...
void func_5(var uParam0, int iParam1, int iParam2) // Position - 0x2E9 (745)
{
...
void func_6(var uParam0, int iParam1, int iParam2) // Position - 0x31B (795)
{
	switch (iParam1)
	{
		case 0:
...
void func_7(var uParam0) // Position - 0x448 (1096)
{
...
void func_8(char* sParam0) // Position - 0x915 (2325)
{
...
void func_9(const char* sParam0) // Position - 0x927 (2343)
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_10(int iParam0, int iParam1) // Position - 0x935 (2357)
{
	BOOL flag;
...
void func_11(var uParam0, BOOL bParam1) // Position - 0x97F (2431)
{
	if (bParam1)
	{
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(const char* message) // Position - 0x9F4 (2548)
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(message);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_13(const char* sParam0, int iParam1) // Position - 0xA07 (2567)
{
	int i;
	int j;
...
void func_14() // Position - 0xAB4 (2740)
{
	int i;
...
void func_15(int iParam0) // Position - 0xBCB (3019)
{
...
void func_16(int iParam0, int iParam1) // Position - 0xC65 (3173)
{
...
void func_17(var uParam0) // Position - 0xD75 (3445)
{
	int num;
	int num2;
...
void func_18(var uParam0) // Position - 0xE48 (3656)
{
	int num;
...
BOOL func_19() // Position - 0x10A8 (4264)
{
...
BOOL func_20() // Position - 0x10CA (4298)
{
...
void func_21(const char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x10E7 (4327)
{
	func_22(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_22(const char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x1108 (4360)
{
	int i;
...
void func_23(var uParam0, int iParam1, int iParam2) // Position - 0x12DB (4827)
{
...
void func_24(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5) // Position - 0x1332 (4914)
{
	if (uParam0->f_483 == 3)
		return;
...
void func_25(var uParam0, var uParam1, float fParam2) // Position - 0x1392 (5010)
{
	var unk;
...
void func_26(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x13D7 (5079)
{
...
Vector3 func_27(var uParam0, var uParam1) // Position - 0x13F6 (5110)
{
	float num;
	float num2;
	float num3;
...
void func_28(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0x14DB (5339)
{
	int value;
	int value2;
...
int func_29(int iParam0, int iParam1) // Position - 0x1546 (5446)
{
	switch (iParam0)
	{
		case 0:
...
int func_30(int iParam0) // Position - 0x162C (5676)
{
	int num;
...
void func_31(var uParam0) // Position - 0x167D (5757)
{
	int num;
...
BOOL func_32(int iParam0, int iParam1) // Position - 0x18EA (6378)
{
	return IS_BIT_SET(Global_114931.f_1.f_120[iParam0], iParam1);
}

void func_33(var uParam0) // Position - 0x1901 (6401)
{
...
void func_34(var uParam0) // Position - 0x1B03 (6915)
{
...
void func_35(var uParam0, int iParam1, int iParam2) // Position - 0x1B25 (6949)
{
	int num;
	int num2;
	int num3;
...
void func_36(var uParam0, int iParam1) // Position - 0x1C5B (7259)
{
	int num;
	int num2;
	int num3;
...
BOOL func_37(var uParam0, int iParam1) // Position - 0x1DE5 (7653)
{
	int num;
	int i;
...
BOOL func_38(int iParam0) // Position - 0x1E2A (7722)
{
	return IS_BIT_SET(Global_114931.f_1.f_118, iParam0);
}

BOOL func_39(int iParam0) // Position - 0x1E3D (7741)
{
	return IS_BIT_SET(Global_114931.f_1.f_116, iParam0);
}

int func_40(int iParam0) // Position - 0x1E50 (7760)
{
	return Global_98304[iParam0 /*5*/];
}

void func_41(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0x1E60 (7776)
{
...
int func_42(int iParam0) // Position - 0x1F9C (8092)
{
	return Global_98304[iParam0 /*5*/].f_1;
}

int func_43(int iParam0, int iParam1) // Position - 0x1FAE (8110)
{
	return BUILTIN::ROUND((BUILTIN::TO_FLOAT(func_45(iParam0, iParam1)) / BUILTIN::TO_FLOAT(func_44(iParam1))) * 100f);
}

int func_44(int iParam0) // Position - 0x1FD7 (8151)
{
	switch (iParam0)
	{
		case 0:
...
int func_45(int iParam0, int iParam1) // Position - 0x2011 (8209)
{
...
int func_46(int iParam0, int iParam1) // Position - 0x202F (8239)
{
	return func_47(iParam1, Global_114931.f_1.f_73[iParam0 /*3*/].f_1, Global_114931.f_1.f_73[iParam0 /*3*/].f_2);
}

int func_47(int iParam0, int iParam1, int iParam2) // Position - 0x2059 (8281)
{
	switch (iParam0)
	{
		case 0:
...
char* func_48(int iParam0) // Position - 0x20AD (8365)
{
	return func_49(3, iParam0);
}

char* func_49(int iParam0, int iParam1) // Position - 0x20BC (8380)
{
	switch (iParam0)
	{
		case 1:
...
int func_50(int iParam0, int iParam1) // Position - 0x219F (8607)
{
	return BUILTIN::ROUND((BUILTIN::TO_FLOAT(func_52(iParam0, iParam1)) / BUILTIN::TO_FLOAT(func_51(iParam1))) * 100f);
}

int func_51(int iParam0) // Position - 0x21C8 (8648)
{
	switch (iParam0)
	{
		case 0:
...
int func_52(int iParam0, int iParam1) // Position - 0x2202 (8706)
{
...
char* func_53(int iParam0) // Position - 0x2220 (8736)
{
	return func_49(2, iParam0);
}

int func_54(int iParam0, int iParam1) // Position - 0x222F (8751)
{
	return BUILTIN::ROUND((BUILTIN::TO_FLOAT(func_56(iParam0, iParam1)) / BUILTIN::TO_FLOAT(func_55(iParam1))) * 100f);
}

int func_55(int iParam0) // Position - 0x2258 (8792)
{
	switch (iParam0)
	{
		case 0:
...
int func_56(int iParam0, int iParam1) // Position - 0x22A1 (8865)
{
...
char* func_57(int iParam0) // Position - 0x22BF (8895)
{
	return func_49(1, iParam0);
}

char* func_58(int iParam0) // Position - 0x22CE (8910)
{
...
char* func_59(int iParam0) // Position - 0x2317 (8983)
{
	return func_60(iParam0);
}

char* func_60(int iParam0) // Position - 0x2325 (8997)
{
	switch (iParam0)
	{
		case 1:
...
void func_61(var uParam0, int iParam1) // Position - 0x2408 (9224)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iParam1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_62(var uParam0, int iParam1, int iParam2) // Position - 0x2427 (9255)
{
	int i;
...
void func_63(var uParam0) // Position - 0x24CF (9423)
{
...
void func_64(var uParam0) // Position - 0x2505 (9477)
{
	switch (uParam0->f_464)
	{
		case 1:
...
int func_65(int iParam0) // Position - 0x2548 (9544)
{
...
int func_66(int iParam0) // Position - 0x2575 (9589)
{
	switch (iParam0)
	{
		case 0:
...
void func_67(var uParam0) // Position - 0x25C6 (9670)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_68(uParam0);
...
void func_68(var uParam0) // Position - 0x25DE (9694)
{
	BOOL flag;
	float dx;
...
void func_69(var uParam0, BOOL bParam1) // Position - 0x27F7 (10231)
{
	Vector3 vector;
...
void func_70(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0x297C (10620)
{
...
void func_71() // Position - 0x2A16 (10774)
{
	Global_24407.f_5 = 0;
	return;
}

void func_72(BOOL bParam0) // Position - 0x2A24 (10788)
{
	if (bParam0)
	{
		func_78();
...
void func_73(int iParam0) // Position - 0x2A87 (10887)
{
	if (func_77())
		return;
...
BOOL func_74() // Position - 0x2B11 (11025)
{
...
void func_75(BOOL bParam0, BOOL bParam1) // Position - 0x2B38 (11064)
{
	if (bParam0)
	{
		if (func_151(0))
...
BOOL func_76() // Position - 0x2BAC (11180)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_77() // Position - 0x2BBA (11194)
{
	return IS_BIT_SET(Global_1964705, 19);
}

void func_78() // Position - 0x2BC9 (11209)
{
...
void func_79(var uParam0) // Position - 0x2BF2 (11250)
{
	const char* controlGroupInstructionalButtonsString;
	BOOL flag;
	Vector3 vector;
...
void func_80(var uParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, int iParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x2E2F (11823)
{
	var unk;
...
float func_81(float fParam0, float fParam1, float fParam2) // Position - 0x3383 (13187)
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_82(int iParam0, int iParam1, int iParam2) // Position - 0x33AA (13226)
{
	if (iParam0 > iParam2)
		return iParam2;
...
void func_83(var uParam0, var uParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x33CF (13263)
{
...
void func_84(var uParam0) // Position - 0x34D3 (13523)
{
	BOOL flag;
	int i;
...
void func_85(int iParam0, int iParam1, BOOL bParam2) // Position - 0x35A9 (13737)
{
	BOOL flag;
...
void func_86(var uParam0, int iParam1) // Position - 0x362B (13867)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "FOCUS_VIEW");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(99);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
void func_87(var uParam0) // Position - 0x3672 (13938)
{
	int i;
	int j;
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x3820 (14368)
{
...
BOOL func_89(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x386E (14446)
{
	Global_23001 = 0;
...
void func_90() // Position - 0x3B3C (15164)
{
	if (!func_91())
		return;
...
BOOL func_91() // Position - 0x3B73 (15219)
{
...
BOOL func_92(Player plParam0) // Position - 0x3BD6 (15318)
{
...
BOOL func_93(Player plParam0, int iParam1) // Position - 0x3C0D (15373)
{
	return IS_BIT_SET(Global_1892798[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_94(int iParam0) // Position - 0x3C25 (15397)
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x3C37 (15415)
{
	return -1;
}

void func_96() // Position - 0x3C40 (15424)
{
	int i;
...
void func_97() // Position - 0x3C71 (15473)
{
...
BOOL func_98() // Position - 0x3D06 (15622)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x3D9F (15775)
{
	if (func_231(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x3E41 (15937)
{
	func_101();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_101() // Position - 0x3E5A (15962)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (_GET_CHARACTER_MODEL(Global_114931.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_102(character) && !func_231(14) || Global_113879)
			{
...
BOOL func_102(eCharacter echParam0) // Position - 0x3F57 (16215)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x3F63 (16227)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x3FA0 (16288)
{
...
Hash func_105(eCharacter echParam0) // Position - 0x3FC5 (16325)
{
	return Global_2339[echParam0 /*29*/];
}

void func_106() // Position - 0x3FD4 (16340)
{
	int i;
...
BOOL func_107(int iParam0, int iParam1) // Position - 0x402C (16428)
{
	switch (iParam0)
	{
		case 5:
...
void func_108() // Position - 0x4064 (16484)
{
...
void func_109(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x40BB (16571)
{
...
void func_110(var uParam0) // Position - 0x4111 (16657)
{
	int num;
	int num2;
	int i;
...
void func_111(var uParam0, int iParam1) // Position - 0x4EB9 (20153)
{
	if (!func_19())
	{
		if (uParam0->f_483 == 0)
...
void func_112(var uParam0, int iParam1) // Position - 0x50C9 (20681)
{
...
void func_113(int iParam0) // Position - 0x57F4 (22516)
{
	int num;
...
void func_114(int iParam0, int iParam1) // Position - 0x58EF (22767)
{
	if (iParam0 == 13 || iParam0 == -1)
		return;
...
void func_115(int iParam0, int iParam1) // Position - 0x5934 (22836)
{
	if (iParam0 == 146 || iParam0 == -1)
		return;

	if (Global_114931.f_9092.f_99.f_58[iParam0] == iParam1)
		return;

	Global_114931.f_9092.f_99.f_58[iParam0] = iParam1;
	return;
}

void func_116(int iParam0, int iParam1, BOOL bParam2) // Position - 0x5979 (22905)
{
	if (bParam2)
...
void func_117(int iParam0) // Position - 0x59B7 (22967)
{
	int i;
	int num;
...
void func_118(int iParam0) // Position - 0x5D34 (23860)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_119(BOOL bParam0) // Position - 0x5E7C (24188)
{
...
void func_120() // Position - 0x5EA4 (24228)
{
	Global_21866 = 0;
	func_121();
	return;
...
void func_121() // Position - 0x5EB4 (24244)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
void func_122() // Position - 0x5ED5 (24277)
{
...
void func_123() // Position - 0x5EE5 (24293)
{
	Global_24407.f_134 = 1;
	return;
}

void func_124(var uParam0) // Position - 0x5EF3 (24307)
{
	Vector3 vector;
	Interior interiorAtCoords;
...
void func_125() // Position - 0x60E5 (24805)
{
	int i;
...
void func_126(BOOL bParam0) // Position - 0x6143 (24899)
{
	if (!bParam0)
...
void func_127(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, float fParam7, int iParam8, int iParam9, int iParam10, var uParam11, int iParam12, int iParam13, int iParam14, BOOL bParam15) // Position - 0x6161 (24929)
{
	uParam0->f_1 = { uParam1 };
	uParam0->f_4 = { uParam4 };
	uParam0->f_7 = fParam7;
...
void func_128() // Position - 0x6259 (25177)
{
	Global_24407.f_5 = 1;
	return;
}

void func_129(Ped pedParam0) // Position - 0x6267 (25191)
{
	int num;
	int num2;
	int num3;
...
void func_130(int iParam0) // Position - 0x62C0 (25280)
{
...
int func_131(Ped pedParam0) // Position - 0x6343 (25411)
{
	int i;
...
void func_132(int iParam0, int iParam1, int iParam2) // Position - 0x6374 (25460)
{
	func_133(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_133(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0x6389 (25481)
{
	int num;
...
int func_134() // Position - 0x640B (25611)
{
	int i;
...
BOOL func_135(int iParam0, int iParam1, int iParam2) // Position - 0x643C (25660)
{
...
int func_136(int iParam0, int iParam1, int iParam2) // Position - 0x6457 (25687)
{
	int i;
...
int func_137(Ped pedParam0) // Position - 0x64A3 (25763)
{
	int i;
...
void func_138(var uParam0) // Position - 0x64EC (25836)
{
	int num;
...
int func_139(int iParam0) // Position - 0x6543 (25923)
{
	int i;
...
BOOL func_140(int iParam0, BOOL bParam1) // Position - 0x657E (25982)
{
	int num;
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x6636 (26166)
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0x6761 (26465)
{
	eCharacter character;
...
BOOL func_143() // Position - 0x6E7E (28286)
{
	return Global_102493.f_1;
}

BOOL func_144() // Position - 0x6E8C (28300)
{
	if (Global_99351 != -1)
...
BOOL func_145() // Position - 0x6EAF (28335)
{
...
BOOL func_146() // Position - 0x6EC9 (28361)
{
	if (Global_80566)
		return true;
...
BOOL func_147() // Position - 0x6EF3 (28403)
{
	return Global_102506.f_418 > 0;
}

BOOL func_148() // Position - 0x6F04 (28420)
{
	return Global_102506.f_417 > 0;
}

BOOL func_149() // Position - 0x6F15 (28437)
{
	return Global_1575092;
}

BOOL func_150() // Position - 0x6F21 (28449)
{
...
BOOL func_151(int iParam0) // Position - 0x6F3D (28477)
{
	if (iParam0 == 1)
		if (Global_21627.f_1 > 3)
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0x6F94 (28564)
{
	return func_153(iParam0, Global_44886);
}

BOOL func_153(int iParam0, int iParam1) // Position - 0x6FA5 (28581)
{
	if (iParam1 == 15)
		return 1;
...
void func_154() // Position - 0x7186 (29062)
{
	var args;
	Vector3 vector;
	...
	if (func_233(18))
	{
		...
		else if (iLocal_41 == -1 && !func_119(false))
		{
			iLocal_41 = MISC::GET_GAME_TIMER() + 1500;
		}
		else if (MISC::GET_GAME_TIMER() > iLocal_41 || func_119(false))
		{
			if (func_119(false))
			{
			...
			func_193(&(Global_114931.f_2370.f_539), 86);
			func_163(&(Global_114931.f_2370.f_539), 86);
			func_162(&iLocal_43);
...
void func_155(int iParam0, BOOL bParam1) // Position - 0x7581 (30081)
{
	int i;
	int num;
...
void func_156(char* sParam0) // Position - 0x7747 (30535)
{
...
BOOL func_157(int iParam0) // Position - 0x776B (30571)
{
	int num;
	int i;
...
BOOL func_158(int iParam0) // Position - 0x77AB (30635)
{
...
void func_159(int iParam0, BOOL bParam1) // Position - 0x77D7 (30679)
{
	int offset;
...
char* func_160(int iParam0) // Position - 0x7820 (30752)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_161(int iParam0) // Position - 0x7903 (30979)
{
...
void func_162(var uParam0) // Position - 0x792F (31023)
{
	if (*uParam0 == -1)
		return;
...
void func_163(var uParam0, int iParam1) // Position - 0x796C (31084)
{
	switch (iParam1)
	{
		case 17:
...
int func_164(var uParam0, int iParam1, int iParam2) // Position - 0x7CB5 (31925)
{
	int num;
	var unk;
	var unk99;
	...
	{
		if (!func_180(Global_100893[iParam2 /*3*/], 0f, 0f, 0f, false))
		{
			unk.f_11 = 12;
			unk.f_31 = 49;
			unk.f_81 = 2;
...
BOOL func_165(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6) // Position - 0x7DD2 (32210)
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_84 = 255;
...
void func_166(int iParam0, var uParam1, int iParam2) // Position - 0xB44D (46157)
{
	int num;
...
int func_167(int iParam0, var uParam1, int iParam2) // Position - 0xB6A9 (46761)
{
	...
	if (!func_168(Global_101858[iParam0 /*98*/], false, -1))
	{
		func_166(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
...
BOOL func_168(Hash hParam0, BOOL bParam1, int iParam2) // Position - 0xB8E1 (47329)
{
	int i;
	Hash outData;
...
BOOL func_169(Hash hParam0) // Position - 0xBA66 (47718)
{
	int num;
	var unk;
	var name;
...
BOOL func_171(Hash hParam0, int iParam1) // Position - 0xBB49 (47945)
{
	int cloudTimeAsInt;
	int num;
	int i;
...
BOOL func_172() // Position - 0xBD31 (48433)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_173() // Position - 0xBD47 (48455)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

BOOL func_174() // Position - 0xBD5D (48477)
{
	return false;
}

BOOL func_175() // Position - 0xBD66 (48486)
{
	return true;
}

BOOL func_176() // Position - 0xBD6F (48495)
{
	return true;
}

BOOL func_177() // Position - 0xBD78 (48504)
{
...
BOOL func_179(int iParam0) // Position - 0xBE49 (48713)
{
...
BOOL func_180(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0xC0CC (49356)
{
	if (bParam6)
...
BOOL func_181(int iParam0, var uParam1, var uParam2) // Position - 0xC113 (49427)
{
	switch (iParam0)
	{
		case 11:
...
var func_182() // Position - 0xCA82 (51842)
{
	var unk;
...
void func_183(var uParam0, int iParam1) // Position - 0xCAC8 (51912)
{
	if (iParam1 <= 0)
		return;
...
void func_184(var uParam0, int iParam1) // Position - 0xCB4E (52046)
{
...
void func_185(var uParam0, int iParam1) // Position - 0xCB81 (52097)
{
	int num;
	int num2;
...
int func_186(int iParam0, int iParam1) // Position - 0xCBD2 (52178)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_187(int iParam0) // Position - 0xCC74 (52340)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_188(BOOL bParam0, var uParam1, var uParam2) // Position - 0xCC96 (52374)
{
	if (bParam0)
		return uParam1;
...
int func_189(int iParam0) // Position - 0xCCAD (52397)
{
	return iParam0 & 15;
}

void func_190(var uParam0, int iParam1) // Position - 0xCCBA (52410)
{
...
void func_191(var uParam0, int iParam1) // Position - 0xCCF4 (52468)
{
...
void func_192(var uParam0, int iParam1) // Position - 0xCD2F (52527)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
void func_193(var uParam0, int iParam1) // Position - 0xCD6B (52587)
{
	int i;
	int num;
	var unk;
	...
	for (i = 0; i < 3; i = i + 1)
	{
		...
		else
		{
			...
			if (!func_181(Global_114931.f_18540[i], &unk, &num2))
			{
...
void func_194(var uParam0) // Position - 0xCF31 (53041)
{
	*uParam0 = -15;
	return;
}

int func_195() // Position - 0xCF3F (53055)
{
	if (func_119(false))
		return 0;
...
void func_196(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xCF8A (53130)
{
	if (bParam0)
	{
...
BOOL func_197() // Position - 0xD0D9 (53465)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_198(Player plParam0, int iParam1) // Position - 0xD0F3 (53491)
{
	BOOL flag;
...
int func_199(int iParam0, BOOL bParam1) // Position - 0xD14C (53580)
{
	int num;
	int num2;
...
int func_200() // Position - 0xD18D (53645)
{
	return Global_1574927;
}

BOOL func_201(Player plParam0) // Position - 0xD199 (53657)
{
	Player player;
...
BOOL func_202(Player plParam0) // Position - 0xD1BB (53691)
{
...
BOOL func_203() // Position - 0xD1FA (53754)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_204(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xD208 (53768)
{
	int num;
...
void func_205(int iParam0) // Position - 0xD23B (53819)
{
	if (iParam0 == 1)
...
void func_206() // Position - 0xD25E (53854)
{
			...
			if (IS_BIT_SET(iLocal_39, 2))
			{
				switch (iLocal_40)
				{
					case 0:
						...
						{
							if (!ENTITY::IS_ENTITY_DEAD(Global_98926.f_9[0], false))
							{
								pedLocal_727 = Global_98926.f_9[0];
								ENTITY::SET_ENTITY_AS_MISSION_ENTITY(pedLocal_727, false, true);
							}
						}
					
						if (ENTITY::DOES_ENTITY_EXIST(Global_98926[0]))
							if (!ENTITY::IS_ENTITY_DEAD(Global_98926[0], false))
								veLocal_729 = Global_98926[0];
...
void func_207() // Position - 0xDB7D (56189)
{
	func_85(1, 0, true);
	func_85(2, 0, true);
	func_215(&uLocal_44);
...
void func_208(var uParam0) // Position - 0xDB9F (56223)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
	{
		if (!CUTSCENE::IS_CUTSCENE_PLAYING())
...
void func_209(var uParam0) // Position - 0xDBE5 (56293)
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xDC21 (56353)
{
...
int func_211(var uParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xDCBC (56508)
{
	int i;
...
void func_212(var uParam0, int iParam1) // Position - 0xDDF3 (56819)
{
	int i;
...
BOOL func_213(int iParam0) // Position - 0xDE42 (56898)
{
	if (Global_44886 == 15)
		return false;
...
void func_214() // Position - 0xDE64 (56932)
{
	Global_102493 = 1;
	return;
}

void func_215(var uParam0) // Position - 0xDE71 (56945)
{
...
BOOL func_216(int iParam0) // Position - 0xDEC0 (57024)
{
	switch (iParam0)
	{
		case 0:
...
int func_217() // Position - 0xDF2D (57133)
{
	return Global_80568;
}

BOOL func_218(var uParam0) // Position - 0xDF39 (57145)
{
	if (IS_BIT_SET(uParam0->f_449, 1))
		func_208(uParam0);
...
void func_219(var uParam0) // Position - 0xDF62 (57186)
{
...
void func_220(var uParam0, float fParam1, float fParam2) // Position - 0xDFCC (57292)
{
	float num;
...
void func_221(var uParam0) // Position - 0xE09D (57501)
{
...
void func_222(var uParam0) // Position - 0xE11B (57627)
{
	int i;
...
void func_223(var uParam0) // Position - 0xE175 (57717)
{
	int i;
	Hash modelHash;
	float pitch;
...
Vector3 func_224(var uParam0, var uParam1) // Position - 0xE2AB (58027)
{
	float num;
	float num2;
	float num3;
...
void func_225(var uParam0) // Position - 0xE329 (58153)
{
	int i;
	int num;
	int num2;
...
void func_226(var uParam0) // Position - 0xE406 (58374)
{
	int num;
	int value;
	int i;
...
BOOL func_227(var uParam0) // Position - 0xE546 (58694)
{
...
void func_228(var uParam0) // Position - 0xE5E1 (58849)
{
	float num;
	float num2;
...
void func_229(var uParam0) // Position - 0xE66A (58986)
{
	int i;
	int num;
	BOOL value;
...
void func_230(var uParam0) // Position - 0xE8AB (59563)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0->f_413, "SET_DATA_SLOT_EMPTY");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(uParam0->f_415 + 1);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
...
BOOL func_231(int iParam0) // Position - 0xE8CF (59599)
{
	return Global_44886 == iParam0;
}

BOOL func_232(int iParam0) // Position - 0xE8DD (59613)
{
	int i;
...
BOOL func_233(int iParam0) // Position - 0xE945 (59717)
{
	if (iParam0 == 146 || iParam0 == -1)
		return false;
...
void func_234(var uParam0, int iParam1) // Position - 0xE972 (59762)
{
	var unk;
	var unk4;
...
void func_235(var uParam0, var uParam1) // Position - 0xEA3E (59966)
{
...
void func_236(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, BOOL bParam5) // Position - 0xECE4 (60644)
{
	var unk;
...
void func_237(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0xED5D (60765)
{
	if (uParam0->f_33 < 20)
	{
...
void func_238(var uParam0, int iParam1, int iParam2, char* sParam3) // Position - 0xEDA1 (60833)
{
	var unk;
...
void func_239(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4) // Position - 0xEDF1 (60913)
{
	if (uParam0->f_117 < 22)
	{
...
void func_240(var uParam0, int iParam1, char* sParam2, char* sParam3) // Position - 0xEE41 (60993)
{
	var unk;
	var unk3;
...
void func_241(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8) // Position - 0xEEDB (61147)
{
	var unk;
	var unk5;
	var unk9;
...
void func_242(var uParam0, float fParam1, float fParam2, float fParam3) // Position - 0xEF7F (61311)
{
	uParam0->f_9 = fParam1;
...
void func_244(var uParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, int iParam8, int iParam9, var uParam10, float fParam11, float fParam12, float fParam13, float fParam14, float fParam15, float fParam16) // Position - 0xF067 (61543)
{
	uParam0->f_1 = iParam1;
...
var func_245(var uParam0, var uParam1) // Position - 0xF0D3 (61651)
{
	if (uParam0 > uParam1)
		return uParam0;
...
int func_246(int iParam0) // Position - 0xF0E9 (61673)
{
	int num;
	int offset;
...
void func_247() // Position - 0xF140 (61760)
{
