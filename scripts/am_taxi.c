...
BOOL func_489(var uParam0, var uParam1, var uParam2, int iParam3, Hash hParam4, var uParam5, var uParam6, var uParam7, float fParam8, Hash hParam9, int iParam10) // Position - 0x16EDF (93919)
{
	...
	func_481(uParam0, iParam3, hParam4, &Global_1983721, &(Global_1983721.f_3), &(Global_1983721.f_6), 1036831949);
	func_481(uParam5, fParam8, hParam9, &(Global_1983721.f_7), &(Global_1983721.f_10), &(Global_1983721.f_13), 1036831949);
...
void func_507(var uParam0, var uParam1, var uParam2, float fParam3, BOOL bParam4) // Position - 0x181E8 (98792)
{
	Vector3 vector;
	float num;
