...
void main() // Position - 0x0 (0)
{
	...
	while (true)
	{
		...
		if (func_72(PLAYER::PLAYER_ID()))
			if (func_71())
				func_68(&uLocal_141, -271.6364f, 289.377f, 103.994f, BLIP_ELEVATOR, "MSG_BLP_EL" /*Elevator*/, 0.8f, false, false);
			else
				func_67(&uLocal_141);
...
void func_1(var uParam0) // Position - 0x101 (257)
{
...
void func_2(var uParam0, int iParam1) // Position - 0x17C (380)
{
...
void func_4(var uParam0) // Position - 0x1A8 (424)
{
	if (uParam0->f_6 != -1)
	{
		func_5(&(uParam0->f_6));
...
void func_5(var uParam0) // Position - 0x1CA (458)
{
	int num;
...
int func_6(int iParam0) // Position - 0x221 (545)
{
	int i;
...
void func_7(var uParam0) // Position - 0x25C (604)
{
	var animDict;
	var animName;
			...
			if (func_57(PLAYER::PLAYER_PED_ID(), &uParam0->f_16[uParam0->f_9 /*14*/]) && func_56(PLAYER::PLAYER_PED_ID(), uParam0->f_16[uParam0->f_9 /*14*/].f_3, uParam0->f_16[uParam0->f_9 /*14*/].f_13))
			{
				...
				else if (uParam0->f_6 == -1)
				{
					if (MISC::GET_GAME_TIMER() - uParam0->f_11 > 150)
						if (func_45(uParam0->f_9) && !Global_262145.f_26731)
...
void func_8(var uParam0, BOOL bParam1) // Position - 0x7EF (2031)
{
...
int func_9(var uParam0) // Position - 0x90E (2318)
{
	int num;
...
BOOL func_10() // Position - 0x995 (2453)
{
	return func_11(PLAYER::PLAYER_ID());
}

BOOL func_11(Player plParam0) // Position - 0x9A5 (2469)
{
...
int func_12(int iParam0) // Position - 0x9C4 (2500)
{
	switch (iParam0)
	{
		case 0:
...
var func_13(BOOL bParam0, var uParam1, var uParam2) // Position - 0xA05 (2565)
{
	if (bParam0)
		return uParam1;
...
void func_14(var uParam0) // Position - 0xA1C (2588)
{
	Vector3 vector;
	float num;
...
BOOL func_15(BOOL bParam0) // Position - 0xC3A (3130)
{
...
BOOL func_16(Ped pedParam0) // Position - 0xD25 (3365)
{
	int weaponHash;
...
BOOL func_17() // Position - 0xD82 (3458)
{
...
BOOL func_19(var uParam0) // Position - 0xDBE (3518)
{
...
void func_21(var uParam0) // Position - 0xE83 (3715)
{
	var animDict;
...
BOOL func_22() // Position - 0xEED (3821)
{
	return IS_BIT_SET(Global_1950714.f_3, 25);
}

void func_23(int* piParam0, int iParam1) // Position - 0xEFE (3838)
{
	MISC::SET_BIT(piParam0, iParam1);
	return;
}

BOOL func_24(var uParam0, int iParam1) // Position - 0xF0E (3854)
{
	return IS_BIT_SET(*uParam0, iParam1);
}

BOOL func_25(float fParam0, float fParam1, float fParam2) // Position - 0xF1C (3868)
{
	float num;
	float num2;
...
void func_26(var uParam0) // Position - 0xFA2 (4002)
{
	int weaponHash;
...
void func_27() // Position - 0x1036 (4150)
{
	Global_24407.f_6 = 1;
	return;
}

void func_28(BOOL bParam0) // Position - 0x1044 (4164)
{
	if (bParam0)
		if (func_29())
...
BOOL func_29() // Position - 0x1069 (4201)
{
	return IS_BIT_SET(Global_2685153.f_2, 11);
}

void func_30() // Position - 0x107A (4218)
{
	MISC::SET_BIT(&Global_9464, 4);
	return;
}

void func_31(int iParam0) // Position - 0x108A (4234)
{
	if (func_37())
		return;
...
void func_32(int iParam0) // Position - 0x10BD (4285)
{
	if (func_37())
		return;
...
BOOL func_33() // Position - 0x1147 (4423)
{
...
void func_34(BOOL bParam0, BOOL bParam1) // Position - 0x116E (4462)
{
	if (bParam0)
	{
		if (func_36(0))
...
BOOL func_35() // Position - 0x11E2 (4578)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_36(int iParam0) // Position - 0x11F0 (4592)
{
	if (iParam0 == 1)
...
BOOL func_37() // Position - 0x1247 (4679)
{
	return IS_BIT_SET(Global_1964705, 19);
}

Vector3 func_38(var uParam0) // Position - 0x1256 (4694)
{
	var unk;
...
Vector3 func_39(var uParam0) // Position - 0x1292 (4754)
{
	return uParam0->f_16[uParam0->f_9 /*14*/];
}

void func_40(var uParam0, char* sParam1) // Position - 0x12A6 (4774)
{
	if (uParam0->f_1.f_1 == 1)
	{
		if (func_10())
...
void func_41(var uParam0, char* sParam1) // Position - 0x15DB (5595)
{
...
void func_42(var uParam0) // Position - 0x1865 (6245)
{
...
int func_43(var uParam0) // Position - 0x189D (6301)
{
	int randomIntInRange;
...
int func_44(int iParam0) // Position - 0x1935 (6453)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_45(int iParam0) // Position - 0x1963 (6499)
{
	switch (iParam0)
	{
		case 2:
...
void _CONTEXT_ADD_HELP_TEXT(var uParam0, int iParam1, char* sParam2, int iParam3, const char* sParam4, int iParam5, int iParam6) // Position - 0x19A1 (6561)
{
	int i;
...
BOOL func_47(Player plParam0) // Position - 0x1ACC (6860)
{
	return func_48(plParam0) == joaat("WEAPON_MINIGUN");
}

int func_48(Player plParam0) // Position - 0x1AE0 (6880)
{
	return Global_1892798[plParam0 /*615*/].f_592;
}

BOOL func_49(var uParam0) // Position - 0x1AF4 (6900)
{
	*uParam0(!func_24(&(uParam0->f_7), 5), &uParam0->f_16[uParam0->f_9 /*14*/], uParam0->f_9);
	return StackVal || StackVal;
}

BOOL func_50(var uParam0) // Position - 0x1B1E (6942)
{
	var sizeAndPeds;
	int i;
...
BOOL func_51(var uParam0) // Position - 0x1B95 (7061)
{
	int i;
...
int func_52(ePedComponentType epctParam0) // Position - 0x1C0F (7183)
{
...
Player _INVALID_PLAYER_INDEX() // Position - 0x1C30 (7216)
{
	return -1;
}

BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x1C39 (7225)
{
...
BOOL func_55(var uParam0) // Position - 0x1C99 (7321)
{
	return uParam0->f_7 & 31 > 0;
}

BOOL func_56(Ped pedParam0, var uParam1, var uParam2, var uParam3, int iParam4) // Position - 0x1CAA (7338)
{
...
BOOL func_59(int iParam0) // Position - 0x1D9D (7581)
{
	switch (iParam0)
	{
		case 1:
...
void func_60(int* piParam0, int iParam1) // Position - 0x1E03 (7683)
{
	MISC::CLEAR_BIT(piParam0, iParam1);
	return;
}

void func_61(var uParam0) // Position - 0x1E13 (7699)
{
	if (uParam0->f_13 == 6)
	{
	}
...
float func_62() // Position - 0x1E66 (7782)
{
	return 0.13f;
}

void func_63(var uParam0) // Position - 0x1E73 (7795)
{
...
void func_64(int* piParam0, int iParam1, BOOL bParam2) // Position - 0x1ECB (7883)
{
	int offset;
...
BOOL func_65() // Position - 0x1EEF (7919)
{
	return Global_77359;
}

BOOL func_66() // Position - 0x1EFB (7931)
{
...
void func_67(Blip* pblParam0) // Position - 0x1F12 (7954)
{
...
void func_68(var uParam0, float fParam1, float fParam2, float fParam3, eBlipSprite ebsParam4, char* sParam5, float fParam6, BOOL bParam7, BOOL bParam8) // Position - 0x1F32 (7986)
{
...
Blip func_69(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x1F95 (8085)
{
	Blip blip;
...
var func_70(BOOL bParam0, var uParam1, var uParam2) // Position - 0x1FC1 (8129)
{
	if (bParam0)
		return uParam1;
...
BOOL func_71() // Position - 0x1FD8 (8152)
{
	return IS_BIT_SET(Global_1950714.f_11, 17);
}

BOOL func_72(Player plParam0) // Position - 0x1FE9 (8169)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
		return Global_1845299[plParam0 /*883*/].f_260.f_524 != 0;

	return false;
}

BOOL func_73() // Position - 0x200F (8207)
{
	...
	if (MISC::GET_DISTANCE_BETWEEN_COORDS(_GET_PLAYER_COORDS(PLAYER::PLAYER_ID()), Global_1950714.f_1336[161 /*3*/], true) >= 150f)
		return true;
...
BOOL func_74() // Position - 0x207F (8319)
{
	if (func_75() == 0)
		return true;
...
int func_75() // Position - 0x2094 (8340)
{
	return Global_1574634.f_18;
}

BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0x20A2 (8354)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0x2126 (8486)
{
	switch (func_79())
	{
		case 0:
...
Hash func_78() // Position - 0x2159 (8537)
{
...
int func_79() // Position - 0x217D (8573)
{
	return Global_33792;
}

BOOL func_80() // Position - 0x2188 (8584)
{
	return Global_2685153.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0x2197 (8599)
{
...
BOOL func_82() // Position - 0x21AE (8622)
{
	return Global_2696981;
}

BOOL func_83() // Position - 0x21BA (8634)
{
	return Global_2685153.f_695;
}

Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x21C9 (8649)
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(plParam0), false);
}

BOOL func_85(ePedComponentType epctParam0) // Position - 0x21DC (8668)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_86(Player plParam0) // Position - 0x2242 (8770)
{
...
void func_87() // Position - 0x2273 (8819)
{
	func_89(&uLocal_142);
	func_67(&uLocal_141);
	func_88();
...
void func_88() // Position - 0x228B (8843)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_89(var uParam0) // Position - 0x2297 (8855)
{
	int localSceneFromNetworkId;
...
void _SET_PLAYER_CONTROL_EX(Player plParam0, BOOL bParam1, eSetPlayerControlFlags espcfParam2, BOOL bParam3) // Position - 0x22F6 (8950)
{
...
BOOL func_91(int iParam0) // Position - 0x27AA (10154)
{
	return iParam0 == 17;
}

void func_92() // Position - 0x27B7 (10167)
{
	var unk;
...
void func_93() // Position - 0x2804 (10244)
{
...
BOOL func_94(Ped pedParam0) // Position - 0x2842 (10306)
{
	int scriptTaskStatus;
...
void func_95(BOOL bParam0, Ped pedParam1, int iParam2) // Position - 0x2873 (10355)
{
	int num;
	eViewModeContext i;
...
void _MPPLY_STAT_SET_BOOL(Hash hParam0, BOOL bParam1) // Position - 0x2943 (10563)
{
	Hash statName;
...
void func_97() // Position - 0x295F (10591)
{
	eViewModeContext i;
...
BOOL func_98(Player plParam0) // Position - 0x29B7 (10679)
{
...
BOOL func_99() // Position - 0x29F6 (10742)
{
	return IS_BIT_SET(Global_2621446, 3);
}

BOOL func_100(Player plParam0, int iParam1) // Position - 0x2A04 (10756)
{
	BOOL flag;
...
BOOL func_103(Player plParam0) // Position - 0x2AAA (10922)
{
	Player player;
...
BOOL func_104() // Position - 0x2ACC (10956)
{
...
void func_105() // Position - 0x2AFD (11005)
{
...
void func_106() // Position - 0x2B2B (11051)
{
	func_107(0, &uLocal_142, 0, 2);
	func_107(1, &uLocal_142, 1, 1);
	func_107(2, &uLocal_142, 2, 2);
	func_107(3, &uLocal_142, 3, 1);
	func_107(4, &uLocal_142, 4, 2);
	func_107(5, &uLocal_142, 5, 1);
	func_107(6, &uLocal_142, 6, 2);
	func_107(7, &uLocal_142, 7, 1);
	return;
}

void func_107(int iParam0, var uParam1, int iParam2, int iParam3) // Position - 0x2B7B (11131)
{
	var unk;
	float num;
	...
	uParam1->f_16[iParam2 /*14*/].f_6 = fLocal_124;
	return;
}

Vector3 func_108() // Position - 0x2BFD (11261)
{
	return 0.4f, -0.5f, 2f;
}

Vector3 func_109(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x2C10 (11280)
{
	float num;
	float num2;
	float num3;
...
Vector3 func_110() // Position - 0x2C54 (11348)
{
	return -0.4f, -0.5f, 0f;
}

void func_111(int iParam0, var uParam1, var uParam2) // Position - 0x2C67 (11367)
{
	switch (iParam0)
	{
		case 0:
...
void func_112() // Position - 0x2D8E (11662)
{
	return;
}

int func_113(int iParam0, int iParam1, BOOL bParam2) // Position - 0x2D96 (11670)
{
	int i;
...
BOOL func_114(BOOL bParam0) // Position - 0x2EAC (11948)
{
	bParam0;
