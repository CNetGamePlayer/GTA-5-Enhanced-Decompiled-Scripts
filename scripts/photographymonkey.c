		...
		if (!func_106(false) && !func_105(14))
		{
			if (iLocal_45 == 0)
			{
				if (func_115())
				{
					...
					bLocal_459 = IS_BIT_SET(Global_9464, 28);
...
void func_1() // Position - 0x398 (920)
{
	Global_114931.f_10056.f_135[1] = -1;
	return;
}

void func_2(int iParam0, BOOL bParam1) // Position - 0x3AD (941)
{
	int offset;
...
BOOL _IS_EXCLUSIVE_CONTENT_UNLOCKED() // Position - 0x412 (1042)
{
	int profileSetting;
...
void func_4(BOOL bParam0) // Position - 0x4CA (1226)
{
	if (bParam0 == 1)
...
void func_6() // Position - 0x538 (1336)
{
	BOOL flag;
	BOOL flag2;
...
void func_7(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, int iParam6) // Position - 0x69C (1692)
{
...
int func_8(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x6E1 (1761)
{
...
BOOL func_9(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x777 (1911)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_10(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x161A (5658)
{
	func_79();
...
void func_11(int iParam0, int iParam1) // Position - 0x166C (5740)
{
	switch (iParam0)
	{
		case 0:
...
void func_12(int iParam0) // Position - 0x175C (5980)
{
	BOOL flag;
	int num;
	var unk;
	...
	func_13(&Global_80088[0 /*14*/], num6, iParam0, &unk, num2, num3, num, flag, num4, num5, false);
	return;
}

void func_13(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, BOOL bParam7, int iParam8, int iParam9, BOOL bParam10) // Position - 0x2949 (10569)
{
	int num;
	int num2;
	...
	*iParam0 = iParam9;
	...
	else
	{
		...
		if (iParam1 == 11 || iParam1 == 4 || iParam1 == 6 || iParam1 == 1 || iParam1 == 14 || iParam1 == 2 || iParam1 == 8 || iParam1 == 9 || iParam1 == 10 || iParam1 == 7 || iParam1 == 12)
		{
			...
			num = func_16(func_20(iParam1, iParam0->f_2), Global_80085);
		
			if (IS_BIT_SET(num, iParam0->f_1))
				MISC::SET_BIT(&(iParam0->f_6), 1);
		
			num = func_16(func_15(iParam1, iParam0->f_2), Global_80085);
...
BOOL func_14(int iParam0, int iParam1, var uParam2) // Position - 0x2CE9 (11497)
{
	*uParam2 = 979;
...
int func_15(int iParam0, int iParam1) // Position - 0x30EE (12526)
{
	switch (iParam1)
	{
		case 0:
...
int func_20(int iParam0, int iParam1) // Position - 0x356D (13677)
{
	switch (iParam1)
	{
		case 0:
...
BOOL func_21(Hash hParam0, int iParam1, BOOL bParam2, BOOL bParam3, int iParam4) // Position - 0x3968 (14696)
{
	int num;
	int num2;
	int num3;
...
BOOL func_22(Hash hParam0, int iParam1, var uParam2, var uParam3, BOOL bParam4, BOOL bParam5) // Position - 0x39A6 (14758)
{
...
int func_23(int iParam0) // Position - 0x66BA (26298)
{
	switch (iParam0)
	{
		case -1:
...
void func_24(int iParam0, int iParam1, int iParam2, Hash hParam3) // Position - 0x678E (26510)
{
	int num;
	int num2;
	Hash outfit;
	...
	if (iParam0 == 12)
	{
		...
		if (outfitIndex >= 0)
		{
			...
			if (num3 > outfitIndex)
			{
				...
				func_13(&Global_80088[0 /*14*/], iParam0, iParam1, &(outfit.f_7), 0, 0, outfit.f_2, false, -1, 2, true);
				return;
			}
		}
	}
	...
	else if (iParam0 == 14)
	{
		...
		if (componentId >= 0)
		{
			...
			if (num5 > componentId)
			{
				...
				func_13(&Global_80088[0 /*14*/], iParam0, iParam1, &(outProp.f_9), outProp.f_3, outProp.f_4, outProp.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outProp.f_1, joaat("OUTFIT_ONLY"), 0), num4, 2, outProp.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (hParam3 != -1 && Global_80286)
		{
			...
			func_13(&Global_80088[0 /*14*/], iParam0, iParam1, &(outComponent.f_9), outComponent.f_3, outComponent.f_4, outComponent.f_5, EXTRAMETADATA::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(outComponent.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, outComponent.f_1 != 0);
			return;
		}
		...
		if (componentId2 >= 0)
		{
			num6 = EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(num2, 11, -1, false, -1, func_25(iParam0));
...
int func_25(int iParam0) // Position - 0x6A13 (27155)
{
	switch (iParam0)
	{
		case 0:
...
void func_26(int iParam0) // Position - 0x6AC3 (27331)
{
	BOOL flag;
	int num;
	var unk;
...
void func_27(int iParam0) // Position - 0x6C06 (27654)
{
	BOOL flag;
	int num;
	var unk;
...
void func_28(int iParam0) // Position - 0x7112 (28946)
{
	BOOL flag;
	int num;
	var unk;
...
void func_29(int iParam0) // Position - 0x7185 (29061)
{
	BOOL flag;
	int num;
	var unk;
...
void func_30(int iParam0) // Position - 0x71F7 (29175)
{
	BOOL flag;
	int num;
	var unk;
...
void func_31(int iParam0) // Position - 0x72DE (29406)
{
	BOOL flag;
	int num;
	var unk;
...
void func_32(int iParam0) // Position - 0x75FF (30207)
{
	BOOL flag;
	int num;
	var unk;
...
void func_33(int iParam0) // Position - 0x77FE (30718)
{
	BOOL flag;
	int num;
	var unk;
...
void func_34(int iParam0) // Position - 0x7A0E (31246)
{
	BOOL flag;
	int num;
	var unk;
...
void func_35(int iParam0) // Position - 0x7B10 (31504)
{
	BOOL flag;
	int num;
	var unk;
...
void func_36(int iParam0) // Position - 0x8496 (33942)
{
	BOOL flag;
	int num;
	var unk;
...
void func_37(int iParam0) // Position - 0x8FD3 (36819)
{
	if (iParam0 < 136)
		func_39(iParam0);
	else
...
void func_38(int iParam0) // Position - 0x9008 (36872)
{
	BOOL flag;
	int num;
	var unk;
...
void func_39(int iParam0) // Position - 0x9C0C (39948)
{
	BOOL flag;
	int num;
	var unk;
...
void func_40(int iParam0) // Position - 0xAAFE (43774)
{
	BOOL flag;
	int num;
	var unk;
...
void func_41(int iParam0) // Position - 0xAC2B (44075)
{
	BOOL flag;
	int num;
	var unk;
...
void func_42(int iParam0, int iParam1) // Position - 0xAD1B (44315)
{
	switch (iParam0)
	{
		case 0:
...
void func_43(int iParam0) // Position - 0xAE0B (44555)
{
	BOOL flag;
	int num;
	var unk;
...
void func_44(int iParam0) // Position - 0xC2B7 (49847)
{
	BOOL flag;
	int num;
	var unk;
...
void func_45(int iParam0) // Position - 0xC3F4 (50164)
{
	BOOL flag;
	int num;
	var unk;
...
void func_46(int iParam0) // Position - 0xC8FD (51453)
{
	BOOL flag;
	int num;
	var unk;
...
void func_47(int iParam0) // Position - 0xCF61 (53089)
{
	BOOL flag;
	int num;
	var unk;
...
void func_48(int iParam0) // Position - 0xCFD3 (53203)
{
	BOOL flag;
	int num;
	var unk;
...
void func_49(int iParam0) // Position - 0xD0A3 (53411)
{
	BOOL flag;
	int num;
	var unk;
...
void func_50(int iParam0) // Position - 0xD569 (54633)
{
	BOOL flag;
	int num;
	var unk;
...
void func_51(int iParam0) // Position - 0xD6F4 (55028)
{
	BOOL flag;
	int num;
	var unk;
...
void func_52(int iParam0) // Position - 0xDED4 (57044)
{
	BOOL flag;
	int num;
	var unk;
...
void func_53(int iParam0) // Position - 0xDFD6 (57302)
{
	BOOL flag;
	int num;
	var unk;
...
void func_54(int iParam0) // Position - 0xEEF1 (61169)
{
	BOOL flag;
	int num;
	var unk;
...
void func_55(int iParam0) // Position - 0xFB8E (64398)
{
	if (iParam0 < 107)
		func_58(iParam0);
	else if (iParam0 < 227)
...
void func_56(int iParam0) // Position - 0xFBD4 (64468)
{
	BOOL flag;
	int num;
	var unk;
...
void func_57(int iParam0) // Position - 0x10678 (67192)
{
	BOOL flag;
	int num;
	var unk;
...
void func_58(int iParam0) // Position - 0x11465 (70757)
{
	BOOL flag;
	int num;
	var unk;
...
void func_59(int iParam0) // Position - 0x1209A (73882)
{
	BOOL flag;
	int num;
	var unk;
...
void func_60(int iParam0) // Position - 0x12311 (74513)
{
	BOOL flag;
	int num;
	var unk;
...
void func_61(int iParam0, int iParam1) // Position - 0x12443 (74819)
{
	switch (iParam0)
	{
		case 0:
...
void func_62(int iParam0) // Position - 0x12533 (75059)
{
	BOOL flag;
	int num;
	var unk;
...
void func_63(int iParam0) // Position - 0x13265 (78437)
{
	BOOL flag;
	int num;
	var unk;
...
void func_64(int iParam0) // Position - 0x133C9 (78793)
{
	BOOL flag;
	int num;
	var unk;
...
void func_65(int iParam0) // Position - 0x13934 (80180)
{
	BOOL flag;
	int num;
	var unk;
...
void func_66(int iParam0) // Position - 0x13E5A (81498)
{
	BOOL flag;
	int num;
	var unk;
...
void func_67(int iParam0) // Position - 0x13ECC (81612)
{
	BOOL flag;
	int num;
	var unk;
...
void func_68(int iParam0) // Position - 0x13F9C (81820)
{
	BOOL flag;
	int num;
	var unk;
...
void func_69(int iParam0) // Position - 0x14460 (83040)
{
	BOOL flag;
	int num;
	var unk;
...
void func_70(int iParam0) // Position - 0x146AD (83629)
{
	BOOL flag;
	int num;
	var unk;
...
void func_71(int iParam0) // Position - 0x14957 (84311)
{
	BOOL flag;
	int num;
	var unk;
...
void func_72(int iParam0) // Position - 0x14B04 (84740)
{
	BOOL flag;
	int num;
	var unk;
...
void func_73(int iParam0) // Position - 0x1563C (87612)
{
	BOOL flag;
	int num;
	var unk;
...
void func_74(int iParam0) // Position - 0x16256 (90710)
{
	if (iParam0 < 60)
		func_76(iParam0);
	else
...
void func_75(int iParam0) // Position - 0x1628B (90763)
{
	BOOL flag;
	int num;
	var unk;
...
void func_76(int iParam0) // Position - 0x17011 (94225)
{
	BOOL flag;
	int num;
	var unk;
...
void func_77(int iParam0) // Position - 0x17689 (95881)
{
	BOOL flag;
	int num;
	var unk;
...
void func_78(int iParam0) // Position - 0x1776E (96110)
{
	BOOL flag;
	int num;
	var unk;
...
void func_79() // Position - 0x1785E (96350)
{
...
void func_80(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x178D5 (96469)
{
	if (iParam2 == -99)
		return;
...
int func_81(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0x179B5 (96693)
{
	int num;
	int i;
	int j;
...
struct<10> func_82(int iParam0, int iParam1) // Position - 0x17D97 (97687)
{
	int i;
	var unk;
...
void func_83(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x186C7 (100039)
{
	int num;
	Hash itemHash;
	Hash outPropVariant;
...
int func_84(int iParam0, Hash hParam1, int iParam2, int iParam3) // Position - 0x187F1 (100337)
{
	var outfit;
	int i;
	int num;
	...
	{
		EXTRAMETADATA::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_25(iParam2));
...
int func_85(int iParam0, int iParam1) // Position - 0x188AC (100524)
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_86(int iParam0) // Position - 0x18C53 (101459)
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
int func_87(int iParam0) // Position - 0x18CB4 (101556)
{
	switch (iParam0)
	{
		case joaat("Player_Zero"):
...
void func_88(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x18D13 (101651)
{
	uParam0->[0] = iParam1;
	uParam0->[1] = iParam2;
	uParam0->[2] = iParam3;
...
struct<17> func_89(int iParam0, int iParam1) // Position - 0x18D5B (101723)
{
	int i;
	var unk;
	...
	switch (iParam0)
	{
		...
		case joaat("Player_Two"):
			...
			{
				case 0:
					func_92(&unk, -99, -99, false, 91, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 12:
					func_92(&unk, -99, -99, false, 93, 29, 0, 13, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 21:
					func_92(&unk, -99, -99, false, 44, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 22:
					func_92(&unk, -99, -99, 98, false, 28, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
			
				case 23:
					func_92(&unk, -99, -99, 27, false, 31, 0, 15, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 42:
					func_92(&unk, -99, -99, 55, false, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
			
				case 43:
					func_92(&unk, -99, -99, false, 52, 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
				...
				case 46:
					func_92(&unk, -99, -99, false, false, 28, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		case joaat("MP_M_Freemode_01"):
			...
			{
				case 0:
					func_92(&unk, -99, -99, false, false, 10, -99, 0, -99, -99, 0, 0, 0, 31);
					break;
			
				case 1:
					func_92(&unk, -99, -99, true, 127, 38, -99, 2, 0, 0, 0, 0, 62, 0);
					break;
			
				case 2:
					func_92(&unk, -99, -99, false, 248, 45, -99, 240, 0, 0, 0, 0, 144, 1);
					break;
				...
				case 4:
					func_92(&unk, -99, -99, true, 66, 10, -99, 21, 0, 0, 0, 0, 123, 3);
					break;
			
				case 5:
					func_92(&unk, -99, -99, true, 93, 141, -99, 3, 0, 0, 0, 0, 114, 4);
					break;
			
				case 6:
					func_92(&unk, -99, -99, true, 116, 113, -99, 7, 0, 0, 0, 0, 113, 5);
					break;
			
				case 7:
					func_92(&unk, -99, -99, true, 61, 136, -99, 27, 0, 0, 0, 0, 61, 6);
					break;
			
				case 8:
					func_92(&unk, -99, -99, false, 112, 10, -99, 240, 0, 0, 0, 0, 8, 7);
					break;
				...
				case 10:
					func_92(&unk, -99, -99, true, 209, 188, -99, 208, 0, 0, 0, 0, 64, 9);
					break;
			
				case 11:
					func_92(&unk, -99, -99, true, 209, 160, -99, 211, 0, 0, 0, 43, 157, 10);
					break;
			
				case 12:
					func_92(&unk, -99, -99, true, 162, 174, -99, 201, 0, 0, 0, 0, 158, 11);
					break;
			
				case 13:
					func_92(&unk, -99, -99, true, 4, 240, -99, 34, 0, 0, 0, 0, 97, 12);
					break;
			
				case 14:
					func_92(&unk, -99, -99, true, 128, 232, -99, 43, 0, 0, 0, 0, 102, 13);
					break;
			
				case 15:
					func_92(&unk, -99, -99, true, 66, 65, -99, 224, 0, 0, 0, 0, 100, 14);
					break;
			
				case 16:
					func_92(&unk, -99, -99, true, 65, 172, -99, 202, 0, 0, 0, 0, 64, 15);
					break;
			
				case 17:
					func_92(&unk, -99, -99, true, 64, 10, -99, 1, 0, 0, 0, 0, 66, 16);
					break;
				...
				case 20:
					func_92(&unk, -99, -99, true, 124, 96, -99, 11, 0, 0, 0, 0, 110, 19);
					break;
			
				case 21:
					func_92(&unk, -99, -99, false, 80, 114, -99, 240, 0, 0, 0, 0, 2, 20);
					break;
				...
				case 23:
					func_92(&unk, -99, -99, true, 116, 144, -99, 2, 0, 0, 0, 0, 108, 22);
					break;
			
				case 24:
					func_92(&unk, -99, -99, true, 63, 38, -99, 3, 0, 0, 0, 0, 63, 23);
					break;
		...
		case joaat("MP_F_Freemode_01"):
			...
			{
				case 0:
					func_92(&unk, -99, -99, false, false, 0, -99, 0, -99, -99, 0, -99, 0, 31);
					break;
				...
				case 2:
					func_92(&unk, -99, -99, 4, true, 96, -99, 32, 0, 0, 0, 7, 215, 0);
					break;
			
				case 3:
					func_92(&unk, -99, -99, true, 73, 241, -99, 3, 0, 0, 0, 0, 25, 1);
					break;
				...
				case 6:
					func_92(&unk, -99, -99, true, 140, 241, -99, 7, 0, 0, 0, 31, 16, 4);
					break;
				...
				case 8:
					func_92(&unk, -99, -99, true, 193, 48, -99, 108, 0, 0, 0, 0, 17, 6);
					break;
				...
				case 13:
					func_92(&unk, -99, -99, 5, false, 0, -99, 10, 0, 0, 0, 0, 130, 31);
					break;
				...
				case 23:
					func_92(&unk, -99, -99, false, 73, 178, -99, 32, 0, 0, 0, 38, 11, 19);
					break;
...
void func_90(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x1ABA3 (109475)
{
	int num;
	Hash outfit;
...
int func_91(int iParam0) // Position - 0x1AD8D (109965)
{
	switch (iParam0)
	{
		case 0:
...
void func_92(var uParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13) // Position - 0x1AE3D (110141)
{
	uParam0->[0] = iParam1;
	uParam0->[2] = iParam2;
	uParam0->[3] = bParam3;
...
int func_93(int iParam0, int iParam1, int iParam2, BOOL bParam3) // Position - 0x1AEAE (110254)
{
	Global_80088[1 /*14*/] = { func_10(iParam0, iParam1, iParam2, -1) };
...
int func_94() // Position - 0x1AF44 (110404)
{
	int i;
	int num;
...
BOOL func_95(int iParam0) // Position - 0x1AF73 (110451)
{
	int num;
	int num2;

	func_96(iParam0, &num, &num2);
	return IS_BIT_SET(Global_114931.f_10056.f_135[num], num2);
}

void func_96(int iParam0, var uParam1, var uParam2) // Position - 0x1AF95 (110485)
{
	*uParam1 = iParam0 / 32;
	*uParam2 = iParam0 % 32;
	return;
...
void func_97(int iParam0, BOOL bParam1) // Position - 0x1AFAD (110509)
{
	int num;
	int offset;
	...
	if (bParam1)
		MISC::SET_BIT(&Global_114931.f_10056.f_135[num], offset);
	else
		MISC::CLEAR_BIT(&Global_114931.f_10056.f_135[num], offset);

	return;
}

void func_98(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4) // Position - 0x1AFED (110573)
{
...
BOOL func_99(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4) // Position - 0x1B013 (110611)
{
	float screenX;
	float screenY;
...
void func_100(Vector3 vParam0, var uParam1, var uParam2, Vector3 vParam3, var uParam4, var uParam5, Vector3 vParam6, var uParam7, var uParam8, var uParam9, var uParam10) // Position - 0x1B053 (110675)
{
	Vector3 screenX;
	Vector3 screenX2;
	Vector3 screenX3;
	...
	*uParam9 = BUILTIN::VDIST(screenX, screenX2);
	*uParam10 = BUILTIN::VDIST(screenX, screenX3);
	return;
}

void func_101(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x1B0A6 (110758)
{
	var entityCoords;
	var unk3;
	var unk6;
...
Vector3 func_102(Vector3 vParam0, var uParam1, var uParam2) // Position - 0x1B247 (111175)
{
	float num;
...
Vector3 func_103(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1B261 (111201)
{
...
int func_104(var uParam0) // Position - 0x1B29A (111258)
{
	int i;
	int num;
	...
	for (i = 0; i < 50; i = i + 1)
	{
		if (!func_95(i))
		{
			num2 = BUILTIN::VDIST2(entityCoords, uLocal_52[i /*8*/]);
...
BOOL func_105(int iParam0) // Position - 0x1B2FF (111359)
{
...
BOOL func_107() // Position - 0x1B335 (111413)
{
	int num;
	int num2;
	int i;
	...
	if (num > 0)
	{
		...
		{
			if (Global_114931.f_10056.f_135[i] != -1)
				return false;
		}
	}

	if (num2 == 31)
		return Global_114931.f_10056.f_135[num] == -1;

	return Global_114931.f_10056.f_135[num] == BUILTIN::ROUND(BUILTIN::POW(2f, BUILTIN::TO_FLOAT(num2 + 1))) - 1;
}

void func_108() // Position - 0x1B3C8 (111560)
{
	if (bLocal_458)
	{
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x1B649 (112201)
{
...
BOOL func_110(int iParam0) // Position - 0x1B660 (112224)
{
...
BOOL func_111() // Position - 0x1B68C (112268)
{
...
BOOL func_112() // Position - 0x1B6B9 (112313)
{
...
void func_113(char* sParam0) // Position - 0x1B6F7 (112375)
{
...
BOOL func_114() // Position - 0x1B709 (112393)
{
	if (Global_80566)
		return true;
...
BOOL func_115() // Position - 0x1B733 (112435)
{
	if (Global_24036)
		return true;
...
void func_116() // Position - 0x1B749 (112457)
{
...
void func_117(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, float fParam8) // Position - 0x1BF99 (114585)
{
...
void func_118(var uParam0) // Position - 0x1BFCF (114639)
{
	if (*uParam0 != -1)
	{
