...
void func_306(var uParam0) // Position - 0x362BE (221886)
{
	...
	func_307(&uLocal_124, -1640.5961f, -3127.1133f, 14.5828f, -2.3352f, 0.0001f, 145.7214f, "HS4_LSA_LAND_VEL", 0, 1, uParam0->f_4, 0);
	return;
}

void func_307(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, var uParam10, int iParam11) // Position - 0x3630B (221963)
{
...
void func_308(var uParam0, char* sParam1, int iParam2, int iParam3, var uParam4) // Position - 0x3633B (222011)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_309(var uParam0, int iParam1, char* sParam2) // Position - 0x36368 (222056)
{
