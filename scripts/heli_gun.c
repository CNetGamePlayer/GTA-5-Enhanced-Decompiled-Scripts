...
void main() // Position - 0x0 (0)
{
	...
	iLocal_347 = -2;
	iLocal_348 = -2;
	uLocal_361 = { 0.1f, 0.1f, 0.1f };
	fLocal_364 = 0f;

	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
		func_356(uScriptParam_0);
	...
	while (true)
	{
		...
		func_327(&uLocal_292, false, false);
		...
		{
			switch (uLocal_378[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/])
			{
				case 0:
					func_325(1);
					break;
				...
				case 1:
					if (func_324(veLocal_367) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::GET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 184, true) != IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_882, 6))
					{
						...
						if (!Global_1836294)
							PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 184, IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_882, 6));
					}
				
					func_1();
					Global_2698885 = false;
...
void func_1() // Position - 0x211 (529)
{
	...
	if (func_309(&uLocal_72))
	{
		if (!bLocal_323 && func_308())
		{
	...
	if (IS_BIT_SET(*Global_4718592.f_192477, 1))
	{
	...
	else if (epctLocal_371 == PLAYER::PLAYER_ID())
	{
		if (bLocal_320)
		{
	...
	switch (uLocal_378[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/].f_1)
	{
		case 0:
			func_286();
			Global_2708955 = 0;
		...
		case 1:
			...
			if (Global_1579260 != -1 || Global_1579266 != -1)
			{
				...
				if (func_230(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()))
				{
					if (PLAYER::GET_MAX_WANTED_LEVEL() > 0)
					{
						PLAYER::SET_WANTED_LEVEL_MULTIPLIER(Global_262145.f_22830);
						iLocal_298 = 1;
					}
				}
			
				if (IS_BIT_SET(Global_1575014, 18))
				{
					iLocal_383 = 1;
					iLocal_388 = 0;
				}
				else if (IS_BIT_SET(Global_1575014, 19))
				{
					iLocal_383 = 2;
					iLocal_388 = 0;
				}
		...
		case 2:
			...
			if (MISC::GET_FRAME_COUNT() % 30 == 0)
				Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_864 = { CAM::GET_FINAL_RENDERED_CAM_COORD() };
			...
			if (Global_1579260 != -1 || func_324(veLocal_367) || Global_1579266 != -1)
			{
				...
				if (uLocal_72.f_217 && uLocal_72.f_218)
				{
					...
					if (func_209())
						func_233(&uLocal_375, false, false);
				...
				else if (!Global_80574 || func_208(3))
				{
			...
			if (Global_1579260 != -1)
			{
				...
				{
					blLocal_374 = func_114(finalRenderedCamCoord, false);
					HUD::SET_BLIP_SPRITE(blLocal_374, BLIP_CENTRE_STROKE);
					HUD::SHOW_HEIGHT_ON_BLIP(blLocal_374, false);
					HUD::SET_BLIP_DISPLAY(blLocal_374, 4);
					HUD::SET_BLIP_COLOUR(blLocal_374, func_113(2));
					HUD::SET_BLIP_SHOW_CONE(blLocal_374, true, 11);
					HUD::SET_BLIP_SCALE(blLocal_374, 0.54f);
					HUD::SET_BLIP_PRIORITY(blLocal_374, 13 + 1);
					...
					HUD::SET_BLIP_COLOUR(blLocal_373, func_113(HUD_COLOUR_GREEN));
			...
			else if (Global_1579266 != -1)
			{
				...
				if (!HUD::DOES_BLIP_EXIST(blLocal_373))
				{
					...
					HUD::SHOW_HEIGHT_ON_BLIP(blLocal_374, false);
					HUD::SET_BLIP_DISPLAY(blLocal_374, 4);
					HUD::SET_BLIP_COLOUR(blLocal_374, func_113(HUD_COLOUR_BLACK));
					HUD::SET_BLIP_SHOW_CONE(blLocal_374, true, 11);
					HUD::SET_BLIP_SCALE(blLocal_374, 0.54f);
					HUD::SET_BLIP_PRIORITY(blLocal_374, 13 + 1);
					blLocal_373 = func_114(finalRenderedCamCoord, false);
			...
			if (uLocal_72.f_34)
			{
				if (Global_1579266 != -1)
				{
					...
					if (Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_863)
						HUD::UNLOCK_MINIMAP_POSITION();
				
					Global_2708953 = false;
					Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_863 = 0;
					func_96();
				}
				else
				{
			...
			if (!bLocal_309 && !bLocal_310 && !bLocal_311 && !bLocal_312 && !bLocal_308 && hLocal_299 != joaat("hunter") && hLocal_299 != joaat("akula") && Global_1579266 == -1)
			{
				Global_2740435 = true;
				uLocal_72.f_7 = 1;
				func_214();
			...
			if (!HUD::IS_PAUSE_MENU_ACTIVE() && !func_66() && !func_65(0) && !HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_1579260 != -1 && func_64(Global_1845129) && !NETWORK::NETWORK_IS_ACTIVITY_SESSION() || Global_1579266 != -1 && func_64(Global_1845129) && !NETWORK::NETWORK_IS_ACTIVITY_SESSION())
			{
				...
				if (PAD::IS_CONTROL_JUST_PRESSED(control, action) || !VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_367, false) || func_63(veLocal_367, false) || _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("HUNTGUN_T_3" /*Turrets are disabled inside of the Bunker.*/) || func_44() || func_39())
				{
					...
					if (HUD::DOES_BLIP_EXIST(blLocal_374))
						HUD::REMOVE_BLIP(&blLocal_374);
					...
					if (Global_1579260 != -1 || Global_1579266 != -1)
					{
						...
						if (!func_18(finalRenderedCamCoord))
							HUD::SET_FAKE_PAUSEMAP_PLAYER_POSITION_THIS_FRAME(finalRenderedCamCoord, finalRenderedCamCoord.f_1);
...
void func_2() // Position - 0x1CC7 (7367)
{
	int num;
	BOOL flag;

	num = 0;
	flag = IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_882, 6);
	...
	{
		if (iLocal_359 != 0)
			AUDIO::STOP_AUDIO_SCENE(func_5(iLocal_359));
	...
	if (flag)
	{
		if (uLocal_72.f_216 == -1)
		{
			...
			if (uLocal_72.f_216 != -1)
				AUDIO::PLAY_SOUND_FRONTEND(uLocal_72.f_216, func_4(iLocal_360, 1), func_3(iLocal_360), true);
		}
	}
...
char* func_3(int iParam0) // Position - 0x1DD9 (7641)
{
	switch (iParam0)
	{
		case 1:
...
char* func_4(int iParam0, int iParam1) // Position - 0x1E1B (7707)
{
	switch (iParam1)
	{
		case 1:
...
char* func_5(int iParam0) // Position - 0x1E9D (7837)
{
	switch (iParam0)
	{
		case 1:
...
BOOL func_6() // Position - 0x1EF1 (7921)
{
...
void func_8(int iParam0) // Position - 0x1F28 (7976)
{
	if (func_9(iParam0))
		iLocal_353 = iParam0;
...
BOOL func_9(int iParam0) // Position - 0x1F41 (8001)
{
	switch (hLocal_299)
	{
		case 858355070:
...
int func_10(BOOL bParam0) // Position - 0x1F7B (8059)
{
	switch (hLocal_299)
	{
		case 858355070:
...
BOOL func_17() // Position - 0x220F (8719)
{
	return PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_VEH_FLY_YAW_RIGHT);
}

BOOL func_18(float fParam0, var uParam1, var uParam2) // Position - 0x221E (8734)
{
...
Vector3 _GET_PLAYER_COORDS(Player plParam0) // Position - 0x2248 (8776)
{
...
BOOL func_21() // Position - 0x277B (10107)
{
	...
	if (func_229(PLAYER::PLAYER_ID()))
	{
		...
		if (NETWORK::NETWORK_IS_ACTIVITY_SESSION() && !IS_BIT_SET(Global_4718592.f_41, 21))
			return false;
...
Vehicle func_26(BOOL bParam0, BOOL bParam1) // Position - 0x291B (10523)
{
	if (func_230(PLAYER::PLAYER_ID()) || bParam0)
	{
		...
		{
			if (!ENTITY::DOES_ENTITY_EXIST(Global_1969791[Global_1845135]))
				return Global_1673942;
		
			return Global_1969791[Global_1845135];
		}
	}

	if (bParam1)
		if (Global_1845136 != _INVALID_PLAYER_INDEX())
			return Global_1969791[Global_1845136];
...
BOOL func_31(ePedComponentType epctParam0) // Position - 0x2BAB (11179)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		return IS_BIT_SET(Global_1845299[epctParam0 /*883*/].f_260.f_318, 0);
...
BOOL func_32(int iParam0) // Position - 0x2BD1 (11217)
{
	...
	player = Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_9;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		...
		if (_NETWORK_IS_PLAYER_VALID(type, true, true) && type != PLAYER::PLAYER_ID())
			if (Global_2658294[type /*468*/].f_325.f_9 == player)
				if (Global_1845299[type /*883*/].f_862 == iParam0)
					return 0;
	}
...
int func_33(int iParam0) // Position - 0x2C50 (11344)
{
	...
	if (func_230(PLAYER::PLAYER_ID()))
		if (ENTITY::IS_ENTITY_DEAD(Global_1673942, false))
			return -1;
	else if (func_229(PLAYER::PLAYER_ID()))
		if (ENTITY::IS_ENTITY_DEAD(Global_2733138.f_314, false) || IS_BIT_SET(Global_1575014, 12))
			return -1;

	if (iParam0 == 0)
	{
		for (i = (Global_1579266 % 4) + 1; !func_35(i); i = (i % 4) + 1)
		{
		}
	...
	for (i = Global_1579266 == 1 ? 4 : Global_1579266 - 1; !func_35(i); i = i <= 1 ? 4 : i - 1)
	{
	}
...
var func_34(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2CFF (11519)
{
	if (bParam0)
		return uParam1;
...
BOOL func_35(int iParam0) // Position - 0x2D16 (11542)
{
	switch (iParam0)
	{
		case 1:
...
int func_37(int iParam0) // Position - 0x2E28 (11816)
{
	...
	if (iParam0 == 0)
	{
		for (i = (Global_1579266 % 4) + 1; !func_36(i); i = (i % 4) + 1)
		{
		}
	...
	for (i = Global_1579266 == 1 ? 4 : Global_1579266 - 1; !func_36(i); i = i <= 1 ? 4 : i - 1)
	{
	}
...
BOOL func_39() // Position - 0x2EEB (12011)
{
	if (func_41())
	{
		if (func_17())
...
BOOL func_40() // Position - 0x2F27 (12071)
{
	return PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_VEH_FLY_YAW_LEFT);
}

BOOL func_41() // Position - 0x2F36 (12086)
{
	if (!func_43() || func_10(true) == -2)
		return false;

	if (uLocal_378[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/].f_1 != 2)
		return false;
...
BOOL func_42() // Position - 0x2F83 (12163)
{
	if (_STOPWATCH_IS_INITIALIZED(&uLocal_349))
		if (func_205(&uLocal_349, 1000, true))
...
BOOL func_43() // Position - 0x2FB2 (12210)
{
	switch (hLocal_299)
	{
		case 858355070:
...
BOOL func_44() // Position - 0x2FD0 (12240)
{
	ePedComponentType type;

	if (func_326(PLAYER::PLAYER_ID()))
	{
		type = func_61(PLAYER::PLAYER_ID());
	
		if (_NETWORK_IS_PLAYER_VALID(type, false, true))
		{
			if (func_60(type) && func_58(func_59(type)) == 4 && ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(type)) && !PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(type)) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(type), false) && ENTITY::DOES_ENTITY_EXIST(PED::GET_VEHICLE_PED_IS_IN(PLAYER::GET_PLAYER_PED(type), false)) && func_57(PED::GET_VEHICLE_PED_IS_IN(PLAYER::GET_PLAYER_PED(type), false)))
				return 1;
		
			if (!func_56(*Global_4718592.f_139000))
				if (func_326(type))
					if (func_64(type))
						return 1;
	...
	if (func_229(PLAYER::PLAYER_ID()) && IS_BIT_SET(Global_1575014, 12))
		return 1;

	if (func_230(PLAYER::PLAYER_ID()))
	{
		type = func_53(PLAYER::PLAYER_ID());
	
		if (_NETWORK_IS_PLAYER_VALID(type, false, true))
		{
			if (func_60(type) && func_58(func_59(type)) == 9 && ENTITY::DOES_ENTITY_EXIST(PLAYER::GET_PLAYER_PED(type)) && !PED::IS_PED_INJURED(PLAYER::GET_PLAYER_PED(type)) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(type), false) && ENTITY::DOES_ENTITY_EXIST(PED::GET_VEHICLE_PED_IS_IN(PLAYER::GET_PLAYER_PED(type), false)) && ENTITY::GET_ENTITY_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::GET_PLAYER_PED(type), false)) == joaat("avenger"))
				return 1;
		
			if (func_52(type))
				return 1;
			else if (func_51(type))
				return 1;
			else if (func_60(PLAYER::PLAYER_ID()) || func_55())
				return 1;
		}
	...
	{
		type = func_49(PLAYER::PLAYER_ID());
	
		if (_NETWORK_IS_PLAYER_VALID(type, false, true))
			if (func_60(type) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(type), false) && VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::GET_PLAYER_PED(type), false), joaat("terbyte")))
				return 1;
			else if (func_48(type) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::GET_PLAYER_PED(type), false) && VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(PLAYER::GET_PLAYER_PED(type), false), joaat("terbyte")))
				return 1;
			else if (func_47(type))
				return 1;
			else if (func_46(type))
				return 1;
			else if (func_60(PLAYER::PLAYER_ID()) || func_55())
				return 1;
	}
...
BOOL func_45(ePedComponentType epctParam0) // Position - 0x336F (13167)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_46(ePedComponentType epctParam0) // Position - 0x33CF (13263)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_47(ePedComponentType epctParam0) // Position - 0x33F5 (13301)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_48(ePedComponentType epctParam0) // Position - 0x341A (13338)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
ePedComponentType func_49(ePedComponentType epctParam0) // Position - 0x3440 (13376)
{
	if (epctParam0 == _INVALID_PLAYER_INDEX())
		return epctParam0;
...
BOOL func_50(ePedComponentType epctParam0, BOOL bParam1) // Position - 0x3464 (13412)
{
	Vehicle vehiclePedIsIn;
...
BOOL func_51(ePedComponentType epctParam0) // Position - 0x34F2 (13554)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_52(ePedComponentType epctParam0) // Position - 0x3518 (13592)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
ePedComponentType func_53(ePedComponentType epctParam0) // Position - 0x353D (13629)
{
	if (epctParam0 == _INVALID_PLAYER_INDEX())
		return epctParam0;
...
BOOL func_54(int iParam0) // Position - 0x3561 (13665)
{
	return *Global_4718592.f_199278 >= iParam0;
}

BOOL func_55() // Position - 0x3576 (13686)
{
...
ePedComponentType func_61(ePedComponentType epctParam0) // Position - 0x3B92 (15250)
{
	if (epctParam0 == _INVALID_PLAYER_INDEX())
		return epctParam0;
...
BOOL _IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(char* message) // Position - 0x3BB6 (15286)
{
...
BOOL func_64(ePedComponentType epctParam0) // Position - 0x3C0A (15370)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_65(int iParam0) // Position - 0x3C2D (15405)
{
	if (iParam0 == 1)
...
BOOL func_66() // Position - 0x3C84 (15492)
{
	return MISC::GET_GAME_TIMER() <= Global_24546.f_6481 + 100;
}

void func_67() // Position - 0x3C99 (15513)
{
	ePedComponentType i;
	Ped playerPed;
	ePedComponentType type;
	...
	for (i = 0; i < 32; i = i + 1)
	{
		flag = IS_BIT_SET(Global_1836661, i);
		type = i;
		...
		if (GRAPHICS::GET_SCREEN_COORD_FROM_WORLD_COORD(unk3 + { -1f, 0f, 0f }, &screenX, &screenY))
		{
			...
			if (!HUD::IS_PAUSE_MENU_ACTIVE())
			{
				...
				if (isControlJustPressed)
					MISC::SET_BIT(&Global_1836661, offset);
			}
		}
	}
...
void func_68(float fParam0, float fParam1) // Position - 0x3DD3 (15827)
{
	var unk;
	var unk3;
...
void _DISPLAY_HELP_TEXT(char* text, int iParam1) // Position - 0x3E0E (15886)
{
...
void func_70(var uParam0, var uParam1, float fParam2, float fParam3) // Position - 0x3E25 (15909)
{
	*uParam0 = fParam2;
	uParam0->f_1 = fParam3;
	*uParam1 = 0;
...
void func_71(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4) // Position - 0x3E6C (15980)
{
...
int func_72(eHudColour ehcParam0) // Position - 0x3EA3 (16035)
{
	int r;
	int g;
	int b;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3) // Position - 0x3EC5 (16069)
{
	var var;
...
float func_74(float fParam0, float fParam1, var uParam2, var uParam3) // Position - 0x3EFA (16122)
{
	float num;
	float num2;
...
BOOL func_75(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x3F55 (16213)
{
...
BOOL func_76(ePedComponentType epctParam0, int iParam1) // Position - 0x3F86 (16262)
{
	if (iParam1 == -1)
		return IS_BIT_SET(Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_33, epctParam0);
	else if (Global_2673274.f_3654[epctParam0] >= iParam1)
		return true;

	return false;
}

BOOL func_77() // Position - 0x3FBF (16319)
{
	if (IS_BIT_SET(Global_4718592.f_34, 24))
		return true;

	if (IS_BIT_SET(Global_4718592.f_34, 25))
		return true;
...
void func_78() // Position - 0x3FF7 (16375)
{
	...
	if (func_197(veLocal_367) || func_196() && !HUD::IS_PAUSE_MENU_ACTIVE())
	{
		if (!func_95())
		{
			...
			{
				if (PAD::IS_DISABLED_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_ATTACK) || PAD::IS_CONTROL_PRESSED(PLAYER_CONTROL, INPUT_ATTACK) && !bLocal_305 && !_STOPWATCH_IS_INITIALIZED(&(Global_2673274.f_3877)))
				{
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
					{
							...
							if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
							{
								if (CAM::DOES_CAM_EXIST(uLocal_72.f_32))
								{
									if (CAM::IS_CAM_ACTIVE(uLocal_72.f_32))
									{
										...
										if (func_90(PLAYER::PLAYER_ID(), PV_COMP_HEAD))
										{
											_int2 = -1;
			...
			if (_STOPWATCH_IS_INITIALIZED(&(Global_2673274.f_3877)) || _STOPWATCH_IS_INITIALIZED(&uLocal_294))
			{
				if (func_89(veLocal_367, Global_1579265) || func_196())
				{
					if (func_326(PLAYER::PLAYER_ID()) || func_231(PLAYER::PLAYER_ID()))
					{
						if (func_205(&(Global_2673274.f_3877), 1000, false))
						{
							_STOPWATCH_DESTROY(&(Global_2673274.f_3877));
							Global_2673274.f_3877 = { unk17 };
						}
					}
					else if (func_230(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()))
					{
						if (func_205(&(Global_2673274.f_3877), 500, false))
						{
							_STOPWATCH_DESTROY(&(Global_2673274.f_3877));
					...
					{
						if (_STOPWATCH_IS_INITIALIZED(&(Global_2673274.f_3877)))
						{
							if (func_205(&(Global_2673274.f_3877), 500, false))
							{
								_STOPWATCH_DESTROY(&(Global_2673274.f_3877));
								Global_2673274.f_3877 = { unk23 };
							}
						}
					
						if (_STOPWATCH_IS_INITIALIZED(&uLocal_294))
						{
							if (func_205(&uLocal_294, 50, false))
							{
					...
					else if (func_205(&(Global_2673274.f_3877), 2000, false))
					{
						_STOPWATCH_DESTROY(&(Global_2673274.f_3877));
						Global_2673274.f_3877 = { unk27 };
					}
				}
			}
		}
...
int func_79(int iParam0, int iParam1) // Position - 0x468F (18063)
{
	switch (iParam0)
	{
		case 4:
...
void func_80() // Position - 0x46AB (18091)
{
	int ammo;
	int seat;
...
int func_81(int iParam0, int iParam1, int iParam2) // Position - 0x470F (18191)
{
	if (iParam0 > iParam2)
		return iParam2;
...
Hash func_82() // Position - 0x4734 (18228)
{
...
Vector3 func_83() // Position - 0x477E (18302)
{
...
int func_84() // Position - 0x4BD1 (19409)
{
...
BOOL func_87() // Position - 0x50ED (20717)
{
	return uLocal_72.f_195;
}

float func_88(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4) // Position - 0x50F9 (20729)
{
...
BOOL func_90(Player plParam0, ePedComponentType epctParam1) // Position - 0x5199 (20889)
{
	Player player;
	...
	if (Global_1845299[player /*883*/] == epctParam1)
		return true;

	return false;
}

BOOL func_91(Player plParam0) // Position - 0x51D2 (20946)
{
	if (!func_92(plParam0))
		return false;
...
BOOL func_92(Player plParam0) // Position - 0x51F1 (20977)
{
	Player player;
...
int func_93() // Position - 0x5213 (21011)
{
	return Global_33792;
}
...
BOOL func_95() // Position - 0x52B4 (21172)
{
...
BOOL func_98() // Position - 0x5404 (21508)
{
	if (hLocal_299 == 858355070)
		return true;
...
void func_99() // Position - 0x541C (21532)
{
	if (iLocal_383 != 0)
	{
		...
		{
			GRAPHICS::SEETHROUGH_SET_MAX_THICKNESS(Global_1934766);
			Global_1934766 = -1f;
...
void func_100(var uParam0, BOOL bParam1) // Position - 0x544D (21581)
{
	Hash entityModel;
...
char* func_101(Hash hParam0) // Position - 0x5493 (21651)
{
	switch (hParam0)
	{
		case 858355070:
...
char* func_102(Hash hParam0) // Position - 0x54B2 (21682)
{
	switch (hParam0)
	{
		case 858355070:
...
void func_105() // Position - 0x5607 (22023)
{
	int offset;
	int i;
	int num;
	...
	if (!_STOPWATCH_IS_INITIALIZED(&uLocal_386))
		func_233(&uLocal_386, false, false);

	if (!func_205(&uLocal_386, 1000, false))
		return;
	...
	if (!func_18(uLocal_72.f_45))
	{
		if (!IS_BIT_SET(Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_404, offset))
			MISC::SET_BIT(&(Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_404), offset);
		...
		if (!func_230(PLAYER::PLAYER_ID()) && !func_229(PLAYER::PLAYER_ID()))
		{
			if (!func_106(Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_405[offset /*3*/], uLocal_72.f_45, 1056964608, false))
				Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_405[offset /*3*/] = { uLocal_72.f_45 };
		}
		else
		{
			finalRenderedCamCoord = { CAM::GET_FINAL_RENDERED_CAM_COORD() };
			...
			Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_405[offset /*3*/] = { unk11 };
		
			if (!func_106(Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_405[offset /*3*/], unk11, 1056964608, false))
				Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_405[offset /*3*/] = { unk11 };
		}
	}
	...
	{
		if (offset != i)
			if (IS_BIT_SET(Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_404, i))
				MISC::CLEAR_BIT(&(Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_404), i);
	}

	return;
}

BOOL func_106(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6, BOOL bParam7) // Position - 0x5845 (22597)
{
	if (iParam6 < 0f)
		iParam6 = 0f;
...
int func_107() // Position - 0x58C0 (22720)
{
	if (func_326(PLAYER::PLAYER_ID()) || func_231(PLAYER::PLAYER_ID()))
	{
		switch (Global_1579260)
...
BOOL func_108(ePedComponentType epctParam0) // Position - 0x595E (22878)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
int func_109() // Position - 0x59A5 (22949)
{
	if (bLocal_309)
		return 0;
	else if (bLocal_310)
...
float func_110(float fParam0, float fParam1, float fParam2) // Position - 0x59EC (23020)
{
	return ((1f - fParam2) * fParam0) + (fParam2 * fParam1);
}

float func_111(float fParam0, float fParam1, float fParam2) // Position - 0x5A01 (23041)
{
	if (fParam0 > fParam2)
		return fParam2;
...
int func_112() // Position - 0x5A28 (23080)
{
	if (bLocal_309)
		return 0;
...
int func_113(eHudColour ehcParam0) // Position - 0x5A6B (23147)
{
	int r;
	int g;
	int b;
...
Blip func_114(Vector3 vParam0, var uParam1, var uParam2, BOOL bParam3) // Position - 0x5CD3 (23763)
{
	Blip blip;
...
var func_115(BOOL bParam0, var uParam1, var uParam2) // Position - 0x5CFF (23807)
{
	if (bParam0)
		return uParam1;
...
Vector3 func_116(float fParam0, var uParam1, var uParam2) // Position - 0x5D16 (23830)
{
	float num;
...
void func_117(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, BOOL bParam7) // Position - 0x5D59 (23897)
{
	if (Global_1574985)
		return;
...
void func_119(var uParam0, int iParam1, int iParam2, int iParam3) // Position - 0x5DFD (24061)
{
	float entitySpeed;
	int i;
	int red;
	...
	if (uParam0->f_50 == 1)
	{
		...
		else
		{
			...
			if (iParam1 == 0)
			{
				if (Global_1579260 != -1 && uParam0->f_218)
				{
				}
				else
				{
		...
		if (uParam0->f_88 == 1)
		{
			...
			if (iParam1 == 0)
			{
				...
				if (func_324(uParam0->f_8) || func_120())
				...
				if (Global_1579260 != -1)
					if (Global_1579260 == 2 || Global_1579260 == 3)
				...
				else if (func_324(uParam0->f_8) || func_120())
				{
...
BOOL func_120() // Position - 0x6CB8 (27832)
{
	if (func_230(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()))
		return 1;
...
int func_121(var uParam0, int iParam1, float fParam2, float fParam3, int iParam4, int iParam5, int iParam6, float fParam7, BOOL bParam8) // Position - 0x6CDE (27870)
{
	var unk;
	int i;
	int num;
...
void func_122(var uParam0, Ped pedParam1, float fParam2, float fParam3) // Position - 0x6DF5 (28149)
{
...
void func_123(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, float fParam7, var uParam8, float fParam9, var uParam10, int iParam11) // Position - 0x7466 (29798)
{
	int i;
	float num;
	float num2;
...
void func_124(float fParam0, float fParam1, char* sParam2, int iParam3) // Position - 0x7516 (29974)
{
...
void func_125(int iParam0, int iParam1, int iParam2, float fParam3, BOOL bParam4) // Position - 0x752E (29998)
{
...
int func_126(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4) // Position - 0x7563 (30051)
{
	switch (iParam1)
	{
		case 0:
...
void func_127(var uParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x7600 (30208)
{
	int red;
	int green;
	int blue;
...
float func_128(var uParam0, Entity eParam1, Entity eParam2) // Position - 0x76F8 (30456)
{
	Vector3 worldPositionOfEntityBone;
	float distanceBetweenCoords;
	float num;
...
void func_129(var uParam0, float fParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6) // Position - 0x7763 (30563)
{
	var screenX;
	float camCoord;
	float camRot;
...
float func_130(var uParam0, var uParam1, var uParam2, float fParam3, var uParam4, var uParam5, int iParam6) // Position - 0x788A (30858)
{
	float num;
	float num2;
	float num3;
...
void func_131() // Position - 0x78EF (30959)
{
	STREAMING::OVERRIDE_LODSCALE_THIS_FRAME(1.7f);
	return;
}

void func_132(var uParam0) // Position - 0x7900 (30976)
{
	float entitySpeed;
	...
	if (uParam0->f_50 == 1)
	{
		...
		if (entitySpeed > *Global_262145.f_36947)
			STREAMING::SUPPRESS_HD_MAP_STREAMING_THIS_FRAME();
...
void func_133(var uParam0) // Position - 0x7986 (31110)
{
	if (func_147())
	{
		...
		func_140(100f);
		func_138(func_139());
		func_136(0, "TITAN2_ZOOM_105" /*105*/);
		func_136(1, "");
		func_136(2, "TITAN2_ZOOM_40" /*40*/);
		func_136(3, "");
		func_136(4, "TITAN2_ZOOM_25" /*25*/);
		func_134(func_135());
	}
	else
	{
...
void func_134(int iParam0) // Position - 0x7A5A (31322)
{
...
int func_135() // Position - 0x7A77 (31351)
{
	switch (Global_1579265)
	{
		case 1:
...
void func_136(int iParam0, char* sParam1) // Position - 0x7AB1 (31409)
{
...
void func_137(char* sParam0) // Position - 0x7AD4 (31444)
{
...
void func_138(char* sParam0) // Position - 0x7AE6 (31462)
{
...
char* func_139() // Position - 0x7B03 (31491)
{
	switch (Global_1579265)
	{
		case 1:
...
void func_140(float fParam0) // Position - 0x7B4C (31564)
{
...
void func_141() // Position - 0x7B69 (31593)
{
	int value;
...
void func_142(var uParam0) // Position - 0x7BC2 (31682)
{
	int ammo;
	int seat;
	int maxAmmoInClip;
	...
	if (func_145())
	{
		...
		if (WEAPON::_GET_AMMO_IN_VEHICLE_WEAPON_CLIP(uParam0->f_8, seat, &ammo))
			func_143(ammo, maxAmmoInClip);
	}
	else
	{
		func_140(100f);
...
int func_144() // Position - 0x7C41 (31809)
{
	if (Global_1579265 == 4)
		return 1;

	return Global_1579265;
}

BOOL func_145() // Position - 0x7C59 (31833)
{
	return Global_1579265 != -1 && Global_1579265 != 3;
}

void func_146(char* sParam0, BOOL bParam1) // Position - 0x7C72 (31858)
{
...
BOOL func_147() // Position - 0x7C8D (31885)
{
	return Global_1579265 != -1;
}

void func_148(var uParam0) // Position - 0x7C9B (31899)
{
	int seat;
	float vehicleWeaponReloadTime;
	int timeBeforeVehicleWeaponReloadFinishes;
	float num;
	...
	if (WEAPON::_HAS_WEAPON_RELOADING_IN_VEHICLE(uParam0->f_8, seat))
	{
...
void func_149(var uParam0) // Position - 0x7D12 (32018)
{
	Hash entityModel;
	...
	if (entityModel != 0)
	{
		if (func_151(entityModel, Global_1579265))
		{
			uParam0->f_214 = AUDIO::GET_SOUND_ID();
			AUDIO::PLAY_SOUND_FRONTEND(uParam0->f_214, func_150(entityModel, Global_1579265), func_101(entityModel), true);
		}
	}
...
char* func_150(Hash hParam0, int iParam1) // Position - 0x7D5B (32091)
{
	switch (hParam0)
	{
		case 858355070:
...
BOOL func_151(Hash hParam0, int iParam1) // Position - 0x7DB3 (32179)
{
	return !MISC::IS_STRING_NULL_OR_EMPTY(func_150(hParam0, iParam1));
}

BOOL func_152() // Position - 0x7DC8 (32200)
{
	return Global_1579265 == 2;
}

void func_153(var uParam0) // Position - 0x7DD6 (32214)
{
	if (uParam0->f_204 == 0)
	{
...
void func_154(var uParam0) // Position - 0x7E38 (32312)
{
	int i;
...
void func_155(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, BOOL bParam6) // Position - 0x7ED7 (32471)
{
	int value;
	int value2;
	int value3;
				...
				if (CAM::IS_CAM_ACTIVE(uParam0->f_32))
				{
					if (!func_160(true))
					{
						if (!PAD::IS_CONTROL_PRESSED(FRONTEND_CONTROL, INPUT_CHARACTER_WHEEL) && !HUD::IS_PAUSE_MENU_ACTIVE() && !bParam6)
						{
							...
							{
								num4 = 15f;
								num = PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(PLAYER_CONTROL, INPUT_REPLAY_PREVIEW_AUDIO) * -num4;
								num2 = PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(PLAYER_CONTROL, INPUT_REPLAY_TIMELINE_SAVE) * num4;
							}
							else
							{
								value3 = BUILTIN::FLOOR(PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(PLAYER_CONTROL, INPUT_REPLAY_PREVIEW_AUDIO) * -num4);
								value2 = BUILTIN::FLOOR(PAD::GET_DISABLED_CONTROL_UNBOUND_NORMAL(PLAYER_CONTROL, INPUT_REPLAY_TIMELINE_SAVE) * num4);
							}
						...
						if (uParam0->f_4)
							if (!func_324(uParam0->f_8) && !func_120() || Global_1579260 != -1)
						...
						{
							if (uParam0->f_25 != 0f && !func_324(uParam0->f_8) && !func_120() || Global_1579260 != -1)
							{
								if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_8, false))
								{
							...
							if (uParam0->f_58 != 0f || uParam0->f_59 != 0f || num8 != 0f || num9 != 0f)
							{
								...
								if (Global_1579265 != -1 || Global_1579266 != -1)
								{
									if (!func_208(3))
									...
									if (Global_1579265 == 4 && entityModel == 858355070 && PAD::IS_USING_KEYBOARD_AND_MOUSE(PLAYER_CONTROL))
										num11 = num11 * 10f;
								...
								if (func_324(uParam0->f_8) || func_120() && !bParam6)
								{
							...
							else
							{
								...
								else if (Global_1579266 != -1 || func_324(uParam0->f_8) && ENTITY::GET_ENTITY_MODEL(uParam0->f_8) != joaat("bombushka"))
...
Vector3 func_156(float fParam0, float fParam1, float fParam2, float fParam3) // Position - 0x95F9 (38393)
{
	float num;
	float num2;
	float num3;
...
int func_157(var uParam0) // Position - 0x963D (38461)
{
	if (func_326(PLAYER::PLAYER_ID()) || func_231(PLAYER::PLAYER_ID()))
		return 1;
...
BOOL func_158(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x96A5 (38565)
{
	if (bParam6)
...
float func_159(float fParam0, int iParam1, int iParam2) // Position - 0x96EC (38636)
{
...
BOOL func_160(BOOL bParam0) // Position - 0x9720 (38688)
{
	if (bParam0)
...
int func_161(var uParam0) // Position - 0x9749 (38729)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_8))
	{
		switch (ENTITY::GET_ENTITY_MODEL(uParam0->f_8))
...
void func_162(var uParam0) // Position - 0x97B3 (38835)
{
	float camCoord;
	float camRot;
	var entityCoords;
...
BOOL func_163(Vector3 vParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, float fParam6) // Position - 0x99DB (39387)
{
	float screenX;
	float screenY;
...
void func_164() // Position - 0x9A19 (39449)
{
	if (bLocal_321)
	{
		...
		else if (iLocal_366 != 99 && iLocal_366 > 0)
		{
			AUDIO::STOP_AUDIO_SCENE("MP_HELI_CAM_FILTERING");
			iLocal_366 = 99;
		}
...
void func_165() // Position - 0x9AA2 (39586)
{
	if (func_195())
	{
		func_169();
...
BOOL func_166() // Position - 0x9E07 (40455)
{
	return IS_BIT_SET(Global_2733138.f_921, 11);
}

BOOL func_167(Player plParam0, int iParam1) // Position - 0x9E19 (40473)
{
	return IS_BIT_SET(Global_2658294[plParam0 /*468*/].f_222, iParam1);
}

BOOL func_168() // Position - 0x9E2F (40495)
{
	if (func_230(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()) || func_208(3))
		return true;

	return !func_205(&uLocal_296, 7500, false);
}

void func_169() // Position - 0x9E6B (40555)
{
...
void func_170(int iParam0, int iParam1, int iParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6, int iParam7, BOOL bParam8) // Position - 0x9F9C (40860)
{
	int num;
	int i;
	int j;
	...
	if (Global_24546.f_5326 != 0)
	{
		...
		if (!Global_24546.f_5327)
		{
			...
			if (MISC::GET_HASH_KEY(&(Global_4521195.f_16)) != MISC::GET_HASH_KEY(""))
			{
				...
				func_171(&Global_4521195);
			
				if (Global_4521195.f_20 == -1)
				{
					func_137(&(Global_4521195.f_16));
				}
				else
				{
...
void func_171(char* sParam0) // Position - 0xA4A0 (42144)
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(sParam0);
	return;
}

BOOL func_172(Player plParam0, int iParam1) // Position - 0xA4AE (42158)
{
	BOOL flag;
...
BOOL func_175() // Position - 0xA554 (42324)
{
	var position;
...
BOOL func_176() // Position - 0xA5C2 (42434)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("cellphone_flashhand")) > 0)
		return true;
...
BOOL func_177(BOOL bParam0, BOOL bParam1) // Position - 0xA5DC (42460)
{
	if (Global_2673274.f_1762.f_701 != 0)
		return true;

	if (!CAM::IS_SCREEN_FADED_IN() || func_179(8, -1) && func_178() != TRANSITION_STATE_WAITING_FOR_EXTERNAL_TERMINATION_CALL || HUD::GET_PAUSE_MENU_STATE() != 0 && !bParam1 || STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS() && !bParam0 || NETWORK::IS_COMMERCE_STORE_OPEN() || Global_80566 || Global_24546.f_9243 || HUD::IS_WARNING_MESSAGE_ACTIVE() || Global_102506.f_1514)
		return false;

	return true;
}

eTransitionState func_178() // Position - 0xA679 (42617)
{
	return Global_1575020;
}

BOOL func_179(int iParam0, int iParam1) // Position - 0xA685 (42629)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_181() // Position - 0xA75A (42842)
{
	return Global_1579265 != -1 && Global_1579265 != 3;
}

void func_182(char* sParam0, const char* sParam1, const char* sParam2, const char* sParam3, const char* sParam4) // Position - 0xA773 (42867)
{
...
void func_191(eControlAction ecaParam0, char* sParam1, int iParam2) // Position - 0xAD08 (44296)
{
	const char* controlInstructionalButtonsString;
...
void func_192(int iParam0) // Position - 0xADB7 (44471)
{
	int i;
	int num;
...
BOOL func_193(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xAE70 (44656)
{
	int num;
	BOOL flag;
	BOOL flag2;
	...
	flag2 = func_194(&Global_24546.f_6263[num /*10*/]);
	!flag || !flag2;
	return flag && flag2;
}

BOOL func_194(int* piParam0) // Position - 0xAF7E (44926)
{
	switch (piParam0->f_9)
	{
		case 0:
...
BOOL func_195() // Position - 0xB020 (45088)
{
	switch (hLocal_299)
	{
		case 858355070:
...
BOOL func_196() // Position - 0xB03E (45118)
{
	if (func_326(PLAYER::PLAYER_ID()) || func_231(PLAYER::PLAYER_ID()))
		if (Global_1579260 != -1)
			return 1;
...
void func_198(int iParam0) // Position - 0xB0E3 (45283)
{
	if (func_203())
		return;
...
void func_199(int iParam0) // Position - 0xB116 (45334)
{
	if (func_203())
		return;
...
BOOL func_200() // Position - 0xB1A0 (45472)
{
...
void func_201(BOOL bParam0, BOOL bParam1) // Position - 0xB1C7 (45511)
{
	if (bParam0)
	{
		if (func_65(0))
...
BOOL func_202() // Position - 0xB23B (45627)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_203() // Position - 0xB249 (45641)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_204() // Position - 0xB258 (45656)
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

BOOL func_205(int iParam0, int iParam1, BOOL bParam2) // Position - 0xB266 (45670)
{
	if (iParam1 == -1)
		return true;
...
BOOL _STOPWATCH_IS_INITIALIZED(int iParam0) // Position - 0xB2C4 (45764)
{
	return iParam0->f_1;
}
...
BOOL func_208(int iParam0) // Position - 0xB2F1 (45809)
{
	return Global_262145.f_4708[iParam0] == *Global_4718592.f_139000;
}

BOOL func_209() // Position - 0xB30F (45839)
{
	if (func_230(PLAYER::PLAYER_ID()) || func_326(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()) || func_108(PLAYER::PLAYER_ID()) || func_208(3))
		return 1;

	return 0;
}

void func_210(var uParam0, int iParam1) // Position - 0xB35C (45916)
{
	uParam0->f_51 = iParam1;
	return;
}

void func_211() // Position - 0xB36A (45930)
{
	if (MISC::IS_PC_VERSION())
	{
		if (bLocal_384 == false)
...
void func_212() // Position - 0xB38D (45965)
{
	iLocal_360 = 0;
...
void func_213() // Position - 0xB434 (46132)
{
	if (ENTITY::DOES_ENTITY_EXIST(uLocal_72.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_72.f_9, false) && !(!ENTITY::IS_ENTITY_DEAD(Global_1673921, false) && ENTITY::GET_ENTITY_MODEL(uLocal_72.f_9) == ENTITY::GET_ENTITY_MODEL(Global_1673921)) && !func_324(veLocal_367))
		{
			if (ENTITY::GET_ENTITY_MODEL(uLocal_72.f_9) != joaat("valkyrie") && ENTITY::GET_ENTITY_MODEL(uLocal_72.f_9) != joaat("savage") && ENTITY::GET_ENTITY_MODEL(uLocal_72.f_9) != joaat("hunter") && !func_230(PLAYER::PLAYER_ID()) && !func_229(PLAYER::PLAYER_ID()))
			{
				...
				if (!bLocal_316)
					NETWORK::SET_PLAYER_INVISIBLE_LOCALLY(epctLocal_371, false);
			
				if (!bLocal_319)
					NETWORK::SET_PLAYER_INVISIBLE_LOCALLY(plLocal_372, false);
			}
		}
	}
...
void func_214() // Position - 0xB500 (46336)
{
	...
	if (bLocal_318)
	{
		if (!bLocal_319 && plLocal_372 != -1)
		{
			finalRenderedRemotePlayerCamRot = { CAM::GET_FINAL_RENDERED_REMOTE_PLAYER_CAM_ROT(plLocal_372, 2) };
			finalRenderedRemotePlayerCamFov = CAM::GET_FINAL_RENDERED_REMOTE_PLAYER_CAM_FOV(plLocal_372);
...
float func_215(float fParam0, float fParam1) // Position - 0xB5E0 (46560)
{
	float num;

	num = fParam1 + ((fParam0 - fParam1) * uLocal_361);

	if (MISC::ABSF(num - fParam0) < fLocal_364)
		num = fParam0;

	return num;
}

Vector3 func_216(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xB60C (46604)
{
	float num;
	float value;
	...
	num = { uParam3 + ((uParam0 - uParam3) * uLocal_361) };

	if (MISC::ABSF(num - uParam0) < fLocal_364)
		num = { uParam0 };

	if (MISC::ABSF(num.f_1 - uParam0.f_1) < fLocal_364)
		num = { uParam0 };

	if (MISC::ABSF(num.f_2 - uParam0.f_2) < fLocal_364)
		num = { uParam0 };

	return num;
}

void func_217() // Position - 0xB6C3 (46787)
{
...
void func_218(var uParam0, var uParam1, var uParam2, var uParam3) // Position - 0xB868 (47208)
{
	if (!func_324(uParam0->f_8) && !func_209() || Global_1579260 != -1)
	{
		...
		if (uParam0->f_1 == 1 && iParam2 == 0)
		{
			...
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_8, false))
			{
				...
				if (!uParam0->f_4)
				{
					...
					ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_8, false, false);
...
int func_220(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xBD93 (48531)
{
	int num;
...
void func_222(int iParam0, int iParam1) // Position - 0xBDD0 (48592)
{
	...
	if (toggle == true)
	{
		...
		if (!(iParam0 == 3))
		{
			...
			MISC::SET_BIT(&(Global_1928397[PLAYER::PLAYER_ID() /*199*/].f_198), 0);
		}
		else
		{
			...
			Global_1934766 = GRAPHICS::SEETHROUGH_GET_MAX_THICKNESS();
			GRAPHICS::SEETHROUGH_SET_MAX_THICKNESS(0.5f);
			MISC::SET_BIT(&(Global_1928397[PLAYER::PLAYER_ID() /*199*/].f_198), 2);
		}
	
		if (iParam1 == 1 || flag)
		{
			if (Global_1934767 == -1)
				Global_1934767 = AUDIO::GET_SOUND_ID();
		
			if (!(Global_1934767 == -1) && AUDIO::HAS_SOUND_FINISHED(Global_1934767))
				if (iParam1 == 1)
					if (!flag2)
						AUDIO::PLAY_SOUND_FRONTEND(Global_1934767, "On", "GTAO_Vision_Modes_SoundSet", false);
					else
						AUDIO::PLAY_SOUND_FRONTEND(Global_1934767, "Switch", "GTAO_Vision_Modes_SoundSet", false);
				else if (flag)
					if (!flag2)
						AUDIO::PLAY_SOUND_FRONTEND(Global_1934767, "On", "GTAO_Vision_Modes_SoundSet", true);
					else
						AUDIO::PLAY_SOUND_FRONTEND(Global_1934767, "Switch", "GTAO_Vision_Modes_SoundSet", true);
		}
	}
	else
	{
		...
		{
			GRAPHICS::SET_NIGHTVISION(toggle);
			MISC::CLEAR_BIT(&(Global_1928397[PLAYER::PLAYER_ID() /*199*/].f_198), 0);
		}
		...
		if (GRAPHICS::GET_USINGSEETHROUGH())
		{
			...
			Global_1934766 = -1f;
			GRAPHICS::SET_SEETHROUGH(toggle);
			MISC::CLEAR_BIT(&(Global_1928397[PLAYER::PLAYER_ID() /*199*/].f_198), 2);
		}
		...
		if (iParam1 == 1 || flag)
		{
			...
			if (!(Global_1934767 == -1) && AUDIO::HAS_SOUND_FINISHED(Global_1934767))
				if (iParam1 == 1)
					AUDIO::PLAY_SOUND_FRONTEND(Global_1934767, "Off", "GTAO_Vision_Modes_SoundSet", false);
				else if (flag)
					AUDIO::PLAY_SOUND_FRONTEND(Global_1934767, "Off", "GTAO_Vision_Modes_SoundSet", true);
		}
	}
...
void func_223(BOOL bParam0) // Position - 0xBFC9 (49097)
{
	func_224(378, bParam0, -1, true);
	return;
}

void func_224(int iParam0, BOOL bParam1, int iParam2, BOOL bParam3) // Position - 0xBFDC (49116)
{
	Hash statName;
...
Hash func_225(int iParam0, int iParam1) // Position - 0xBFFF (49151)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_226(iParam1));
}

int func_226(int iParam0) // Position - 0xC015 (49173)
{
	int num;
	int num2;
...
BOOL func_227(var uParam0, int iParam1) // Position - 0xC049 (49225)
{
	uParam0->f_5 = iParam1;
	uParam0->f_64 = 93;
...
void func_228() // Position - 0xC201 (49665)
{
	MISC::SET_BIT(&Global_9464, 4);
	return;
}

BOOL func_229(ePedComponentType epctParam0) // Position - 0xC211 (49681)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658294[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID)
...
BOOL func_230(ePedComponentType epctParam0) // Position - 0xC258 (49752)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658294[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID && Global_2658294[epctParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
...
BOOL func_231(ePedComponentType epctParam0) // Position - 0xC2B8 (49848)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658294[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID)
...
char* func_232(Hash hParam0) // Position - 0xC2FE (49918)
{
	if (func_230(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()) || func_326(PLAYER::PLAYER_ID()) || func_231(PLAYER::PLAYER_ID()) || Global_1579266 != -1)
		return "turret_cam";
...
void func_233(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xC363 (50019)
{
	if (uParam0->f_1 == 0)
	{
...
void func_234() // Position - 0xC3A8 (50088)
{
	if (bLocal_324)
	{
		bLocal_324 = false;
...
void func_235(BOOL bParam0, int iParam1) // Position - 0xC3C0 (50112)
{
	int num;
...
void func_236(int* piParam0) // Position - 0xC486 (50310)
{
	if (piParam0->f_9 != 0)
	{
		if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(*piParam0))
...
void func_237(BOOL bParam0) // Position - 0xC4B2 (50354)
{
	Hash entityModel;
...
void _STOPWATCH_DESTROY(int iParam0) // Position - 0xC7B3 (51123)
{
	iParam0->f_1 = 0;
	return;
}
...
void func_241(int iParam0) // Position - 0xC809 (51209)
{
	if (NETWORK::PARTICIPANT_ID_TO_INT() != -1)
		uLocal_378[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/].f_1 = iParam0;

	return;
}

BOOL func_242() // Position - 0xC826 (51238)
{
	BOOL flag;
	...
	if (!HUD::IS_PAUSE_MENU_ACTIVE() && !func_66() && !func_65(0) && !Global_1574975 && !Global_1576402)
	{
		num = 0;
		...
		else
		{
			...
			if (PAD::IS_CONTROL_JUST_RELEASED(control, action))
			{
				...
				{
					if (func_205(&uLocal_341, 500, true))
					{
						if (func_247())
						{
...
BOOL func_243() // Position - 0xCCEE (52462)
{
	if (Global_1579260 != -1 || Global_1579266 != -1)
	{
...
BOOL func_246() // Position - 0xCEDF (52959)
{
	if (bLocal_309)
	{
		switch (hLocal_299)
...
BOOL func_247() // Position - 0xCF09 (53001)
{
	if (hLocal_299 == 858355070 && bLocal_308 && Global_1579265 == 4)
		return true;
...
BOOL func_249(ePedComponentType epctParam0, BOOL bParam1) // Position - 0xCF51 (53073)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
BOOL func_250(ePedComponentType epctParam0) // Position - 0xCFA0 (53152)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658294[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID)
...
BOOL func_251() // Position - 0xCFE6 (53222)
{
...
BOOL func_254(ePedComponentType epctParam0) // Position - 0xD0B2 (53426)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
...
void func_257() // Position - 0xD347 (54087)
{
	int seat;
	int seat2;
	int seat3;
	...
	if (bLocal_351 || bLocal_352)
	{
		func_238();
		seat = func_10(bLocal_351);
...
void func_258() // Position - 0xD6AD (54957)
{
	_STOPWATCH_DESTROY(&(Global_2733138.f_3583));
	return;
}

void func_259() // Position - 0xD6C0 (54976)
{
	func_327(&uLocal_349, true, false);
	return;
}

void func_260() // Position - 0xD6D1 (54993)
{
	func_327(&(Global_2733138.f_3583), true, false);
	return;
}
...
void func_262() // Position - 0xD80B (55307)
{
	BOOL flag;
	...
	if (IS_BIT_SET(Global_4718592.f_16, 12) || Global_2697023.f_2 || Global_1576402)
		return;
	...
	if (veLocal_367 != Global_2733138.f_3729 || Global_1579260 != -1 || func_324(veLocal_367) || Global_1579266 != -1)
	{
		if (!bLocal_301 || Global_1579260 != -1)
		{
			if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
			{
				...
				{
					if (!Global_2740433 && hLocal_299 != 858355070)
					{
		...
		else if (func_267(PLAYER::PLAYER_ID(), true) || func_264(PLAYER::PLAYER_ID(), true, false))
		{
			if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
			{
				if (!bLocal_307)
...
BOOL func_263() // Position - 0xDE7F (56959)
{
	return false;
}

int func_264(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0xDE88 (56968)
{
	if (bParam1)
...
BOOL func_265(Player plParam0) // Position - 0xDEBA (57018)
{
	return func_266(plParam0);
}

BOOL func_266(Player plParam0) // Position - 0xDEC8 (57032)
{
	return IS_BIT_SET(Global_1845299[plParam0 /*883*/].f_11.f_1, 0);
}

int func_267(Player plParam0, BOOL bParam1) // Position - 0xDEDF (57055)
{
	if (bParam1)
		if (func_265(plParam0))
			return 1;
...
BOOL func_268() // Position - 0xDF51 (57169)
{
	if (func_65(0) || func_66() || HUD::IS_WARNING_MESSAGE_ACTIVE() || HUD::IS_PAUSE_MENU_ACTIVE() || func_269())
		return false;

	return true;
}

BOOL func_269() // Position - 0xDF8E (57230)
{
	return Global_77359;
}

int func_270(Player plParam0) // Position - 0xDF9A (57242)
{
	if (func_252(plParam0) == 339)
		return func_271(plParam0, 339);
...
int func_272(Player plParam0) // Position - 0xDFD8 (57304)
{
	if (func_253(plParam0, false))
...
int func_273(Player plParam0) // Position - 0xDFFB (57339)
{
	if (func_252(plParam0) == 271)
		return func_272(plParam0);

	return -1;
}

BOOL func_274() // Position - 0xE019 (57369)
{
...
void func_277(char* sParam0) // Position - 0xE0F1 (57585)
{
	if (func_279(*Global_4718592.f_139000) == 5)
		func_278(sParam0);
	else
...
void func_278(char* sParam0) // Position - 0xE11B (57627)
{
...
int func_279(int iParam0) // Position - 0xE131 (57649)
{
	int i;

	for (i = 0; i < 6; i = i + 1)
	{
		if (iParam0 == func_280(i))
			return i;
	}
...
int func_280(int iParam0) // Position - 0xE15C (57692)
{
	if (iParam0 != -1)
...
BOOL func_281() // Position - 0xE17B (57723)
{
	if (!func_254(PLAYER::PLAYER_ID()))
	{
		if (_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED("BHH_LEFTRANGE" /*You are out of range of the Business Battle that is currently in progress. Press ~INPUT_CONTEXT~ to continue participating.*/))
...
BOOL func_282() // Position - 0xE1B0 (57776)
{
...
BOOL func_283() // Position - 0xE249 (57929)
{
...
void func_285() // Position - 0xE29D (58013)
{
	if (MISC::IS_PC_VERSION())
	{
		if (bLocal_384 == true)
...
void func_288() // Position - 0xE374 (58228)
{
...
BOOL func_289(Player plParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE392 (58258)
{
...
void func_290() // Position - 0xE3E9 (58345)
{
...
void func_291() // Position - 0xE3F9 (58361)
{
	Global_24407.f_134 = 1;
	return;
}

void func_292() // Position - 0xE407 (58375)
{
	int ammo;
	int maxAmmoInClip;
	int seat;
...
void func_293() // Position - 0xE49F (58527)
{
...
void func_294() // Position - 0xE71D (59165)
{
	func_295();
...
void func_295() // Position - 0xE7F0 (59376)
{
	if (!func_38())
		return;
...
void func_296(int iParam0) // Position - 0xE820 (59424)
{
	int num;
	BOOL flag;
	int num2;
	...
	while (flag)
	{
		...
		if (iLocal_383 == 1 && !IS_BIT_SET(Global_1575014, 16))
		{
			flag = false;
			break;
		}
	
		if (iLocal_383 == 2 && !IS_BIT_SET(Global_1575014, 17))
		{
			flag = false;
			break;
		}
...
BOOL func_297(int iParam0) // Position - 0xE8AC (59564)
{
	eControlAction action;
	...
	if (iParam0 == 1)
	{
		if (IS_BIT_SET(Global_1575014, 14))
		{
	...
	else if (IS_BIT_SET(Global_1575014, 14))
	{
...
BOOL func_298() // Position - 0xE909 (59657)
{
	if (func_66() || func_65(0) || Global_77359 || func_204() || func_299() || Global_1949241 || Global_1949235)
		return true;

	return false;
}

BOOL func_299() // Position - 0xE95A (59738)
{
...
void func_300() // Position - 0xE97C (59772)
{
	switch (hLocal_299)
	{
		case joaat("akula"):
...
BOOL func_301(Vehicle veParam0) // Position - 0xEA10 (59920)
{
	...
	if (Global_1579260 != -1 && IS_BIT_SET(Global_4718592.f_26, 7))
		return true;
...
BOOL func_303() // Position - 0xEB6F (60271)
{
	Player player;
	...
	if (bLocal_330)
	{
		if (!bLocal_331)
		{
			...
			if (player != -1)
				return IS_BIT_SET(Global_1845299[player /*883*/].f_882, 6);
		}
	}
...
int func_304() // Position - 0xEBA1 (60321)
{
	if (func_303() || func_306() || func_305())
		return 1;

	return 0;
}

BOOL func_305() // Position - 0xEBC9 (60361)
{
	Player player;
...
BOOL func_306() // Position - 0xEBFB (60411)
{
	Player player;
...
BOOL func_307() // Position - 0xEC2D (60461)
{
	Player player;
...
BOOL func_308() // Position - 0xEC5F (60511)
{
	if (func_230(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()))
		return false;
...
BOOL func_309(var uParam0) // Position - 0xEC85 (60549)
{
	if (uParam0->f_1 == 1)
		return true;
...
void func_310() // Position - 0xEC9A (60570)
{
	if (_STOPWATCH_IS_INITIALIZED(&uLocal_343))
	{
		...
		if (func_205(&uLocal_343, 1000, true))
		{
...
void func_311() // Position - 0xECD3 (60627)
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(vehiclePedIsIn) && VEHICLE::IS_VEHICLE_DRIVEABLE(vehiclePedIsIn, false) && func_324(vehiclePedIsIn) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(vehiclePedIsIn))
...
void func_312() // Position - 0xED32 (60722)
{
	PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_ATTACK, true);
	PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_VEH_GUN_LR, true);
	PAD::DISABLE_CONTROL_ACTION(PLAYER_CONTROL, INPUT_VEH_GUN_UD, true);
...
void func_317() // Position - 0xEEE3 (61155)
{
	if (_STOPWATCH_IS_INITIALIZED(&(iLocal_353.f_2)))
	{
		if (func_205(&(iLocal_353.f_2), 500, true))
		{
			func_318();
			_STOPWATCH_DESTROY(&(iLocal_353.f_2));
		}
	}
...
void func_320() // Position - 0xEF98 (61336)
{
	if (func_209())
		if (uLocal_378[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/].f_1 == 1 || uLocal_378[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/].f_1 == 2 || Global_1579266 != -1 && CAM::DOES_CAM_EXIST(uLocal_72.f_32) && CAM::IS_CAM_RENDERING(uLocal_72.f_32))
...
void func_321() // Position - 0xF00D (61453)
{
	int num;

	num = -1;

	if (Global_1579266 != -1 && func_208(3))
	{
...
void func_322(int iParam0) // Position - 0xF071 (61553)
{
	Global_1579266 = iParam0;
	uLocal_72.f_35 = 0;
	_STOPWATCH_DESTROY(&uLocal_296);
	return;
}

void func_323() // Position - 0xF08B (61579)
{
	int num;

	num = -1;

	if (Global_1579266 != -1 && func_230(PLAYER::PLAYER_ID()) || func_229(PLAYER::PLAYER_ID()))
	{
		if (PAD::IS_CONTROL_JUST_PRESSED(PLAYER_CONTROL, INPUT_SCRIPT_LB))
		{
			num = func_33(0);
...
void func_325(int iParam0) // Position - 0xF142 (61762)
{
	if (NETWORK::PARTICIPANT_ID_TO_INT() != -1)
		uLocal_378[NETWORK::PARTICIPANT_ID_TO_INT() /*2*/] = iParam0;

	return;
}

BOOL func_326(ePedComponentType epctParam0) // Position - 0xF15D (61789)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
		if (_NETWORK_IS_PLAYER_VALID(epctParam0, true, true))
			if (Global_2658294[epctParam0 /*468*/].f_325.f_8 != PV_COMP_INVALID && Global_2658294[epctParam0 /*468*/].f_325.f_11 != _INVALID_PLAYER_INDEX())
...
void func_327(int iParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF1BC (61884)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
		if (!bParam2)
...
BOOL func_329() // Position - 0xF384 (62340)
{
	return Global_1575092;
}

BOOL func_330(BOOL bParam0) // Position - 0xF390 (62352)
{
	if (func_339())
	{
		if (bParam0)
		{
			if (!Global_1836750 && !func_167(PLAYER::PLAYER_ID(), 2))
			{
...
void func_331(BOOL bParam0, int iParam1) // Position - 0xF3D0 (62416)
{
	if (bParam0)
		func_336(true, false, true);
	else
		func_332(iParam1);
...
void func_332(int iParam0) // Position - 0xF3ED (62445)
{
	func_335();
	...
	if (func_334() == 0 || HUD::IS_PAUSE_MENU_ACTIVE())
	{
		func_333(1);
...
void func_333(int iParam0) // Position - 0xF42E (62510)
{
...
int func_334() // Position - 0xF449 (62537)
{
...
void func_336(BOOL bParam0, BOOL bParam1, BOOL bParam2) // Position - 0xF464 (62564)
{
	if (func_337())
		return;

	if (func_334() == 1 || HUD::IS_PAUSE_MENU_ACTIVE() || bParam0)
	{
		func_333(0);
...
BOOL func_337() // Position - 0xF4BB (62651)
{
	if (func_338())
...
BOOL func_338() // Position - 0xF4D2 (62674)
{
	if (Global_2696898)
...
BOOL func_339() // Position - 0xF4E9 (62697)
{
	return Global_2673274.f_23;
}

BOOL func_340(Hash hParam0) // Position - 0xF4F7 (62711)
{
	return hLocal_368 == hParam0 && hParam0 != 0;
}

void func_341() // Position - 0xF50E (62734)
{
	Ped ped;
	...
	bLocal_309 = false;
	Global_1836660 = _INVALID_PLAYER_INDEX();
	bLocal_321 = false;
	pedLocal_329 = -1;
	bLocal_330 = false;
	...
	if (ENTITY::DOES_ENTITY_EXIST(ped))
	{
		if (!ENTITY::IS_ENTITY_DEAD(ped, false))
		{
			if (ENTITY::DOES_ENTITY_EXIST(veLocal_367) && VEHICLE::IS_VEHICLE_DRIVEABLE(veLocal_367, false))
			{
				...
				if (plLocal_372 == PLAYER::PLAYER_ID())
					if (!bLocal_316)
						Global_1836660 = epctLocal_371;
				else if (!bLocal_319)
					Global_1836660 = plLocal_372;
			}
		}
	}
...
void func_344() // Position - 0xF991 (63889)
{
	Entity entity;
	...
	if (IS_BIT_SET(iLocal_358, 0))
		PED::SET_PED_CONFIG_FLAG(PLAYER::PLAYER_PED_ID(), 184, IS_BIT_SET(iLocal_358, 1));
...
void func_345() // Position - 0xFAFF (64255)
{
	SCRIPT::TERMINATE_THIS_THREAD();
	return;
}

void func_346() // Position - 0xFB0B (64267)
{
	if (iLocal_359 != 0)
		AUDIO::STOP_AUDIO_SCENE(func_5(iLocal_359));
...
void func_347() // Position - 0xFB62 (64354)
{
	if (bLocal_309)
...
BOOL _SHOULD_NETWORK_SCRIPT_TERMINATE() // Position - 0xFB79 (64377)
{
...
Hash _GET_CURRENT_SESSION_TYPE_SCRIPT_HASH() // Position - 0xFBFD (64509)
{
	switch (func_93())
	{
		case 0:
...
Hash func_350() // Position - 0xFC30 (64560)
{
...
BOOL func_351() // Position - 0xFC54 (64596)
{
	return Global_2685153.f_700;
}

BOOL _DOES_EVENT_OF_TYPE_EXIST(int iParam0) // Position - 0xFC63 (64611)
{
...
BOOL func_353() // Position - 0xFC7A (64634)
{
	return Global_2696981;
}

BOOL func_354() // Position - 0xFC86 (64646)
{
	return Global_2685153.f_695;
}

void func_355() // Position - 0xFC95 (64661)
{
	BUILTIN::WAIT(0);
	return;
}
...
BOOL func_357() // Position - 0xFE47 (65095)
{
	var unk;

	func_233(&unk, true, false);
...
int func_358(int iParam0, int iParam1, BOOL bParam2) // Position - 0xFEA5 (65189)
{
	int i;
