...
BOOL _NETWORK_IS_PLAYER_VALID(ePedComponentType player, BOOL bIsPlaying, BOOL bUnk) // Position - 0x14EB (5355)
{
...
eCharacter func_124(int iParam0, BOOL bParam1) // Position - 0x5CC1 (23745)
{
