...
void main() // Position - 0x0 (0)
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114018[num /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_114018[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		func_215(num);
		func_208(&iLocal_91, &(num.f_9), vector);
	
		if (num == 44)
		{
			func_200(&num, vector, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_92);
			func_199();
		}
		else if (num == 45)
		{
			func_200(&num, vector, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_93);
			func_197(&num);
		}
...
BOOL func_1(var uParam0) // Position - 0x260 (608)
{
...
BOOL func_2(Any* panParam0) // Position - 0x27E (638)
{
	const char* str;
	var unk32;
	...
	if (!func_181())
	{
		while (!func_172(*panParam0))
		{
			...
			if (!func_216(panParam0, *panParam0 != 2))
			{
...
void func_3(int iParam0, const char* sParam1) // Position - 0x33F (831)
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x3FB (1019)
{
	int num;
	int num2;
...
void func_5() // Position - 0x555 (1365)
{
	int i;
...
void func_6(int iParam0) // Position - 0x608 (1544)
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0x9F0 (2544)
{
	Global_65020 = true;
	Global_65023 = 1;
...
void func_8(int iParam0) // Position - 0xA3B (2619)
{
...
struct<2> func_9(int iParam0) // Position - 0xA6F (2671)
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xAA7 (2727)
{
	if (Global_65027)
		return;
...
void func_11() // Position - 0xAFD (2813)
{
	int i;
...
void func_12() // Position - 0xB2A (2858)
{
	int i;
...
void func_13() // Position - 0xB61 (2913)
{
	Global_65186 = 0;
	return;
}
...
var func_15(Hash hParam0) // Position - 0xBC1 (3009)
{
	var outValue;
...
void func_16() // Position - 0xBD5 (3029)
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xBFF (3071)
{
...
void func_18() // Position - 0xC13 (3091)
{
	int i;
...
void func_19() // Position - 0xC4C (3148)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xC8E (3214)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xCB8 (3256)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xCCB (3275)
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xCE8 (3304)
{
...
void func_24() // Position - 0xD2D (3373)
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19C1 (6593)
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x284A (10314)
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x286C (10348)
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x28F4 (10484)
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2934 (10548)
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2962 (10594)
{
...
int func_31(Vehicle veParam0) // Position - 0x2A3E (10814)
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2A80 (10880)
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2AE3 (10979)
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2B71 (11121)
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2BB3 (11187)
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2E0F (11791)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2E1B (11803)
{
	int i;
...
int func_38(int iParam0) // Position - 0x30C6 (12486)
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3176 (12662)
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x3369 (13161)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3389 (13193)
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x343A (13370)
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3569 (13673)
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x35D7 (13783)
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x36B0 (14000)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x36ED (14061)
{
...
Hash func_47(eCharacter echParam0) // Position - 0x3712 (14098)
{
	return Global_2339[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3721 (14113)
{
...
int func_49(int iParam0, int iParam1) // Position - 0x38BB (14523)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x38EA (14570)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x38FF (14591)
{
	int num;
	int num2;
...
int func_52() // Position - 0x3933 (14643)
{
	return Global_1574927;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x393F (14655)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3963 (14691)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3978 (14712)
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3EC1 (16065)
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x4104 (16644)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_58() // Position - 0x411D (16669)
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x421A (16922)
{
	return Global_44886 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x4228 (16936)
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x431B (17179)
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x45A3 (17827)
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x4644 (17988)
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x483C (18492)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x55BD (21949)
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x55F8 (22008)
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x586C (22636)
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x58A8 (22696)
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5DF7 (24055)
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5E3B (24123)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x65E2 (26082)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x6629 (26153)
{
...
BOOL func_73(int iParam0) // Position - 0x6684 (26244)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6694 (26260)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x66F4 (26356)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6AD8 (27352)
{
	return Global_33792;
}

BOOL func_77(int iParam0) // Position - 0x6AE3 (27363)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6AF3 (27379)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6B95 (27541)
{
	Vector3 vector;
	var unk3;
...
Vector3 func_80() // Position - 0x73FB (29691)
{
...
int func_81() // Position - 0x76F6 (30454)
{
	return Global_2652582.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x7705 (30469)
{
...
BOOL func_83() // Position - 0x772F (30511)
{
	return Global_2658294[PLAYER::PLAYER_ID() /*468*/].f_325.f_8;
}

Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7747 (30535)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x775C (30556)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x7773 (30579)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x77CB (30667)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7875 (30837)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x790A (30986)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x794E (31054)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7AD2 (31442)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7AE0 (31456)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x85A8 (34216)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x862A (34346)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8682 (34434)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x868B (34443)
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_97(int iParam0, int iParam1) // Position - 0x89A3 (35235)
{
	switch (iParam1)
	{
		case 0:
...
int func_98() // Position - 0x8B33 (35635)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8B43 (35651)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658294[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8B60 (35680)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8B70 (35696)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8EDA (36570)
{
	return Global_102506.f_417 > 0;
}

var func_103() // Position - 0x8EEB (36587)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x8F31 (36657)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x8FB7 (36791)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x8FEA (36842)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x903B (36923)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x90DD (37085)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x90FF (37119)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x9116 (37142)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x9123 (37155)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x915D (37213)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9198 (37272)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x91D4 (37332)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x91ED (37357)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x9250 (37456)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x9266 (37478)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x927C (37500)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x92BE (37566)
{
...
struct<2> func_120(int iParam0) // Position - 0x92E6 (37606)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x9733 (38707)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAA0B (43531)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAD51 (44369)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xADF6 (44534)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAE91 (44689)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAEB7 (44727)
{
	Global_80560 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAEEF (44783)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xAF48 (44872)
{
...
int func_130(Ped pedParam0) // Position - 0xAFCB (45003)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xAFFC (45052)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB011 (45073)
{
	int num;
...
int func_133() // Position - 0xB093 (45203)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB0C4 (45252)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB0DF (45279)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB12B (45355)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB174 (45428)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xB194 (45460)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
...
BOOL func_139(int iParam0) // Position - 0xB1B5 (45493)
{
	switch (iParam0)
	{
		case 5:
...
void func_140() // Position - 0xB208 (45576)
{
...
BOOL func_141(int iParam0) // Position - 0xB285 (45701)
{
	switch (iParam0)
	{
		case 5:
...
void func_142(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB2D8 (45784)
{
	int i;
...
BOOL func_143(int iParam0) // Position - 0xB3CE (46030)
{
	switch (iParam0)
	{
		case 5:
...
void func_144(BOOL bParam0) // Position - 0xB439 (46137)
{
	Player playerIndex;
...
void func_145(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB478 (46200)
{
	if (bParam0)
	{
...
BOOL func_146() // Position - 0xB5C7 (46535)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_147(Player plParam0, int iParam1) // Position - 0xB5E1 (46561)
{
	BOOL flag;
...
int func_148(int iParam0, BOOL bParam1) // Position - 0xB63A (46650)
{
	int num;
	int num2;
...
BOOL func_149(Player plParam0) // Position - 0xB67B (46715)
{
	Player player;
...
BOOL func_150(Player plParam0) // Position - 0xB69D (46749)
{
...
BOOL func_151() // Position - 0xB6DC (46812)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_152(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB6EA (46826)
{
	int num;
...
BOOL func_153() // Position - 0xB71D (46877)
{
...
void func_154(int iParam0) // Position - 0xB744 (46916)
{
	if (iParam0 == 1)
...
BOOL func_155(const char* sParam0) // Position - 0xB767 (46951)
{
...
void func_156() // Position - 0xB7A4 (47012)
{
	Global_21866 = 0;
	func_157();
	return;
...
void func_157() // Position - 0xB7B4 (47028)
{
...
BOOL func_158() // Position - 0xB80B (47115)
{
...
void func_159() // Position - 0xB82D (47149)
{
	func_165(0);
	func_164();
	func_160();
...
void func_160() // Position - 0xB842 (47170)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_161(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB89A (47258)
{
...
void func_162(Vehicle veParam0) // Position - 0xB8F1 (47345)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_163(BOOL bParam0, BOOL bParam1) // Position - 0xB91D (47389)
{
...
void func_164() // Position - 0xBA6E (47726)
{
...
void func_165(int iParam0) // Position - 0xBABF (47807)
{
	if (func_170())
		return;
...
void func_166(int iParam0) // Position - 0xBAF2 (47858)
{
	if (func_170())
		return;
...
void func_167(BOOL bParam0, BOOL bParam1) // Position - 0xBB7C (47996)
{
	if (bParam0)
	{
		if (func_169(0))
...
BOOL func_168() // Position - 0xBBF0 (48112)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_169(int iParam0) // Position - 0xBBFE (48126)
{
	if (iParam0 == 1)
...
BOOL func_170() // Position - 0xBC55 (48213)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_171(int iParam0) // Position - 0xBC64 (48228)
{
...
BOOL func_172(int iParam0) // Position - 0xBCA5 (48293)
{
	int num;
...
void func_173(int iParam0) // Position - 0xBCEA (48362)
{
...
int func_174(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBD1C (48412)
{
	int i;
...
void func_175(int iParam0, int iParam1) // Position - 0xBE53 (48723)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBEA2 (48802)
{
	return func_177(iParam0, Global_44886);
}

BOOL func_177(int iParam0, int iParam1) // Position - 0xBEB3 (48819)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_178(int iParam0) // Position - 0xC0A6 (49318)
{
	if (Global_44886 == 15)
		return false;
...
int func_179() // Position - 0xC0C8 (49352)
{
	return func_180(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_180(const char* sParam0, int iParam1) // Position - 0xC0D9 (49369)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_181() // Position - 0xC122 (49442)
{
	if (Global_102454 == 10 || Global_102454 == 9)
		return true;
...
BOOL func_182(var uParam0, int iParam1) // Position - 0xC146 (49478)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_183() // Position - 0xC929 (51497)
{
	func_27(&(Global_105490.f_2890), &Global_105490, 0, 1, 1, 0);
	return;
}

BOOL func_184(var uParam0) // Position - 0xC944 (51524)
{
	float num;
...
void func_185(int iParam0, var uParam1) // Position - 0xC9D2 (51666)
{
	if (iParam0 == 1)
	{
		if (!func_141(uParam1))
...
BOOL func_186(BOOL bParam0) // Position - 0xCA36 (51766)
{
...
BOOL func_187(Vehicle veParam0) // Position - 0xCACD (51917)
{
...
BOOL func_188(int iParam0) // Position - 0xCAF7 (51959)
{
	eCharacter character;
...
BOOL func_189() // Position - 0xD214 (53780)
{
	return Global_102493.f_1;
}

BOOL func_190() // Position - 0xD222 (53794)
{
	if (Global_99351 != -1)
...
BOOL func_191() // Position - 0xD245 (53829)
{
...
BOOL func_192() // Position - 0xD25F (53855)
{
	if (Global_80566)
		return true;
...
BOOL func_193() // Position - 0xD289 (53897)
{
	return Global_102506.f_418 > 0;
}

BOOL func_194(int iParam0, int iParam1) // Position - 0xD29A (53914)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_195() // Position - 0xD2D2 (53970)
{
	return Global_1575092;
}

BOOL func_196() // Position - 0xD2DE (53982)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
void func_197(var uParam0) // Position - 0xD2FA (54010)
{
	var entityCoords;
	float entityCoords2;
	float heading;
	...
	if (MISC::GET_GAME_TIMER() - iLocal_96 > 1250)
	{
		...
		{
			if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && !func_198(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 50f, true))
			{
...
BOOL func_198(Ped pedParam0, Entity eParam1, float fParam2, BOOL bParam3) // Position - 0xD3E3 (54243)
{
...
void func_199() // Position - 0xD405 (54277)
{
	float x;
	float y;
	float width;
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, var uParam8) // Position - 0xD4F7 (54519)
{
	var unk;
	...
	if (!(*uParam8 == 3))
	{
		if (func_188(2))
		{
			if (!func_158())
			{
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && func_207(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f)
				{
			...
			if (func_207(PLAYER::PLAYER_PED_ID(), uParam1, true) < 20f && *uParam8 == 1)
			{
...
void func_201(int iParam0) // Position - 0xD619 (54809)
{
	Global_24011 = iParam0;
	return;
}

BOOL func_202(char* sParam0) // Position - 0xD626 (54822)
{
	var string1;
...
struct<6> func_203() // Position - 0xD646 (54854)
{
	var unk;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD66A (54890)
{
...
void func_205(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD6A5 (54949)
{
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0xD6FB (55035)
{
...
float func_207(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xD796 (55190)
{
...
void func_208(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xD7D0 (55248)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_209(int iParam0, BOOL bParam1) // Position - 0xD8C1 (55489)
{
	if (iParam0 == -1)
		return;
...
int func_210(int iParam0) // Position - 0xD8FD (55549)
{
	if (Global_80301 == iParam0)
		if (Global_80302 == -1)
...
void func_211(var uParam0, int iParam1) // Position - 0xD936 (55606)
{
	BOOL flag;
	int i;
...
BOOL func_212() // Position - 0xD9D4 (55764)
{
	return Global_99738;
}

void func_213(var uParam0) // Position - 0xD9E0 (55776)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_214(uParam0);
...
void func_214(var uParam0) // Position - 0xD9F7 (55799)
{
	BOOL flag;
	int num;
	int i;
...
void func_215(int iParam0) // Position - 0xDADF (56031)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_216(Any* panParam0, BOOL bParam1) // Position - 0xDB07 (56071)
{
	var unk;
	...
	if (func_253(*panParam0) || func_251(*panParam0) || Global_80551 == true)
		return true;
...
void func_217(Ped pedParam0, var uParam1, int iParam2) // Position - 0xDD77 (56695)
{
	int taskSequenceId;
	int taskSequenceId2;
...
BOOL func_218(int iParam0) // Position - 0xE0CF (57551)
{
...
BOOL func_219(var uParam0) // Position - 0xE0EF (57583)
{
...
BOOL func_220(var uParam0) // Position - 0xE107 (57607)
{
...
void func_221(var uParam0) // Position - 0xE12C (57644)
{
	int i;
	int taskSequenceId;
...
void func_222(Object* pobParam0) // Position - 0xE430 (58416)
{
...
void func_223(var uParam0) // Position - 0xE45B (58459)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xE4DB (58587)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_225(Ped pedParam0, Vehicle veParam1) // Position - 0xE699 (59033)
{
...
BOOL func_226(var uParam0, BOOL bParam1, int iParam2) // Position - 0xE6C9 (59081)
{
	int i;
	int num;
...
BOOL func_227(int iParam0) // Position - 0xE985 (59781)
{
...
BOOL func_228(Ped pedParam0, int iParam1) // Position - 0xE9B9 (59833)
{
	float xSize;
...
BOOL func_229(Ped pedParam0, int iParam1) // Position - 0xEA2F (59951)
{
	return func_230(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_230(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xEA47 (59975)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_231(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xEB08 (60168)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_232(Ped pedParam0, int iParam1) // Position - 0xEC34 (60468)
{
...
int func_233() // Position - 0xECF9 (60665)
{
	int i;
...
BOOL func_234(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xED43 (60739)
{
	var unk;
...
float func_235(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xEDD4 (60884)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_236(float fParam0, var uParam1, var uParam2) // Position - 0xEDF5 (60917)
{
	float num;
	float num2;
...
void func_237(var uParam0) // Position - 0xEE34 (60980)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_238(Ped pedParam0, Ped pedParam1) // Position - 0xEE4F (61007)
{
	int i;
...
BOOL func_239(Ped pedParam0) // Position - 0xEE8E (61070)
{
...
BOOL func_240(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xEEB6 (61110)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_241(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xEFB1 (61361)
{
	float entityCoords;
	float num;
...
BOOL func_242(Ped pedParam0, float fParam1) // Position - 0xF0BD (61629)
{
	var outProjectile;
	var outCoords;
...
BOOL func_243(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xF152 (61778)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_244(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xF1E0 (61920)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_245(int iParam0) // Position - 0xF228 (61992)
{
...
void func_246(Vehicle veParam0) // Position - 0xF272 (62066)
{
	int taskSequenceId;
...
BOOL func_247(int iParam0) // Position - 0xF30F (62223)
{
	if (iParam0 == -1)
		iParam0 = func_179();
...
BOOL func_248(int iParam0) // Position - 0xF3A4 (62372)
{
...
BOOL func_249() // Position - 0xF3E3 (62435)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_250() // Position - 0xF400 (62464)
{
	if (Global_99351 != -1)
...
BOOL func_251(int iParam0) // Position - 0xF423 (62499)
{
...
BOOL func_252() // Position - 0xF457 (62551)
{
...
BOOL func_253(int iParam0) // Position - 0xF495 (62613)
{
	if (func_119(false))
...
void func_254() // Position - 0xF4BD (62653)
{
	iLocal_96 = MISC::GET_GAME_TIMER();
	return;
}

void func_255() // Position - 0xF4CB (62667)
{
...
BOOL func_256(var uParam0) // Position - 0xF533 (62771)
{
	switch (*uParam0)
	{
		case 44:
...
BOOL func_257(var uParam0) // Position - 0xF57A (62842)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_260(&uParam0->f_28[0], CHAR_OMEGA, 2319.443f, 2583.5881f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
					flag = false;
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				func_258(&uParam0->f_35[0], num[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
...
void func_258(Vehicle* pveParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0xF749 (63305)
{
	func_259(pveParam0);
...
void func_259(Vehicle* pveParam0) // Position - 0xF78C (63372)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_260(Ped* ppedParam0, eCharacter echParam1, float fParam2, float fParam3, float fParam4, float fParam5, char* sParam6, int iParam7) // Position - 0xF828 (63528)
{
...
BOOL func_261(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0xF884 (63620)
{
	Hash model;
...
int func_262(Ped pedParam0, eCharacter echParam1) // Position - 0xF912 (63762)
{
	int num;
...
BOOL func_263(var uParam0) // Position - 0xF958 (63832)
{
	if (func_220(uParam0))
	{
...
BOOL func_264(var uParam0) // Position - 0xF982 (63874)
{
	int i;
...
void func_265(var uParam0, char* sParam1, char* sParam2, int iParam3) // Position - 0xF9B3 (63923)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
BOOL func_266(var uParam0) // Position - 0xF9EF (63983)
{
	int num;
	int i;
	BOOL flag;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (!func_260(&uParam0->f_28[0], CHAR_OMEGA, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
					flag = false;
...
BOOL func_267(int iParam0) // Position - 0xFC73 (64627)
{
	var unk;
	eCharacter character;
...
BOOL func_268(int iParam0) // Position - 0xFCC4 (64708)
{
	const char* string2;
...
BOOL func_269(int iParam0) // Position - 0xFD7D (64893)
{
	var unk;
...
BOOL func_270(int iParam0) // Position - 0xFE3E (65086)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_271(int iParam0, char* sParam1) // Position - 0xFEC3 (65219)
{
...
BOOL func_272(int iParam0) // Position - 0xFFA5 (65445)
{
...
BOOL func_273(int iParam0) // Position - 0xFFD0 (65488)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_274(int iParam0) // Position - 0xFFFB (65531)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_275(int iParam0) // Position - 0x1002B (65579)
{
	if (func_248(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_276() // Position - 0x10060 (65632)
{
...
BOOL func_277(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, float fParam5) // Position - 0x1007A (65658)
{
	int i;
...
BOOL func_278(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x100DF (65759)
{
	int num;
	char* str;
...
BOOL func_279(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x10157 (65879)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_280(var uParam0, BOOL bParam1) // Position - 0x101D2 (66002)
{
	char* str;
...
void func_281(char* sParam0) // Position - 0x102A2 (66210)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_202(sParam0))
			func_282();
...
void func_282() // Position - 0x102C1 (66241)
{
	Global_21866 = 0;
	func_283();
	return;
...
void func_283() // Position - 0x102D1 (66257)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
int func_284(var uParam0) // Position - 0x102F2 (66290)
{
	if (func_220(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_285(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x10328 (66344)
{
...
void func_286(var uParam0, BOOL bParam1) // Position - 0x10348 (66376)
{
	func_287(&(uParam0->f_41), bParam1);
	return;
}

void func_287(var uParam0, BOOL bParam1) // Position - 0x1035A (66394)
{
	int i;
...
void func_288(Object* pobParam0, BOOL bParam1) // Position - 0x10398 (66456)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_289(var uParam0, BOOL bParam1) // Position - 0x103D3 (66515)
{
	func_290(&(uParam0->f_35), bParam1);
	return;
}

void func_290(var uParam0, BOOL bParam1) // Position - 0x103E5 (66533)
{
	int i;
...
void func_291(Vehicle* pveParam0) // Position - 0x10422 (66594)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_292(var uParam0, int iParam1) // Position - 0x1045A (66650)
{
	func_293(&(uParam0->f_28), iParam1);
	return;
}

void func_293(var uParam0, int iParam1) // Position - 0x1046C (66668)
{
	int i;
...
void func_294(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x104AD (66733)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_295(Ped* ppedParam0) // Position - 0x104FD (66813)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
void func_296(int iParam0) // Position - 0x1053E (66878)
{
	if (*iParam0 == -1)
		return;
...
void func_297(char* sParam0) // Position - 0x1057B (66939)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_298(var uParam0) // Position - 0x1058D (66957)
{
	*uParam0 = -1;
...
void func_299() // Position - 0x105C0 (67008)
{
...
Hash func_300(eCharacter echParam0) // Position - 0x105DA (67034)
{
	if (!func_36(echParam0))
