...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19C1 (6593)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x286C (10348)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x28F4 (10484)
{
...
int func_83() // Position - 0x772F (30511)
{
...
BOOL func_86(Player plParam0) // Position - 0x7773 (30579)
{
...
BOOL func_94(Player plParam0) // Position - 0x862A (34346)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_205(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xD6A5 (54949)
{
...
int func_262(var uParam0, eCharacter echParam1) // Position - 0xF912 (63762)
{
	int num;
