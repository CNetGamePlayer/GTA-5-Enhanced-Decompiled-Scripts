...
void func_16(char* sParam0) // Position - 0x15F8 (5624)
{
	var unk;
...
void func_17(char* sParam0) // Position - 0x161E (5662)
{
	TEXT_LABEL_ASSIGN_STRING(sParam0, "", 64);
	return;
}

void func_18(char* sParam0) // Position - 0x162C (5676)
{
	int num;
...
void func_19(int iParam0, char* sParam1) // Position - 0x1670 (5744)
{
	switch (iParam0)
	{
		case 0:
...
void func_20(char* sParam0) // Position - 0x1839 (6201)
{
	var unk;
...
void func_21(char* sParam0) // Position - 0x186D (6253)
{
	var unk;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x1898 (6296)
{
	func_23();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_23() // Position - 0x18B1 (6321)
{
...
BOOL func_24(int iParam0) // Position - 0x19AE (6574)
{
	return Global_44886 == iParam0;
}

BOOL func_25(eCharacter echParam0) // Position - 0x19BC (6588)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x19C8 (6600)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x1A05 (6661)
{
...
Hash func_28(eCharacter echParam0) // Position - 0x1A2A (6698)
{
	return Global_2339[echParam0 /*29*/];
}

void func_29(char* sParam0) // Position - 0x1A39 (6713)
{
...
void func_30() // Position - 0x1A5A (6746)
{
	iLocal_252 = MISC::GET_RANDOM_INT_IN_RANGE(0, iLocal_251);
	return;
}

void func_31(char* sParam0) // Position - 0x1A6B (6763)
{
	eCharacter character;
...
void func_32() // Position - 0x1AC1 (6849)
{
	if (!func_63())
		func_102(1, true);
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0x1AD7 (6871)
{
...
int func_34(char* sParam0, int iParam1, BOOL bParam2) // Position - 0x1B25 (6949)
{
	Global_23001 = 0;
...
void func_35() // Position - 0x1DF3 (7667)
{
	if (!func_36())
		return;
...
BOOL func_36() // Position - 0x1E2A (7722)
{
...
BOOL func_37(Player plParam0) // Position - 0x1E8D (7821)
{
...
BOOL func_38(Player plParam0, int iParam1) // Position - 0x1EC4 (7876)
{
	return IS_BIT_SET(Global_1892798[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_39(int iParam0) // Position - 0x1EDC (7900)
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

Player _INVALID_PLAYER_INDEX() // Position - 0x1EEE (7918)
{
	return -1;
}

void func_41() // Position - 0x1EF7 (7927)
{
	int i;
...
void func_42() // Position - 0x1F27 (7975)
{
...
BOOL func_43() // Position - 0x1FBC (8124)
{
...
BOOL func_44() // Position - 0x1FE3 (8163)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0x207C (8316)
{
	if (func_24(14))
	{
...
void func_46() // Position - 0x211E (8478)
{
	int i;
...
BOOL func_47(int iParam0, int iParam1) // Position - 0x2174 (8564)
{
	switch (iParam0)
	{
		case 5:
...
void func_48(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0x21AC (8620)
{
...
void func_49(var uParam0) // Position - 0x2202 (8706)
{
	eCharacter character;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x223D (8765)
{
...
void func_51(char* sParam0) // Position - 0x22D8 (8920)
{
	eCharacter character;
...
void func_52(int iParam0) // Position - 0x2310 (8976)
{
	return;
}

void func_53(int iParam0, int iParam1, float fParam2) // Position - 0x2318 (8984)
{
	return;
}

void func_54() // Position - 0x2320 (8992)
{
	STREAMING::REMOVE_ANIM_DICT(&uLocal_386);
	return;
}

void func_55() // Position - 0x232F (9007)
{
	var unk;
	var animationName;
...
void func_56(int iParam0) // Position - 0x23A5 (9125)
{
	return;
}

void func_57(const char* sParam0) // Position - 0x23AD (9133)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_58(int iParam0, char* sParam1, char* sParam2) // Position - 0x23C0 (9152)
{
...
int func_59() // Position - 0x245F (9311)
{
	var unk;
	int num;
...
BOOL func_60() // Position - 0x24B3 (9395)
{
	return Global_102506.f_417 > 0;
}

BOOL func_61() // Position - 0x24C4 (9412)
{
...
BOOL func_62() // Position - 0x24D7 (9431)
{
...
BOOL func_63() // Position - 0x24F9 (9465)
{
...
void func_64() // Position - 0x2528 (9512)
{
	var animDict;
...
void func_65(char* sParam0) // Position - 0x2547 (9543)
{
	var unk;
...
void func_66(char* sParam0) // Position - 0x2587 (9607)
{
	func_19(iLocal_295, sParam0);
	return;
}

void func_67(char* sParam0) // Position - 0x2598 (9624)
{
...
void func_68(Hash hParam0, BOOL bParam1) // Position - 0x25B6 (9654)
{
	int num;
...
void func_69(int iParam0, BOOL bParam1) // Position - 0x25D7 (9687)
{
	int offset;
...
void func_70(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8) // Position - 0x2648 (9800)
{
	func_71(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
	return;
}

void func_71(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9) // Position - 0x2668 (9832)
{
	int i;
...
void func_72() // Position - 0x283A (10298)
{
	int i;
...
BOOL func_73(int iParam0) // Position - 0x2951 (10577)
{
	int num;
	int i;
...
char* func_75(int iParam0) // Position - 0x29B4 (10676)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_76(int iParam0) // Position - 0x2A97 (10903)
{
	if (func_78(iParam0))
...
BOOL func_77(int iParam0) // Position - 0x2ABB (10939)
{
	int num;
...
BOOL func_78(int iParam0) // Position - 0x2AEB (10987)
{
...
int func_79(Hash hParam0) // Position - 0x2B15 (11029)
{
	switch (hParam0)
	{
...
void func_80(Blip* pblParam0) // Position - 0x2BD3 (11219)
{
	if (iLocal_445 == 1)
...
void func_81(var uParam0, var uParam1, BOOL bParam2) // Position - 0x2BF2 (11250)
{
	if (iLocal_445 == 1)
	{
...
Blip func_82(Entity eParam0, BOOL bParam1, int iParam2) // Position - 0x2C45 (11333)
{
	Blip blip;
...
Blip func_83(Entity eParam0, BOOL bParam1, BOOL bParam2) // Position - 0x2C8F (11407)
{
	Blip blip;
...
var func_84(BOOL bParam0, var uParam1, var uParam2) // Position - 0x2D33 (11571)
{
	if (bParam0)
		return uParam1;
...
float func_85(Ped pedParam0, Ped pedParam1, BOOL bParam2) // Position - 0x2D4A (11594)
{
	Vector3 entityCoords;
...
BOOL func_86(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0x2DA8 (11688)
{
	var unk;
...
float func_87(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0x2E39 (11833)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_88(float fParam0, var uParam1, var uParam2) // Position - 0x2E5A (11866)
{
	float num;
	float num2;
...
int func_89(Ped pedParam0) // Position - 0x2E99 (11929)
{
	int weaponHash;
...
BOOL func_90() // Position - 0x2EAD (11949)
{
...
void func_91() // Position - 0x2ECD (11981)
{
	if (iLocal_243 != -1)
	{
...
void func_92() // Position - 0x2EED (12013)
{
	Global_21866 = 0;
	func_93();
	return;
...
void func_93() // Position - 0x2EFD (12029)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
BOOL func_94() // Position - 0x2F1E (12062)
{
	return false;
}

void func_95() // Position - 0x2F27 (12071)
{
	_CONVERSATION_INITIALIZE_ACTOR(&uLocal_35, 3, pedLocal_238, &uLocal_234, 0, 1);
...
BOOL func_96() // Position - 0x2F4E (12110)
{
	return true;
}

float func_97(Ped pedParam0, Ped pedParam1) // Position - 0x2F57 (12119)
{
	return func_85(pedParam0, pedParam1, true);
}

void func_98(int iParam0) // Position - 0x2F68 (12136)
{
	int num;
...
int func_99(int iParam0) // Position - 0x2F99 (12185)
{
	int i;
	int num;
...
int func_100(int iParam0, BOOL bParam1) // Position - 0x2FCA (12234)
{
	if (!func_78(iParam0))
	{
		!bParam1;
...
void func_101(int iParam0, int iParam1) // Position - 0x307D (12413)
{
	*iParam0 = *iParam0 || iParam1;
	return;
}

void func_102(int iParam0, BOOL bParam1) // Position - 0x308E (12430)
{
	if (iParam0 == 1)
		TASK::TASK_PLAY_ANIM(pedLocal_238, &uLocal_322, &uLocal_216, 2f, -2f, -1, 0, 0, false, false, false);
	else
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0x3100 (12544)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_104() // Position - 0x3121 (12577)
{
	func_105();
	return;
}

void func_105() // Position - 0x312D (12589)
{
	return;
}

void func_106() // Position - 0x3135 (12597)
{
...
BOOL func_107() // Position - 0x31D4 (12756)
{
...
BOOL func_108() // Position - 0x31F1 (12785)
{
	if (Global_99351 != -1)
...
BOOL func_109() // Position - 0x3214 (12820)
{
	if (Global_44886 == 15)
		return false;
...
BOOL func_110() // Position - 0x3229 (12841)
{
	return true;
}

BOOL func_111(int iParam0) // Position - 0x3232 (12850)
{
	return func_112(Global_114931.f_20124, iParam0);
}

BOOL func_112(int iParam0, int iParam1) // Position - 0x3247 (12871)
{
	return iParam0 && iParam1 != false;
}

int func_113(const char* sParam0) // Position - 0x3256 (12886)
{
...
void func_114(int iParam0) // Position - 0x337D (13181)
{
	var string1;
...
void func_115(Blip* pblParam0) // Position - 0x344C (13388)
{
	if (HUD::DOES_BLIP_EXIST(*pblParam0))
	{
...
struct<6> func_116() // Position - 0x346C (13420)
{
	var unk;
...
void func_117() // Position - 0x3490 (13456)
{
	func_118();
	return;
}

void func_118() // Position - 0x349C (13468)
{
	return;
}

void func_119() // Position - 0x34A4 (13476)
{
	if (iLocal_243 == -1)
