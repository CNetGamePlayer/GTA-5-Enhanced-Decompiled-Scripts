...
void func_306(var uParam0) // Position - 0x362BE (221886)
{
	...
	func_309(&uLocal_124, joaat("velum2"), "Smuggler_Plane");
	func_307(&uLocal_124, 3178.6318f, -4960.667f, 99.0647f, -3.4084f, -0.004f, -78.1044f, "HS4_VEL_LSA_ISD", 1, 1, 5, 0);
	return;
}

void func_307(var uParam0, float fParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11) // Position - 0x36309 (221961)
{
...
void func_308(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4) // Position - 0x36339 (222009)
{
	uParam0->f_1 = sParam1;
	uParam0->f_2 = iParam3;
...
void func_309(var uParam0, int iParam1, char* sParam2) // Position - 0x36366 (222054)
{
