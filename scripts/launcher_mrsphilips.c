...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x19BA (6586)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x2865 (10341)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x28ED (10477)
{
...
int func_83() // Position - 0x7723 (30499)
{
...
BOOL func_86(Player plParam0) // Position - 0x7767 (30567)
{
...
BOOL func_94(Player plParam0) // Position - 0x8622 (34338)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
