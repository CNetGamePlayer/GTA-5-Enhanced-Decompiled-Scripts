...
void main() // Position - 0x0 (0)
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (num != -1)
		{
			if (Global_114018[num /*10*/].f_9 != -1)
			{
				...
				func_324(&(Global_114018[num /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		if (!func_228(&num, num != 2))
			func_307(&num, true);
	
		func_227(num);
		func_220(&iLocal_91, &(num.f_9), vector);
	
		if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(num.f_28[0]))
			if (num == 2)
				if (func_217(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
					func_216(&num, uLocal_95, true, 0);
			else if (num == 3)
				func_217(&num, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f);
			else if (num == 4)
				func_201(&uLocal_103, ENTITY::GET_ENTITY_COORDS(num.f_28[0], true), "BARR3AU", "BARRY3_AMB");
		...
		if (func_185(&num, num2))
		{
			if (func_184(num))
				func_181(num, &blLocal_94);
...
BOOL func_1(var uParam0) // Position - 0x32E (814)
{
...
BOOL func_2(Any* panParam0) // Position - 0x34C (844)
{
	const char* str;
	var unk32;
	...
	if (!func_180())
	{
		while (!func_171(*panParam0))
		{
			...
			if (!func_228(panParam0, *panParam0 != 2))
			{
...
void func_3(int iParam0, const char* sParam1) // Position - 0x40D (1037)
{
	func_21(sParam1);
...
void func_4(int iParam0) // Position - 0x4C9 (1225)
{
	int num;
	int num2;
...
void func_5() // Position - 0x623 (1571)
{
	int i;
...
void func_6(int iParam0) // Position - 0x6D6 (1750)
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0) // Position - 0xABE (2750)
{
	Global_65020 = true;
	Global_65023 = 1;
...
void func_8(int iParam0) // Position - 0xB09 (2825)
{
...
struct<2> func_9(int iParam0) // Position - 0xB3D (2877)
{
	var unk;
	var unk3;
...
void func_10() // Position - 0xB75 (2933)
{
	if (Global_65027)
		return;
...
void func_11() // Position - 0xBCB (3019)
{
	int i;
...
void func_12() // Position - 0xBF8 (3064)
{
	int i;
...
void func_13() // Position - 0xC2F (3119)
{
	Global_65186 = 0;
	return;
}

void func_14() // Position - 0xC3B (3131)
{
	Global_65046 = 0;
...
var func_15(Hash hParam0) // Position - 0xC8F (3215)
{
	var outValue;
...
void func_16() // Position - 0xCA3 (3235)
{
	int i;
...
void func_17(BOOL bParam0) // Position - 0xCCD (3277)
{
...
void func_18() // Position - 0xCE1 (3297)
{
	int i;
...
void func_19() // Position - 0xD1A (3354)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) > 0)
	{
		if (func_20())
...
BOOL func_20() // Position - 0xD5C (3420)
{
	if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("mission_stat_watcher")) < 1)
		return false;
...
void func_21(const char* sParam0) // Position - 0xD86 (3462)
{
	MISC::ARE_STRINGS_EQUAL(sParam0, sParam0);
	return;
}

void func_22(char* sParam0, int iParam1) // Position - 0xD99 (3481)
{
...
void func_23(char* sParam0, int iParam1, Ped pedParam2) // Position - 0xDB6 (3510)
{
...
void func_24() // Position - 0xDFB (3579)
{
	int i;
	int j;
...
void func_25(int iParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A8F (6799)
{
	int i;
	eCharacter j;
...
int func_26(var uParam0) // Position - 0x2918 (10520)
{
...
void func_27(var uParam0, int iParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x293A (10554)
{
	Vehicle vehicle;
...
int func_28(var uParam0, int iParam1, Vehicle veParam2, int iParam3) // Position - 0x29C2 (10690)
{
...
BOOL func_29(Vehicle veParam0) // Position - 0x2A02 (10754)
{
	int i;
...
void func_30(var uParam0, Vehicle veParam1, int iParam2) // Position - 0x2A30 (10800)
{
...
int func_31(Vehicle veParam0) // Position - 0x2B0C (11020)
{
	int i;
...
eCharacter func_32(Vehicle veParam0) // Position - 0x2B4E (11086)
{
	int i;
...
int func_33(Vehicle veParam0, eCharacter echParam1, int iParam2) // Position - 0x2BB1 (11185)
{
	int i;
...
Hash func_34(eCharacter echParam0, int iParam1) // Position - 0x2C3F (11327)
{
	Hash num;
...
void func_35(eCharacter echParam0, var uParam1, int iParam2) // Position - 0x2C81 (11393)
{
	int num;
...
BOOL func_36(eCharacter echParam0) // Position - 0x2EDD (11997)
{
	return echParam0 < CHAR_MULTIPLAYER;
}

void func_37(Vehicle veParam0, var uParam1) // Position - 0x2EE9 (12009)
{
	int i;
...
int func_38(int iParam0) // Position - 0x3194 (12692)
{
	switch (iParam0)
	{
		case 1:
...
int func_39(var uParam0, var uParam1, var uParam2) // Position - 0x3244 (12868)
{
	int i;
	int modType;
...
BOOL func_40(int iParam0) // Position - 0x3437 (13367)
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_41(var uParam0) // Position - 0x3457 (13399)
{
	int i;
...
BOOL func_42(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x3508 (13576)
{
...
BOOL func_43(Vehicle veParam0, eCharacter echParam1, BOOL bParam2) // Position - 0x3637 (13879)
{
	int i;
	var garageName;
	int num;
...
BOOL func_44(eCharacter echParam0, int iParam1, char* sParam2, var uParam3) // Position - 0x36A5 (13989)
{
...
eCharacter _GET_PLAYER_CHARACTER_FROM_PED(Ped pedParam0) // Position - 0x377E (14206)
{
	eCharacter i;
	Hash entityModel;
...
Hash _GET_CHARACTER_MODEL(eCharacter character) // Position - 0x37BB (14267)
{
...
Hash func_47(eCharacter echParam0) // Position - 0x37E0 (14304)
{
	return Global_2339[echParam0 /*29*/];
}

void func_48(Ped pedParam0, var uParam1, int iParam2, int iParam3) // Position - 0x37EF (14319)
{
...
int func_49(int iParam0, int iParam1) // Position - 0x3989 (14729)
{
	Hash statHash;
	int outValue;
...
Hash func_50(int iParam0, int iParam1) // Position - 0x39B8 (14776)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(0, iParam0, func_51(iParam1));
}

int func_51(int iParam0) // Position - 0x39CD (14797)
{
	int num;
	int num2;
...
int func_52() // Position - 0x3A01 (14849)
{
	return Global_1574927;
}

BOOL func_53(int iParam0, int iParam1) // Position - 0x3A0D (14861)
{
	Hash statHash;
	BOOL outValue;
...
Hash func_54(int iParam0, int iParam1) // Position - 0x3A31 (14897)
{
	return STATS::_GET_STAT_HASH_FOR_CHARACTER_STAT(2, iParam0, func_51(iParam1));
}

void func_55(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, int iParam4, eCharacter echParam5) // Position - 0x3A46 (14918)
{
	eCharacter character;
...
void func_56(Ped pedParam0, ePedComponentType epctParam1, var uParam2, var uParam3, var uParam4, int iParam5, eCharacter echParam6) // Position - 0x3F8F (16271)
{
	eCharacter character;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER() // Position - 0x41D2 (16850)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_58() // Position - 0x41EB (16875)
{
	eCharacter character;
...
BOOL func_59(int iParam0) // Position - 0x42E8 (17128)
{
	return Global_44886 == iParam0;
}

void func_60(Ped pedParam0, BOOL bParam1) // Position - 0x42F6 (17142)
{
	eCharacter character;
...
void func_61(Ped pedParam0, var uParam1) // Position - 0x43E9 (17385)
{
	int i;
	int j;
	Hash k;
...
BOOL func_62(int iParam0) // Position - 0x4671 (18033)
{
	switch (iParam0)
	{
...
BOOL func_63(int iParam0) // Position - 0x4712 (18194)
{
...
Hash func_64(Hash hParam0, int iParam1) // Position - 0x490A (18698)
{
	int num;
	int dlcWeaponIndex;
	int i;
...
int func_65(Hash hParam0, Any* panParam1) // Position - 0x568B (22155)
{
	int i;
	int numDlcWeapons;
...
Hash func_66(int iParam0) // Position - 0x56C6 (22214)
{
	int num;
...
void func_67(Ped pedParam0) // Position - 0x593A (22842)
{
	eCharacter character;
...
void func_68(var uParam0, int iParam1) // Position - 0x5976 (22902)
{
	var unk;
	var unk2;
	var unk5;
...
BOOL func_69(Vector3 vParam0, var uParam1, var uParam2, char* sParam3, float fParam4, float fParam5, float fParam6) // Position - 0x5EC5 (24261)
{
...
BOOL func_70(int iParam0, var uParam1, var uParam2) // Position - 0x5F09 (24329)
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
...
BOOL func_71(float fParam0, var uParam1, var uParam2, float fParam3, float fParam4, float fParam5, BOOL bParam6) // Position - 0x66B0 (26288)
{
	if (bParam6)
...
BOOL func_72(var uParam0) // Position - 0x66F7 (26359)
{
...
BOOL func_73(int iParam0) // Position - 0x6752 (26450)
{
	return func_74(iParam0, 0, true);
}

BOOL func_74(int iParam0, int iParam1, BOOL bParam2) // Position - 0x6762 (26466)
{
	if (iParam0 == -1)
		return false;
...
int func_75(int iParam0) // Position - 0x67C2 (26562)
{
	switch (iParam0)
	{
		case 0:
...
int func_76() // Position - 0x6BA6 (27558)
{
	return Global_33792;
}

BOOL func_77(int iParam0) // Position - 0x6BB1 (27569)
{
	return func_74(iParam0, 5, true);
}

int func_78(Vector3 vParam0, var uParam1, var uParam2, int iParam3, int iParam4, BOOL bParam5, BOOL bParam6, int iParam7) // Position - 0x6BC1 (27585)
{
	int i;
...
Vector3 func_79(int iParam0, BOOL bParam1) // Position - 0x6C63 (27747)
{
	Vector3 vector;
	var unk3;
...
Vector3 func_80() // Position - 0x74C9 (29897)
{
...
int func_81() // Position - 0x77C4 (30660)
{
	return Global_2652582.f_2706;
}

BOOL func_82(float fParam0, var uParam1, var uParam2) // Position - 0x77D3 (30675)
{
...
Vector3 func_84(float fParam0, float fParam1, float fParam2) // Position - 0x7815 (30741)
{
	return OBJECT::GET_OFFSET_FROM_COORD_AND_HEADING_IN_WORLD_COORDS(func_85(), 0f, fParam0);
}

Vector3 func_85() // Position - 0x782A (30762)
{
	return -880f, -2770f, -50f;
}

BOOL func_86(ePedComponentType epctParam0) // Position - 0x7841 (30785)
{
...
Vector3 func_87(int iParam0, int iParam1) // Position - 0x7899 (30873)
{
	var unk;
	var unk7;
...
BOOL func_88(int iParam0, int iParam1, var uParam2, int iParam3, BOOL bParam4) // Position - 0x7943 (31043)
{
	var unk;
	Vector3 vector;
	var unk12;
...
Vector3 func_89(float fParam0, var uParam1, var uParam2, float fParam3) // Position - 0x79D8 (31192)
{
	float num;
	float num2;
	float num3;
...
struct<6> func_90(int iParam0) // Position - 0x7A1C (31260)
{
	var unk;
...
struct<6> func_91(int iParam0) // Position - 0x7BA0 (31648)
{
	return func_92(iParam0);
}

struct<6> func_92(int iParam0) // Position - 0x7BAE (31662)
{
	var unk;
...
BOOL func_93(int iParam0, var uParam1) // Position - 0x8678 (34424)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_94(ePedComponentType epctParam0) // Position - 0x86FA (34554)
{
	if (epctParam0 != _INVALID_PLAYER_INDEX())
...
Player _INVALID_PLAYER_INDEX() // Position - 0x8752 (34642)
{
	return -1;
}

Vector3 func_96(int iParam0) // Position - 0x875B (34651)
{
	switch (iParam0)
	{
		case 1:
...
int func_98() // Position - 0x8C03 (35843)
{
	return func_99(PLAYER::PLAYER_ID());
}

int func_99(Player plParam0) // Position - 0x8C13 (35859)
{
	return MISC::GET_BITS_IN_RANGE(Global_2658294[plParam0 /*468*/].f_325.f_3, 28, 31);
}

BOOL func_100(int iParam0) // Position - 0x8C30 (35888)
{
	return func_74(iParam0, 0, false);
}

int func_101(int iParam0) // Position - 0x8C40 (35904)
{
	switch (iParam0)
	{
		case -1:
...
BOOL func_102() // Position - 0x8FAA (36778)
{
	return Global_102506.f_417 > 0;
}

var func_103() // Position - 0x8FBB (36795)
{
	var unk;
...
void func_104(var uParam0, int iParam1) // Position - 0x9001 (36865)
{
	if (iParam1 <= 0)
		return;
...
void func_105(var uParam0, int iParam1) // Position - 0x9087 (36999)
{
...
void func_106(var uParam0, int iParam1) // Position - 0x90BA (37050)
{
	int num;
	int num2;
...
int func_107(int iParam0, int iParam1) // Position - 0x910B (37131)
{
	if (iParam1 < 0)
		iParam1 = 0;
...
int func_108(int iParam0) // Position - 0x91AD (37293)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * IS_BIT_SET(iParam0, 31) ? -1 : 1) + 2011;
}

var func_109(BOOL bParam0, var uParam1, var uParam2) // Position - 0x91CF (37327)
{
	if (bParam0)
		return uParam1;
...
int func_110(int iParam0) // Position - 0x91E6 (37350)
{
	return iParam0 & 15;
}

void func_111(var uParam0, int iParam1) // Position - 0x91F3 (37363)
{
...
void func_112(var uParam0, int iParam1) // Position - 0x922D (37421)
{
...
void func_113(var uParam0, int iParam1) // Position - 0x9268 (37480)
{
	if (iParam1 < 0 || iParam1 >= 60)
		return;
...
eCharacter _GET_CURRENT_PLAYER_CHARACTER_0() // Position - 0x92A4 (37540)
{
	func_58();
	return Global_114931.f_2370.f_539.f_4321;
}

void func_115(int iParam0) // Position - 0x92BD (37565)
{
	int num;
	var textLabel;
...
BOOL func_116() // Position - 0x9320 (37664)
{
	return MISC::IS_ORBIS_VERSION() || MISC::IS_PROSPERO_VERSION();
}

BOOL func_117() // Position - 0x9336 (37686)
{
	return MISC::IS_DURANGO_VERSION() || MISC::IS_SCARLETT_VERSION();
}

void func_118(char* sParam0, Any anParam1, int iParam2) // Position - 0x934C (37708)
{
...
BOOL func_119(BOOL bParam0) // Position - 0x938E (37774)
{
...
struct<2> func_120(int iParam0) // Position - 0x93B6 (37814)
{
	var unk;
...
void func_121(int iParam0, var uParam1) // Position - 0x9803 (38915)
{
	switch (iParam0)
	{
		case 0:
...
int func_123(int iParam0) // Position - 0xAADB (43739)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_124(Any* panParam0) // Position - 0xAE21 (44577)
{
	int threadId;
...
void func_125(int iParam0) // Position - 0xAEC6 (44742)
{
	var name;
...
void func_126(int iParam0) // Position - 0xAF61 (44897)
{
	if (iParam0 < 63)
	{
		func_127();
...
void func_127() // Position - 0xAF87 (44935)
{
	Global_80560 != 6;
...
void func_128(Ped pedParam0) // Position - 0xAFBF (44991)
{
	int num;
	int num2;
	int num3;
...
void func_129(int iParam0) // Position - 0xB018 (45080)
{
...
int func_130(Ped pedParam0) // Position - 0xB09B (45211)
{
	int i;
...
void func_131(int iParam0, int iParam1, int iParam2) // Position - 0xB0CC (45260)
{
	func_132(iParam0, iParam1, iParam2, 0, 0, 1);
	return;
}

void func_132(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xB0E1 (45281)
{
	int num;
...
int func_133() // Position - 0xB163 (45411)
{
	int i;
...
BOOL func_134(int iParam0, int iParam1, int iParam2) // Position - 0xB194 (45460)
{
...
int func_135(int iParam0, int iParam1, int iParam2) // Position - 0xB1AF (45487)
{
	int i;
...
int func_136(Ped pedParam0) // Position - 0xB1FB (45563)
{
	int i;
...
BOOL func_137(Ped pedParam0) // Position - 0xB244 (45636)
{
...
BOOL func_138(int iParam0) // Position - 0xB264 (45668)
{
	switch (iParam0)
	{
		case 5:
...
void func_139() // Position - 0xB2B7 (45751)
{
...
BOOL func_140(int iParam0) // Position - 0xB334 (45876)
{
	switch (iParam0)
	{
		case 5:
...
void func_141(Any* panParam0, BOOL bParam1, BOOL bParam2) // Position - 0xB387 (45959)
{
	int i;
...
BOOL func_142(int iParam0) // Position - 0xB47D (46205)
{
	switch (iParam0)
	{
		case 5:
...
void func_143(BOOL bParam0) // Position - 0xB4E8 (46312)
{
	Player playerIndex;
...
void func_144(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB527 (46375)
{
	if (bParam0)
	{
...
BOOL func_145() // Position - 0xB676 (46710)
{
	return IS_BIT_SET(Global_1845299[PLAYER::PLAYER_ID() /*883*/].f_36.f_18, 14);
}

BOOL func_146(Player plParam0, int iParam1) // Position - 0xB690 (46736)
{
	BOOL flag;
...
int func_147(int iParam0, BOOL bParam1) // Position - 0xB6E9 (46825)
{
	int num;
	int num2;
...
BOOL func_148(Player plParam0) // Position - 0xB72A (46890)
{
	Player player;
...
BOOL func_149(Player plParam0) // Position - 0xB74C (46924)
{
...
BOOL func_150() // Position - 0xB78B (46987)
{
	return IS_BIT_SET(Global_2621446, 3);
}

int func_151(BOOL bParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3) // Position - 0xB799 (47001)
{
	int num;
...
BOOL func_152() // Position - 0xB7CC (47052)
{
...
void func_153(int iParam0) // Position - 0xB7F3 (47091)
{
	if (iParam0 == 1)
...
BOOL func_154(const char* sParam0) // Position - 0xB816 (47126)
{
...
void func_155() // Position - 0xB853 (47187)
{
	Global_21866 = 0;
	func_156();
	return;
...
void func_156() // Position - 0xB863 (47203)
{
...
BOOL func_157() // Position - 0xB8BA (47290)
{
...
void func_158() // Position - 0xB8DC (47324)
{
	func_164(0);
	func_163();
	func_159();
...
void func_159() // Position - 0xB8F1 (47345)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
...
BOOL func_160(Vehicle veParam0, float fParam1, int iParam2, int iParam3, BOOL bParam4, BOOL bParam5, BOOL bParam6) // Position - 0xB949 (47433)
{
...
void func_161(Vehicle veParam0) // Position - 0xB9A0 (47520)
{
	if (!ENTITY::IS_ENTITY_DEAD(veParam0, false))
...
void func_162(BOOL bParam0, BOOL bParam1) // Position - 0xB9CC (47564)
{
...
void func_163() // Position - 0xBB1D (47901)
{
...
void func_164(int iParam0) // Position - 0xBB6E (47982)
{
	if (func_169())
		return;
...
void func_165(int iParam0) // Position - 0xBBA1 (48033)
{
	if (func_169())
		return;
...
void func_166(BOOL bParam0, BOOL bParam1) // Position - 0xBC2B (48171)
{
	if (bParam0)
	{
		if (func_168(0))
...
BOOL func_167() // Position - 0xBC9F (48287)
{
	return IS_BIT_SET(Global_1964705, 5);
}

BOOL func_168(int iParam0) // Position - 0xBCAD (48301)
{
	if (iParam0 == 1)
...
BOOL func_169() // Position - 0xBD04 (48388)
{
	return IS_BIT_SET(Global_1964705, 19);
}

BOOL func_170(int iParam0) // Position - 0xBD13 (48403)
{
...
BOOL func_171(int iParam0) // Position - 0xBD54 (48468)
{
	int num;
...
void func_172(int iParam0) // Position - 0xBD99 (48537)
{
...
int func_173(int iParam0, int iParam1, int iParam2, BOOL bParam3, int iParam4) // Position - 0xBDCB (48587)
{
	int i;
...
void func_174(int iParam0, int iParam1) // Position - 0xBF02 (48898)
{
	int i;
...
BOOL _CAN_ENTER_FREEROAM_STATE(int iParam0) // Position - 0xBF51 (48977)
{
	return func_176(iParam0, Global_44886);
}

BOOL func_176(int iParam0, int iParam1) // Position - 0xBF62 (48994)
{
	if (iParam1 == 15)
		return 1;
...
BOOL func_177(int iParam0) // Position - 0xC157 (49495)
{
	if (Global_44886 == 15)
		return false;
...
int func_178() // Position - 0xC179 (49529)
{
	return func_179(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_179(const char* sParam0, int iParam1) // Position - 0xC18A (49546)
{
	int num;
	const char* str;
	Hash hashKey;
...
BOOL func_180() // Position - 0xC1D3 (49619)
{
	if (Global_102454 == 10 || Global_102454 == 9)
		return true;
...
void func_181(int iParam0, var uParam1) // Position - 0xC1F7 (49655)
{
	switch (iParam0)
	{
		case 0:
...
Blip func_182(float fParam0, float fParam1, float fParam2, BOOL bParam3) // Position - 0xC666 (50790)
{
	Blip blip;
...
var func_183(BOOL bParam0, var uParam1, var uParam2) // Position - 0xC692 (50834)
{
	if (bParam0)
		return uParam1;
...
BOOL func_184(int iParam0) // Position - 0xC6A9 (50857)
{
	switch (iParam0)
	{
		case 0:
...
BOOL func_185(var uParam0, int iParam1) // Position - 0xC738 (51000)
{
	switch (uParam0->f_16)
	{
		case 0:
...
void func_186() // Position - 0xCF1B (53019)
{
	func_27(&(Global_105490.f_2890), &Global_105490, 0, 1, 1, 0);
	return;
}

BOOL func_187(var uParam0) // Position - 0xCF36 (53046)
{
	float num;
...
void func_188(int iParam0, var uParam1) // Position - 0xCFC4 (53188)
{
	if (iParam0 == 1)
	{
		if (!func_140(uParam1))
...
BOOL func_189(BOOL bParam0) // Position - 0xD028 (53288)
{
...
BOOL func_190(Vehicle veParam0) // Position - 0xD0BF (53439)
{
...
BOOL func_191(int iParam0) // Position - 0xD0E9 (53481)
{
	eCharacter character;
...
BOOL func_192() // Position - 0xD806 (55302)
{
	return Global_102493.f_1;
}

BOOL func_193() // Position - 0xD814 (55316)
{
	if (Global_99351 != -1)
...
BOOL func_194() // Position - 0xD837 (55351)
{
...
BOOL func_195() // Position - 0xD851 (55377)
{
	if (Global_80566)
		return true;
...
BOOL func_196() // Position - 0xD87B (55419)
{
	return Global_102506.f_418 > 0;
}

BOOL func_197(int iParam0, int iParam1) // Position - 0xD88C (55436)
{
	switch (iParam0)
	{
		case 5:
...
BOOL func_198() // Position - 0xD8C4 (55492)
{
	return Global_1575092;
}

BOOL func_199() // Position - 0xD8D0 (55504)
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
...
BOOL func_200(int iParam0) // Position - 0xD8EC (55532)
{
	switch (iParam0)
	{
		case 5:
...
void func_201(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5) // Position - 0xD90F (55567)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_215(PLAYER::PLAYER_PED_ID(), uParam1, true) <= 20f)
		...
		case 2:
			...
			else if (func_215(PLAYER::PLAYER_PED_ID(), uParam1, true) >= 25f)
			{
				func_155();
				*uParam0 = 0;
			}
...
BOOL _CONVERSATION_ADD_LINE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6) // Position - 0xD9AC (55724)
{
	func_214(uParam0, _CHAR_NULL, sParam1, iParam4, iParam5, iParam6);
...
BOOL func_203(char* sParam0, int iParam1, BOOL bParam2) // Position - 0xD9FA (55802)
{
	Global_23001 = 0;
...
void func_204() // Position - 0xDCC8 (56520)
{
	if (!func_205())
		return;
...
BOOL func_205() // Position - 0xDCFF (56575)
{
...
BOOL func_206(Player plParam0) // Position - 0xDD62 (56674)
{
	if (plParam0 == PLAYER::PLAYER_ID())
	{
		if (func_208(8))
...
BOOL func_207(Player plParam0, int iParam1) // Position - 0xDD99 (56729)
{
	return IS_BIT_SET(Global_1892798[plParam0 /*615*/].f_10.f_4, iParam1);
}

BOOL func_208(int iParam0) // Position - 0xDDB1 (56753)
{
	return IS_BIT_SET(Global_2733138.f_6050, iParam0);
}

void func_209() // Position - 0xDDC3 (56771)
{
	int i;
...
void func_210() // Position - 0xDDF5 (56821)
{
...
BOOL func_211() // Position - 0xDE8A (56970)
{
	int num;
	int weaponHash;
...
void _UPDATE_CURRENT_PLAYER_CHARACTER() // Position - 0xDF23 (57123)
{
	if (func_59(14))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
...
void func_213() // Position - 0xDFC5 (57285)
{
	int i;
...
void func_214(var uParam0, eCharacter echParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE01D (57373)
{
...
float func_215(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, BOOL bParam4) // Position - 0xE073 (57459)
{
...
void func_216(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, BOOL bParam9, int iParam10) // Position - 0xE0AD (57517)
{
	int taskSequenceId;
	int num;
...
BOOL func_217(var uParam0, var uParam1, var uParam2, var uParam3, char* sParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9) // Position - 0xE14A (57674)
{
	var unk;

	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()) && _DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]) && !func_157() && MISC::GET_GAME_TIMER() - uParam0->f_60 > iParam8 && func_215(PLAYER::PLAYER_PED_ID(), uParam1, true) < fParam9)
	{
		unk = 16;
...
void _CONVERSATION_ADD_LINE_NO_SUBTITLE(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE1D2 (57810)
{
...
BOOL _DOES_ENTITY_EXIST_AND_IS_ALIVE(Ped pedParam0) // Position - 0xE20D (57869)
{
	if (ENTITY::DOES_ENTITY_EXIST(pedParam0))
		if (!ENTITY::IS_ENTITY_DEAD(pedParam0, false))
			return true;
...
void func_220(var uParam0, const char* sParam1, var uParam2, var uParam3, var uParam4) // Position - 0xE22E (57902)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_215(PLAYER::PLAYER_PED_ID(), uParam2, true) <= 100f)
					func_223(uParam0, 1);
			}
			else
			{
				...
				if (func_215(PLAYER::PLAYER_PED_ID(), uParam2, true) > 120f)
					func_225(uParam0);
			}
		}
	}
...
void func_221(int iParam0, BOOL bParam1) // Position - 0xE31F (58143)
{
	if (iParam0 == -1)
		return;
...
int func_222(int iParam0) // Position - 0xE35B (58203)
{
	if (Global_80301 == iParam0)
		if (Global_80302 == -1)
...
void func_223(var uParam0, int iParam1) // Position - 0xE394 (58260)
{
	BOOL flag;
	int i;
...
BOOL func_224() // Position - 0xE432 (58418)
{
	return Global_99738;
}

void func_225(var uParam0) // Position - 0xE43E (58430)
{
	CUTSCENE::STOP_CUTSCENE(false);
	CUTSCENE::REMOVE_CUTSCENE();
	func_226(uParam0);
...
void func_226(var uParam0) // Position - 0xE455 (58453)
{
	BOOL flag;
	int num;
	int i;
...
void func_227(int iParam0) // Position - 0xE53D (58685)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_228(Any* panParam0, BOOL bParam1) // Position - 0xE565 (58725)
{
	var unk;
	...
	if (func_265(*panParam0) || func_263(*panParam0) || Global_80551 == true)
		return true;
	...
	if (func_232(&(panParam0->f_48)) && bParam1)
		func_229(panParam0->f_28[0], &(panParam0->f_48), *panParam0);

	return true;
}

void func_229(Ped pedParam0, var uParam1, int iParam2) // Position - 0xE7D5 (59349)
{
	int taskSequenceId;
	int taskSequenceId2;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(pedParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_231(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(pedParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_230(iParam2) && !PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(pedParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if (func_231(uParam1) && uParam1->f_4 == 0 && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(pedParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_230(iParam2) || PED::IS_PED_FACING_PED(pedParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, false))
						TASK::TASK_PLAY_ANIM(pedParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, false, false, false);
					else
...
BOOL func_230(int iParam0) // Position - 0xEB2D (60205)
{
...
BOOL func_231(var uParam0) // Position - 0xEB4D (60237)
{
...
BOOL func_232(var uParam0) // Position - 0xEB65 (60261)
{
...
void func_233(var uParam0) // Position - 0xEB8A (60298)
{
	int i;
	int taskSequenceId;
...
void func_234(Object* pobParam0) // Position - 0xEE8E (61070)
{
...
void func_235(var uParam0) // Position - 0xEEB9 (61113)
{
	int i;
...
BOOL CHECK_VEHICLES_OK(var uParam0, BOOL bParam1, BOOL bParam2) // Position - 0xEF39 (61241)
{
	int i;
	int num;
	Vehicle playersLastVehicle;
...
BOOL func_237(Ped pedParam0, Vehicle veParam1) // Position - 0xF0F7 (61687)
{
...
BOOL func_238(var uParam0, BOOL bParam1, int iParam2) // Position - 0xF127 (61735)
{
	int i;
	int num;
...
BOOL func_239(int iParam0) // Position - 0xF3E3 (62435)
{
...
BOOL func_240(Ped pedParam0, int iParam1) // Position - 0xF417 (62487)
{
	float xSize;
...
BOOL func_241(Ped pedParam0, int iParam1) // Position - 0xF48D (62605)
{
	return func_242(pedParam0, PLAYER::PLAYER_PED_ID(), iParam1, 1, 250, 7);
}

BOOL func_242(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3, int iParam4, int iParam5) // Position - 0xF4A5 (62629)
{
	BOOL flag;
	var pedBoneCoords;
	int num;
...
BOOL func_243(var uParam0, Vector3 vParam1, var uParam2, var uParam3, Ped pedParam4, var uParam5, Ped pedParam6, int iParam7) // Position - 0xF566 (62822)
{
	var hit;
	var endCoords;
	var surfaceNormal;
...
Vector3 func_244(Ped pedParam0, int iParam1) // Position - 0xF692 (63122)
{
...
int func_245() // Position - 0xF757 (63319)
{
	int i;
...
BOOL func_246(Ped pedParam0, Ped pedParam1, int iParam2, int iParam3) // Position - 0xF7A1 (63393)
{
	var unk;
...
float func_247(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5) // Position - 0xF832 (63538)
{
	return (fParam0 * uParam3) + (fParam0.f_1 * uParam3.f_1) + (fParam0.f_2 * uParam3.f_2);
}

Vector3 func_248(float fParam0, var uParam1, var uParam2) // Position - 0xF853 (63571)
{
	float num;
	float num2;
...
void func_249(var uParam0) // Position - 0xF892 (63634)
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_250(Ped pedParam0, Ped pedParam1) // Position - 0xF8AD (63661)
{
	int i;
...
BOOL func_251(Ped pedParam0) // Position - 0xF8EC (63724)
{
...
BOOL func_252(Ped pedParam0, BOOL bParam1, BOOL bParam2, BOOL bParam3, BOOL bParam4) // Position - 0xF914 (63764)
{
	float radius;
	float num;
	int weaponHash;
...
BOOL func_253(Ped pedParam0, float fParam1, BOOL bParam2, BOOL bParam3) // Position - 0xFA0F (64015)
{
	float entityCoords;
	float num;
...
BOOL func_254(Ped pedParam0, float fParam1) // Position - 0xFB1B (64283)
{
	var outProjectile;
	var outCoords;
...
BOOL func_255(Ped pedParam0, var uParam1, var uParam2, var uParam3, float fParam4, int iParam5) // Position - 0xFBB0 (64432)
{
	var unk;
	var entityForwardVector;
	float num;
...
BOOL func_256(Ped pedParam0, BOOL bParam1, float fParam2, float fParam3) // Position - 0xFC3E (64574)
{
	if (bParam1)
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
BOOL func_257(int iParam0) // Position - 0xFC86 (64646)
{
...
void func_258(Vehicle veParam0) // Position - 0xFCD0 (64720)
{
	int taskSequenceId;
...
BOOL func_259(int iParam0) // Position - 0xFD6D (64877)
{
	if (iParam0 == -1)
		iParam0 = func_178();
...
BOOL func_260(int iParam0) // Position - 0xFE02 (65026)
{
...
BOOL func_261() // Position - 0xFE41 (65089)
{
	if (MISC::IS_PC_VERSION())
...
BOOL func_262() // Position - 0xFE5E (65118)
{
	if (Global_99351 != -1)
...
BOOL func_263(int iParam0) // Position - 0xFE81 (65153)
{
...
BOOL func_264() // Position - 0xFEB5 (65205)
{
...
BOOL func_265(int iParam0) // Position - 0xFEF3 (65267)
{
	if (func_119(false))
...
void func_266() // Position - 0xFF1B (65307)
{
	var unk;
	float num;
	...
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(PLAYER::PLAYER_PED_ID()))
		if (func_267(PLAYER::PLAYER_PED_ID(), unk, num, true))
			func_163();

	return;
}

BOOL func_267(Ped pedParam0, Vector3 vParam1, var uParam2, var uParam3, float fParam4, BOOL bParam5) // Position - 0xFF5E (65374)
{
	return BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(pedParam0, bParam5), vParam1) <= fParam4 * fParam4;
}

void func_268(var uParam0) // Position - 0xFF7C (65404)
{
	if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_28[0]))
	{
...
void func_269(var uParam0) // Position - 0xFFEC (65516)
{
	int i;
...
void _CONVERSATION_INITIALIZE_ACTOR(var uParam0, int iParam1, Ped pedParam2, char* sParam3, int iParam4, int iParam5) // Position - 0x10087 (65671)
{
...
BOOL func_272(var uParam0) // Position - 0x10151 (65873)
{
	...
	{
		func_274(&uLocal_95);
		func_273(&uLocal_95, "democ_only_works");
		func_273(&uLocal_95, "gift_from_god");
		func_273(&uLocal_95, "rigged_vote");
		func_273(&uLocal_95, "suck_my");
		func_273(&uLocal_95, "tyranny");
	}
...
void func_273(var uParam0, char* sParam1) // Position - 0x10233 (66099)
{
...
void func_274(var uParam0) // Position - 0x1025C (66140)
{
	int i;
...
BOOL func_275(var uParam0) // Position - 0x10289 (66185)
{
	uParam0->f_16 = 3;
...
BOOL func_276(var uParam0) // Position - 0x102B4 (66228)
{
	int num;
	var unk4;
	var unk7;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_278(&uParam0->f_35[0], num[0], unk4, num2);
			...
			{
				func_277(&uParam0->f_41[0], num[1], unk4 + vector, 0f);
			...
			{
				func_278(&uParam0->f_35[1], num[2], unk7, num3);
...
void func_277(Object* pobParam0, Hash hParam1, float fParam2, float fParam3, float fParam4, float fParam5) // Position - 0x1053A (66874)
{
	func_234(pobParam0);
...
void func_278(Vehicle* pveParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5) // Position - 0x10561 (66913)
{
	func_279(pveParam0);
...
void func_279(Vehicle* pveParam0) // Position - 0x105A4 (66980)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
BOOL func_280(var uParam0) // Position - 0x10640 (67136)
{
	int i;
...
BOOL func_281(var uParam0) // Position - 0x10671 (67185)
{
	int num;
	var unk5;
	Vector3 vector;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			flag = true;
			func_278(&uParam0->f_35[0], num[0], unk5, num2);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_277(&uParam0->f_41[0], num[1], unk5 + vector, 0f);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
				func_278(&uParam0->f_35[1], num[2], unk10, num3);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				func_282(&uParam0->f_28[0], num[3], unk10, num3, PED_TYPE_COP);
		
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
				func_282(&uParam0->f_28[1], num[3], unk10, num3, PED_TYPE_COP);
...
void func_282(Ped* ppedParam0, Hash hParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, ePedType eptParam6) // Position - 0x109C1 (68033)
{
	func_283(ppedParam0);
...
void func_283(Ped* ppedParam0) // Position - 0x109E2 (68066)
{
...
BOOL func_284(var uParam0) // Position - 0x10A23 (68131)
{
	int num;
	var unk3;
	float num2;
	...
	switch (iLocal_89)
	{
		...
		case 1:
			if (!func_280(&num) || !func_288(&(uParam0->f_48)))
				return false;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_285(&uParam0->f_28[0], CHAR_BARRY, unk3, num2, "RC LAUNCHER: BARRY 3", 1))
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_277(&uParam0->f_41[0], num[1], unk3 + { 0f, 0f, 5f }, -115.18f);
...
BOOL func_285(Ped* ppedParam0, eCharacter echParam1, var uParam2, var uParam3, var uParam4, float fParam5, char* sParam6, int iParam7) // Position - 0x10C1B (68635)
{
	if (func_286(ppedParam0, echParam1, uParam2, fParam5, true))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*ppedParam0, false))
...
BOOL func_286(Ped* ppedParam0, eCharacter echParam1, Vector3 vParam2, var uParam3, var uParam4, float fParam5, BOOL bParam6) // Position - 0x10C77 (68727)
{
	Hash model;

	if (!func_36(echParam1))
	{
		model = func_328(echParam1);
...
int func_287(Ped pedParam0, eCharacter echParam1) // Position - 0x10D05 (68869)
{
	int num;
...
BOOL func_288(var uParam0) // Position - 0x10D4B (68939)
{
	if (func_232(uParam0))
	{
...
void func_289(var uParam0, char* sParam1, char* sParam2, char* sParam3) // Position - 0x10D75 (68981)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
BOOL func_290(var uParam0) // Position - 0x10DB1 (69041)
{
	int num;
	Vector3 vector;
	float heading;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_285(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 2", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_277(&uParam0->f_41[0], num[1], 189.5964f, -956.0344f, 29.09179f, func_292(-2.01f));
			
				if (_DOES_ENTITY_EXIST_AND_IS_ALIVE(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], true);
					func_277(&uParam0->f_41[2], num[3], 189.79015f, -956.1675f, 29.8229f, func_292(-2.01f));
			...
			{
				func_277(&uParam0->f_41[1], num[2], 190.417f, -956.511f, 29.09179f, -99.157f);
...
void func_291(Object* pobParam0, Hash hParam1) // Position - 0x11150 (69968)
{
	var unk;
	float num;
	...
	num = 23.45f;
	func_277(pobParam0, hParam1, unk, num);
	return;
}

float func_292(float fParam0) // Position - 0x11180 (70016)
{
	return fParam0 * 57.29578f;
}

BOOL func_293(var uParam0) // Position - 0x11190 (70032)
{
	int num;
	Vector3 vector;
	float heading;
	...
	switch (iLocal_89)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
				if (func_285(&uParam0->f_28[0], CHAR_BARRY, vector, heading, "RC LAUNCHER: BARRY 1", 1))
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				else
					flag = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_277(&uParam0->f_41[1], num[2], 190.2574f, -956.3513f, 29.09179f, func_292(-1.68f));
		...
		case 3:
			...
			func_277(&uParam0->f_41[4], num[5], 189.895f, -955.945f, 29.818f, 0f);
			...
			func_277(&uParam0->f_41[3], num[4], 189.783f, -956.015f, 29.79f, 0f);
...
BOOL func_294(int iParam0) // Position - 0x115EF (71151)
{
	var unk;
	eCharacter character;
...
BOOL func_295(int iParam0) // Position - 0x11640 (71232)
{
	const char* string2;
...
BOOL func_296(int iParam0) // Position - 0x116F9 (71417)
{
	var unk;
...
BOOL func_297(int iParam0) // Position - 0x117BA (71610)
{
	int i;
	var interiorType;
	Interior interiorAtCoordsWithType;
...
BOOL func_298(int iParam0, char* sParam1) // Position - 0x1183F (71743)
{
...
BOOL func_299(int iParam0) // Position - 0x11921 (71969)
{
...
BOOL func_300(int iParam0) // Position - 0x1194C (72012)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_301(int iParam0) // Position - 0x11977 (72055)
{
	if (iParam0 == 63 || iParam0 == -1)
		return false;
...
BOOL func_302(int iParam0) // Position - 0x119A2 (72098)
{
	if (func_260(iParam0))
		return false;
	else if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_303() // Position - 0x119D7 (72151)
{
...
BOOL func_304(var uParam0, var uParam1, var uParam2, var uParam3, float fParam4) // Position - 0x119F1 (72177)
{
	int num;
	int i;
	...
	for (i = 0; i < num; i = i + 1)
	{
		if (func_305(num[i], uParam1, fParam4, uParam0))
		{
			i = num;
			return true;
		}
...
BOOL func_305(int iParam0, var uParam1, var uParam2, var uParam3, float fParam4, var uParam5) // Position - 0x11A82 (72322)
{
	int num;
	char* str;
	...
	if (func_306(str.f_6, uParam1, fParam4, false))
	{
...
BOOL func_306(float fParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, float fParam6, BOOL bParam7) // Position - 0x11AFA (72442)
{
	if (fParam6 < 0f)
		fParam6 = 0f;
...
void func_307(var uParam0, BOOL bParam1) // Position - 0x11B75 (72565)
{
	char* str;
...
void func_308(char* sParam0) // Position - 0x11C0A (72714)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
		if (func_311(sParam0))
			func_309();
...
void func_309() // Position - 0x11C29 (72745)
{
	Global_21866 = 0;
	func_310();
	return;
...
void func_310() // Position - 0x11C39 (72761)
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_24011 = 0;
...
BOOL func_311(char* sParam0) // Position - 0x11C5A (72794)
{
	var string1;
...
struct<6> func_312() // Position - 0x11C7A (72826)
{
	var unk;
...
int func_313(var uParam0) // Position - 0x11C9E (72862)
{
	if (func_232(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_314(var uParam0, int iParam1, BOOL bParam2, BOOL bParam3) // Position - 0x11CD4 (72916)
{
...
void func_315(var uParam0, BOOL bParam1) // Position - 0x11CF4 (72948)
{
	func_316(&(uParam0->f_41), bParam1);
	return;
}

void func_316(var uParam0, BOOL bParam1) // Position - 0x11D06 (72966)
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (bParam1)
			...
			func_317(&uParam0->[i], false);
	}

	return;
}

void func_317(Object* pobParam0, BOOL bParam1) // Position - 0x11D44 (73028)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pobParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*pobParam0))
...
void func_318(var uParam0, BOOL bParam1) // Position - 0x11D7F (73087)
{
	func_319(&(uParam0->f_35), bParam1);
	return;
}

void func_319(var uParam0, BOOL bParam1) // Position - 0x11D91 (73105)
{
	int i;
...
void func_320(Vehicle* pveParam0) // Position - 0x11DCE (73166)
{
	if (ENTITY::DOES_ENTITY_EXIST(*pveParam0))
	{
...
void func_321(var uParam0, int iParam1) // Position - 0x11E06 (73222)
{
	func_322(&(uParam0->f_28), iParam1);
	return;
}

void func_322(var uParam0, int iParam1) // Position - 0x11E18 (73240)
{
	int i;
	...
	for (i = 0; i <= *uParam0 - 1; i = i + 1)
	{
		if (iParam1 == 1)
			...
			func_323(&uParam0->[i], false, 1, 0);
	}

	return;
}

void func_323(Ped* ppedParam0, BOOL bParam1, int iParam2, int iParam3) // Position - 0x11E59 (73305)
{
	if (ENTITY::DOES_ENTITY_EXIST(*ppedParam0))
	{
...
void func_324(int iParam0) // Position - 0x11EA9 (73385)
{
	if (*iParam0 == -1)
		return;
...
void func_325(char* sParam0) // Position - 0x11EE6 (73446)
{
	!MISC::IS_STRING_NULL_OR_EMPTY(sParam0);
	return;
}

void func_326(var uParam0) // Position - 0x11EF8 (73464)
{
	*uParam0 = -1;
...
void func_327() // Position - 0x11F2B (73515)
{
...
Hash func_328(eCharacter echParam0) // Position - 0x11F45 (73541)
{
	if (!func_36(echParam0))
