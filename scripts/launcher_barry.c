...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, Ped pedParam5) // Position - 0x1A8F (6799)
{
	int i;
	eCharacter j;
...
void func_27(var uParam0, var uParam1, Ped pedParam2, int iParam3, int iParam4, int iParam5) // Position - 0x293A (10554)
{
	Vehicle vehicle;
...
int func_28(var uParam0, var uParam1, Vehicle veParam2, int iParam3) // Position - 0x29C2 (10690)
{
...
int func_83() // Position - 0x77FD (30717)
{
...
BOOL func_86(Player plParam0) // Position - 0x7841 (30785)
{
...
BOOL func_94(Player plParam0) // Position - 0x86FA (34554)
{
	if (plParam0 != _INVALID_PLAYER_INDEX())
...
void func_214(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5) // Position - 0xE01D (57373)
{
...
BOOL func_228(Any* panParam0, BOOL bParam1) // Position - 0xE565 (58725)
{
	...
	if (func_265(*panParam0) || func_263(*panParam0) || Global_80551 == 1)
		return true;
...
int func_287(var uParam0, eCharacter echParam1) // Position - 0x10D05 (68869)
{
	int num;
